...
public class StormTrackParserTest {
    ...
    public void testProcessWarnTime() {
        ...
        assertEquals(warnTimeD.get(Calendar.MONTH),
                warnTime.get(Calendar.MONTH));
        assertEquals(warnTimeD.get(Calendar.DAY_OF_MONTH),
                warnTime.get(Calendar.DAY_OF_MONTH));
        assertEquals(warnTimeD.get(Calendar.HOUR_OF_DAY),
                warnTime.get(Calendar.HOUR_OF_DAY));
