...
public class NcUairTimeGroupTest {
	...
	public void testTimeField() {
		...
		NcUairTimeGroup.TimeField(report);
		String obsUTC = NcUairTimeGroup.getObsUTC();
		String UTC = NcUairTimeGroup.getUTC();
		int topwind = NcUairTimeGroup.getTopwind();
		Boolean windKnot = NcUairTimeGroup.getWindKnot();
