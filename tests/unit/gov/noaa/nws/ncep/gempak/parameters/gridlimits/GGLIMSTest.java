...
public class GGLIMSTest {
    ...
    public void testGGLIMSString() {
        ...
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
        System.out.println("The minimum grid value = "
                + gglimitsObj.getMinValue());
        System.out.println("The upper grid limit   = "
                + gglimitsObj.getUpperLimit());
        System.out.println("The maximum grid value = "
                + gglimitsObj.getMaxValue());
        System.out.println("The default value      = "
                + gglimitsObj.getDefaultGridValue());
    ...
    public void testGGLIMSStringWithoutDefaultValue() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test valid GGLIMS string of the form lowerLimit;minValue|upperLimit;maxValue");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    /**
     * Test valid GGLIMS string of the form
     * <tt>lowerLimit;minValue|upperLimit;|defaultValue</tt>
     */
    @Test
    public void testGGLIMSStringWithoutMaxValue() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test valid GGLIMS string of the form lowerLimit;minValue|upperLimit;|defaultValue");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    /**
     * Test valid GGLIMS string of the form
     * <tt>lowerLimit;minValue|  ; maxValue|defaultValue</tt>
     */
    @Test
    public void testGGLIMSStringWithoutUpperLimit() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test valid GGLIMS string of the form lowerLimit;minValue|  ;maxValue|defaultValue");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    /**
     * Test for valid GGLIMS string of the form
     * <tt>  lowerLimit|upperLimit;maxValue|defaultValue</tt>
     */
    @Test
    public void testGGLIMSStringWithoutMinValue() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test for valid GGLIMS string of the form lowerLimit|upperLimit;maxValue|defaultValue");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    /**
     * Test for valid GGLIMS string of the form
     * <tt>  ;minValue|upperLimit;maxValue|defaultValue</tt>
     */
    @Test
    public void testGGLIMSStringWithoutLowerLimit() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test for valid GGLIMS string of the form ;minValue|upperLimit;maxValue|defaultValue");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    /**
     * Test valid GGLIMS string of the form
     * <tt>lowerLimit;minValue|  ;  |defaultValue</tt>
     */
    @Test
    public void testGGLIMSStringWithoutUpperLimitAndMaxValue() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test valid GGLIMS string of the form lowerLimit;minValue|   ;  |defautValue");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    public void testGGLIMSStringWithUpperLimitAndMaxValueOnly() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test valid GGLIMS string of the form |upperLimit;maxValue|");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    public void testGGLIMSStringWithLowerLimitAndMinValueOnly() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test valid GGLIMS string of the form lowerLimit;minValue||");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    public void testGGLIMSStringWithLowerLimitOnly() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test valid GGLIMS string of the form lowerLimit;  ||");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    public void testGGLIMSStringWithMinValueOnly3() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test valid GGLIMS string of the form   ;minValue  ");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    public void testGGLIMSStringWithUpperLimitOnly() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test valid GGLIMS string of the form | upperLimit;  |");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    public void testGGLIMSStringWithMaxValueOnly2() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test valid GGLIMS string of the form   ;  |;maxValue|");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    public void testGGLIMSStringWithDefaultOnly() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test for valid GGLIMS string of the form  |   |defaultValue");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    public void testGGLIMSStringWithLowerLimitAndDefaultOnly() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test for valid GGLIMS string of the form  lowerLimit|   |defaultValue");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    public void testGGLIMSStringWithMinValueAndDefaultOnly() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test for valid GGLIMS string of the form  ;minValue|   |defaultValue");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    public void testGGLIMSStringWithUpperLimitAndDefaultOnly() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test for valid GGLIMS string of the form   |upperLimit|defaultValue");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    public void testGGLIMSStringWithMaxValueAndDefaultOnly() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test for valid GGLIMS string of the form   |   ; maxValue|defaultValue");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    public void testGGLIMSStringWithLowerAndUpperLimitsExchanged() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test valid GGLIMS string with lower and upper limits exchanged");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    /**
     * Test valid GGLIMS string with lower and upper limits set to the same
     * value
     */
    @Test
    public void testGGLIMSStringWithEqualLowerAndUpperLimits() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test valid GGLIMS string with lower and upper limits set to the same value");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
    ...
    public void testGGLIMSStringWithExtraArguments() {
        ...
        GGLIMS gglimitsObj = new GGLIMS(
                "0.2;0.1;0.8880.9999|0.9;1;345|0.5;14.369");
        assertEquals(gglimitsObj.getLowerLimit(), 0.2);
        assertEquals(gglimitsObj.getMinValue(), 0.1);
        assertEquals(gglimitsObj.getUpperLimit(), 0.9);
        assertEquals(gglimitsObj.getMaxValue(), 1);
    ...
    public void testGGLIMSWithInvalidDelimiters1() {
        ...
        System.out.println("=====================Test-Case " + testCaseNumber
                + " ========================");
        System.out
                .println("Test GGLIMS for invalid delimiter - when '|' is replaced with '/'");
        System.out.println("The input string       = "
                + gglimitsObj.getGgLimitsStr());
        System.out.println("The lower grid limit   = "
                + gglimitsObj.getLowerLimit());
