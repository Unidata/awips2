...
public class LineDataStringParserTest {
    ...
    public void testValidLineDataStringWithAllInputsAndBlanksWithinInputString() {
        ...
        if (ldsp1.isLineDataParsed()) {
            ...
            System.out.println("The input string : "
                    + ldsp1.getLineDataString());
            System.out.println("List of line colors:  "
                    + ldsp1.getInstanceOfLineBuilder().getLineColorsList());
            System.out.println("List of line patterns: "
                    + ldsp1.getInstanceOfLineBuilder().getLinePatternsList());
            System.out.println("List of line widths: "
                    + ldsp1.getInstanceOfLineBuilder().getLineWidthList());
            System.out.println("List of lines to be labelled: "
                    + ldsp1.getInstanceOfLineBuilder()
                            .getLineLabelPresentList());
            System.out.println("Smoothing Level: "
                    + ldsp1.getInstanceOfLineBuilder().getLineSmoothingLevel());
            System.out.println("Points filter data: "
                    + ldsp1.getInstanceOfLineBuilder().getPointsFilter());
            System.out.println("Small Contour Flag: "
                    + ldsp1.getInstanceOfLineBuilder()
    ...
    public void testValidLineDataStringWithOnlyLineColorInput() {
        ...
        if (ldsp1.isLineDataParsed()) {
            ...
            System.out.println("The input string : "
                    + ldsp1.getLineDataString());
            System.out.println("Is line data parsed in test-case "
                    + testCaseNumber + "a? " + ldsp1.isLineDataParsed());
            System.out.println("List of line colors: "
                    + ldsp1.getInstanceOfLineBuilder().getLineColorsList());
            System.out.println("List of line patterns: "
                    + ldsp1.getInstanceOfLineBuilder().getLinePatternsList());
        ...
        if (ldsp2.isLineDataParsed()) {
            ...
            assertEquals(ldsp2.getInstanceOfLineBuilder()
                    .getLineSmoothingLevel().intValue(), 0);
            System.out.println("The input string : "
                    + ldsp2.getLineDataString());
            System.out.println("Is line data parsed in test-case "
                    + testCaseNumber + "b? " + ldsp1.isLineDataParsed());
            System.out.println("List of line colors: "
                    + ldsp2.getInstanceOfLineBuilder().getLineColorsList());
            System.out.println("List of line patterns: "
                    + ldsp2.getInstanceOfLineBuilder().getLinePatternsList());
            System.out.println("List of line widths: "
                    + ldsp2.getInstanceOfLineBuilder().getLineWidthList());
            System.out.println("List of lines to be labelled: "
                    + ldsp2.getInstanceOfLineBuilder()
                            .getLineLabelPresentList());
            System.out.println("Smoothing Level: "
                    + ldsp2.getInstanceOfLineBuilder().getLineSmoothingLevel());
            System.out.println("Points filter data: "
                    + ldsp2.getInstanceOfLineBuilder().getPointsFilter());
            System.out.println("Small Contour Flag: "
                    + ldsp2.getInstanceOfLineBuilder()
                            .isSmallContourFlagSuppressed());
            System.out
        ...
        if (ldsp3.isLineDataParsed()) {
            ...
            assertEquals(ldsp3.getInstanceOfLineBuilder()
                    .getLineSmoothingLevel().intValue(), 0);
            System.out.println("The input string : "
                    + ldsp3.getLineDataString());
            System.out.println("Is line data parsed in test-case "
                    + testCaseNumber + "c? " + ldsp1.isLineDataParsed());
            System.out.println("List of line colors: "
                    + ldsp3.getInstanceOfLineBuilder().getLineColorsList());
            System.out.println("List of line patterns: "
                    + ldsp3.getInstanceOfLineBuilder().getLinePatternsList());
            System.out.println("List of line widths: "
                    + ldsp3.getInstanceOfLineBuilder().getLineWidthList());
            System.out.println("List of lines to be labelled: "
                    + ldsp3.getInstanceOfLineBuilder()
                            .getLineLabelPresentList());
            System.out.println("Smoothing Level: "
                    + ldsp3.getInstanceOfLineBuilder().getLineSmoothingLevel());
            System.out.println("Points filter data: "
                    + ldsp3.getInstanceOfLineBuilder().getPointsFilter());
            System.out.println("Small Contour Flag: "
                    + ldsp3.getInstanceOfLineBuilder()
                            .isSmallContourFlagSuppressed());
            System.out
    ...
    public void testValidLineDataStringWithMultipleColorsAndFilterDataOnly() {
        ...
        if (ldsp1.isLineDataParsed()) {
            ...
            System.out.println("The input string : "
                    + ldsp1.getLineDataString());
            System.out.println("Is line data parsed in test-case "
                    + testCaseNumber + "? " + ldsp1.isLineDataParsed());
            System.out.println("List of line colors: "
                    + ldsp1.getInstanceOfLineBuilder().getLineColorsList());
            System.out.println("List of line patterns: "
                    + ldsp1.getInstanceOfLineBuilder().getLinePatternsList());
    ...
    public void testLineDataStringWithExcessInputs() {
        ...
        LineDataStringParser ldsp1 = new LineDataStringParser(
                "5;6;12/3;4/5;6/1/3/4/5/2/0.5/T");
    ...
    public void testLineDataStringWithNegativeLabel() {
        ...
        if (ldsp1.isLineDataParsed()) {
            ...
            System.out.println("Is line data parsed in test-case "
                    + testCaseNumber + "? " + ldsp1.isLineDataParsed());
            System.out.println("Is there a break in the line for the label: "
                    + ldsp1.getInstanceOfLineBuilder().isBreakInLineForLabel());
        }
        testCaseNumber++;
    ...
    public void testLineDataStringWithPositiveLabel() {
        ...
        LineDataStringParser ldsp2 = new LineDataStringParser(
                "5;6;12/3;4/5;6/1;2/0.5/T");
        ...
        if (ldsp1.isLineDataParsed()) {
            ...
            System.out.println("Is line data parsed in test-case "
                    + testCaseNumber + "b? " + ldsp1.isLineDataParsed());
            System.out.println("Is there a break in the line for the label: "
                    + ldsp2.getInstanceOfLineBuilder().isBreakInLineForLabel());
        }
