...
public class DiscreteTest {
    ...
    public void testGetDiscreteDataList() {
        ...
        Discrete discreteObj = new Discrete(
                "0.1~.5  =  0.444 ;   0.6  ~  0.9  =   0.75  ;   0.99  ~  1.15  =  1.105");
        testList = new ArrayList<Float>(Arrays.asList(0.1f, 0.5f, 0.444f, 0.6f,
                0.9f, 0.75f, 0.99f, 1.15f, 1.05f));
        System.out.println("Test-case: " + testCaseNumber);
        System.out
                .println("Test valid input string with multiple start/end/discrete value pair strings");
        System.out.println("The input string is "
                + discreteObj.getStrDiscrete());
        for (int i = 0; i < discreteObj.getDiscreteDataList().size(); i++) {

            System.out.println("-----------------");
            System.out.println("Element number:" + (i + 1));
            System.out.println("Start value = "
                    + discreteObj.getDiscreteDataList().get(i).getStartValue());
            System.out.println("End value = "
                    + discreteObj.getDiscreteDataList().get(i).getEndValue());
            System.out.println("Discrete value = "
                    + discreteObj.getDiscreteDataList().get(i)
                            .getDiscreteValue());
            if (i == 0) {
                assertFloatComparison(discreteObj.getDiscreteDataList().get(i)
                        .getStartValue(), testList.get(0));

                assertFloatComparison(discreteObj.getDiscreteDataList().get(i)
                        .getEndValue(), testList.get(1));

                assertFloatComparison(discreteObj.getDiscreteDataList().get(i)
                        .getDiscreteValue(), testList.get(2));
            } else if (i == 1) {
                assertFloatComparison(discreteObj.getDiscreteDataList().get(i)
                        .getStartValue(), testList.get(3));

                assertFloatComparison(discreteObj.getDiscreteDataList().get(i)
                        .getEndValue(), testList.get(4));

                assertFloatComparison(discreteObj.getDiscreteDataList().get(i)
                        .getDiscreteValue(), testList.get(5));
            } else if (i == 2) {
                assertFloatComparison(discreteObj.getDiscreteDataList().get(i)
                        .getStartValue(), testList.get(6));

                assertFloatComparison(discreteObj.getDiscreteDataList().get(i)
                        .getEndValue(), testList.get(7));

                assertFloatComparison(discreteObj.getDiscreteDataList().get(i)
                        .getDiscreteValue(), testList.get(8));
            }
        }
        System.out.println("==========================================");
        testCaseNumber++;
    ...
    /**
     * Test valid input string with multiple start/end/discrete value strings,
     * all of which are negative numbers
     */
    @Test
    public void testGetDiscreteDataListForNegativeNumbers() {
        ...
        Discrete discreteObj = new Discrete(
                "-0.1~ -.5  =  -0.444 ;   -0.6  ~  -0.9  =    -0.75  ;   -0.99  ~  -1.15  =  -1.105");
        testList = new ArrayList<Float>(Arrays.asList(-0.1f, -0.5f, -0.444f,
                -0.6f, -0.9f, -0.75f, -0.99f, -1.15f, -1.05f));
        System.out.println("Test-case: " + testCaseNumber);
        System.out
                .println("Test valid input string with multiple start/end/discrete value pair strings,  all of which are negative numbers");
        System.out.println("The input string is "
                + discreteObj.getStrDiscrete());
        for (int i = 0; i < discreteObj.getDiscreteDataList().size(); i++) {
    ...
    public void testDiscreteDataListWithMissingStartValueInFirstString() {
        ...
        Discrete discreteObj = new Discrete(
                "~.5=0.444;0.6~0.9=0.75;0.99~1.15=1.105");
        testList = new ArrayList<Float>(Arrays.asList(-Float.MAX_VALUE, 0.5f,
                0.444f, 0.6f, 0.9f, 0.75f, 0.99f, 1.15f, 1.05f));

        System.out.println("Test-case: " + testCaseNumber);
        System.out
                .println("Test valid input string with a missing start value in the first string");
        System.out.println("The input string is "
                + discreteObj.getStrDiscrete());
        for (int i = 0; i < discreteObj.getDiscreteDataList().size(); i++) {
    ...
    public void testDiscreteDataListWithMissingStartValueInSecondString() {
        ...
        Discrete discreteObj = new Discrete(
                "0.1~.5=0.444;~0.9=0.75;0.99~1.15=1.105");
        testList = new ArrayList<Float>(Arrays.asList(0.1f, 0.5f, 0.444f,
                Float.NaN, 0.9f, 0.75f, 0.99f, 1.15f, 1.05f));

        System.out.println("Test-case: " + testCaseNumber);
        System.out
                .println("Test input string with a missing start value in the second string.");
        System.out.println("The input string is "
                + discreteObj.getStrDiscrete());
        for (int i = 0; i < discreteObj.getDiscreteDataList().size(); i++) {
    ...
    public void testDiscreteDataListWithMissingEndValueInLastString() {
        ...
        Discrete discreteObj = new Discrete(
                "0.1~.5=0.444;0.6~0.9=0.75;0.99~=1.105");
        testList = new ArrayList<Float>(Arrays.asList(0.1f, 0.5f, 0.444f, 0.6f,
                0.9f, 0.75f, 0.99f, Float.MAX_VALUE, 1.05f));
        System.out.println("Test-case: " + testCaseNumber);
        System.out
                .println("Test valid input string with a missing end value in the last string\n");
        System.out.println("The input string is "
                + discreteObj.getStrDiscrete());
        for (int i = 0; i < discreteObj.getDiscreteDataList().size(); i++) {
    ...
    public void testDiscreteDataListWithMissingEndValueInSecondString() {
        ...
        Discrete discreteObj = new Discrete(
                "0.1~.5=0.444;0.6~=0.75;0.99~1.15=1.105");
        testList = new ArrayList<Float>(Arrays.asList(0.1f, 0.5f, 0.444f, 0.6f,
                Float.NaN, 0.75f, 0.99f, 1.15f, 1.05f));

        System.out.println("Test-case: " + testCaseNumber);
        System.out
                .println("Test input string with a missing end value in the second string\n");
        System.out.println("The input string is "
                + discreteObj.getStrDiscrete());
        for (int i = 0; i < discreteObj.getDiscreteDataList().size(); i++) {
    ...
    public void testDiscreteDataListWithMissingDiscreteValuesInAllStrings() {
        ...
        testList = new ArrayList<Float>(Arrays.asList(0.1f, 0.5f, Float.NaN,
                0.6f, 0.9f, 0.75f, Float.NaN, 1.15f, Float.NaN));

        System.out.println("Test-case: " + testCaseNumber);
        System.out
                .println("Test input string with missing discrete values in all strings\n");
        System.out.println("The input string is "
                + discreteObj.getStrDiscrete());
        for (int i = 0; i < discreteObj.getDiscreteDataList().size(); i++) {
    ...
    public void testDiscreteDataListWithInvalidDelimiters() {
        ...
        Discrete discreteObj = new Discrete(
                "0.1-.5=0.3,0.6-0.9=0.75,0.99-1.15=1.05");

        System.out.println("Test-case: " + testCaseNumber);
        System.out.println("Test input string with invalid delimiters\n");
        System.out.println("The input string is "
                + discreteObj.getStrDiscrete());
        System.out.println("Size of discrete data list = "
                + discreteObj.getDiscreteDataList().size());
    ...
    public void testDiscreteDataListWithAllNumbersMissing() {
        ...
        Discrete discreteObj = new Discrete(" ~ = ; ~ = ; ~ =");
        testList = new ArrayList<Float>(Arrays.asList(-Float.MAX_VALUE,
                Float.NaN, Float.NaN, Float.NaN, Float.NaN, Float.NaN,
                Float.NaN, Float.MAX_VALUE, Float.NaN));
    ...
    public void testGetDiscreteDataListForExtraArguments() {
        ...
        Discrete discreteObj = new Discrete(
                "-0.1 ~ -.5 ~ -0.5999  =  -0.444 ;   -0.6  ~  -0.9 ~ -0.9111  =    -0.75  ;   -0.99  ~  -1.15  =  -1.105");

        System.out.println("Test-case: " + testCaseNumber);
        System.out.println("Test Discrete with extra arguments");
        System.out.println("The input string is "
                + discreteObj.getStrDiscrete());
        System.out.println("Size of the discrete data list is "
                + discreteObj.getDiscreteDataList().size());
    ...
    public void testDiscreteDataListWithEmptyString() {
        ...
        System.out.println("Test empty string\n");
        System.out.println("The input string is "
                + discreteObj2.getStrDiscrete());
        System.out.println("Size of discrete data list = "
                + discreteObj2.getDiscreteDataList().size());
        ...
        System.out.println("Test empty string\n");
        System.out.println("The input string is "
                + discreteObj3.getStrDiscrete());
        System.out.println("Size of discrete data list = "
                + discreteObj3.getDiscreteDataList().size());
    ...
    public void testDiscreteDataListWithNonNumericInputs() {
        ...
        Discrete discreteObj = new Discrete(
                "0.1l~.S5=0.O3;0.O6~0.90=0.S75;0.J99~1Q.1$5=1.^05");
    ...
    public void testGetDiscreteValueLeftOfCurrentDiscreteValue() {
        Discrete discreteObj = new Discrete(
                "0.1~.5=0.444;0.6~0.9=0.75;0.99~1.15=1.105;1.25~4.5=3.6");

        System.out.println("Test-case: " + testCaseNumber);
        System.out
                .println("Test the method getDiscreteValueLeftOfCurrentDiscreteValue()\n");
        System.out.println("The input string is "
                + discreteObj.getStrDiscrete());

        System.out.println("Discrete Value to the left of 3.6 = "
                + discreteObj.getPrecedingDiscreteValue(3.6f));
        System.out.println("Discrete Value to the left of 0.444 = "
                + discreteObj.getPrecedingDiscreteValue(0.444f));
    ...
    public void testGetDiscreteValueClosestToTwoContourLines1() {
        Discrete discreteObj = new Discrete(
                "0.1~.5=0.444;0.6~0.9=0.75;0.99~1.15=1.105;1.25~3.5=3.6");

        System.out.println("Test-case: " + testCaseNumber);
        System.out
                .println("Test the method getDiscreteValueClosestToTwoContourLines() when the following conditions are satisfied:\n"
                        + "The absolute difference between the current start value and the first parameter in the function is\n"
                        + "less than "
                        + discreteObj.getTOLERANCE()
                        + "and \n"
        ...
        System.out.println("Discrete Value between 0.99 and 1.15 = "
     ...
     * Test the method getDiscreteValueClosestToTwoContourLines() when the
     * following conditions are satisfied: The absolute difference between the
     * current start value and the first parameter in the function is exactly
     * the tolerance value and The absolute difference between the current end
     * value and the second parameter in the function is less than the tolerance
     * value
     */
    ...
    public void testGetDiscreteValueClosestToTwoContourLines2() {
        Discrete discreteObj = new Discrete(
                "0.1~.5=0.444;0.6~0.9=0.75;0.99~1.15=1.105;1.25~2.5=3.6");
        ...
        System.out.println("Discrete Value between 0.990001 and 1.15 = "
     ...
     * current start value and the first parameter in the function is less than
     * the tolerance value and The absolute difference between the current end
     * value and the second parameter in the function is exactly the tolerance
     * value
     */
    @Test
    public void testGetDiscreteValueClosestToTwoContourLines3() {
        ...
        System.out.println("Discrete Value between 0.99 and 1.150001 = "
                + discreteObj.getDiscreteValueClosestToTwoContourLines(0.99f,
                        1.150001f));
        assertFloatComparison(
                discreteObj.getDiscreteValueClosestToTwoContourLines(0.99f,
     ...
     * Test the method getDiscreteValueClosestToTwoContourLines() when the
     * following conditions are satisfied: The absolute difference between the
     * negative of current start value and the Float MAX is less than the
     * tolerance value The first parameter in the function is >= the current
     * starting value The absolute difference between the current end value and
     * the second parameter in the function is less than the tolerance value
     */
    @Test
    public void testGetDiscreteValueClosestToTwoContourLines4() {
        Discrete discreteObj = new Discrete(
                "~.5=0.444;0.6~0.9=0.75;0.99~1.15=1.105;1.25~2.5=3.6");
        ...
        System.out.println("Discrete Value between Float.MAX-VALUE and 1.15 = "
                + discreteObj.getDiscreteValueClosestToTwoContourLines(
    ...
    public void testGetDiscreteValueClosestToTwoContourLines5() {
        Discrete discreteObj = new Discrete(
                "0.1~.5=0.444;0.6~0.9=0.75;0.99~1.15=1.105;1.25~=3.6");
        ...
        System.out.println("Discrete Value between 1.25 and Float.MAX-VALUE = "
    ...
    /**
     * Test Discrete class when only a single value1-value2=value3; pair is
     * given
     */
    ...
    public void testSingleString() {
        ...
        System.out.println("Test-case: " + testCaseNumber);
        System.out
                .println("Test Discrete class when only a single value1-value2=value3; pair is given\n");
        System.out.println("The input string is "
                + discreteObj.getStrDiscrete());
        System.out.println("The size of the list"
                + discreteObj.getDiscreteDataList().size());
        System.out.println("The starting value="
                + discreteObj.getDiscreteDataList().get(0).getStartValue());
        System.out.println("The ending value="
                + discreteObj.getDiscreteDataList().get(0).getEndValue());
        System.out.println("The discrete value="
                + discreteObj.getDiscreteDataList().get(0).getDiscreteValue());
    ...
    public void testSingleString3() {
        ...
        System.out.println("Test-case: " + testCaseNumber);
        System.out
                .println("Test Discrete class when only a single value1-value2=value3; pair is given, but with value1 missing\n");
        System.out.println("The input string is "
                + discreteObj.getStrDiscrete());
        System.out.println("The size of the list"
                + discreteObj.getDiscreteDataList().size());
    ...
    /**
     * Test Discrete class when only a single value1-value2=value3 pair is
     * given, but with both value1 and value2 missing
     */
    ...
    public void testSingleString5() {
        ...
        System.out.println("Test-case: " + testCaseNumber);
        System.out
                .println("Test Discrete class when only a single value1-value2=value3; pair is given, but "
