...
@Table(name = "bufrmosEta", uniqueConstraints = { @UniqueConstraint(name = "uk_bufrmoseta_datauri_fields", columnNames = { "dataURI" }) })
/*
 * Both refTime and forecastTime are included in the refTimeIndex since
 * forecastTime is unlikely to be used.
 */
@org.hibernate.annotations.Table(appliesTo = "bufrmosEta", indexes = { @Index(name = "bufrmosEta_refTimeIndex", columnNames = {
