...
@Table(name = "bufrmosGfs", uniqueConstraints = { @UniqueConstraint(name = "uk_bufrmosgfs_datauri_fields", columnNames = { "dataURI" }) })
/*
 * Both refTime and forecastTime are included in the refTimeIndex since
 * forecastTime is unlikely to be used.
 */
@org.hibernate.annotations.Table(appliesTo = "bufrmosGfs", indexes = { @Index(name = "bufrmosGfs_refTimeIndex", columnNames = {
