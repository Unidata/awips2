 ...
 * Jul 30, 2019  7002     randerso   Removed unused getTimeZoneCode method. Code
 *                                   cleanup.
 *
 * </pre>
 *
...
public class ShefRecord extends PluginDataObject {
    ...
    @Transient
    protected List<String> commentArray = new ArrayList<>();
    ...
    public void setRecordDate(String recordDate) throws ParseException {
        ...
        if (recordDate.length() == 4) {
            ...
            synchronized (ShefConstants.YYYYMMDD_FORMAT) {
                recordDateObj = ShefConstants.YYYYMMDD_FORMAT
                        .parse(year + recordDate);
            }
