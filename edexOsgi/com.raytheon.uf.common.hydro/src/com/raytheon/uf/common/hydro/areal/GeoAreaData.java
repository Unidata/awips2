 ...
 * Aug 28, 2018 6979       mduff       Moved to hydrocommon, added getAreaCoordinates.
 *
 * </pre>
 *
 * @author mpduff
...
public class GeoAreaData {
    ...
    /**
     * Returns a list of the lat/lon pairs as Coordinate objects.
     * 
     * @return coordinateList
     */
    public Coordinate[] getAreaCoordinates() {
        List<Coordinate> coordinateList = new ArrayList<>();
        for (int i = 0; i < numberPoints; i++) {
            Coordinate c = new Coordinate(lon[i], lat[i]);
