 ...
 * Mar 11, 2020 19533  mgamazaychikov  Added constants
 * 
 * </pre>
 * 
 * @author skorolev
...
public class CommonHydroConstants {
    ...
    public static final String[] IMPORT_LOGS = { "process_geoarea_ZONE.log", "process_geoarea_COUNTY.log",
            "process_geoarea_BASIN.log", "process_geoarea_RESRVR.log" };

    /**
     * IHFS Date format String. Use this format to create a SimpleDateFormat
     * object locally for thread safety.
     */
    public static final String IHFS_DATE_FORMAT = "yyyy-MM-dd HH:mm:ss";
}
