 ...
 * Jul 26, 2016 5757       nabowle     Remove unused dataDir field.
...
public class SoundingBuilder {
    ...
    public ACARSSoundingRecord[] createSoundings(IntermediateData data,
        ...
        List<ACARSSoundingRecord> soundings = new ArrayList<>();
    ...
    private List<List<ACARSRecord>> findBreaks(List<ACARSRecord> obsData) {
        List<List<ACARSRecord>> breaks = new ArrayList<>();

        List<ACARSRecord> tList = new ArrayList<>();
        breaks.add(tList);
    ...
    private static List<ACARSSoundingLayer> getLayers(
        ...
        List<ACARSSoundingLayer> layers = new ArrayList<>();
    ...
    private List<ACARSRecord> fixupObservations(List<ACARSRecord> obsData) {
        ...
        List<List<ACARSRecord>> times = new ArrayList<>();
        List<ACARSRecord> currTime = new ArrayList<>();
        times.add(currTime);
