...
import com.raytheon.uf.edex.backupsvc.service.BackupServiceException;
...
public class BackupEnqueueHandler
    ...
    private void enqueue(IServerRequest request, String jobName, int priority,
        ...
        DeflatedRequest deflatedRequest = new DeflatedRequest();
        byte[] blob = null;
        deflatedRequest.setRequest(request);
        blob = DynamicSerializationManager.getManager(SerializationType.Thrift)
                .serialize(deflatedRequest);
        try {
