 ...
 * 7/18/2018     7239       ksunil      Added queued versions of add/remove objects call.
 * </pre>
 * 
 * @author bphillip
 * @version 1
...
public interface LifecycleManager {
    ...
    public static final String SUBMIT_OBJECTS_QUEUED_ACTION = EbxmlNamespaces.OASIS_WSDL_PREFIX
            + "registry:bindings:4.0:LifecycleManager#submitObjectsQueued";

    public static final String REMOVE_OBJECTS_QUEUED_ACTION = EbxmlNamespaces.OASIS_WSDL_PREFIX
            + "registry:bindings:4.0:LifecycleManager#removeObjectsQueued";
    ...
    * @throws MsgRegistryException
    */
   @WebMethod(action = REMOVE_OBJECTS_QUEUED_ACTION)
   @WebResult(name = "RegistryResponse", targetNamespace = EbxmlNamespaces.RS_URI, partName = "partRegistryResponse")
   public RegistryResponseType removeObjectsQueued(
           @WebParam(name = "RemoveObjectsRequestQueued", targetNamespace = EbxmlNamespaces.LCM_URI, partName = "partRemoveObjectsRequestQueued") RemoveObjectsRequest partRemoveObjectsRequest)
           throws MsgRegistryException;
     ...
     * @throws MsgRegistryException
     */
    @WebMethod(action = SUBMIT_OBJECTS_QUEUED_ACTION)
    @WebResult(name = "RegistryResponse", targetNamespace = EbxmlNamespaces.RS_URI, partName = "partRegistryResponse")
    public RegistryResponseType submitObjectsQueued(
            @WebParam(name = "SubmitObjectsRequestQueued", targetNamespace = EbxmlNamespaces.LCM_URI, partName = "partSubmitObjectsRequestQueued") SubmitObjectsRequest partSubmitObjectsRequest)
            throws MsgRegistryException;
