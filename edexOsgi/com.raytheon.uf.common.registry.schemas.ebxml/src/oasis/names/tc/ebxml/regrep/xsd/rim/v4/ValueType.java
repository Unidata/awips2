 ...
 * Dec 02, 2013  1829     bphillip  Removed generic methods
 * Aug 25, 2016  5846     rjpeter   Remove SlotValueType and InternationaldStringValueType
 * 
 * </pre>
 * 
 * @author bphillip
...
@XmlSeeAlso({ StringValueType.class, DateTimeValueType.class,
        VocabularyTermValueType.class, IntegerValueType.class,
        AnyValueType.class, BooleanValueType.class, FloatValueType.class,
        MapValueType.class, DurationValueType.class, CollectionValueType.class })
@DynamicSerialize
@Entity
