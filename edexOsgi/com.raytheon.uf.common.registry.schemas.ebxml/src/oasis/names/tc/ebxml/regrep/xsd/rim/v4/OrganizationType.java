...
@AssociationOverride(name = "postalAddress", joinTable = @JoinTable(schema = RegrepUtil.EBXML_SCHEMA, joinColumns = {
        @JoinColumn(name = "organization_id") }))
@AssociationOverride(name = "telephoneNumber", joinTable = @JoinTable(schema = RegrepUtil.EBXML_SCHEMA, joinColumns = {
        @JoinColumn(name = "organization_id") }))
@AssociationOverride(name = "emailAddress", joinTable = @JoinTable(schema = RegrepUtil.EBXML_SCHEMA, joinColumns = {
        @JoinColumn(name = "organization_id") }))
