 ...
 * 10/25/2019    7948       bsteffen    Add indexes for affectedObjects and affectedObjectRefs
 * </pre>
 * 
 * @author bphillip
 * @version 1
...
public class ActionType extends ExtensibleObjectType {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((affectedObjectRefs == null) ? 0
                : affectedObjectRefs.hashCode());
        result = prime * result
