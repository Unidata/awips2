...
public class StdTextProductId extends PersistableDataObject implements
    ...
    /** partial constructor */
    public StdTextProductId(String site, String nnnid, String xxxid, String hdrtime) {
        this();
        this.site = site;
        this.nnnid = nnnid;
        this.xxxid = xxxid;
    ...
    /** full constructor */
    public StdTextProductId(String site, String nnnid, String xxxid, String hdrtime, Long dataCrc) {
        this(site, nnnid, xxxid, hdrtime);
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(getSite())
                .append(getNnnid()).append(getXxxid())
