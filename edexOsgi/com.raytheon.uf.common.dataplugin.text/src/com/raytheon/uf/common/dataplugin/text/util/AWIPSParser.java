...
public class AWIPSParser {
    ...
    private boolean parseCommand() {
        ...
        if (awipsCommand.startsWith("ALL:")) {
            ...
            validCommand = (!"0000".equals(cccc) && !"000".equals(nnn) && !"000"
                    .equals(xxx));
            if (cccc == null) {
                cccc = localSite;
            }
            ...
            if (i > 0) {
                ...
                return (!"0000".equals(cccc) && !"000".equals(nnn));
            }
        }
    ...
    public String getAwipsCommand() {
        return awipsCommand.startsWith(DRAFT_PIL) ? cccc + nnn + xxx
                : awipsCommand;
    }
