...
/**
 * Parser for an AFOS style query string.
 *
 * <pre>
 * usage :
 * &lt;code&gt;
 ...
 * Nov 30, 2018 7586       tgurney     Remove max length restriction from AFOS
 *                                     command
 * Nov 30, 2018 7643       tgurney     Make A:NNN and A:CCCNNN get only the
                                       current-hour products
 *
 * </pre>
 *
 * @author jkorman
...
public class AFOSParser implements IParser {
    ...
    public AFOSParser(String afosCmd, String siteId) {
        ...
        this.afosCommand = afosCmd;
        this.site = siteId;

        this.validCommand = parseCommand(siteId);
    ...
    private boolean parseCommand(String siteId) {
        ...
        if (afosCommand.startsWith("ALL:")) {
            ...
            validCommand = (!"000".equals(ccc) && !"000".equals(nnn)
                    && !"000".equals(xxx));
