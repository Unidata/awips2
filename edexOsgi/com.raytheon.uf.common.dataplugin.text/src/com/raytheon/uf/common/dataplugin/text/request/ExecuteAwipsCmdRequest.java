...
/**
 * Awips command information to send to StdTextProductDao.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * Aug 28, 2016 5839      rferrel     Added pastVersion
 * 
 * </pre>
 * 
 * @author rferrel
...
public class ExecuteAwipsCmdRequest implements IServerRequest {
    ...
    public String getPastVersion() {
        return pastVersion;
    }

    public void setPastVersion(String pastVersion) {
