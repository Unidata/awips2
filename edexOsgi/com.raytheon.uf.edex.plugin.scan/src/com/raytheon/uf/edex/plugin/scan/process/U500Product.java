...
/**
 * U-Wind Component Product at 500 mb
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public class U500Product extends GridProduct {
    ...
    public static final String U500 = SCANRunSiteConfigurationManager.DATA_TYPE.U500
            .getType();
     ...
     * @param filter
     */
    public U500Product(String uri, ScanTables tableType, ScanURIFilter filter) {
    ...
    public ScanTableDataRow write(ScanTableDataRow row,
        ...
        // U500, new Coordinate(row.getLon(), row.getLat())));
        // }
        // return row;
    }
