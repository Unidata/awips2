...
/**
 * Geopotential Height Product at 500 mb
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public class GH500Product extends GridProduct {

    private static final long serialVersionUID = 1L;

    public static final String GH500 = SCANRunSiteConfigurationManager.DATA_TYPE.GH500
            .getType();
     ...
     * @param filter
     */
    public GH500Product(String uri, ScanTables tableType, ScanURIFilter filter) {
    ...
    public PersistablePluginDataObject getRecord() throws PluginException,
        ...
        try {
            filter.setGridRecord(GH500, uri);
            // statusHandler.handle(Priority.INFO, "MATCHED " + GH500
            // + " MODEL URI: " + uri);
            grib = filter.getGridRecord(GH500);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return grib;
    ...
    public void process() throws Exception {
        ...
        if (rec != null) {
            filter.setGridRecord(GH500, rec);
        }
    }
    ...
    public ScanTableDataRow write(ScanTableDataRow row,
        ...
        // GH500, new Coordinate(row.getLon(), row.getLat())));
        // }
        // return row;
    }
    ...
    public static Pattern getPattern(String model) {
        return getGridPattern(model, "GH", "MB", "500.0",
