...
public class MesoCycloneTabularProduct extends RadarProduct {
    ...
    public void process() throws Exception {
        ...
        ArrayList<String> mesoKeys = getIdsFromGraphicBlock(rec);
        ...
        if (mesoKeys != null) {
            ...
            if (!newMesoKeys.isEmpty() && alarms != null) {
                if ((alarms.getMesoAlarmTime() * 60
                        * 1000) <= (rec.getDataTime().getRefTime().getTime()
                                - previousTime.getTime())) {

                    alarmString = new StringBuilder();
                    alarmString.append("NEW meso for " + filter.getIcao()
