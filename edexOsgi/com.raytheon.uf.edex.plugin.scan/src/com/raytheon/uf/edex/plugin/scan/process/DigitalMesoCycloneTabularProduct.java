...
public class DigitalMesoCycloneTabularProduct extends RadarProduct {
    ...
    public ScanTableDataRow write(ScanTableDataRow srow,
        ...
        if ((featureVal != null) && !featureVal.equals(BLANK)) {
            String[] values2 = featureVal.split(",");
            ArrayList<Double> heights2 = new ArrayList<>();
            for (String val : values2) {
        ...
        if ((featureVal != null) && !featureVal.equals(BLANK)) {
            String[] values2 = featureVal.split(",");
            ArrayList<Double> diams2 = new ArrayList<>();
            for (String val : values2) {
        ...
        if ((featureVal != null) && !featureVal.equals(BLANK)) {
            String[] values2 = featureVal.split(",");
            ArrayList<Double> rotvel2 = new ArrayList<>();
            for (String val : values2) {
        ...
        if ((featureVal != null) && !featureVal.equals(BLANK)) {
            String[] values2 = featureVal.split(",");
            ArrayList<Double> shear2 = new ArrayList<>();
            for (String val : values2) {
        ...
        if ((featureVal != null) && !featureVal.equals(BLANK)) {
            String[] values2 = featureVal.split(",");
            ArrayList<Double> gtgMax2 = new ArrayList<>();
            for (String val : values2) {
        ...
        if ((featureVal != null) && !featureVal.equals(BLANK)) {
            String[] values2 = featureVal.split(",");
            ArrayList<Double> rank2 = new ArrayList<>();
            for (String val : values2) {
        ...
        if ((featureVal != null) && !featureVal.equals(BLANK)) {
            String[] values2 = featureVal.split(",");
            ArrayList<Double> indexes2 = new ArrayList<>();
            for (String val : values2) {
