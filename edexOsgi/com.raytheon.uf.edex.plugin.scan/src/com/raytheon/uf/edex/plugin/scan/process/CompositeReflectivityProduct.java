 ...
 * 02/22/2012   14414     mgamazay   Added initializing the ScanTableData table
 ...
 * 07/11/2016   5744      mapeters   VCP file moved from edex_static to common_static
...
public class CompositeReflectivityProduct extends RadarProduct {
    ...
    public void process() throws Exception {
        ...
        if (!catMap.isEmpty()) {
                    ...
                    if (table.getRow(id) != null) {
                        ...
                        if ((table.getRow(id).getLat() != null)
                            ...
                            if (((CellTableDataRow) table.getRow(id))
                                ...
                                HashMap<Date, Coordinate> coors = new HashMap<>();
            ...
            if (alarms != null && !newIds.isEmpty() && previousTime != null) {
                if (((alarms.getCellAlarmTime() * 60 * 1000) <= (rec
                    ...
                    alarmString.append("NEW cell for " + filter.getIcao()
    ...
    private static int getVolumeScanDurationSeconds(RadarRecord rec,
        ...
        if (duration < 0) {
            if (prevRec != null
                    && rec.getVolumeCoveragePattern() == prevRec
                            .getVolumeCoveragePattern()) {
