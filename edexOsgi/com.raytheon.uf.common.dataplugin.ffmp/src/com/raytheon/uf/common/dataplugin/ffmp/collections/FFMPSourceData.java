 ...
 * Aug 06, 2018  6720      njensen     Added toString()
 * 
 * </pre>
 * 
 * @author njensen
...
public class FFMPSourceData {
    ...
    private AtomicReference<FFMPRecord> ffmpData = new AtomicReference<>();

    /** earliest available date queried **/
    private Date previousUriQueryDate;

    private ConcurrentNavigableMap<Date, List<String>> availableUris = new ConcurrentSkipListMap<>();

    /** map of huc to list of loaded URIs **/
    private List<String> loadedUris = new ArrayList<>();
    ...
    public String toString() {
        return "FFMPSourceData [ffmpData=" + ffmpData
                + ", previousUriQueryDate=" + previousUriQueryDate
                + ", availableUris=" + availableUris + ", loadedUris="
                + loadedUris + "]";
    }
