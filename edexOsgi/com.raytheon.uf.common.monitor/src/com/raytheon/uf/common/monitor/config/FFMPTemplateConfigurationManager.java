 ...
 * Oct 25, 2012  15514    gzhang    Adding getHucLevelsInArray()
 ...
 *                                  SITE
 * Jun 22, 2018  6641     njensen   Use interfaces where possible
 * 
 * </pre>
 * 
 * @author dhladky
...
public class FFMPTemplateConfigurationManager implements
    ...
    private static final String CONFIG_FILE_NAME = "ffmp"
            + IPathManager.SEPARATOR + "FFMPTemplateConfig.xml";
    ...
    public void saveConfigXml() {
        ...
        try (SaveableOutputStream sos = newXmlFile.openOutputStream()) {
            ...
            statusHandler.handle(Priority.ERROR,
                    "Couldn't save config file " + newXmlFile.getPath(),
                    e);
        }
    }
     ...
     * @return
     */
    public List<String> getHucLevels() {
        List<String> hucLevels = new ArrayList<>();
        hucLevels.add("ALL");
    ...
    public void setExcludedVGBs(List<String> vgbs) {
