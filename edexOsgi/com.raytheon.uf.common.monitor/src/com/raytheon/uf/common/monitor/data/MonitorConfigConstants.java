 ...
 * Jan 04, 2016  5115     skorolev  Moved from com.raytheon.uf.viz.monitor.util.
...
public class MonitorConfigConstants {
     ...
     */
    public static final String MON_METEO_WIND_SPEED = "Monitor.Meteo.wind_speed";

    public static final String MON_METEO_GUST_SPEED = "Monitor.Meteo.gust_speed";

    public static final String MON_METEO_PEAK_WIND = "Monitor.Meteo.peak_wind_speed";

    public static final String MON_METEO_WAVE_HT = "Monitor.Meteo.wave_height";

    public static final String MON_METEO_VIS = "Monitor.Meteo.visibility";

    public static final String MON_SWELL_PRIM_HT = "Monitor.Swell.Primary.height";

    public static final String MON_SWELL_PRIM_PD = "Monitor.Swell.Primary.period";

    public static final String MON_SWELL_PRIM_DIR_FROM = "Monitor.Swell.Primary.dirFrom";

    public static final String MON_SWELL_PRIM_DIR_TO = "Monitor.Swell.Primary.dirTo";

    public static final String MON_SWELL_SEC_HT = "Monitor.Swell.Secondary.height";

    public static final String MON_SWELL_SEC_PD = "Monitor.Swell.Secondary.period";

    public static final String MON_SWELL_SEC_DIR_FROM = "Monitor.Swell.Secondary.dirFrom";

    public static final String MON_SWELL_SEC_DIR_TO = "Monitor.Swell.Secondary.dirTo";

    public static final String MON_METEO_TEMP = "Monitor.Meteo.temperature";

    public static final String MON_METEO_WIND_CHILL = "Monitor.Meteo.wind_chill";

    public static final String MON_METEO_SNOW_DEPTH = "Monitor.Meteo.snow_depth";
    ...
    public static enum SafeSeasDisplay {
        ...
        SS_DISP_PROD_HFWW_PEAK_WIND(
                "Display.Product.Hurricane.peak_wind_speed"),
        ...
        private SafeSeasDisplay(String s) {
            XMLKey = s;
        }
    ...
    public static enum SafeSeasMonitor {
        SS_MON_METEO_WIND_SPEED(MON_METEO_WIND_SPEED),
        SS_MON_METEO_PEAK_WIND(MON_METEO_PEAK_WIND),
        SS_MON_METEO_GUST_SPEED(MON_METEO_GUST_SPEED),
        SS_MON_METEO_WAVE_HT(MON_METEO_WAVE_HT),
        SS_MON_METEO_VIS(MON_METEO_VIS),
        SS_MON_SWELL_PRIM_HT(MON_SWELL_PRIM_HT),
        SS_MON_SWELL_PRIM_PD(MON_SWELL_PRIM_PD),
        SS_MON_SWELL_PRIM_DIR_FROM(MON_SWELL_PRIM_DIR_FROM),
        SS_MON_SWELL_PRIM_DIR_TO(MON_SWELL_PRIM_DIR_TO),
        SS_MON_SWELL_SEC_HT(MON_SWELL_SEC_HT),
        SS_MON_SWELL_SEC_PD(MON_SWELL_SEC_PD),
        SS_MON_SWELL_SEC_DIR_FROM(MON_SWELL_SEC_DIR_FROM),
        SS_MON_SWELL_SEC_DIR_TO(MON_SWELL_SEC_DIR_TO);

        private String XMLKey;

        private SafeSeasMonitor(String s) {
            XMLKey = s;
        }
    ...
    public static enum SnowDisplay {
        ...
        SNOW_DISP_PROD_BLIZZ_PEAK_WIND(
                "Display.Product.Blizzard.peak_wind_speed"),
        SNOW_DISP_PROD_FRZ_TEMP("Display.Product.Freezing_Precip.temperature"),
        SNOW_DISP_PROD_FRZ_HOURLY_PRECIP(
                "Display.Product.Freezing_Precip.hourly_precip"),
        SNOW_DISP_PROD_HSW_SNINCR_HOURLY(
                "Display.Product.Heavy_Snow_Warning.snincr_hourly"),
        SNOW_DISP_PROD_HSW_SNINCR_TOTAL(
                "Display.Product.Heavy_Snow_Warning.snincr_total"),
        SNOW_DISP_PROD_HSW_SNOW_DEPTH(
                "Display.Product.Heavy_Snow_Warning.snow_depth"),
    ...
    public static enum SnowMonitor {
        SNOW_MON_METEO_WIND_SPEED(MON_METEO_WIND_SPEED),
        SNOW_MON_METEO_PEAK_WIND(MON_METEO_PEAK_WIND),
        SNOW_MON_METEO_GUST_SPEED(MON_METEO_GUST_SPEED),
        SNOW_MON_METEO_TEMP(MON_METEO_TEMP),
        SNOW_MON_METEO_WIND_CHILL(MON_METEO_WIND_CHILL),
        SNOW_MON_METEO_VIS(MON_METEO_VIS),
        SNOW_MON_METEO_SNOW_DEPTH(MON_METEO_SNOW_DEPTH);

        private String XMLKey;

        private SnowMonitor(String s) {
            XMLKey = s;
        }
    ...
    public static Boolean rValueIsHigher(String key, AppName appName) {
        if (appName.equals(AppName.SAFESEAS)) {
            ...
            if (ryHigherMapSS.containsKey(key)) {
            ...
            if (ryHigherMapSnow.containsKey(key)) {
            ...
            if (ryHigherMapFog.containsKey(key)) {
    ...
    private static void createRYHigherMapSS() {
        ...
        ryHigherMapSS.put(SafeSeasDisplay.SS_DISP_WIND_DIR_FROM.getXmlKey(),
                null);
        ryHigherMapSS.put(SafeSeasDisplay.SS_DISP_WIND_DIR_TO.getXmlKey(),
                null);
        ...
        ryHigherMapSS.put(SafeSeasDisplay.SS_DISP_METEO_DEWPT.getXmlKey(),
                true);
        ...
        ryHigherMapSS.put(SafeSeasDisplay.SS_DISP_SWELL_PRIM_DIR_TO.getXmlKey(),
                null);
        ...
        ryHigherMapSS.put(SafeSeasMonitor.SS_MON_SWELL_PRIM_DIR_TO.getXmlKey(),
                null);
        ryHigherMapSS.put(SafeSeasMonitor.SS_MON_SWELL_SEC_HT.getXmlKey(),
                true);
        ryHigherMapSS.put(SafeSeasMonitor.SS_MON_SWELL_SEC_PD.getXmlKey(),
                false);
        ryHigherMapSS.put(SafeSeasMonitor.SS_MON_SWELL_SEC_DIR_FROM.getXmlKey(),
                null);
    ...
    private static void createRYHigherMapSnow() {
        ...
        ryHigherMapSnow.put(SnowDisplay.SNOW_DISP_WIND_DIR_FROM.getXmlKey(),
                null);
        ryHigherMapSnow.put(SnowDisplay.SNOW_DISP_WIND_DIR_TO.getXmlKey(),
                null);
        ryHigherMapSnow.put(SnowDisplay.SNOW_DISP_METEO_TEMP.getXmlKey(),
                false);
    ...
    private static void createRYHigherMapFog() {
        ryHigherMapFog = new HashMap<>();
        /*
         * Fog Display
         */
        ryHigherMapFog.put(FogDisplay.FOG_DISP_METEO_VIS.getXmlKey(), false);
        ryHigherMapFog.put(FogDisplay.FOG_DISP_METEO_CEILING.getXmlKey(),
                false);
        ...
        ryHigherMapFog.put(FogDisplay.FOG_DISP_WIND_WIND_SPEED.getXmlKey(),
                true);
        ryHigherMapFog.put(FogDisplay.FOG_DISP_WIND_PEAK_WIND.getXmlKey(),
                true);
    ...
    private static final String[] TABLE_FIELDS = { "low", "mid", "upp", "rank",
            "trend", "mClr", "clucon", "inTbl", "min", "intrvl", "range",
            "alarm", "aAlarm", "units" };

    private static final String[] FFMP_TABLE = { "ffmpTable", "name", "rate",
