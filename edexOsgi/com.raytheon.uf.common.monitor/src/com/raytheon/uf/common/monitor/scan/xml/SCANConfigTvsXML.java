...
public class SCANConfigTvsXML extends SCANAbstractXML<SCANConfigTvsXML> {
    ...
    @Override
    public void combine(SCANConfigTvsXML otherXml) {
        SCANConfigTvsXML other = otherXml;
