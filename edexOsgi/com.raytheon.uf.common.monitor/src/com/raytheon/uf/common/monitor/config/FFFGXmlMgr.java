...
public class FFFGXmlMgr {
    ...
    public void saveFFFGDataXml() {
        ...
        try (SaveableOutputStream sos = locFile.openOutputStream()) {
            ...
            statusHandler.error("Error saving XML configuration to " + locFile,
                    e);
        }
        setForcingConfigured();
    }
    ...
    public void printData() {
        ...
        List<FFFGSourceXML> sources = dataXML.getSources();
        ...
        for (FFFGSourceXML src : sources) {
            ...
            List<FFFGSourceItemXML> srcItems = src.getSourceItems();
    ...
    private void setForcingConfigured() {
        if ((dataXML.getSources() != null)
                || (dataXML.getSources().size() > 0)) {
