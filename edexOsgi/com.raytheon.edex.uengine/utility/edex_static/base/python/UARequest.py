...
from com.raytheon.uf.common.dataplugin.bufrua.dao import BufrUAPointDataTransform
...
class UARequest(PointDataQuery.PointDataQuery):
    
    def __init__(self, pluginNameDummyVar):
        PointDataQuery.PointDataQuery.__init__(self, "bufrua")
