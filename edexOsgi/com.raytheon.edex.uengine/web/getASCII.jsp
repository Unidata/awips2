...
<TD><H1>&mu;Engine Demonstration<BR>ASCII Product Retrieval</H1>
...
<input type=hidden name=requesttype value=ascii>
<input type=hidden name=sortby value=timeobs>
<table align=center>
<tr><th colspan=2><em>Enter Search Values</em></th></tr> 
<tr><td><B>Name:</B></td>
<td><input type=text name=name value="ASCII Request"></td></tr>
...
<tr><td><B>Station:</B></td><td><input type=text name=station value="">(Required for TAF)</td></tr>
<tr><td><B>Time:</B></td>
...
<tr><td><B>Count:</B></td><td><select name=count>
   <option value=1 selected>1 Report
   <option value=2>2 Report
   <option value=3>3 Report
   <option value=4>4 Report
   <option value=5>5 Report
   <option value=6>6 Report
   <option value=7>7 Report
   <option value=8>8 Report
   <option value=9>9 Report
   <option value=10>10 Report
</select>
</td></td>
