...
public class RadarDecoder {
    ...
    public PluginDataObject[] decode(byte[] messageData, Headers headers)
        ...
        // for free text messages, which come in with the following wmo
            ...
            if (l3Radar.getMessageCode() == Level3BaseRadar.COMMAND_PARAMETER_MESSAGE) {
                ...
                EDEXUtil.sendMessageAlertViz(Priority.VERBOSE,
                        ...
                        + ": Command Parameter Message Received", l3Radar.getCpmBlock().getMessage().toString(), null);
            }
    ...
    private void finalizeRecord(RadarRecord record) {
        ...
        if (record.getProductCode() == Level3BaseRadar.GSM_MESSAGE ||
                record.getProductCode() == Level3BaseRadar.COMMAND_PARAMETER_MESSAGE) {
