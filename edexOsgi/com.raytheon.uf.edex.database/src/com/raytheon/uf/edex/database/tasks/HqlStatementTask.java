...
/**
 * uEngine task to execute and arbitrary (non-query) hql statement
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public class HqlStatementTask {
     ...
     *            The database name
     */
    public HqlStatementTask(String hqlStatement, String dbName) {
     ...
     *            The sql to execute
     */
    public HqlStatementTask(String hqlStatement) {
        this(hqlStatement, DaoConfig.DEFAULT_DB_NAME);
    }

    public Object execute() throws Exception {
        CoreDao dao = new CoreDao(DaoConfig.forDatabase(dbName));
        return dao.executeHQLStatement(hqlStatement);
    }
