 ...
 * May 03, 2018  6573     bsteffen    Make static data constant.
 * 
 * </pre>
 * 
 * @author bsteffen
...
public class GridRequestableNode extends AbstractBaseDataNode {
    ...
    public boolean isConstant() {
        String parameter = rcMap.get(GridConstants.PARAMETER_ABBREVIATION)
                .getConstraintValue();
        return GridPathProvider.STATIC_PARAMETERS.contains(parameter);
    }
