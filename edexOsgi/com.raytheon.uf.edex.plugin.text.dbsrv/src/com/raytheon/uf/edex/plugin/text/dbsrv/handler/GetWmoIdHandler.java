...
/**
 * Request handler for GetWmoIdHandlers.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * Aug 10, 2016  5801     tgurney   Use AfosToAwipsLookup
 * 
 * </pre>
 * 
 * @author rjpeter
...
public class GetWmoIdHandler implements IRequestHandler<GetWmoIdRequest> {

    protected final transient Logger logger = LoggerFactory
            .getLogger(getClass());

    @Override
    public AfosWmoIdDataContainer handleRequest(GetWmoIdRequest request) {
        return AfosToAwipsLookup.lookupWmoId(request.getAfosId());
    }
}
