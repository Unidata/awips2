...
public class RemoteRetrievalManager {
    public interface IRRDelegate {
        RemoteRetrievalResponse retrieve(RemoteRetrievalRequest req)
                throws Exception;
    }
    ...
    class RRJob {
        ...
        public synchronized RemoteRetrievalResponse waitResponse()
    ...
    /**
     * @param remoteRetrievalExternalURI
     *            the remoteRetrievalExternalURI to set
     */
