 ...
 * Sep 09, 2016 4628       bkowal      Fixed decimal scale factor read.
 * 
 * </pre>
 * 
 * @author bkowal
...
public class ProductDefinitionSection {
    ...
    public void readSection(final ByteBuffer byteBuffer) {
        ...
        if (timeRangerIndicator == TIME_RANGE_IND_10) {
            periodOfTimeP1 = (unsignedSectionBytes[15]
                    * XmrgGribPropertyUtils.DIVISOR_6)
         ...
         */
        includedNumber = (unsignedSectionBytes[18]
                * XmrgGribPropertyUtils.DIVISOR_6) + unsignedSectionBytes[19];
        ...
        XmrgGribPropertyUtils.unpackBytes(unpackedValue, unsignedSectionBytes,
                XmrgGribPropertyUtils.calculateBitOffset(27), 16, 0, 1, true);
