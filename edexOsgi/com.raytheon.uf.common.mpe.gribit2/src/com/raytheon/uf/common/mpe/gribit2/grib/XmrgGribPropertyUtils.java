 ...
 * Apr 23, 2019 7715       tgurney     Remove ByteUtils import (fix for
 *                                     com.mchange upgrade)
 *
 * </pre>
 *
...
public final class XmrgGribPropertyUtils {
    ...
    private static final int[] BIT_ONES = { 1, 3, 7, 15, 31, 63, 127,
            CONST_255 };
    ...
    /**
     * Converts the specified byte array to unsigned bytes
     *
     * @param bytes
    ...
    public static short[] getUnsignedBytes(final byte[] bytes) {
        ...
        for (int i = 0; i < bytes.length; i++) {
            unsignedBytes[i] = toUnsigned(bytes[i]);
        }
    ...
    public static void unpackBytes(int[] destination, final short[] toUnpack,
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            if (bitCount > 0) {
                 ...
                 */
                itmp = itmp << bitCount | toUnpack[index] >>> 8 - bitCount
                        & BIT_ONES[bitCount - 1];
            }
