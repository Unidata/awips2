...
public class ECMWFHiResProcessor extends SixHrPrecipGridProcessor {
    ...
    public GribRecord[] process(GribRecord record) throws GribException {
        ...
        if (record.getModelInfo().getParameterAbbreviation().equals("TP-ECMWF")) {
    ...
    protected List<GribRecord> getPrecipInventory(Date refTime)
        ...
        query.addQueryParam("modelInfo.parameterAbbreviation", "TP-ECMWF");
        query.addQueryParam("modelInfo.modelName", "ECMWF-HiRes");
