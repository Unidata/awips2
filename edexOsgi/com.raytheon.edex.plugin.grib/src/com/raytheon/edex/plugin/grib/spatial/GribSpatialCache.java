    ...
    private Map<String, GridCoverage> loadSubGridDefinitionsFromDisk(
        ...
        if (subGridDefs != null && subGridDefs.size() > 0) {
            ...
            for (FileData fd : subGridDefs) {
                try {
                    SubGridDef subGridDef = (SubGridDef) SerializationUtil
                    ...
                    subGridDef.setLowerLeftLon(MapUtil.correctLon(subGridDef
                            .getLowerLeftLon()));
                    subGridDef.setUpperRightLon(MapUtil.correctLon(subGridDef
                            .getUpperRightLon()));
                            ...
                            if (baseCoverage != null) {
                                ...
                                if (subGridCoverage != null) {
                                    subGrids.put(subGridCoverage.getName(),
                                            subGridCoverage);
                                    definedSubGridMap.put(modelName, subGrid);
                                }
                            }
                        }
                    }
