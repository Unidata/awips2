...
public class DerivParamMethod {
    ...
    public void parseFields(String fields) throws DataCubeException {
        if (fields == null) {
            throw new DataCubeException("method [" + getName()
     ...
     */
    private DerivParamField parseField(String rawField)
