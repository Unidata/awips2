...
public class MetarPointDataTransform {
    ...
    // ------------------
    public static final String ICEACCUM6_HOUR = "iceAccum6Hour";

    public static final String ICEACCUM3_HOUR = "iceAccum3Hour";

    public static final String ICEACCUM1_HOUR = "iceAccum1Hour";

    // ICEACCUM6_HOUR, ICEACCUM3_HOUR, ICEACCUM1_HOUR
    ...
    private PointDataView buildView(PointDataContainer container,
        ...
        pdv.setFloat(ICEACCUM1_HOUR, record.getIceAccum1Hour());
        pdv.setFloat(ICEACCUM3_HOUR, record.getIceAccum3Hour());
        pdv.setFloat(ICEACCUM6_HOUR, record.getIceAccum6Hour());
    ...
    public static MetarRecord toMetarRecord(PointDataView pdv) {
        ...
        mr.setIceAccum1Hour(pdv.getNumber(ICEACCUM1_HOUR).floatValue());
        mr.setIceAccum3Hour(pdv.getNumber(ICEACCUM3_HOUR).floatValue());
        mr.setIceAccum6Hour(pdv.getNumber(ICEACCUM6_HOUR).floatValue());
