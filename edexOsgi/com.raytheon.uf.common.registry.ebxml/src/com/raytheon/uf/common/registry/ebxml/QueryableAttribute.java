 ...
 * Aug 25, 2016  5846     rjpeter   Remove SlotValueType
 * 
 * </pre>
 * 
 * @author jspinks
...
public abstract class QueryableAttribute<T> {
    ...
    /**
     * Return the formatted text of this QueryableAttribute appropriate for the
     * options specified when created. This includes text, numeric, list, like
    ...
    /**
     * Return the type of slot used to contain the value. For instance if the
     * attribute is a String attribute, then 'stringValue' should be returned.
     * If the attribute is an integer, then 'integerValue' should be returned.
     * 
     * @return The type of value attribute the slot for this QueryableAttribute
     *         contains.
     * 
     * @see SlotValueType
     */
