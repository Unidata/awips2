...
public class BooleanAttribute extends QueryableAttribute<Boolean> {
    ...
    /**
     * Return the formatted text of this BooleanAttribute including the
    ...
    /**
     * Return the type of slot used to contain the value. For BooleanAttribute
     * that is "booleanValue".
     * 
