 ...
 * Aug 20, 2012  743      djohnson  Change to support {@link BigInteger}.
...
public class IntegerAttribute extends QueryableAttribute<BigInteger> {
    ...
    /**
     * Return the type of slot used to contain the value. For IntegerAttribute
     * that is "integerValue".
     * 
     ...
     */
    public static IntegerAttribute fromIntegers(List<Integer> values) {
        List<BigInteger> bigInts = new ArrayList<>(values.size());
