 ...
 * Mar 17, 2016 3919       tjensen      Remove unneeded interface check
...
public final class RegistryObjectHandlers {
    ...
    private static final Logger logger = LoggerFactory
            .getLogger(RegistryObjectHandlers.class);
    ...
    /**
     * Retrieve the registered {@link IRegistryObjectHandler} implementation for
     ...
     * @throws IllegalArgumentException
     *             if no handler is registered for the specific interface
     */
