...
##
#
#   Smart Init for HIRESWFV3 model.
#
##
...
##--------------------------------------------------------------------------
class HIRESWFV3Forecaster(HIRESWForecaster):
    def __init__(self):
        HIRESWForecaster.__init__(self, "HIRESWFV3", "HIRESWFV3")

def main():
    forecaster = HIRESWFV3Forecaster()
    forecaster.run()
