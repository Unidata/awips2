...
class BaseTool(UnitConvertor.UnitConvertor):
    ...
    def interpolateValues(self, height, values1, values2):
    ...
    def extrapolate(self, height, values1, values2):
    ...
    def interpolateScalarValues(self, height, values1, values2):
        # Interpolate between the height and values
    ...
    def interpolateVectorValues(self, height, values1, values2):
        # Interpolate between the height and values
