...
class Generator():
    ...
    def setSiteId(self,siteId):
        ...
        """
        if siteId in list(SiteInfo.keys()):
    ...
    def allinfo(self):
        ...
        for site in list(SiteInfo.keys()):
            LOG.info("--------------------------------------------")
            LOG.info("%s %s %s" % (site, 
    ...
    def __createPilDictionary(self, siteid):
        ...
        response = AfosToAwipsLookup.lookupAfosId(stationID4, None, None)
    ...
    def __create(self, srcDir, destDir):
        ...
        for lf in templateFiles:
            ...
            try:                
                ...
                (num,info) = xxx_todo_changeme1.args
            ...
            for product in products:
                ...
                for pilInfo in pils:
                    ...
                    try:
                        ...
                        (number, description) = xxx_todo_changeme.args
