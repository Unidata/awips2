...
class TextProduct(
    ...
    for key in list(ZFP_regionDefinition.keys()):
        Definition[key] = ZFP_regionDefinition[key]

    # Get SAF Definition settings
    for key in list(SAF_Definition.keys()):
    ...
    # Definition overrides should really go in SAF_<site>_<MultiPil> Definition
    # but may be put here for testing.
    # Most common would be need to set unique display name
    ##Definition["displayName"] = "Test_SAF_<MultiPil>"
