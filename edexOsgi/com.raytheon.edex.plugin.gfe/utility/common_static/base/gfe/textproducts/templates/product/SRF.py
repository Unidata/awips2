...
##### SURF PERIOD AND ISSUANCE LISTS
    ...
    def _getSurfPeriod_additionalAreas(self):
        ...
        surfList = []
        for combo in list(self._combinedAreaDict.keys()):
    ...
    def _getAdditionalAreas(self, component):
        ...
        elementDict = {}
        for areaType in list(areaDict.keys()):
        ...
        #  e.g. ("MaxT", ["SRF_586"])
        for element in list(elementDict.keys()):
    ...
    def _getSurfPeriod_intersectWithAreas(self):
        ...
        intersectWithAreas = []
        for key in list(self._combinedAreaDict.keys()):
            if 'landSeaArea' in self._combinedAreaDict[key]:
    ...
    def _setSurfAreaLabel(self, tree, node, phrase):
        ...
        useAreaType = None
        for areaType in list(areasDict.keys()):
...
### Generate Product
    ...
    def _getCombinedSurfAreas(self, argDict, components, comboList, comboLabel):
        ...
        #print "\nLabelDict", labelDict
        # Make combinations
        for surfLabel in list(labelDict.keys()):
