...
#
# FireWx_EditAreas_<site>_<MultiPil>_Definition.TextUtility
#
#  This file is used to generate a combinations file that contains
#  all FireWx codes for the given site.  This file is similar to a product
...
#----- WFO <site> FireWx_EditAreas Definition -----
...
Definition["mapNameForCombinations"] = "FireWxZones_<site>"
