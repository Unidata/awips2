...
class TextProduct(HLSTCV_Common.TextProduct):
    ...
    Definition["debug"] = {
                          ...
                          "_isCorrectNumGrids": 1,
                          "_checkContinuousDuration": 1,
                          "_noOpParts": 0,
                          "_easMessage": 0,
                          "_setup_segment": 0,
                          "_vtecRecords": 0,
...
#                                 % (index, prettyStartTime, prettyEndTime), 1)
        ...
        if not retval:
            ...
            self.debug_print("self._timeRange: %s" % str(self._timeRange), 1)
...
#                                 % (prettyStartTime, prettyEndTime), 1)
        ...
        if not retval:
            ...
            self.debug_print("self._timeRange: %s" % self._pp.pformat(self._timeRange), 1)
