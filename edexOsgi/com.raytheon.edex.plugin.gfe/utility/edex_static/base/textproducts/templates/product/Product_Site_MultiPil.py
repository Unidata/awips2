...
# ---------------------------------------------------------------------
#
# <product>_<site>_<MultiPil>
#
#  This file should not be edited by the site.
#  Site changes should go in <product>_<site>_Overrides for methods and
#       <product>_<site>_<MultiPil>_Definition to set up Product 
#       Definition Settings.
#
#
# ---------------------------------------------------------------------
...
class TextProduct(
    ...
    # Definition overrides should go in <product>_<site>_<MultiPil> Definition
    # but may be put here for testing.
    # Most common would be the need to set a unique display name
    ##Definition["displayName"] = "Test_<product>_<MultiPil>"
