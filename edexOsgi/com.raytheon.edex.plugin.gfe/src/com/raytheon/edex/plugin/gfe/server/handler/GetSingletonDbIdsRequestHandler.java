...
public class GetSingletonDbIdsRequestHandler implements
        IRequestHandler<GetSingletonDbIdsRequest> {
    ...
    public ServerResponse<List<DatabaseID>> handleRequest(
        ...
        sr.setPayload(IFPServerConfigManager.getServerConfig(
                request.getSiteID()).getSingletonDatabases());
        return sr;
    }
