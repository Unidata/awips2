...
public class DatMenuUtil extends AbstractMenuUtil {
    ...
    public void createMenus() {
        ...
        createFFMPMenu(ffmp, ffmpProductKeys);
     ...
     * Creates FFMP Menus.
     */
    private void createFFMPMenu(List<FFMPRunXML> ffmp,
        ...
        for (String productKey : ffmpProductKeys) {
            for (FFMPRunXML runner : ffmp) {
                ...
                if (primarySource.getDataType()
                        .equals(DATA_TYPE.XMRG.getDataType())) {
                ...
                for (ProductRunXML innerproduct : runner
                    ...
                    SourceXML qpesource = FFMPSourceConfigurationManager
                            .getInstance()
                            .getSource(innerproduct.getProductName());
                    ...
                    qpeIncludeMenuCont.fileName = new File(
                            qpepath + "ffmpQPE.xml");
                ...
                List<String> qpfTypes = product.getQpfTypes(qpfProduct);
                ...
                for (String qpfType : qpfTypes) {
                    ...
                    List<SourceXML> qpfSources = product
                            .getQpfSources(qpfProduct, qpfType);
                ...
                List<String> guidTypes = product.getGuidanceTypes(guidProduct);
                ...
                for (String guidType : guidTypes) {
                    ...
                    for (SourceXML guidSource : guidSources) {
                        ...
                        String guidpath = "menus" + IPathManager.SEPARATOR
                                + "ffmp" + IPathManager.SEPARATOR + "";
                        ...
                        guidIncludeMenuCont = (CommonIncludeMenuContribution) processFFMPContribution(
                                product.getProductKey(),
                                guidSource.getSourceName(), guiddataKey,
