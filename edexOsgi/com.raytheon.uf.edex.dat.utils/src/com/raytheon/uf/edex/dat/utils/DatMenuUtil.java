...
public class DatMenuUtil extends AbstractMenuUtil {
    ...
    public boolean checkCreated() {
        ...
        LocalizationFile lfile = pm.getStaticLocalizationFile(
                LocalizationType.COMMON_STATIC, "ffmp" + IPathManager.SEPARATOR
                        + "FFMPRunConfig.xml");
        ...
        lfile = pm.getLocalizationFile(caveConfigured, "menus"
                + IPathManager.SEPARATOR + "scan" + IPathManager.SEPARATOR
                + "scan.xml");
        long menuModified = 0;
        if (lfile != null && lfile.exists()) {
