...
/**
 * {@link IRegistryObjectHandler} for {@link DataSetName}.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * @version 1.0
 */
public interface IDataSetNameHandler extends
        IRegistryObjectHandler<DataSetName> {
     ...
     *             on error
     */
    Set<String> getByDataTypes(List<String> dataTypes)
            throws RegistryHandlerException;
}
