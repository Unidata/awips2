...
public class QueryFilterVisitor implements OgcFilterVisitor {
     ...
     */
    @Override
    public Criterion equal(ExpressionProcessor left, ExpressionProcessor right,
     ...
     */
    @Override
    public Criterion isLike(PropertyIsLikeType op, Object obj) throws Exception {
     ...
     */
    @Override
    public Criterion isNull(PropertyIsNullType op, Object obj) throws Exception {
        VisitorBag bag = (VisitorBag) obj;
    ...
    public Criterion spatialEquals(BinarySpatialOpType op, Object obj)
        ...
        return SpatialRestrictions
                .eq(bag.filterField(e.getKey()), e.getValue());
    }
