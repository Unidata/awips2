...
public class TimeInRange extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:time-in-range";
    ...
    public Boolean executeFunction(XMLGregorianCalendar arg1,
            XMLGregorianCalendar arg2, XMLGregorianCalendar arg3) {
        return arg1.compare(arg2) >= 0 && arg1.compare(arg3) <= 0;
    }
}
