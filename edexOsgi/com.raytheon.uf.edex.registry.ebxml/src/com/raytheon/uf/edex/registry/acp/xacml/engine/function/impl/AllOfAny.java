...
public class AllOfAny extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:all-of-any";
    ...
    public Boolean executeFunction(FunctionType function, List<Object> bag1,
        ...
        for (Object arg1 : bag1) {
            ...
            for (Object arg2 : bag2) {
                boolean functionResult = XACMLFunctionEvaluator.getInstance()
                        .evaluate(functionId, new Object[] { arg1, arg2 },
                                request);
                if (functionResult) {
                    flag = true;
                    break;
