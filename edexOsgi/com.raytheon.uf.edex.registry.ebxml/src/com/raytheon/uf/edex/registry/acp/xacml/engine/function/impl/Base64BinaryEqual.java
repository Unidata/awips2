...
public class Base64BinaryEqual extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:base64Binary-equal";
    ...
    public Boolean executeFunction(Base64Binary arg1, Base64Binary arg2) {
        if (arg1 == null) {
            return arg2 == null;
        }
