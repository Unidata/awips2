...
public class X500NameRegexpMatch extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:2.0:function:x500Name-regexp-match";
    ...
    public Boolean executeFunction(String regex, LdapName name) {
