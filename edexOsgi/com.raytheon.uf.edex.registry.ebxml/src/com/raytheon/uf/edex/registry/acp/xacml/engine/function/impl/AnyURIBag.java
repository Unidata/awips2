...
public class AnyURIBag extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:anyURI-bag";
    ...
    public List<URI> executeFunction(Object[] uris) {
        return CommonFunctions.createBag(uris);
    }
