 ...
 * ------------- -------- --------- ----------------------------------------------------------------
 * Feb 13, 2012  184      bphillip  Initial creation
 * Mar 18, 2013  1802     bphillip  Modified to use transaction boundaries and spring dao injection
 * Apr 09, 2013  1802     bphillip  Changed abstract method signature, modified return processing,
 *                                  and changed static variables
 * Aug 01, 2013  1693     bphillip  Fixed minor typo
...
public class BasicQuery extends RegistryQueryPlugin {
    ...
    private boolean containsAllClassifications(RegistryObjectType obj,
        ...
        if (!CollectionUtil.isNullOrEmpty(classifications)) {
            List<String> ids = new ArrayList<>(classifications.size());
    ...
    private String getDescriptionClause(String description) {
        return description == null ? null : " obj.description = '"
                + description + "' ";
    }
    ...
    private String getNameClause(String name) {
        return name == null ? null : " obj.name = '" + name + "' ";
    }
