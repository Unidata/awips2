...
public class StringIntersection extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:string-intersection";
    ...
    public List<String> executeFunction(List<String> list1, List<String> list2) {
