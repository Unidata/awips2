 ...
 * ------------- -------- --------- ----------------------------------------------------------------
 * Apr 09, 2013  1802     bphillip  Initial Coding
 * Apr 15, 2013  1905     bphillip  Implemented notification to email endpoints
 * Apr 17, 2013  1672     djohnson  No longer cares about notification protocol.
 * May 21, 2013  2022     bphillip  Cleaned up unused method parameters and batching of
 *                                  notifications
 * Sep 11, 2013  2354     bphillip  Added logic to ensure delete events get included in
 *                                  notifications
 * Sep 30, 2013  2191     bphillip  Fixing federated replication
 * Oct 08, 2013  1682     bphillip  Moved get objects of interest from RegistrySubscriptionManager
 *                                  and javadoc
 * Oct 20, 2013  1682     bphillip  Added synchronous notification delivery
 * Oct 23, 2013  1538     bphillip  Adding log messages and changed methods to handle DateTime value
 *                                  on AuditableEvents instead of integer
 * Dec 09, 2013  2613     bphillip  Changed start time boundary of get auditable events to be the
 *                                  last run time of the subscription
 * Jan 21, 2014  2613     bphillip  Changed start time boundary again and also a few minor cleanup
 *                                  items
 * Feb 13, 2014  2769     bphillip  Optimized sendNotifications method
...
public class RegistryNotificationManager {
    ...
    private final int notificationBatchSize = Integer.parseInt(System
    ...
    protected void checkNotification(NotificationType notification,
        ...
        List<AuditableEventType> eventsToSend = new ArrayList<>();
        List<RegistryObjectType> objectsToRemove = new ArrayList<>();
        List<ObjectRefType> refsToRemove = new ArrayList<>();
    ...
    protected NotificationType createNotification(String subscriptionId,
        ...
        notification.setName("Subscription Notification");
        notification.setDescription("Notification for subscription ["
                + subscriptionId + "]");
