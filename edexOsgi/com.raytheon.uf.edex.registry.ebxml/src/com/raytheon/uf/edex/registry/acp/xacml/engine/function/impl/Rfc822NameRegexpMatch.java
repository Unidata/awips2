...
public class Rfc822NameRegexpMatch extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:2.0:function:rfc822Name-regexp-match";
    ...
    public Boolean executeFunction(String regex, Rfc822Name name) {
        return name.toString().matches(regex);
    }
