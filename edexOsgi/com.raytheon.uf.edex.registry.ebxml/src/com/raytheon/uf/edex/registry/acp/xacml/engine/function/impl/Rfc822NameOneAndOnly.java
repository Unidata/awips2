...
public class Rfc822NameOneAndOnly extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:rfc822Name-one-and-only";
    ...
    public Rfc822Name executeFunction(List<Rfc822Name> list)
