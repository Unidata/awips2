...
public class BooleanBag extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:boolean-bag";
    ...
    public List<Boolean> executeFunction(Object[] booleanBag) {
        return CommonFunctions.createBag(booleanBag);
    }
