...
public class IntegerSetEquals extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:integer-set-equals";

    private IntegerSubset subset = new IntegerSubset();
    ...
    public Boolean executeFunction(List<Integer> bag1, List<Integer> bag2) {
