...
public class Base64BinarySubset extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:base64Binary-subset";
    ...
    public Boolean executeFunction(List<Base64Binary> list1,
