...
public class Floor extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:floor";
    ...
    public Double executeFunction(Double arg1) throws XACMLProcessingException {
        return new Double(Math.floor(arg1));
    }
}
