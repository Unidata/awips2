...
public class DateTimeOneAndOnly extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:dateTime-one-and-only";
    ...
    public XMLGregorianCalendar executeFunction(List<XMLGregorianCalendar> list)
            throws XACMLProcessingException {
        return CommonFunctions.oneAndOnly(list);
    }
