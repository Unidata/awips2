 ...
 * Feb 19, 2014  2769     bphillip  Moved getFederationAssociation from RegistryFederationManager
 * Jul 28, 2014  2752     dhladky   Fixed bad default user setup.
 ...
 * Jul 18  2018  7239     ksunil    Added version info in RegistryType object.
 * 
 * </pre>
 * 
 * @author bphillip
...
public class FederationProperties {
    ...
    public RegistryType createRegistryObject() {
        ...
        registryObj.setName(RegistryIdUtil.getId() + " Registry Specification");
        ...
        versionInfo.setUserVersionName(AppInfo.getInstance().getVersion());
        
        registryObj.setVersionInfo(versionInfo);
        return registryObj;
    }
    ...
    public OrganizationType createOrganization() {
        ...
        org.setName("National Weather Service Office: "
    ...
    public AssociationType getFederationAssociation(RegistryType registry,
        ...
        association.setName(registry.getId() + " Federation Membership");
