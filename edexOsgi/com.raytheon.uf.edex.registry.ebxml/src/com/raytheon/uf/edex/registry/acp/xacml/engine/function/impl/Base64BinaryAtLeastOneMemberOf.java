...
public class Base64BinaryAtLeastOneMemberOf extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:base64Binary-at-least-one-member-of";
    ...
    public Boolean executeFunction(List<Base64Binary> bag1,
        ...
        return CommonFunctions.atLeastOneMemberOf(bag1, bag2);
    }
