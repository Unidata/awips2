...
public class BooleanIntersection extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:boolean-intersection";
    ...
    public List<Boolean> executeFunction(List<Boolean> list1,
            List<Boolean> list2) {
