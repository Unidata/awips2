...
public class DoubleIntersection extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:double-intersection";
    ...
    public List<Double> executeFunction(List<Double> list1, List<Double> list2) {
