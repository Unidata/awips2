...
public class HexBinaryIntersection extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:hexBinary-intersection";
    ...
    public List<BigInteger> executeFunction(List<BigInteger> list1,
