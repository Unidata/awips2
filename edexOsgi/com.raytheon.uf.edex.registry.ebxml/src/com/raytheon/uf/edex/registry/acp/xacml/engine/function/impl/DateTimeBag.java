...
public class DateTimeBag extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:dateTime-bag";
    ...
    public List<XMLGregorianCalendar> executeFunction(Object[] objs) {
        return CommonFunctions.createBag(objs);
    }
