...
public class TimeIntersection extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:time-intersection";
    ...
    public List<XMLGregorianCalendar> executeFunction(
            List<XMLGregorianCalendar> list1, List<XMLGregorianCalendar> list2) {
