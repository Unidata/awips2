...
public class LifecycleManagerImpl implements LifecycleManager {
    ...
    public RegistryResponseType removeObjects(RemoveObjectsRequest request)
        ...
        statusHandler
                .debug("LifecycleManager received removeObjectsRequest from ["
        ...
        statusHandler
                .debug("LifeCycleManager removeObjects operation completed in "
                        + totalTime + " ms");
    ...
    private List<RegistryObjectType> versionObject(RegistryObjectType obj,
         ...
         */
            ...
            versionAssociation.setDescription(objectId + " Supersedes "
