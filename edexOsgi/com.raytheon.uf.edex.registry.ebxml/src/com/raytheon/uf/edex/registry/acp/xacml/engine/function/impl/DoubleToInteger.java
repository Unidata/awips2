...
public class DoubleToInteger extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:double-to-integer";
    ...
    public Integer executeFunction(Double arg1) throws XACMLProcessingException {
