...
public class AnyURIIsIn extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:anyURI-is-in";
    ...
    public Boolean executeFunction(URI uri, List<URI> uriBag) {
        return uriBag.contains(uri);
    }
}
