 ...
 * Apr 09, 2013  1802     bphillip  Added additional object checking
 * Oct 23, 2013  1538     bphillip  Changed constructor call for QueryRequest
 * Jul 10, 2014  1717     bphillip  Removed obligation processing from authorize method
...
public class XACMLContextHandler {
    ...
    public ResponseType authorize(String userName, Object object)
        ...
        ResponseType response = pdp.evaluate(policy, request);
        return response;
    }
    ...
    public RequestType constructRequest(String user, Object nativeRequest)
        ...
        for (RegistryObjectType obj : regObjs) {
            ...
            if (obj.getDescription() != null) {
                addAttributeToResource(resource, "description",
                        obj.getDescription());
            }
    ...
    private List<RegistryObjectType> getRegistryObjects(Object nativeRequest)
            throws MsgRegistryException, EbxmlRegistryException {
        List<RegistryObjectType> registryObjects = new ArrayList<>();
        if (nativeRequest instanceof SubmitObjectsRequest) {
