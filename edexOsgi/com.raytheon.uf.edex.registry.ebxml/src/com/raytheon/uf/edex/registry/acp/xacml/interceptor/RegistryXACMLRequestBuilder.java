...
/**
 * 
 * This class generates XACML authorization requests from SOAP and REST
 * requests.
 * 
 * <pre>
 * 
 ...
 * ------------ ----------  ----------- --------------------------
 * 8/11/2014    1712         bphillip    Initial Creation
...
public class RegistryXACMLRequestBuilder {
     ...
     * 
     * @param principal
     *            The principal on the message
     * @param roles
     *            The role(s) of the user making the request
     * @param issuer
     *            The issuer of the message
     * @param actionToUse
     *            The action being executed by the request
     * @param registryObject
     *            The registry object involved with the request
     * @param isSoapCall
     ...
     * 
     * @param message
     *            The message to get the registry request object from
     * @return The registry request message extracted from the received xml
     *         message
     */
     ...
     * 
     * @param message
     *            The message to get the issuer from
     * @return The issuer of the message
     * @throws WSSecurityException
     *             If errors occur while extracting the issuer
     */
    private String getIssuer(Message message) throws WSSecurityException {
        ...
        if (sc instanceof SAMLSecurityContext) {
            ...
            if (assertionElement != null) {
                SamlAssertionWrapper wrapper = new SamlAssertionWrapper(
                        assertionElement);
     ...
     * 
     * @param message
     *            The message to get the action from
     * @param isSoapCall
     *            True if this is a soap call
