...
public class AnyURIOneAndOnly extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:anyURI-one-and-only";
    ...
    public URI executeFunction(List<URI> uriBag)
            throws XACMLProcessingException {
        return CommonFunctions.oneAndOnly(uriBag);
    }
