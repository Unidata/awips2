...
public class IntegerAtLeastOneMemberOf extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:integer-at-least-one-member-of";
    ...
    public Boolean executeFunction(List<Integer> list1, List<Integer> list2) {
