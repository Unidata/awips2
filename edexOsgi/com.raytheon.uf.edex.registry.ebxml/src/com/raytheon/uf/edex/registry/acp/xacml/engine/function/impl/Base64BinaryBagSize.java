...
public class Base64BinaryBagSize extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:base64Binary-bag-size";
    ...
    public Integer executeFunction(List<Base64Binary> bag) {
        return bag.size();
    }
