...
public class DoubleGreaterThanOrEqual extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:double-greater-than-or-equal";
    ...
    public Boolean executeFunction(Double arg1, Double arg2) {
        return arg1 >= arg2;
    }
}
