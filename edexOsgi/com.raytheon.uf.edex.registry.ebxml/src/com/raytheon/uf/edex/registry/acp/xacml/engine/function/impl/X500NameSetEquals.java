...
public class X500NameSetEquals extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:x500Name-set-equals";

    private X500NameSubset subset = new X500NameSubset();
    ...
    public Boolean executeFunction(List<LdapName> bag1, List<LdapName> bag2) {
