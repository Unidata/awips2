...
/**
 *
 * Custom SslContextFacotry implementation which accepts encrypted values for
 * passwords
 *
 * <pre>
 *
 ...
 * Mar 04, 2021 8351        dgilling    Updated to subclass
 *                                        SslContextFactory.Server. 
 * </pre>
 *
 * @author bphillip
 **/
public class RegistrySSLContextFactory extends SslContextFactory.Server {
    ...
    public RegistrySSLContextFactory() throws IOException {
        ...
        this.encryption = new AESEncryptor(
                securityConfiguration.getEncryptionKey());
    }
