...
public class Base64BinaryBag extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:base64Binary-bag";
    ...
    public List<Base64Binary> executeFunction(Object[] values) {
        return CommonFunctions.createBag(values);
    }
