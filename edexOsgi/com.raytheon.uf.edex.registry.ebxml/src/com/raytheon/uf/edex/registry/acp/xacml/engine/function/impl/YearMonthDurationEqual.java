...
public class YearMonthDurationEqual extends XACMLFunction {
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:yearMonthDuration-equal";
    ...
    public Boolean executeFunction(Duration arg1, Duration arg2) {
        if (arg1 == null) {
            return arg2 == null;
        }
