...
public class StringRegexpMatch extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:string-regexp-match";
    ...
    public Boolean executeFunction(String regex, String str) {
        if (regex.startsWith("*")) {
            regex = " " + regex;
        }
