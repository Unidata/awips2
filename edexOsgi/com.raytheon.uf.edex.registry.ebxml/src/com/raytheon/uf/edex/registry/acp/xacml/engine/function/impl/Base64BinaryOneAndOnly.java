...
public class Base64BinaryOneAndOnly extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:base64Binary-one-and-only";
    ...
    public Base64Binary executeFunction(List<Base64Binary> obj)
            throws XACMLProcessingException {
        return CommonFunctions.oneAndOnly(obj);
    }
