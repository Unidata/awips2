...
public class DateTimeIntersection extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:dateTime-intersection";
    ...
    public List<XMLGregorianCalendar> executeFunction(
            List<XMLGregorianCalendar> bag1, List<XMLGregorianCalendar> bag2) {
