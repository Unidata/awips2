...
public class IntegerDivide extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:integer-divide";
    ...
    public Integer executeFunction(Integer arg1, Integer arg2)
            throws XACMLProcessingException {
        if (arg2 == 0) {
            throw new XACMLProcessingException(FUNCTION_ID + " division by 0");
        }
        return arg1 / arg2;
    }
}