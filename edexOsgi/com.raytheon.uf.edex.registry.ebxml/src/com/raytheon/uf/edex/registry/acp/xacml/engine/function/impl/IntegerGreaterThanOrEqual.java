...
public class IntegerGreaterThanOrEqual extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:integer-greater-than-or-equal";
    ...
    public Boolean executeFunction(Integer arg1, Integer arg2) {
        return arg1 >= arg2;
    }
}
