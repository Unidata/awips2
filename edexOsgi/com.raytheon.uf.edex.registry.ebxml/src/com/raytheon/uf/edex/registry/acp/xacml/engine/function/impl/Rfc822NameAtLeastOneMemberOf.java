...
public class Rfc822NameAtLeastOneMemberOf extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:rfc822Name-at-least-one-member-of";
    ...
    public Boolean executeFunction(List<Rfc822Name> list1,
