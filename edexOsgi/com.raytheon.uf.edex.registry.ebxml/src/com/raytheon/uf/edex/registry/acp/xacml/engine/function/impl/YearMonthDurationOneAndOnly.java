...
public class YearMonthDurationOneAndOnly extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:yearMonthDuration-one-and-only";
    ...
    public Duration executeFunction(List<Duration> list)
