...
public class Rfc822NameIntersection extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:rfc822Name-intersection";
    ...
    public List<Rfc822Name> executeFunction(List<Rfc822Name> list1,
