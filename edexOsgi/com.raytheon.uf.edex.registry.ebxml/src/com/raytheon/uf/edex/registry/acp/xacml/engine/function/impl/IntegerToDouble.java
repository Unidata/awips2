...
public class IntegerToDouble extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:integer-to-double";
    ...
    public Double executeFunction(Integer arg1) throws XACMLProcessingException {
