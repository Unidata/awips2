...
public class Rfc822NameSetEquals extends XACMLFunction {
    ...
    private static final String FUNCTION_ID = "urn:oasis:names:tc:xacml:1.0:function:rfc822Name-set-equals";

    private Rfc822NameSubset subset = new Rfc822NameSubset();
    ...
    public Boolean executeFunction(List<Rfc822Name> bag1, List<Rfc822Name> bag2) {
