...
/**
 * Section C.2 of the XACML 2.0 core spec defines the rule
 * ordered-deny-overrides combiner algorithm:
 * <p>
 ...
 * @version 1
 */
public class RuleOrderedDenyOverrides implements CombinerAlgorithm {

    @Override
    public String getAlgorithmId() {
        return RuleCombinerAlgorithms.COMBINE_RULES_ORDERED_DENY_OVERRIDES;
    }
