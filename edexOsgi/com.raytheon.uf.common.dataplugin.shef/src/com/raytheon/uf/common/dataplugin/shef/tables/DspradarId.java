...
/**
 * DspradarId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class DspradarId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public DspradarId(String radid, Date obstime) {
        this.radid = radid;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof DspradarId))
            return false;
        DspradarId castOther = (DspradarId) other;
