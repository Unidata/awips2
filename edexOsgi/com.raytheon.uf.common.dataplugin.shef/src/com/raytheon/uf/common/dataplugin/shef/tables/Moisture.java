...
/**
 * Moisture generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class Moisture extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {

    private static final long serialVersionUID = 1L;

    @javax.xml.bind.annotation.XmlElement
    @com.raytheon.uf.common.serialization.annotations.DynamicSerializeElement
    private MoistureId id;
    ...
    public Moisture(MoistureId id) {
        this.id = id;
    }

    public Moisture(MoistureId id, Double value, String shefQualCode,
    ...
    public MoistureId getId() {
        return this.id;
    }

    public void setId(MoistureId id) {
        this.id = id;
    }
