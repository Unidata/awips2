...
/**
 * RiverstatusId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class RiverstatusId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public RiverstatusId() {
    }

    public RiverstatusId(String lid, String pe, String ts) {
        this.lid = lid;
        this.pe = pe;
        this.ts = ts;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof RiverstatusId))
            return false;
        RiverstatusId castOther = (RiverstatusId) other;
