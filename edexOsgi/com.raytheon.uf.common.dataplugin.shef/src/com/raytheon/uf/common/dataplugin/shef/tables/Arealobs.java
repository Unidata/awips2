...
/**
 * Arealobs generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class Arealobs extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {

    private static final long serialVersionUID = 1L;

    @javax.xml.bind.annotation.XmlElement
    @com.raytheon.uf.common.serialization.annotations.DynamicSerializeElement
    private ArealobsId id;
    ...
    public Arealobs(ArealobsId id) {
        this.id = id;
    }

    public Arealobs(ArealobsId id, Double value, String shefQualCode,
    ...
    public ArealobsId getId() {
        return this.id;
    }

    public void setId(ArealobsId id) {
        this.id = id;
    }
