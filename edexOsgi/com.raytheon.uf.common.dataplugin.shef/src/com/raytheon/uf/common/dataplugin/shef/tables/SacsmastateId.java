...
/**
 * SacsmastateId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class SacsmastateId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public SacsmastateId() {
    }

    public SacsmastateId(String basinId, String source, Date validtime) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof SacsmastateId))
            return false;
        SacsmastateId castOther = (SacsmastateId) other;
