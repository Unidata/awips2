...
/**
 * WaterqualityId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class WaterqualityId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public WaterqualityId() {
    }

    public WaterqualityId(String lid, String pe, short dur, String ts,
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof WaterqualityId))
            return false;
        WaterqualityId castOther = (WaterqualityId) other;
