...
/**
 * FpprevprodId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class FpprevprodId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public FpprevprodId(String lid, Date producttime) {
        this.lid = lid;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof FpprevprodId))
            return false;
        FpprevprodId castOther = (FpprevprodId) other;
