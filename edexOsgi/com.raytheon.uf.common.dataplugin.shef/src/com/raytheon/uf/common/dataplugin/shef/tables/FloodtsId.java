...
/**
 * FloodtsId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class FloodtsId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public FloodtsId(String lid, Date obstime) {
        this.lid = lid;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof FloodtsId))
            return false;
        FloodtsId castOther = (FloodtsId) other;
