...
/**
 * OfsdatatransId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class OfsdatatransId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public OfsdatatransId() {
    }

    public OfsdatatransId(String pe, short dur, String extremum) {
        this.pe = pe;
        this.dur = dur;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof OfsdatatransId))
            return false;
        OfsdatatransId castOther = (OfsdatatransId) other;
