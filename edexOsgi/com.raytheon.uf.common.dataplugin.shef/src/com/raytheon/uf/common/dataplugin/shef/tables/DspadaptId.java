...
/**
 * DspadaptId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class DspadaptId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public DspadaptId(String radid, Date obstime) {
        this.radid = radid;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof DspadaptId))
            return false;
        DspadaptId castOther = (DspadaptId) other;
