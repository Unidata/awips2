...
public class Yunique extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {

    private static final long serialVersionUID = 1L;

    @javax.xml.bind.annotation.XmlElement
    @com.raytheon.uf.common.serialization.annotations.DynamicSerializeElement
    private YuniqueId id;
    ...
    public Yunique(YuniqueId id) {
        this.id = id;
    }

    public Yunique(YuniqueId id, Double value, String shefQualCode,
    ...
    public YuniqueId getId() {
        return this.id;
    }

    public void setId(YuniqueId id) {
        this.id = id;
    }
