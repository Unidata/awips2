...
public class RawppId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public RawppId(String lid, short dur, String ts, String extremum,
            Date obstime) {
        this.lid = lid;
        this.dur = dur;
        this.ts = ts;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof RawppId))
            return false;
        RawppId castOther = (RawppId) other;
