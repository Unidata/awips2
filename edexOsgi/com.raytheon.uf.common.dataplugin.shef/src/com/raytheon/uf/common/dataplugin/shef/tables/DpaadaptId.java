...
/**
 * DpaadaptId generated by hbm2java
 * 
 * 
 * <pre>
 * 
 ...
 * Sep 14, 2016  4622      jschmid     Cleanup, removed extends PersistableDataObj
 * Nov 02, 2016  4622      skorolev    Modified toString().
 * 
 * </pre>
 * 
 * @author jkorman
...
public class DpaadaptId implements java.io.Serializable {
    ...
    public DpaadaptId(String radid, Date obstime) {
        this.radid = radid;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof DpaadaptId))
            return false;
        DpaadaptId castOther = (DpaadaptId) other;
    ...
    public String toString() {
        ...
        record.append("DpaadaptId: {radid: ").append(radid);
        record.append(", obstime: ").append(obstime).append("}");
