...
public class Curpc extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public Curpc(CurpcId id, String pe, short dur) {
        this.id = id;
        this.pe = pe;
        this.dur = dur;
    }

    public Curpc(CurpcId id, String pe, short dur, Double value,
    ...
    public CurpcId getId() {
        return this.id;
    }

    public void setId(CurpcId id) {
        this.id = id;
    }
