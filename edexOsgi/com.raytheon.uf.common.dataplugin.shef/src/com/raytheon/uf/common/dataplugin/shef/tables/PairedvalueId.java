...
/**
 * PairedvalueId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class PairedvalueId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public PairedvalueId() {
    }

    public PairedvalueId(String lid, String pe, short dur, String ts,
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof PairedvalueId))
            return false;
        PairedvalueId castOther = (PairedvalueId) other;
        ...
        return ((this.getLid() == castOther.getLid()) || (this.getLid() != null
                ...
                && (this.getRefValue() == castOther.getRefValue());
    }
    ...
    public int hashCode() {
        ...
        result = 37 * result + this.getRefValue();
        return result;
    }
