...
/**
 * Locclass generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class Locclass extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {

    private static final long serialVersionUID = 1L;

    @javax.xml.bind.annotation.XmlElement
    @com.raytheon.uf.common.serialization.annotations.DynamicSerializeElement
    private LocclassId id;

    public Locclass() {
    }

    public Locclass(LocclassId id) {
        this.id = id;
    }
    ...
    public LocclassId getId() {
        return this.id;
    }

    public void setId(LocclassId id) {
        this.id = id;
    }
