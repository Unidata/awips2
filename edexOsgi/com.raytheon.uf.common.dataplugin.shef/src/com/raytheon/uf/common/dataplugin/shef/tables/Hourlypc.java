 ...
 */
@NamedQueries({
        @NamedQuery(name = Hourlypc.SELECT_DATA_BETWEEN_OBS_DATE_RANGE, query = Hourlypc.SELECT_DATA_BETWEEN_OBS_DATE_RANGE_HQL),
...
public class Hourlypc extends PersistableDataObject<HourlypcId>
    ...
    public static final String SELECT_DATA_BETWEEN_OBS_DATE_RANGE = "selectHourlyPCDataBetweenObsDateRange";

    protected static final String SELECT_DATA_BETWEEN_OBS_DATE_RANGE_HQL = "FROM Hourlypc h WHERE date_trunc('day', h.id.obsdate) >= :startObsDate AND date_trunc('day', h.id.obsdate) <= :endObsDate ORDER BY h.id.lid, h.id.ts, h.id.obsdate";
