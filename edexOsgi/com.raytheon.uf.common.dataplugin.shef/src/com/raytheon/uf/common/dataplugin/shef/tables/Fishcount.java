...
/**
 * Fishcount generated by hbm2java
 * 
 * 
 * <pre>
 * 
 ...
 */
@Entity
@Table(name = "fishcount")
@javax.xml.bind.annotation.XmlRootElement
@javax.xml.bind.annotation.XmlAccessorType(javax.xml.bind.annotation.XmlAccessType.NONE)
@com.raytheon.uf.common.serialization.annotations.DynamicSerialize
public class Fishcount extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {

    private static final long serialVersionUID = 1L;

    @javax.xml.bind.annotation.XmlElement
    @com.raytheon.uf.common.serialization.annotations.DynamicSerializeElement
    private FishcountId id;
    ...
    public Fishcount(FishcountId id) {
        this.id = id;
    }

    public Fishcount(FishcountId id, Double value, String shefQualCode,
    ...
    public FishcountId getId() {
        return this.id;
    }

    public void setId(FishcountId id) {
        this.id = id;
    }
