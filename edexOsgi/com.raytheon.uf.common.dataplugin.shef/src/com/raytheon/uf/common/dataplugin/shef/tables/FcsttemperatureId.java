...
/**
 * FcsttemperatureId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class FcsttemperatureId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public FcsttemperatureId() {
    }

    public FcsttemperatureId(String lid, String pe, short dur, String ts,
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof FcsttemperatureId))
            return false;
        FcsttemperatureId castOther = (FcsttemperatureId) other;
