...
/**
 * MpeGageQcId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class MpeGageQcId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public MpeGageQcId(String lid, String pe, String ts) {
        this.lid = lid;
        this.pe = pe;
        this.ts = ts;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof MpeGageQcId))
            return false;
        MpeGageQcId castOther = (MpeGageQcId) other;
