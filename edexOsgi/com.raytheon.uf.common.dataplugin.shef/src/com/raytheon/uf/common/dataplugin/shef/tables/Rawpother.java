...
/**
 * Rawpother generated by hbm2java
 * 
 * 
 * <pre>
 * 
 ...
 */
@Entity
@Table(name = "rawpother")
@javax.xml.bind.annotation.XmlRootElement
@javax.xml.bind.annotation.XmlAccessorType(javax.xml.bind.annotation.XmlAccessType.NONE)
@com.raytheon.uf.common.serialization.annotations.DynamicSerialize
public class Rawpother extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {

    private static final long serialVersionUID = 1L;

    @javax.xml.bind.annotation.XmlElement
    @com.raytheon.uf.common.serialization.annotations.DynamicSerializeElement
    private RawpotherId id;
    ...
    public Rawpother(RawpotherId id) {
        this.id = id;
    }

    public Rawpother(RawpotherId id, Float value, String shefQualCode,
    ...
    public RawpotherId getId() {
        return this.id;
    }

    public void setId(RawpotherId id) {
        this.id = id;
    }
