...
/**
 * Radiation generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class Radiation extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {

    private static final long serialVersionUID = 1L;

    @javax.xml.bind.annotation.XmlElement
    @com.raytheon.uf.common.serialization.annotations.DynamicSerializeElement
    private RadiationId id;
    ...
    public Radiation(RadiationId id) {
        this.id = id;
    }

    public Radiation(RadiationId id, Double value, String shefQualCode,
    ...
    public RadiationId getId() {
        return this.id;
    }

    public void setId(RadiationId id) {
        this.id = id;
    }
