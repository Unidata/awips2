...
/**
 * HourlypcId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class HourlypcId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public HourlypcId(String lid, String ts, Date obsdate) {
        this.lid = lid;
        this.ts = ts;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof HourlypcId))
            return false;
        HourlypcId castOther = (HourlypcId) other;
