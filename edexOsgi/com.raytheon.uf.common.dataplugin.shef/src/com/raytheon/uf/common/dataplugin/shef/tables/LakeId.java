...
public class LakeId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public LakeId(String lid, String pe, short dur, String ts, String extremum,
            Date obstime) {
        this.lid = lid;
        this.pe = pe;
        this.dur = dur;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof LakeId))
            return false;
        LakeId castOther = (LakeId) other;
