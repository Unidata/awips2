...
/**
 * EvaporationId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class EvaporationId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public EvaporationId() {
    }

    public EvaporationId(String lid, String pe, short dur, String ts,
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof EvaporationId))
            return false;
        EvaporationId castOther = (EvaporationId) other;
