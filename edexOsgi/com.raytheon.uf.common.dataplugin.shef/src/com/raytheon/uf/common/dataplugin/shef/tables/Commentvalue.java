...
/**
 * Commentvalue generated by hbm2java
 * 
 * 
 * <pre>
 * 
 ...
 */
@Entity
@Table(name = "commentvalue")
@javax.xml.bind.annotation.XmlRootElement
@javax.xml.bind.annotation.XmlAccessorType(javax.xml.bind.annotation.XmlAccessType.NONE)
@com.raytheon.uf.common.serialization.annotations.DynamicSerialize
public class Commentvalue extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {

    private static final long serialVersionUID = 1L;

    @javax.xml.bind.annotation.XmlElement
    @com.raytheon.uf.common.serialization.annotations.DynamicSerializeElement
    private CommentvalueId id;
    ...
    @javax.xml.bind.annotation.XmlElement
    @com.raytheon.uf.common.serialization.annotations.DynamicSerializeElement
    private String shefComment;

    public Commentvalue() {
    }

    public Commentvalue(CommentvalueId id) {
        this.id = id;
    }

    public Commentvalue(CommentvalueId id, Double value, String shefQualCode,
            Short revision, String productId, Date producttime,
            Date postingtime, String shefComment) {
        this.id = id;
        this.value = value;
    ...
    public CommentvalueId getId() {
        return this.id;
    }

    public void setId(CommentvalueId id) {
        this.id = id;
    }
    ...
    @Column(name = "shef_comment", length = 80)
    public String getShefComment() {
        return this.shefComment;
    }

    public void setShefComment(String shefComment) {
        this.shefComment = shefComment;
    }
