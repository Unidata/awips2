...
/**
 * Pairedvalue generated by hbm2java
 * 
 * 
 * <pre>
 * 
 ...
 */
@Entity
@Table(name = "pairedvalue")
@javax.xml.bind.annotation.XmlRootElement
@javax.xml.bind.annotation.XmlAccessorType(javax.xml.bind.annotation.XmlAccessType.NONE)
@com.raytheon.uf.common.serialization.annotations.DynamicSerialize
public class Pairedvalue extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {

    private static final long serialVersionUID = 1L;

    @javax.xml.bind.annotation.XmlElement
    @com.raytheon.uf.common.serialization.annotations.DynamicSerializeElement
    private PairedvalueId id;
    ...
    public Pairedvalue(PairedvalueId id) {
        this.id = id;
    }

    public Pairedvalue(PairedvalueId id, Double value, String shefQualCode,
    ...
    @AttributeOverrides( {
            ...
            @AttributeOverride(name = "refValue", column = @Column(name = "ref_value", nullable = false)) })
    public PairedvalueId getId() {
        return this.id;
    }

    public void setId(PairedvalueId id) {
        this.id = id;
    }
