...
/**
 * RejecteddataId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class RejecteddataId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public RejecteddataId() {
    }

    public RejecteddataId(String lid, String pe, short dur, String ts,
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof RejecteddataId))
            return false;
        RejecteddataId castOther = (RejecteddataId) other;
