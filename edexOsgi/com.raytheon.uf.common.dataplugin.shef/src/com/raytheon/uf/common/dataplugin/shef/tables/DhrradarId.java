...
/**
 * DhrradarId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class DhrradarId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public DhrradarId(String radid, Date obstime) {
        this.radid = radid;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof DhrradarId))
            return false;
        DhrradarId castOther = (DhrradarId) other;
