...
public class PowerId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public PowerId(String lid, String pe, short dur, String ts,
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof PowerId))
            return false;
        PowerId castOther = (PowerId) other;
