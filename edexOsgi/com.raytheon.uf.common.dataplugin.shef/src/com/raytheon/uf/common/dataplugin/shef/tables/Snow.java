...
public class Snow extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public Snow(SnowId id) {
        this.id = id;
    }

    public Snow(SnowId id, Double value, String shefQualCode,
