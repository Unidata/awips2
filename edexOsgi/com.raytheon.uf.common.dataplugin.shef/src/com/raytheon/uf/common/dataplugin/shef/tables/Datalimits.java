...
/**
 * Datalimits generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
@NamedQueries({
        ...
        @NamedQuery(name = Datalimits.SELECT_PP_WITH_DUR_1006_2001_5004_LIMITS_FROM_DATALIMITS, query = Datalimits.SELECT_PP_WITH_DUR_1006_2001_5004_LIMITS_FROM_DATALIMITS_HQL),
        @NamedQuery(name = Datalimits.SELECT_TA_LIMITS_FROM_DATALIMITS, query = Datalimits.SELECT_TA_LIMITS_FROM_DATALIMITS_HQL) })
@Entity
@Table(name = "datalimits")
@DynamicSerialize
public class Datalimits extends PersistableDataObject<DatalimitsId>
        implements Serializable {

    public static final String SELECT_ALL_DATALIMITS_RECORDS = "selectAllDataLimitsRecords";
    ...
    protected static final String SELECT_OBS_LIMITS_FROM_DATALIMITS_HQL = "SELECT id, monthdayend, rocMax, alarmRocLimit, alertRocLimit FROM Datalimits dl";

    public static final String SELECT_PP_WITH_DUR_1006_2001_5004_LIMITS_FROM_DATALIMITS = "selectPPWithDur1006_2001_5004LimitsFromDataLimits";

    public static final String SELECT_PP_WITH_DUR_1006_2001_5004_LIMITS_FROM_DATALIMITS_HQL = "SELECT id, monthdayend, grossRangeMax FROM Datalimits dl WHERE dl.id.pe = 'PP' AND dl.id.dur IN (1006, 2001, 5004)";

    public static final String SELECT_TA_LIMITS_FROM_DATALIMITS = "selectTALimitsFromDataLimits";

    public static final String SELECT_TA_LIMITS_FROM_DATALIMITS_HQL = "SELECT id, monthdayend, grossRangeMin, grossRangeMax FROM Datalimits dl WHERE dl.id.pe = 'TA'";

    private static final long serialVersionUID = 1L;

    @DynamicSerializeElement
    private DatalimitsId id;
    ...
    public Datalimits(DatalimitsId id, Shefpe shefpe, Shefdur shefdur,
            String monthdayend) {
        this.id = id;
        this.shefpe = shefpe;
    ...
    public void setId(DatalimitsId id) {
        this.id = id;
    }
