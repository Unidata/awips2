...
@NamedQueries({ @NamedQuery(name = Curpp.SELECT_CURPP_BY_START_AND_FINISH, query = Curpp.SELECT_CURPP_BY_START_AND_FINISH_HQL) })
@Entity
@Table(name = "curpp")
@DynamicSerialize
public class Curpp implements java.io.Serializable {

    public static final String SELECT_CURPP_BY_START_AND_FINISH = "SELECT_CURPP_BY_START_AND_FINISH";

    protected static final String SELECT_CURPP_BY_START_AND_FINISH_HQL = "FROM Curpp c WHERE c.value != -9999.0 AND c.id.obstime >= :start AND c.id.obstime <= :finish AND c.id.dur < 1001 ORDER BY c.id.lid ASC, c.id.ts ASC, c.id.dur DESC, c.id.obstime DESC";
    ...
    public Curpp(CurppId id, String pe) {
        this.id = id;
        this.pe = pe;
    }

    public Curpp(CurppId id, String pe, Double value, String shefQualCode,
    ...
    public CurppId getId() {
        return this.id;
    }

    public void setId(CurppId id) {
        this.id = id;
    }
