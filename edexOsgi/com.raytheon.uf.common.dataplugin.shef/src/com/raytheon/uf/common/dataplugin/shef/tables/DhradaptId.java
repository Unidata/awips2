...
/**
 * DhradaptId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class DhradaptId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public DhradaptId(String radid, Date obstime) {
        this.radid = radid;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof DhradaptId))
            return false;
        DhradaptId castOther = (DhradaptId) other;
