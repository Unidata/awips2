...
/**
 * Procvalue generated by hbm2java
 * 
 * 
 * <pre>
 * 
 ...
 */
@Entity
@Table(name = "procvalue")
@javax.xml.bind.annotation.XmlRootElement
@javax.xml.bind.annotation.XmlAccessorType(javax.xml.bind.annotation.XmlAccessType.NONE)
@com.raytheon.uf.common.serialization.annotations.DynamicSerialize
public class Procvalue extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {

    private static final long serialVersionUID = 1L;

    @javax.xml.bind.annotation.XmlElement
    @com.raytheon.uf.common.serialization.annotations.DynamicSerializeElement
    private ProcvalueId id;
    ...
    public Procvalue(ProcvalueId id) {
        this.id = id;
    }

    public Procvalue(ProcvalueId id, Double value, String shefQualCode,
    ...
    public ProcvalueId getId() {
        return this.id;
    }

    public void setId(ProcvalueId id) {
        this.id = id;
    }
