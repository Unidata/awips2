...
/**
 * AdjustfactorId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class AdjustfactorId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public AdjustfactorId() {
    }

    public AdjustfactorId(String lid, String pe, short dur, String ts,
            String extremum) {
        this.lid = lid;
        this.pe = pe;
        this.dur = dur;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof AdjustfactorId))
            return false;
        AdjustfactorId castOther = (AdjustfactorId) other;
