...
/**
 * Waterquality generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class Waterquality extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {

    private static final long serialVersionUID = 1L;

    @javax.xml.bind.annotation.XmlElement
    @com.raytheon.uf.common.serialization.annotations.DynamicSerializeElement
    private WaterqualityId id;
    ...
    public Waterquality(WaterqualityId id) {
        this.id = id;
    }

    public Waterquality(WaterqualityId id, Double value, String shefQualCode,
    ...
    public WaterqualityId getId() {
        return this.id;
    }

    public void setId(WaterqualityId id) {
        this.id = id;
    }
