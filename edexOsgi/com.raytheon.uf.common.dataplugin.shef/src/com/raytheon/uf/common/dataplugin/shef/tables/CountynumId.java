...
/**
 * CountynumId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class CountynumId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public CountynumId(String lid, String state, String county) {
        this.lid = lid;
        this.state = state;
        this.county = county;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof CountynumId))
            return false;
        CountynumId castOther = (CountynumId) other;
