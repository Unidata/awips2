...
/**
 * ContingencyvalueId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class ContingencyvalueId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public ContingencyvalueId() {
    }

    public ContingencyvalueId(String lid, String pe, short dur, String ts,
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof ContingencyvalueId))
            return false;
        ContingencyvalueId castOther = (ContingencyvalueId) other;
