...
public class RawpcId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public RawpcId(String lid, String ts, String extremum, Date obstime) {
        this.lid = lid;
        this.ts = ts;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof RawpcId))
            return false;
        RawpcId castOther = (RawpcId) other;
