...
/**
 * MonthlyvaluesId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class MonthlyvaluesId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public MonthlyvaluesId() {
    }

    public MonthlyvaluesId(String lid, String pe, short dur, String ts,
            String extremum, String adjustment) {
        this.lid = lid;
        this.pe = pe;
        this.dur = dur;
        this.ts = ts;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof MonthlyvaluesId))
            return false;
        MonthlyvaluesId castOther = (MonthlyvaluesId) other;
        ...
        return ((this.getLid() == castOther.getLid()) || (this.getLid() != null
                ...
                && ((this.getAdjustment() == castOther.getAdjustment()) || (this
                        .getAdjustment() != null
                        && castOther.getAdjustment() != null && this
                        .getAdjustment().equals(castOther.getAdjustment())));
    }
    ...
    public int hashCode() {
        ...
        result = 37
                * result
                + (getAdjustment() == null ? 0 : this.getAdjustment()
                        .hashCode());
        return result;
    }
