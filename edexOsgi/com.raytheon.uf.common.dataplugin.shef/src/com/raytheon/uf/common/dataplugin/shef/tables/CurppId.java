...
public class CurppId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public CurppId(String lid, short dur, String ts, String extremum,
            Date obstime) {
        this.lid = lid;
        this.dur = dur;
        this.ts = ts;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof CurppId))
            return false;
        CurppId castOther = (CurppId) other;
