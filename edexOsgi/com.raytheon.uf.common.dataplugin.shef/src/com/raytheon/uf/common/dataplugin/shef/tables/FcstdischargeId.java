...
/**
 * FcstdischargeId generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class FcstdischargeId extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {
    ...
    public FcstdischargeId() {
    }

    public FcstdischargeId(String lid, String pe, short dur, String ts,
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof FcstdischargeId))
            return false;
        FcstdischargeId castOther = (FcstdischargeId) other;
