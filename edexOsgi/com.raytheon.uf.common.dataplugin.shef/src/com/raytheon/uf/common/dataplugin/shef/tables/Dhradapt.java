...
/**
 * Dhradapt generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class Dhradapt extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {

    private static final long serialVersionUID = 1L;

    @javax.xml.bind.annotation.XmlElement
    @com.raytheon.uf.common.serialization.annotations.DynamicSerializeElement
    private DhradaptId id;
    ...
    public Dhradapt(DhradaptId id, Radarloc radarloc) {
        this.id = id;
        this.radarloc = radarloc;
    }

    public Dhradapt(DhradaptId id, Radarloc radarloc, Float minReflth,
    ...
    public DhradaptId getId() {
        return this.id;
    }

    public void setId(DhradaptId id) {
        this.id = id;
    }
