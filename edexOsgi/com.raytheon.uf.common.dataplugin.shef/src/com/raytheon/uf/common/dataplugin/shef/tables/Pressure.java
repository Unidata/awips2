...
/**
 * Pressure generated by hbm2java
 * 
 * 
 * <pre>
 * 
...
public class Pressure extends com.raytheon.uf.common.dataplugin.persist.PersistableDataObject implements java.io.Serializable, com.raytheon.uf.common.serialization.ISerializableObject {

    private static final long serialVersionUID = 1L;

    @javax.xml.bind.annotation.XmlElement
    @com.raytheon.uf.common.serialization.annotations.DynamicSerializeElement
    private PressureId id;
    ...
    public Pressure(PressureId id) {
        this.id = id;
    }

    public Pressure(PressureId id, Double value, String shefQualCode,
    ...
    public PressureId getId() {
        return this.id;
    }

    public void setId(PressureId id) {
        this.id = id;
    }
