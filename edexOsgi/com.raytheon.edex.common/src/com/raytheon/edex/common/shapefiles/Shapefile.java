...
public class Shapefile {
     ...
     * shapefiles
     */
    private FeatureSource<SimpleFeatureType, SimpleFeature> theFeatureSource;
    ...
    public boolean readShapefile() {
        ...
        try {
            ...
            FeatureCollection<SimpleFeatureType, SimpleFeature> collection = theFeatureSource
                    .getFeatures();
    ...
    public boolean writeShapefile(String anOutputFileName) {
        ...
        FeatureCollection<SimpleFeatureType, SimpleFeature> outFeatures = FeatureCollections
                .newCollection();
