...
public interface IContinuousSlice extends IGridSlice {
    ...
    /**
     * Apply an operation to a specified subset of this GridSlice, with a single
    ...
    /**
     * Apply an operation to this GridSlice, with a single real-valued operand.
     * <BR>
     * <BR>
     * <B>NOTE:</B> In AWIPS I GFE, this replaces the following methods:
     * <ul>
    ...
    /**
     * Apply an operation to a specified subset of this GridSlice, with a slice
    ...
    /**
     * Apply an operation to this GridSlice, with a slice of values providing
     * the operands. <BR>
     * <BR>
     * These operations are the equivalents to +=, -=, *=, /=, and =
     * (assignment) operators. <BR>
