 ...
 * Jun 13, 2013  2044     randerso  JavaDoc cleanup
...
@DynamicSerialize
public class GridUpdateNotification extends GfeNotification {
     ...
     *            The site ID
     */
    public GridUpdateNotification(ParmID parmId, TimeRange replacementTimeRange,
