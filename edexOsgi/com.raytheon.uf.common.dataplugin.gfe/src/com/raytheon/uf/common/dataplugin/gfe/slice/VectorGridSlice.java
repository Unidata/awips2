...
public class VectorGridSlice extends ScalarGridSlice {
    ...
    public VectorGridSlice clone() throws CloneNotSupportedException {
        ...
        Grid2DFloat aDirGrid = null;
        if (dirGrid != null) {
            aDirGrid = dirGrid.clone();
        }
    ...
    public Object getNDArray() {
        ...
        arr[0] = new NDArray<>(getMagGrid().getFloats(),
                getMagGrid().getYdim(), getMagGrid().getXdim());
        arr[1] = new NDArray<>(getDirGrid().getFloats(),
                getDirGrid().getYdim(), getDirGrid().getXdim());
        return arr;
    }
