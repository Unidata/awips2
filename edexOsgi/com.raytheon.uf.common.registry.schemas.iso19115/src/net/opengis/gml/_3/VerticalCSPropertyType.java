...
public class VerticalCSPropertyType {
    ...
    @XmlElementRef(name = "VerticalCS", namespace = "http://www.opengis.net/gml/3.2", type = VerticalCSSub.class)
    protected VerticalCSSub verticalCS;
    @XmlAttribute
     ...
     *     
     */
    public VerticalCSSub getVerticalCS() {
        return verticalCS;
    }
     ...
     *     
     */
    public void setVerticalCS(VerticalCSSub value) {
