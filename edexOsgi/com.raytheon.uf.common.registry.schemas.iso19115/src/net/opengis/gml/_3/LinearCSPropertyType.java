...
public class LinearCSPropertyType {
    ...
    @XmlElementRef(name = "LinearCS", namespace = "http://www.opengis.net/gml/3.2", type = LinearCSSub.class)
    protected LinearCSSub linearCS;
    @XmlAttribute
     ...
     *     
     */
    public LinearCSSub getLinearCS() {
        return linearCS;
    }
     ...
     *     
     */
    public void setLinearCS(LinearCSSub value) {
        this.linearCS = value;
    }
