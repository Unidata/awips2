...
public class TimeCSPropertyType {
    ...
    @XmlElementRef(name = "TimeCS", namespace = "http://www.opengis.net/gml/3.2", type = TimeCSSub.class)
    protected TimeCSSub timeCS;
    @XmlAttribute
     ...
     *     
     */
    public void setTimeCS(TimeCSSub value) {
        this.timeCS = value;
    }
