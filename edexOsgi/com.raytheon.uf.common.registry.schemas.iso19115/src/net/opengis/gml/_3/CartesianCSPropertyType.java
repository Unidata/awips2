...
public class CartesianCSPropertyType {
    ...
    @XmlElementRef(name = "CartesianCS", namespace = "http://www.opengis.net/gml/3.2", type = CartesianCSSub.class)
    protected CartesianCSSub cartesianCS;
    @XmlAttribute
     ...
     *     
     */
    public CartesianCSSub getCartesianCS() {
        return cartesianCS;
    }
     ...
     *     
     */
    public void setCartesianCS(CartesianCSSub value) {
