...
public class ConversionPropertyType {
    ...
    @XmlElementRef(name = "Conversion", namespace = "http://www.opengis.net/gml/3.2", type = ConversionSub.class)
    protected ConversionSub conversion;
    @XmlAttribute
     ...
     *     
     */
    public ConversionSub getConversion() {
        return conversion;
    }
     ...
     *     
     */
    public void setConversion(ConversionSub value) {
