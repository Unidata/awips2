...
public class VerticalDatumPropertyType {
    ...
    @XmlElementRef(name = "VerticalDatum", namespace = "http://www.opengis.net/gml/3.2", type = VerticalDatumSub.class)
    protected VerticalDatumSub verticalDatum;
    @XmlAttribute
     ...
     *     
     */
    public VerticalDatumSub getVerticalDatum() {
     ...
     *     
     */
    public void setVerticalDatum(VerticalDatumSub value) {
