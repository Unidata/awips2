...
public class PolarCSPropertyType {
    ...
    @XmlElementRef(name = "PolarCS", namespace = "http://www.opengis.net/gml/3.2", type = PolarCSSub.class)
    protected PolarCSSub polarCS;
    @XmlAttribute
     ...
     *     
     */
    public void setPolarCS(PolarCSSub value) {
        this.polarCS = value;
    }
