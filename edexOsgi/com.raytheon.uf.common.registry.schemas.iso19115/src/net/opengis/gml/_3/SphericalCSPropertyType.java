...
public class SphericalCSPropertyType {
    ...
    @XmlElementRef(name = "SphericalCS", namespace = "http://www.opengis.net/gml/3.2", type = SphericalCSSub.class)
    protected SphericalCSSub sphericalCS;
    @XmlAttribute
     ...
     *     
     */
    public SphericalCSSub getSphericalCS() {
        return sphericalCS;
    }
     ...
     *     
     */
    public void setSphericalCS(SphericalCSSub value) {
