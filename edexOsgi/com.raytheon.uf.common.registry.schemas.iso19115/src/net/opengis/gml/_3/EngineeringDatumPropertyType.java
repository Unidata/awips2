...
public class EngineeringDatumPropertyType {
    ...
    @XmlElementRef(name = "EngineeringDatum", namespace = "http://www.opengis.net/gml/3.2", type = EngineeringDatumSub.class)
    protected EngineeringDatumSub engineeringDatum;
    @XmlAttribute
     ...
     *     
     */
    public EngineeringDatumSub getEngineeringDatum() {
     ...
     *     
     */
    public void setEngineeringDatum(EngineeringDatumSub value) {
