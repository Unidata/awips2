...
public class EllipsoidalCSPropertyType {
    ...
    @XmlElementRef(name = "EllipsoidalCS", namespace = "http://www.opengis.net/gml/3.2", type = EllipsoidalCSSub.class)
    protected EllipsoidalCSSub ellipsoidalCS;
    @XmlAttribute
     ...
     *     
     */
    public EllipsoidalCSSub getEllipsoidalCS() {
     ...
     *     
     */
    public void setEllipsoidalCS(EllipsoidalCSSub value) {
