...
public class GeodeticDatumPropertyType {
    ...
    @XmlElementRef(name = "GeodeticDatum", namespace = "http://www.opengis.net/gml/3.2", type = GeodeticDatumSub.class)
    protected GeodeticDatumSub geodeticDatum;
    @XmlAttribute
     ...
     *     
     */
    public GeodeticDatumSub getGeodeticDatum() {
     ...
     *     
     */
    public void setGeodeticDatum(GeodeticDatumSub value) {
