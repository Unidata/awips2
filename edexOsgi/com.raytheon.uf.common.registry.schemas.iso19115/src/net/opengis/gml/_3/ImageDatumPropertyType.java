...
public class ImageDatumPropertyType {
    ...
    @XmlElementRef(name = "ImageDatum", namespace = "http://www.opengis.net/gml/3.2", type = ImageDatumSub.class)
    protected ImageDatumSub imageDatum;
    @XmlAttribute
     ...
     *     
     */
    public ImageDatumSub getImageDatum() {
        return imageDatum;
    }
     ...
     *     
     */
    public void setImageDatum(ImageDatumSub value) {
