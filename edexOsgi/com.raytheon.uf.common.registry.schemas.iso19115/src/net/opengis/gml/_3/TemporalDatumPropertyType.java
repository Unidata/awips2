...
public class TemporalDatumPropertyType {
    ...
    @XmlElementRef(name = "TemporalDatum", namespace = "http://www.opengis.net/gml/3.2", type = TemporalDatumSub.class)
    protected TemporalDatumSub temporalDatum;
    @XmlAttribute
     ...
     *     
     */
    public TemporalDatumSub getTemporalDatum() {
     ...
     *     
     */
    public void setTemporalDatum(TemporalDatumSub value) {
