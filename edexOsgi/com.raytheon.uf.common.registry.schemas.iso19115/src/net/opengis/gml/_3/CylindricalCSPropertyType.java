...
public class CylindricalCSPropertyType {
    ...
    @XmlElementRef(name = "CylindricalCS", namespace = "http://www.opengis.net/gml/3.2", type = CylindricalCSSub.class)
    protected CylindricalCSSub cylindricalCS;
    @XmlAttribute
     ...
     *     
     */
    public CylindricalCSSub getCylindricalCS() {
     ...
     *     
     */
    public void setCylindricalCS(CylindricalCSSub value) {
