...
public class UserDefinedCSPropertyType {
    ...
    @XmlElementRef(name = "UserDefinedCS", namespace = "http://www.opengis.net/gml/3.2", type = UserDefinedCSSub.class)
    protected UserDefinedCSSub userDefinedCS;
    @XmlAttribute
     ...
     *     
     */
    public UserDefinedCSSub getUserDefinedCS() {
     ...
     *     
     */
    public void setUserDefinedCS(UserDefinedCSSub value) {
