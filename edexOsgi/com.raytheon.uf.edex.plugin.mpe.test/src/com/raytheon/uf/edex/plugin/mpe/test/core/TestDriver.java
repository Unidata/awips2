...
import com.raytheon.uf.edex.plugin.mpe.test.impl.ProcessGribFilesValidationTest;
 ...
 * Sep 09, 2016 4628       bkowal      Register {@link ProcessGribFilesValidationTest}.
 * 
 * </pre>
 * 
 * @author bkowal
...
public class TestDriver {
    ...
    public TestDriver() {
        ...
        registeredTests.add(new ProcessGribFilesValidationTest());
    }
    ...
    public void runTests() {
        ...
        verifyTimer.start();
        logger.info("MPE verification tests: {} running ...",
        ...
        for (IValidationTest validationTest : registeredTests) {
            ...
            try {
                ...
                logger.error("Validation Test: " + testName + " has failed.",
                        e);
                continue;
            } catch (Exception e) {
