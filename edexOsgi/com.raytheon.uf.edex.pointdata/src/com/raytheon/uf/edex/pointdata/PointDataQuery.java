...
public class PointDataQuery {
    ...
    public PointDataQuery(String plugin) throws DataAccessLayerException,
            PluginException {
    ...
    public void requestSpecificLevel(String parameter, String vals) {
    ...
    public PointDataContainer execute() throws Exception {
        ...
        if (hdf5attribList.isEmpty()) {
            ...
            for (Map<String, Object> workingMap : dbResults) {
                ...
                int idx = (Integer) workingMap.get("pdv.curIdx");
