 ...
 * Feb 16, 2018  6895         tgurney     Move to uf.edex.maintenance package
 *
 * </pre>
 *
 * @author randerso
...
public class FilePurger {
    ...
    public FilePurger(String rootDirectory, long purgeAge,
        ...
        this.matcher = this.rootPath.getFileSystem()
                .getPathMatcher("glob:" + filenamePattern);
    }

    public void purge() {
        statusHandler.info("Purging files older than "
                + TimeUtil.prettyDuration(purgeAge) + " from " + rootPath);
        final FileTime purgeTime = FileTime
                .fromMillis(System.currentTimeMillis() - purgeAge);
        ...
        FileVisitor<Path> visitor = new SimpleFileVisitor<Path>() {
            ...
            public FileVisitResult visitFile(Path file,
                ...
                boolean oldEnough = attrs.lastModifiedTime()
                        .compareTo(purgeTime) < 0;
