 ...
 */
@DynamicSerialize
public class OUPRequest extends AbstractPrivilegedRequest
        implements IServerRequest {
    /** Edex origination constant */
    public static final String EDEX_ORIGINATION = "edex_origination";
     ...
     */
    @DynamicSerializeElement
    private String roleId = PermissionUtils.buildPermissionString("oup",
            "send");
