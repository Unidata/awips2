...
/**
 * 
 * Defines an abstract utility command
 * 
 * All commands have the concept of "context", the domain over which the command
 * is applicable.
 * 
 * <pre>
 * SOFTWARE HISTORY
...
public abstract class AbstractUtilityCommand extends AbstractCommand {
    ...
    public AbstractUtilityCommand() {
        super();
    }

    public AbstractUtilityCommand(LocalizationContext context) {
        super(context);
    }
}
