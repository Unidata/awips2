...
/**
 * Abstract localization streaming request
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 */
@DynamicSerialize
public abstract class AbstractLocalizationStreamRequest extends
    ...
    public void setFileName(String fileName) {
        fileName = fileName.replace("\\", IPathManager.SEPARATOR);
        if (fileName.startsWith(IPathManager.SEPARATOR)) {
