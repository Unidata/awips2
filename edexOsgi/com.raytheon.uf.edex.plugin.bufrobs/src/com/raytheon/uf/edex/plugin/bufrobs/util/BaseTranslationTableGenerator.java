 ...
 * Jul 11, 2016  5744     mapeters  Default destination dir changed from
...
public class BaseTranslationTableGenerator {
    ...
    public static final Set<String> OPTIONS = new HashSet<>(Arrays.asList(
            PREFIX_OPT, TABLES_OPT, DEST_DIR_OPT));

    public static final String DEFAULT_DEST_DIR = "utility/common_static/base/bufrobs/tables";
     ...
     * 
     * <pre>
     * -p synoptic_land -d utility/common_static/base/bufrobs/tables -t "0 10 063,0 20 011,0 20 012,0 20 003" BUFRCREX_21_0_0_CodeFlag_en.xml
     * </pre>
     * 
     * @param args
    ...
    public static void main(String[] args) throws XMLStreamException,
        ...
        try {
            TranslationTableGenerator.generate(prefix, new File(dest),
                    includedTables, true, bufrTables);
        } finally {
            bufrTables.close();
        }
    }
