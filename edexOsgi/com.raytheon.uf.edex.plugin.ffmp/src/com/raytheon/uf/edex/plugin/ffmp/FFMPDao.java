...
public class FFMPDao extends PluginDao {
    ...
    protected RuleResult purgeExpiredKey(PurgeRuleSet ruleSet,
        ...
        /*
         * We assume the String array only contains 1 sourceName, so we only
         * take sourceName[0] from string array.
         */
        ...
        if (source != null) {
            ...
            statusHandler.warn("Encountered a non-recognized source key: "
                    + sourceName[0] + " can not be purged!");
