...
public class FFMPInterpolatedGuidanceDelay {
    ...
    public FFMPInterpolatedGuidanceDelay(String siteKey, long guidFrequency,
        ...
        /*
         * FIXME We should be setting this.generator = generator; here.
         * Otherwise the method call below, calculateDelayedGuidance(), will
         * immediately NullPointerException when it tries to call
         * generator.getFFMPDataContainer(...). That method must have never been
         * invoked. See related fixme comment in FFMPProcessor.java where this
         * is called.
         */
    }
        ...
        if (qpeContainer != null) {
            ...
            for (Entry<Long, FFMPBasin> entry : currentRecord.getBasinData()
                ...
                if (oldBasin != null && currBasin != null) {
                    float fraction = 0.0f;
                    float delta = currBasin.getValue() - oldBasin
