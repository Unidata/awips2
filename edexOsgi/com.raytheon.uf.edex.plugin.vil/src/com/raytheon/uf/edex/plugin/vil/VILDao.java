...
public class VILDao extends PluginDao {
    ...
    protected boolean populateDataStore(final IDataStore dataStore,
        ...
        IMetadataIdentifier metaId = new DataUriMetadataIdentifier(VILRec);
    ...
    @Override
    public List<IDataRecord[]> getHDF5Data(final List<PluginDataObject> objects,
            final int tileSet) throws PluginException {
