...
@org.hibernate.annotations.Table(
		appliesTo = "ldad_manual",
		indexes = {
				@Index(name = "ldad_manual_refTimeIndex", columnNames = { "refTime", "forecastTime" } )
		}
)
@XmlRootElement
...
public class ManualLdadRecord extends PluginDataObject implements ISpatialEnabled,
IDecoderGettable {
    ...
    @XmlElement
    @DynamicSerializeElement
    private SurfaceObsLocation location; //latitude, longitude, elevation, stationId
 ...
 // Home WFO Id for the LDAD data
    ...
    private Short code82; // short 
						...
						//    12  Compact or wet snow (with or without ice) covering less than one half of the ground but not completely covered"
						//    13  Even layer of comapct or wet snow covering ground completely"
						//    14  Uneven layer of comapct or wet snow covering ground completely"
						...
						//    17  Even layers of loose dry snow covering ground completely"
						//    18  Uneven layers of loose dry snow covering ground completely"
    ...
    private Short code84; // short 
						...
						//    19  "Funnel cloud at or within sight of station during previous hour or at ob time"
						...
						//    61  "Rain, not freezing, continuous, slight at ob time"
						//    63  "Rain, not freezing, continuous, moderate at ob time"
						//    65  "Rain, not freezing, continuous, heavy at ob time"
						...
						//    89  "Showers of hail, with or without rain or rain and snow mixed at ob time"
    ...
    private Short code85; // short 
						...
						//    1  "Cloud covering more than one half the sky throughout the appropriate period and covering one half or less during part of the period"
						//    2  "Cloud covering more than one half the sky throughout the appropriate period"
	...
	/**
	 * @param code12 the code12 to set
	 */
	...
	/**
	 * @param code13 the code13 to set
	 */
	...
	/**
	 * @param code14 the code14 to set
	 */
	...
	/**
	 * @param code15 the code15 to set
	 */
	...
	/**
	 * @param code16 the code16 to set
	 */
	...
	/**
	 * @param code17 the code17 to set
	 */
	...
	/**
	 * @param code18 the code18 to set
	 */
	...
	/**
	 * @param code19 the code19 to set
	 */
	...
	/**
	 * @param code20 the code20 to set
	 */
	...
	/**
	 * @param code21 the code21 to set
	 */
	...
	/**
	 * @param code22 the code22 to set
	 */
	...
	/**
	 * @param code23 the code23 to set
	 */
	...
	/**
	 * @param code24 the code24 to set
	 */
	...
	/**
	 * @param code25 the code25 to set
	 */
	...
	/**
	 * @param code26 the code26 to set
	 */
	...
	/**
	 * @param code27 the code27 to set
	 */
	...
	/**
	 * @param code28 the code28 to set
	 */
	...
	/**
	 * @param code29 the code29 to set
	 */
	...
	/**
	 * @param code30 the code30 to set
	 */
	...
	/**
	 * @param code31 the code31 to set
	 */
	...
	/**
	 * @param code32 the code32 to set
	 */
	...
	/**
	 * @param code33 the code33 to set
	 */
	...
	/**
	 * @param code34 the code34 to set
	 */
	...
	/**
	 * @param code35 the code35 to set
	 */
	...
	/**
	 * @param code36 the code36 to set
	 */
	...
	/**
	 * @param code37 the code37 to set
	 */
	...
	/**
	 * @param code38 the code38 to set
	 */
	...
	/**
	 * @param code39 the code39 to set
	 */
	...
	/**
	 * @param code40 the code40 to set
	 */
	...
	/**
	 * @param code41 the code41 to set
	 */
	...
	/**
	 * @param code43 the code43 to set
	 */
	...
	/**
	 * @param code44 the code44 to set
	 */
	...
	/**
	 * @param code45 the code45 to set
	 */
	...
	/**
	 * @param code46 the code46 to set
	 */
	...
	/**
	 * @param code47 the code47 to set
	 */
	...
	/**
	 * @param code48 the code48 to set
	 */
	...
	/**
	 * @param code49 the code49 to set
	 */
	...
	/**
	 * @param code50 the code50 to set
	 */
	...
	/**
	 * @param code52 the code52 to set
	 */
	...
	/**
	 * @param code53 the code53 to set
	 */
	...
	/**
	 * @param code54 the code54 to set
	 */
	...
	/**
	 * @param code55 the code55 to set
	 */
	...
	/**
	 * @param code56 the code56 to set
	 */
	...
	/**
	 * @param code57 the code57 to set
	 */
	...
	/**
	 * @param code58 the code58 to set
	 */
	...
	/**
	 * @param code59 the code59 to set
	 */
	...
	/**
	 * @param code60 the code60 to set
	 */
	...
	/**
	 * @param code61 the code61 to set
	 */
	...
	/**
	 * @param code62 the code62 to set
	 */
	...
	/**
	 * @param code63 the code63 to set
	 */
	...
	/**
	 * @param code64 the code64 to set
	 */
	...
	/**
	 * @param code65 the code65 to set
	 */
	...
	/**
	 * @param code66 the code66 to set
	 */
	...
	/**
	 * @param code67 the code67 to set
	 */
	...
	/**
	 * @param code68 the code68 to set
	 */
	...
	/**
	 * @param code69 the code69 to set
	 */
	...
	/**
	 * @param code70 the code70 to set
	 */
	...
	/**
	 * @param code71 the code71 to set
	 */
	...
	/**
	 * @param code72 the code72 to set
	 */
	...
	/**
	 * @param code73 the code73 to set
	 */
	...
	/**
	 * @param code74 the code74 to set
	 */
	...
	/**
	 * @param code75 the code75 to set
	 */
	...
	/**
	 * @param code76 the code76 to set
	 */
	...
	/**
	 * @param code77 the code77 to set
	 */
	...
	/**
	 * @param code78 the code78 to set
	 */
	...
	/**
	 * @param code79 the code79 to set
	 */
	...
	/**
	 * @param code80 the code80 to set
	 */
	...
	/**
	 * @param code81 the code81 to set
	 */
	...
	/**
	 * @param code82 the code82 to set
	 */
	...
	/**
	 * @param code83 the code83 to set
	 */
	...
	/**
	 * @param code84 the code84 to set
	 */
	...
	/**
	 * @param code85 the code85 to set
	 */
	...
	/**
	 * @param code86 the code86 to set
	 */
	...
	/**
	 * @param code87 the code87 to set
	 */
	...
	/**
	 * @param code88 the code88 to set
	 */
	...
	/**
	 * @param code89 the code89 to set
	 */
	...
	/**
	 * @param code90 the code90 to set
	 */
	...
	/**
	 * @param code91 the code91 to set
	 */
	...
	/**
	 * @param code92 the code92 to set
	 */
	...
	/**
	 * @param code93 the code93 to set
	 */
	...
	/**
	 * @param code94 the code94 to set
	 */
	...
	/**
	 * @param code95 the code95 to set
	 */
	...
	/**
	 * @param code96 the code96 to set
	 */
...
//    }
	...
	/**
	 * @param homeWFO the homeWFO to set
	 */
	...
	/**
	 * @param unitsCode the unitsCode to set
	 */
	...
	/**
	 * @param code10 the code10 to set
	 */
	...
	/**
	 * @param code11 the code11 to set
	 */
