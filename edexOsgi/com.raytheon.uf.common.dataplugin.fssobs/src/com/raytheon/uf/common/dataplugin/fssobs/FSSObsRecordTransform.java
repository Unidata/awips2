 ...
 * ------------- -------- --------- -----------------------------
 * Mar 08, 2011           skorolev  Initial creation
...
public class FSSObsRecordTransform {
    ...
    public static final String FSSOBS_PARAMS_LIST = String.join(",",
            FSSOBS_PARAMS);
    ...
    public static FSSObsRecord[] toFSSObsRecords(PointDataContainer container) {
        List<FSSObsRecord> records = new ArrayList<>();
        if (container != null) {
    ...
    private static FSSObsRecord toFSSObsRecord(PointDataView pdv) {
        ...
        if (pdv != null) {
            ...
            obs.setPrimarySwellWaveDir(
                    pdv.getNumber(PRI_SWELL_WV_DIR).doubleValue());
            obs.setPrimarySwellWaveHeight(
                    pdv.getNumber(PRI_SWELL_WV_HGT).doubleValue());
            obs.setPrimarySwellWavePeriod(
                    pdv.getNumber(PRI_SWELL_WV_PD).intValue());
            ...
            obs.setSecondarySwellWaveDir(
                    pdv.getNumber(SEC_SWELL_WV_DIR).doubleValue());
            obs.setSecondarySwellWaveHeight(
                    pdv.getNumber(SEC_SWELL_WV_HGT).doubleValue());
            obs.setSecondarySwellWavePeriod(
                    pdv.getNumber(SEC_SWELL_WV_PD).intValue());
