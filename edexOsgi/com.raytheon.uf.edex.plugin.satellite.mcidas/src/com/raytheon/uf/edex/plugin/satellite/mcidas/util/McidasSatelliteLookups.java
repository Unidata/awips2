...
public class McidasSatelliteLookups {
    ...
    private static final String LOOKUP_DIR = "satellite/mcidas";
    ...
    public static class PhysicalElementKey {
        ...
        @XmlAttribute(name="ss") public int sensorSource;
        @XmlAttribute(name="band") public int bandIndex; // 1-based
    ...
    public static class PhysicalElements extends AbstractLookup<PhysicalElementKey, PhysicalElementValue> {
        public HashMap<PhysicalElementKey, PhysicalElementValue> map = 
            new HashMap<McidasSatelliteLookups.PhysicalElementKey, PhysicalElementValue>();
    ...
    @XmlRootElement
    @XmlAccessorType(XmlAccessType.FIELD)
    public static class CreatingEntities extends AbstractLookup<Integer, String> {
    ...
    public PhysicalElementValue getPhysicalElement(int sensorSource, int bandIndex) {
        return physicalElementLookup.map.get(
                new PhysicalElementKey(sensorSource, bandIndex));
    }
