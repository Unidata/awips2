...
public class BuildHourly {
    ...
    private List<PrecipTotal> listPrecipAgg = new ArrayList<>();
    ...
    public void runBuildHourly() throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < getLbWindow(); i++) {
                ...
                for (PrecipTotal precipAgg : listPrecipAgg) {
     ...
     * @return
     */
    private void createBuildHourlyWorkFile(PrecipTotal precipAgg, Date endTime,
            Path loadDir) {
        if (loadDir == null) {
            return;
        }
