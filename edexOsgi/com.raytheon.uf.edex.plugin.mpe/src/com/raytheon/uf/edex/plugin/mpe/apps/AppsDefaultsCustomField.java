 ...
 * {@link String} that will be converted to another completely separate data
 * type using the specified {@link ICustomValueConverter}.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public @interface AppsDefaultsCustomField {
     ...
     * (provided that the token is not required). Must be possible to convert
     * the specified default value to the custom data type using the
    ...
    /**
     * The {@link ICustomValueConverter} that should be used to convert the
     * {@link String} read from Apps Defaults to the desired data type.
     * 
     * @return the {@link ICustomValueConverter}
     */
    Class<? extends ICustomValueConverter<?>> converter();
}