...
/**
 * IHFS Database Dao for interacting with the {@link Rwresult} entity.
 * 
 * <pre>
 *
 * SOFTWARE HISTORY
...
public class RwresultDao extends AbstractIHFSDbDao<Rwresult, RwresultId> {

    public RwresultDao() {
        super(Rwresult.class);
    }
}