...
public class DatalimitsDao extends AbstractIHFSDbDao<Datalimits, DatalimitsId> {
    ...
    /**
     * Retrieves {@link Datalimits} records with pe = "TA".
     * 
     * @return a {@link List} of the {@link Datalimits} records
     */
    public List<Datalimits> getPeFromDatalimitRecords() {
        return findByNamedQuery(Datalimits.SELECT_PE_DATALIMITS_RECORDS);
    }

    /**
     * Retrieves the {@link Datalimits} records with pe = 'PP' and dur in (1006,
     * 2001, 5004).
     * 
     * @return a {@link List} of the {@link Datalimits} records
     */
    public List<Datalimits> getPeAndDurFromDatalimitsRecords() {
        return findByNamedQuery(Datalimits.SELECT_PE_AND_DUR_DATALIMITS_RECORDS);
    }
