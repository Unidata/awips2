...
/**
 * Common interface supporting the retrieval of gridded radar data.
 * 
 * <pre>
 *
 * SOFTWARE HISTORY
...
public interface IGriddedRadarRetrievalDao<T extends IGriddedRadarRecord> {

    public List<T> selectByRadIdBetweenObsTime(final String radarId,
