 ...
 * property value to a {@link HPERadarMosaic}.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public class RadarMosaicConverter implements
        ICustomValueConverter<HPERadarMosaic> {

    @Override
    public HPERadarMosaic convertValue(String value)
            throws ValueConverterException {
        return HPERadarMosaic.lookupRadarMosaic(value);
    }
}