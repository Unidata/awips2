...
/**
 * IHFS Database Dao for interacting with the {@link Dspadapt} entity.
 *
 * <pre>
 *
 * SOFTWARE HISTORY
...
public class DspadaptDao extends AbstractIHFSDbDao<Dspadapt, DspradarId> {
    public DspadaptDao() {
        super(Dspadapt.class);
    }
}