...
public @interface AppsDefaultsStringField {
    ...
    /**
     * Boolean flag indicating whether or not a null value should be used in
     * place of the default value when the token cannot be found in Apps
     * Defaults (provided that the token is not required).
     * 
     * @return {@code true}, if null should be used in place of the default
