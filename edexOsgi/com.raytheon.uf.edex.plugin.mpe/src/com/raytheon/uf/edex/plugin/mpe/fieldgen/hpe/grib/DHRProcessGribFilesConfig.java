...
/**
 * xmrg to grib configuration for mosaics associated with the "DHR" process
...
public class DHRProcessGribFilesConfig implements IProcessGribFilesConfig {

    public static final String PROCESS_ID_MATCH = "DHR";
    ...
    @AppsDefaultsPathField(property = HPEFieldgenGribConstants.AppsDefaults.HPE_DHRMOSAIC_GRIB_DIR)
    private Path gribOutputPath;

    public DHRProcessGribFilesConfig() {
    }
