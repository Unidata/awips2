...
/**
 * xmrg to grib configuration for mosaics associated with the "BDSP" process
...
public class BDSPProcessGribFilesConfig implements IProcessGribFilesConfig {

    public static final String PROCESS_ID_MATCH = "BDSP";

    public static final String XMRG_MATCH = HPEProcessGribFilesConfigLookupKey.MATCH_ANY;

    @AppsDefaultsPathField(property = AppsDefaultsDirKeys.HPE_EBMOSAIC_DIR)
    private Path xmrgInputPath;

    @AppsDefaultsPathField(property = HPEFieldgenGribConstants.AppsDefaults.HPE_EBMOSAIC_GRIB_DIR)
    private Path gribOutputPath;

    public BDSPProcessGribFilesConfig() {
    }
