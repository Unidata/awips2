...
public class GetTotalPP extends GetTotalPrecip {
    ...
    private List<EdexPrecipTotal> reportList = null;
     ...
     * @return
     */
    public List<EdexPrecipTotal> getTotalPPRaw(List<IRawTS> rawPCList,
        ...
        while (iter.hasNext()) {
            ...
            EdexPrecipTotal bestPrecipTotal = new EdexPrecipTotal();
            // Set lid
