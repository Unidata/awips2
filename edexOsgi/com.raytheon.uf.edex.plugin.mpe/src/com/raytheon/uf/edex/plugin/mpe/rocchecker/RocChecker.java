 ...
 * Sep 12, 2016 5631       bkowal      Use the {@link CommonMPEUtils} method for comparing
 *                                     data limit dates.
 * Nov 10, 2016 5999       bkowal      Retrieve partial data limits records using: getObsLimits.                                     
 * Apr 06, 2018 7184       bkowal      {@link MpeConstants} moved to common.
 * 
 * </pre>
 * 
 * @author bkowal
...
public class RocChecker {
    ...
    private static final String CONFIG_FILE = "mpeProc" + IPathManager.SEPARATOR
            + "RocChecker.xml";
    ...
    private ObsLimits lookupDataLimits(
        ...
        if (locDataLimitList != null) {
            ...
            for (Locdatalimits locdatalimits : locDataLimitList) {
                if (CommonMPEUtils.withinDataLimitTimeRange(
