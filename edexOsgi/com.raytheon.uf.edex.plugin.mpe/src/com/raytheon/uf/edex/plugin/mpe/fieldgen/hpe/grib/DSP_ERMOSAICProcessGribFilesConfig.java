 ...
 * produced for the ERMOSAIC mosaic.
 * 
 * <pre>
 *
 * SOFTWARE HISTORY
...
public class DSP_ERMOSAICProcessGribFilesConfig
        extends AbstractDSPProcessGribFilesConfig {

    public static final String XMRG_MATCH = "ERMOSAIC";

    @AppsDefaultsPathField(property = AppsDefaultsDirKeys.HPE_ERMOSAIC_DIR)
    private Path xmrgInputPath;

    public DSP_ERMOSAICProcessGribFilesConfig() {
    }
