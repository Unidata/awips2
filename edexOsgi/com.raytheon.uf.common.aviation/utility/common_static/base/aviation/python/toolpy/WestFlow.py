...
class Gui():
    def __init__(self, bbb, fcsts):
        ...
        body = tkinter.Frame(self.master)
        label = tkinter.Label(body, text='If forecasts for KPKB and KHTS are ready\nenter delay between KPKB and KCKB')
        label.pack(side=tkinter.TOP, pady=5)
        self.counter = tkinter.Spinbox(body, from_=1, to=3, increment=1, width=1, state='readonly')
        self.counter.pack(side=tkinter.TOP)
        ...
        bbox.pack(side=tkinter.BOTTOM, pady=5)
