 ...
 * <br>
 * <br>
 * This class is a bridge form using a single xml configuration file for all
 * sites to using the AWIPS I style configuration files. This makes porting from
 * AWIPS I easier for sites.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
