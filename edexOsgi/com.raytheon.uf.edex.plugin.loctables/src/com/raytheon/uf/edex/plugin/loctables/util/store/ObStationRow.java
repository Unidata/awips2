...
public class ObStationRow {
    ...
    /**
     * Determine if a given ObStation instance needs to be updated from a
     * second ObStation instance. 
     * @param a Target ObStation instance to be updated.
     * @param b ObStation instance that may contain changes.
