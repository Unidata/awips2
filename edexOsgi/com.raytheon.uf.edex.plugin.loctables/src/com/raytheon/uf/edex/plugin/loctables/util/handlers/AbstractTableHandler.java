 ...
 * Jan 16, 2018 6976       njensen     Skip and log bad lines
 * 
 * </pre>
 * 
 * @author jkorman
...
public abstract class AbstractTableHandler implements TableHandler {
     ...
     * @param storeStrategy
     */
    protected AbstractTableHandler(String name) {
        handlerName = name;
    }
     ...
     * @return
     */
    protected abstract ObStationRow parseLine(String data);
