...
/**
 * 
 * Filter for checking if a product has a VTEC string
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * Jan 31, 2017  5934      njensen     Moved to activetable plugin
 * 
 * </pre>
 * 
 * @author ekladstrup
...
public class WarningHasVTECFilter {
    ...
    public boolean hasVTEC(PluginDataObject[] pdo) {
        ...
        /*
         * return a default value of true when no warning records are found so
         * that the default full route is followed when ingesting warnings
         */
        return true;
    }
}
