...
public class DumpActiveTableHandler implements
    ...
    protected List<ActiveTableRecord> getActiveTableForSites(String[] sites,
            String fromSite, String mode) throws ExecutionException {
    ...
    protected List<Map<String, Object>> fileStringToActiveTable(
        ...
        try (PythonScript python = new PythonScript(
                ...
                scriptPath)) {
            /*
             * The file has a pickled active table, possibly gzipped. unpickle
             * it and convert it to Java.
             */
            python.instantiatePythonClass("converter", "BackupConverter", null);
            return (List<Map<String, Object>>) python.execute(
