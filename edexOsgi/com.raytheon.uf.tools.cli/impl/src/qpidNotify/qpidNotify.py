...
#    01/27/2017      DR 19698      D. Friedman    Use BROKER_HOST environment variable.
#    08/30/2017      6381          randerso       Return None from getMessageHeader if
...
def run():
    ...
    try:
        ...
        log.exception("Error running qpidNotify")
        sys.exit(1)
    else:
        sys.exit(exit_code)
