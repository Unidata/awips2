...
public class SatelliteMenuUtil extends AbstractMenuUtil {
    ...
    public void createMenus() {
        ...
        LocalizationContext commonBaseCtx = pm.getContext(
                LocalizationType.COMMON_STATIC, LocalizationLevel.BASE);
        String menuTemplateDir = "menuTemplate" + IPathManager.SEPARATOR
                + "satellite" + IPathManager.SEPARATOR;

        MenuTemplateFile file = (MenuTemplateFile) fromXml(menuTemplateDir
        ...
        if ("Alaska".equals(state) || "Hawaii".equals(state)
            ...
            toXml(fileOCONUS, "menus" + IPathManager.SEPARATOR + "satellite"
                    + IPathManager.SEPARATOR + "baseDerivedProductsImagery.xml");
        } else {
