...
# ---------------------------------------------------------------------
#
# <product>_<site>_<MultiPil>_Baseline
#
#  This file should not be edited by the site.
#  This file can act as a backup for trouble-shooting.
#  It incorporates only the <product>_<site>_<MultiPil>_Definition to 
#  set up Product Definition Settings.
#
#
# ---------------------------------------------------------------------
...
class TextProduct(
    ...
    Definition["displayName"] = "Baseline_" + displayName + "_<MultiPil>"
