...
/**
 * Class for errors that occurred during a privileged request execution. Wraps
 * any updated authentication data from the server along with the stack trace
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 */
@DynamicSerialize
public class AuthServerErrorResponse extends ServerErrorResponse {
