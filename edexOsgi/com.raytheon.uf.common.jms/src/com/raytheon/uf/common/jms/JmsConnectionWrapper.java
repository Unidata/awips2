...
public class JmsConnectionWrapper implements Connection {
    ...
    public JmsConnectionWrapper(JmsPooledConnectionFactory connFactory) {
    ...
    public void close() throws JMSException {
        // return to pool
        // need to close associated sessions
    }
    ...
    public Session createSession(boolean transacted, int acknowledgeMode)
            throws JMSException {
        return connFactory.createSession(clientId, transacted, acknowledgeMode);
    }
