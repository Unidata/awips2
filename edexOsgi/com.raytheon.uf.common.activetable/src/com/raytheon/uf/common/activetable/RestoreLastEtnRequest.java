...
/**
 * Request for restoring the last ETN used for the phen/sig.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 */
@DynamicSerialize
public class RestoreLastEtnRequest implements IServerRequest {
    ...
    public RestoreLastEtnRequest() {
        // no-op, for dynamic serialize support
    }

    /**
     * Constructs a UpdateNextEtnRequest.
     * 
     * @param siteID
     ...
     *            UpdateNextEtnRequest.
     */
    public RestoreLastEtnRequest(String siteID, ActiveTableMode mode,
            String phensig, Date currentTime, boolean lockEtn) {
        this(siteID, mode, phensig, currentTime, false, false, null);
    }
     ...
     *            UpdateNextEtnUtil#getLastEtnFromPartners(String, ActiveTableMode,
