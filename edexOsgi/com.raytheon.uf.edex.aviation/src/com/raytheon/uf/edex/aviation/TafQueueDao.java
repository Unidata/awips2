 ...
 * Mar 29, 2017 6065       tgurney     Exclude XML TAFs from VFT product
 *
 * </pre>
 *
 * @author rferrel
...
public class TafQueueDao extends CoreDao {
    ...
    public List<TafQueueRecord> getRecordsByState(
        ...
        List<TafQueueRecord> records = (List<TafQueueRecord>) queryByCriteria(
                query);
        return records;
    }
    ...
    public List<TafQueueRecord> getRecordsByXmittime(Date xmittime,
        ...
        query.addQueryParam("xmitTime",
                new Date[] { startCalendar.getTime(), endCalendar.getTime() },
    ...
    public String getLogMessages(List<Date> dateList)
        ...
        query.addOrder("xmitTime", true);
        List<TafQueueRecord> obs = (List<TafQueueRecord>) queryByCriteria(
                query);
    ...
    public List<TafQueueRecord> getRecordsForVFT(Date lastVftTime,
        ...
        query.addQueryParam("xml", false, QueryOperand.EQUALS);
        query.addOrder("xmitTime", true);
        List<TafQueueRecord> records = (List<TafQueueRecord>) queryByCriteria(
                query);
        return records;
