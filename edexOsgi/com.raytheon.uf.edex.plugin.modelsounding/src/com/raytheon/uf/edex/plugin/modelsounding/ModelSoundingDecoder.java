 ...
 * Mar 03, 2016  5434     bkowal      Eliminated deprecation warnings.
 * Sep 23, 2021  8608     mapeters    Handle PDO.traceId changes
 * </pre>
 *
 * @author jkorman
 */
public class ModelSoundingDecoder implements IDescriptorFactorySelector {
        ...
        if ((data != null) && (data.length > 0)) {
            ...
            if (wmoHeader.isValid()) {
                try {
                    ...
                    Map<String, ModelSoundingStorageContainer> containerMap = new HashMap<>();
                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (container == null) {
                            ...
                            if (container == null) {
                                if (logger.isPriorityEnabled(Priority.DEBUG)) {
                                    logger.debug(
                                            "Creating new Point Data Container: "
                                                    + pdcKey);
                                }
