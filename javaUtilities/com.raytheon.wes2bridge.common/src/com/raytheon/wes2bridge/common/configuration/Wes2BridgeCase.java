 ...
 * Oct 4,  2018 DR20592    smoorthy    Added functionality for separate registry port
...
public class Wes2BridgeCase {
    ...
    /**
     * @param httpRegistryPort
     *            the httpRegistryPort to set
     */
    ...
    /**
     * @return the webRegistryPort
     */
    public int getWebRegistryPort(){
        return webRegistryPort;
    }
    
    /**
     * @param webRegistryPort
     *            the webRegistryPort to set
     */
    public void setWebRegistryPort(int webRegistryPort){
        this.webRegistryPort = webRegistryPort;
    }
