...
public class LatestObsValueRecord extends DbRecord
{
    private String lid;
    ...
    // Copy constructor
    //-----------------------------------------------------------------
    public LatestObsValueRecord(LatestObsValueRecord origRecord)
    {
    ...
    //-----------------------------------------------------------------
    //  get and set methods for all data items in a LatestObsValue record
...
} // end of LatestObsValueRecord class
