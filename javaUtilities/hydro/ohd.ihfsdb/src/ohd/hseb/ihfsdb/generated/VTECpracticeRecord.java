...
public class VTECpracticeRecord extends DbRecord
{
    ...
    // Copy constructor
    //-----------------------------------------------------------------
    public VTECpracticeRecord(VTECpracticeRecord origRecord)
    {
    ...
    //-----------------------------------------------------------------
    //  get and set methods for all data items in a VTECpractice record
...
} // end of VTECpracticeRecord class
