...
public class dhradaptRecord extends DbRecord
{
    ...
    // Copy constructor
    //-----------------------------------------------------------------
    public dhradaptRecord(dhradaptRecord origRecord)
    {
    ...
    //-----------------------------------------------------------------
    //  get and set methods for all data items in a dhradapt record
