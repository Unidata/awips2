...
public class PairedValueTable extends DbTable
{
//-----------------------------------------------------------------
//  Private data
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
//  PairedValueTable() - constructor to set statement variable and initialize
//		number of records found to zero
//-----------------------------------------------------------------
    public PairedValueTable(Database database) 
    {
        //Constructor calls DbTable's constructor
        super(database);
        setTableName("pairedvalue");
    }


    //-----------------------------------------------------------------
    //  select() - this method is called with a where clause and returns
    //		a List of PairedValueRecord objects
    //-----------------------------------------------------------------
    public List select(String where) throws SQLException
    {
        PairedValueRecord record = null;

        // create a List to hold PairedValue Records
        ...
        String selectStatement = "SELECT * FROM pairedvalue " + where;
        ...
        while (rs.next())
        {
            // create an instance of a PairedValueRecord
            // and store its address in oneRecord
            record = new PairedValueRecord();

            // increment the number of records found
            _recordsFound++;

            // assign the data returned to the result set for one
            // record in the database to a PairedValueRecord object
            ...
            record.setRef_value(getInt(rs, 9));
            ...
            // add this PairedValueRecord object to the list
            recordList.add(record);
        }
        // Close the result set
        rs.close();

        // return a List which holds the PairedValueRecord objects
        return recordList;
    ...
    //		a List filled with a maximum of maxRecordCount of PairedValueRecord objects 
    //-----------------------------------------------------------------
...
//-----------------------------------------------------------------
//  insert() - this method is called with a PairedValueRecord object and..
//-----------------------------------------------------------------
    public int insert(PairedValueRecord record)  throws SQLException
    {
        int returnCode=-999;
...
" INSERT INTO pairedvalue VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?        )");
        ...
        setInt(insertStatement, 9, record.getRef_value());
...
//-----------------------------------------------------------------
    public int delete(String where) throws SQLException
    {
        ...
        String deleteStatement = "DELETE FROM pairedvalue " + where;
...
//-----------------------------------------------------------------
//  update() - this method is called with a PairedValueRecord object and a where clause..
//-----------------------------------------------------------------
    public int update(PairedValueRecord record, String where)  throws SQLException
    {
        int returnCode=-999;
        // Create a SQL update statement and issue it
        // construct the update statement
        PreparedStatement updateStatement = getConnection().prepareStatement(
" UPDATE pairedvalue SET lid = ?, pe = ?, dur = ?, ts = ?, extremum = ?, probability = ?, validtime = ?, basistime = ?, ref_value = ?, value = ?, shef_qual_code = ?, quality_code = ?, revision = ?, product_id = ?, producttime = ?, postingtime = ?        " + where );
        ...
        setInt(updateStatement, 9, record.getRef_value());
...
//                   the number of records deleted
//-----------------------------------------------------------------
    public int delete(PairedValueRecord record) throws SQLException
    {
        int returnCode=-999;

        // Create a SQL delete statement and issue it
        // construct the delete statement
        String deleteStatement = "DELETE FROM pairedvalue " + record.getWhereString();
...
//  update() - this method is called with a PairedValueRecord object and a where clause..
//-----------------------------------------------------------------
    public int update(PairedValueRecord oldRecord, PairedValueRecord newRecord)  throws SQLException
    {
        int returnCode=-999;
        // Create a SQL update statement and issue it
        // construct the update statement
        PreparedStatement updateStatement = getConnection().prepareStatement(
" UPDATE pairedvalue SET lid = ?, pe = ?, dur = ?, ts = ?, extremum = ?, probability = ?, validtime = ?, basistime = ?, ref_value = ?, value = ?, shef_qual_code = ?, quality_code = ?, revision = ?, product_id = ?, producttime = ?, postingtime = ?        " + oldRecord.getWhereString() );
        ...
        setInt(updateStatement, 9, newRecord.getRef_value());
...
//-----------------------------------------------------------------
//  insertOrUpdate() - this method is call with a PairedValueRecord object.
//                   the number of records inserted or updated
//-----------------------------------------------------------------
    public int insertOrUpdate(PairedValueRecord record) throws SQLException
    {
        int returnCode=-999;
        ...
        {
            PairedValueRecord oldRecord = (PairedValueRecord) recordList.get(0);
            returnCode = update(oldRecord, record);
        }
        return returnCode;
    } // end of insertOrUpdate() 
} // end of PairedValueTable class
