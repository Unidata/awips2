...
public class DataLimitsRecord extends DbRecord
{
    private String pe;
    ...
    // Copy constructor
    //-----------------------------------------------------------------
    public DataLimitsRecord(DataLimitsRecord origRecord)
    {
    ...
    //-----------------------------------------------------------------
    //  get and set methods for all data items in a DataLimits record
