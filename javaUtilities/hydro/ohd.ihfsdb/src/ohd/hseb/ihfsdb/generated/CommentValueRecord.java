...
public class CommentValueRecord extends DbRecord
{
    private String lid;
    ...
    private String shef_comment;

    //---------------------------------------------------------------
    // Empty constructor
    //---------------------------------------------------------------
    public CommentValueRecord()
    {
    }
    ...
    // Copy constructor
    //-----------------------------------------------------------------
    public CommentValueRecord(CommentValueRecord origRecord)
    {
        ...
        setShef_comment(origRecord.getShef_comment());
    }

    //-----------------------------------------------------------------
    //  get and set methods for all data items in a CommentValue record
    ...
    public String getShef_comment()
    {
        return shef_comment;
    }

    public void setShef_comment(String shef_comment)
    {
        this.shef_comment = shef_comment ;
    }
...
} // end of CommentValueRecord class
