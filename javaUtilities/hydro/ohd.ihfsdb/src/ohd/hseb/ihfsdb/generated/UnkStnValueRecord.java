...
public class UnkStnValueRecord extends DbRecord
{
    private String lid;
    ...
    // Copy constructor
    //-----------------------------------------------------------------
    public UnkStnValueRecord(UnkStnValueRecord origRecord)
    {
    ...
    //-----------------------------------------------------------------
    //  get and set methods for all data items in a UnkStnValue record
...
} // end of UnkStnValueRecord class
