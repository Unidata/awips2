...
public class FcstTemperatureRecord extends DbRecord
{
    private String lid;
    ...
    // Copy constructor
    //-----------------------------------------------------------------
    public FcstTemperatureRecord(FcstTemperatureRecord origRecord)
    {
    ...
    //-----------------------------------------------------------------
    //  get and set methods for all data items in a FcstTemperature record
...
} // end of FcstTemperatureRecord class
