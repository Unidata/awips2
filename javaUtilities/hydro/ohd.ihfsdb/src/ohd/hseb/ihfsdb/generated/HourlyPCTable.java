...
public class HourlyPCTable extends DbTable
{
//-----------------------------------------------------------------
//  Private data
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
//  HourlyPCTable() - constructor to set statement variable and initialize
//		number of records found to zero
//-----------------------------------------------------------------
    public HourlyPCTable(Database database) 
    {
        //Constructor calls DbTable's constructor
        super(database);
        setTableName("hourlypc");
    }


    //-----------------------------------------------------------------
    //  select() - this method is called with a where clause and returns
    //		a List of HourlyPCRecord objects
    //-----------------------------------------------------------------
    public List select(String where) throws SQLException
    {
        HourlyPCRecord record = null;

        // create a List to hold HourlyPC Records
        ...
        String selectStatement = "SELECT * FROM hourlypc " + where;
        ...
        while (rs.next())
        {
            // create an instance of a HourlyPCRecord
            // and store its address in oneRecord
            record = new HourlyPCRecord();

            // increment the number of records found
            _recordsFound++;

            // assign the data returned to the result set for one
            // record in the database to a HourlyPCRecord object
            ...
            // add this HourlyPCRecord object to the list
            recordList.add(record);
        }
        // Close the result set
        rs.close();

        // return a List which holds the HourlyPCRecord objects
        return recordList;
    ...
    //		a List filled with a maximum of maxRecordCount of HourlyPCRecord objects 
    //-----------------------------------------------------------------
...
//-----------------------------------------------------------------
//  insert() - this method is called with a HourlyPCRecord object and..
//-----------------------------------------------------------------
    public int insert(HourlyPCRecord record)  throws SQLException
    {
        int returnCode=-999;
...
//-----------------------------------------------------------------
    public int delete(String where) throws SQLException
    {
        ...
        String deleteStatement = "DELETE FROM hourlypc " + where;
...
//-----------------------------------------------------------------
//  update() - this method is called with a HourlyPCRecord object and a where clause..
//-----------------------------------------------------------------
    public int update(HourlyPCRecord record, String where)  throws SQLException
    {
        int returnCode=-999;
        // Create a SQL update statement and issue it
        // construct the update statement
        PreparedStatement updateStatement = getConnection().prepareStatement(
" UPDATE hourlypc SET lid = ?, ts = ?, obsdate = ?, minute_offset = ?, hourly_qc = ?, hour1 = ?, hour2 = ?, hour3 = ?, hour4 = ?, hour5 = ?, hour6 = ?, hour7 = ?, hour8 = ?, hour9 = ?, hour10 = ?, hour11 = ?, hour12 = ?, hour13 = ?, hour14 = ?, hour15 = ?, hour16 = ?, hour17 = ?, hour18 = ?, hour19 = ?, hour20 = ?, hour21 = ?, hour22 = ?, hour23 = ?, hour24 = ?        " + where );
...
//                   the number of records deleted
//-----------------------------------------------------------------
    public int delete(HourlyPCRecord record) throws SQLException
    {
        int returnCode=-999;

        // Create a SQL delete statement and issue it
        // construct the delete statement
        String deleteStatement = "DELETE FROM hourlypc " + record.getWhereString();
...
//  update() - this method is called with a HourlyPCRecord object and a where clause..
//-----------------------------------------------------------------
    public int update(HourlyPCRecord oldRecord, HourlyPCRecord newRecord)  throws SQLException
    {
        int returnCode=-999;
        // Create a SQL update statement and issue it
        // construct the update statement
        PreparedStatement updateStatement = getConnection().prepareStatement(
" UPDATE hourlypc SET lid = ?, ts = ?, obsdate = ?, minute_offset = ?, hourly_qc = ?, hour1 = ?, hour2 = ?, hour3 = ?, hour4 = ?, hour5 = ?, hour6 = ?, hour7 = ?, hour8 = ?, hour9 = ?, hour10 = ?, hour11 = ?, hour12 = ?, hour13 = ?, hour14 = ?, hour15 = ?, hour16 = ?, hour17 = ?, hour18 = ?, hour19 = ?, hour20 = ?, hour21 = ?, hour22 = ?, hour23 = ?, hour24 = ?        " + oldRecord.getWhereString() );
...
//-----------------------------------------------------------------
//  insertOrUpdate() - this method is call with a HourlyPCRecord object.
//                   the number of records inserted or updated
//-----------------------------------------------------------------
    public int insertOrUpdate(HourlyPCRecord record) throws SQLException
    {
        int returnCode=-999;
        ...
        {
            HourlyPCRecord oldRecord = (HourlyPCRecord) recordList.get(0);
            returnCode = update(oldRecord, record);
        }
        return returnCode;
    } // end of insertOrUpdate() 
} // end of HourlyPCTable class
