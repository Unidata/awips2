...
public class FcstDischargeRecord extends DbRecord
{
    private String lid;
    ...
    // Copy constructor
    //-----------------------------------------------------------------
    public FcstDischargeRecord(FcstDischargeRecord origRecord)
    {
    ...
    //-----------------------------------------------------------------
    //  get and set methods for all data items in a FcstDischarge record
...
} // end of FcstDischargeRecord class
