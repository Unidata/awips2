...
public class HourlyPPRecord extends DbRecord
{
    private String lid;
    ...
    // Copy constructor
    //-----------------------------------------------------------------
    public HourlyPPRecord(HourlyPPRecord origRecord)
    {
        ...
        setSixhr06(origRecord.getSixhr06());
        setSixhr12(origRecord.getSixhr12());
        setSixhr18(origRecord.getSixhr18());
        setSixhr24(origRecord.getSixhr24());
        setSixhrqc(origRecord.getSixhrqc());
        setSixhroffset(origRecord.getSixhroffset());
    }

    //-----------------------------------------------------------------
    //  get and set methods for all data items in a HourlyPP record
