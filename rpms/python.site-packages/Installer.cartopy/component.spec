...
#
# AWIPS Python cartopy Spec File
#
Name: awips2-python-cartopy
Summary: AWIPS Python cartopy Distribution
Version: 0.14.2
Release: 1%{?dist}
Group: AWIPSII
...
AutoReq: no
BuildRequires: awips2, awips2-postgresql
requires: awips2-python
requires: awips2-python-numpy
provides: awips2-python-cartopy

%description
AWIPS Python cartopy Site-Package
...
%build
CARTOPY_SRC_DIR="%{_python_pkgs_dir}/cartopy"
