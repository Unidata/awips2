#
# AWIPS II Python numpy Site-Package Spec File
#
Name: awips2-python-numpy
Summary: AWIPS II Python numpy Site-Package
Version: 1.5.0b1
Release: 2
Group: AWIPSII
BuildRoot: /tmp
...
%define _docdir python.numpy

%description
AWIPS II Python numpy Site-Package - Installs the AWIPS II Python
numpy Site-Package in the Python installation.
...
%build
SITE_PACKAGE_SRC_DIR="pythonPackages/numpy"
...
rm -f numpy/distutils/fcompiler/gnu.py
...
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;34m\| Installing the AWIPS II Python numpy Site-Package...\e[m"
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
...
cd ${PYTHON_PACKAGE_DIR}/numpy
find . -name "test*.py" -exec chmod -x {} \;

echo -e "\e[1;32m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;32m\| AWIPS II Python numpy Site-Package Installation - COMPLETE\e[m"
echo -e "\e[1;32m--------------------------------------------------------------------------------\e[m"
...
%postun
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;34m\| The AWIPS II Python numpy Site-Package Has Been Successfully Removed\e[m"
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
echo ""
