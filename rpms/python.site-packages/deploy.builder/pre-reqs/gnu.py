...
class GnuFCompiler(FCompiler):
    ...
    executables = {
        ...
        'compiler_f77' : [None, "-g", "-Wall -m32", "-fno-second-underscore"],
...
class Gnu95FCompiler(GnuFCompiler):
    ...
    executables = {
        ...
        'compiler_f77' : [None, "-Wall -m32", "-ffixed-form",
        "-fno-second-underscore"] + _EXTRAFLAGS,
        'compiler_f90' : [None, "-Wall -m32", "-fno-second-underscore"] + _EXTRAFLAGS,
        'compiler_fix' : [None, "-Wall -m32", "-ffixed-form",
                          "-fno-second-underscore"] + _EXTRAFLAGS,
        'linker_so'    : ["<F90>", "-Wall"],
        'archiver'     : ["ar", "-cr"],
        'ranlib'       : ["ranlib"],
