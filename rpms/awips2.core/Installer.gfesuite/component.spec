...
%install
mkdir -p ${RPM_BUILD_ROOT}/awips2/GFESuite || exit 1
mkdir -p ${RPM_BUILD_ROOT}/etc/profile.d || exit 1
...
mkdir -p ${RPM_BUILD_ROOT}/awips2/GFESuite/exportgrids/primary || exit 1
mkdir -p ${RPM_BUILD_ROOT}/awips2/GFESuite/exportgrids/backup || exit 1
mkdir -p ${RPM_BUILD_ROOT}/awips2/GFESuite/products/ISC || exit 1
mkdir -p ${RPM_BUILD_ROOT}/awips2/GFESuite/products/ATBL || exit 1
mkdir -p ${RPM_BUILD_ROOT}/awips2/GFESuite/rsyncGridsToCWF/data || exit 1
mkdir -p ${RPM_BUILD_ROOT}/awips2/GFESuite/rsyncGridsToCWF/etc || exit 1
mkdir -p ${RPM_BUILD_ROOT}/awips2/GFESuite/rsyncGridsToCWF/log || exit 1
mkdir -p ${RPM_BUILD_ROOT}/awips2/GFESuite/irt || exit 1
