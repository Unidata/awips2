...
%define _component_name           awips2-edex-common-core
%define _component_project_dir    awips2.edex/Installer.edex-common-core
%define _component_zip            com.raytheon.uf.edex.common.core.feature-edex.zip
%define _component_default_prefix /awips2
#
# AWIPS II Edex Common Core Spec File
#
...
AutoReq: no
provides: awips2-edex-common-core
requires: awips2
...
%description
AWIPS II Edex Installation - Installs The AWIPS II Edex Common Core Plugins.
...
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;34m\| Installing AWIPS II Edex Common Core Plugins...\e[m"
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
...
#---------------------------------------------------------------------------#
echo -e "\e[1;32m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;32m\| AWIPS II Edex Common Core Plugin Installation - COMPLETE\e[m"
echo -e "\e[1;32m--------------------------------------------------------------------------------\e[m"
...
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;34m\| AWIPS II Edex Common Core Plugins Have Been Successfully Removed\e[m"
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
