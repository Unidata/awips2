...
%define _component_name           awips2-edex-satellite
%define _component_project_dir    awips2.core/Installer.edex-satellite
%define _component_zip            com.raytheon.uf.edex.satellite.feature-edex.zip
%define _component_default_prefix /awips2
#
# AWIPS II Edex Satellite Spec File
#
...
AutoReq: no
provides: awips2-edex-satellite
requires: awips2
...
%description
AWIPS II Edex Installation - Installs The AWIPS II Edex Satellite Plugins.
...
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;34m\| Installing AWIPS II Edex Satellite Plugins...\e[m"
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
...
#---------------------------------------------------------------------------#
echo -e "\e[1;32m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;32m\| AWIPS II Edex Satellite Plugin Installation - COMPLETE\e[m"
echo -e "\e[1;32m--------------------------------------------------------------------------------\e[m"
...
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;34m\| AWIPS II Edex Satellite Plugins Have Been Successfully Removed\e[m"
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
