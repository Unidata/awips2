...
%define _component_name           awips2-edex-core
%define _component_project_dir    awips2.edex/Installer.edex-core
%define _component_zip            com.raytheon.uf.edex.core.feature-edex.zip
%define _component_default_prefix /awips2
#
# AWIPS II Edex Core Spec File
#
...
%description
AWIPS II Edex Installation - Installs The AWIPS II Edex Core Plugins.
...
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;34m\| Installing AWIPS II Edex Core Plugins...\e[m"
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
...
#---------------------------------------------------------------------------#
echo -e "\e[1;32m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;32m\| AWIPS II Edex Core Plugin Installation - COMPLETE\e[m"
echo -e "\e[1;32m--------------------------------------------------------------------------------\e[m"
...
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;34m\| AWIPS II Edex Core Plugins Have Been Successfully Removed\e[m"
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
