...
%define _component_name           awips2-edex-gfe
%define _component_project_dir    awips2.edex/Installer.edex-gfe
%define _component_zip            com.raytheon.uf.edex.gfe.feature-edex.zip
%define _component_default_prefix /awips2
#
# AWIPS II Edex GFE Spec File
#
...
%description
AWIPS II Edex Installation - Installs The AWIPS II Edex GFE Plugins.
...
# 1] GFESuite/exportgrids
# 2] GFESuite/exportgrids2
# 3] GFESuite/ServiceBackup/svcbu
GFESUITE_DIRS_TO_CREATE=\
(\
   '/awips2/GFESuite/exportgrids'\
   '/awips2/GFESuite/exportgrids2'\
#   '/awips2/GFESuite/ServiceBackup/svcbu'\
#   '/awips2/GFESuite/ServiceBackup/data'\
#   '/awips2/GFESuite/ServiceBackup/locks'\
#   '/awips2/GFESuite/ServiceBackup/logs'\
)
for dir in ${GFESUITE_DIRS_TO_CREATE[*]}
do
...
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;34m\| Installing AWIPS II Edex GFE Plugins...\e[m"
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;34m   Installation Root = ${RPM_INSTALL_PREFIX}/edex\e[m"
echo -e "\e[1;34m       GFESuite Root = ${RPM_INSTALL_PREFIX}/GFESuite\e[m"
...
#---------------------------------------------------------------------------#
echo -e "\e[1;32m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;32m\| AWIPS II Edex GFE Plugin Installation - COMPLETE\e[m"
echo -e "\e[1;32m--------------------------------------------------------------------------------\e[m"
...
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;34m\| AWIPS II Edex GFE Plugins Have Been Successfully Removed\e[m"
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
