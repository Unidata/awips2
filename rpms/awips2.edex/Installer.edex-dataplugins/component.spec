...
%define _component_name           awips2-edex-dataplugins
%define _component_project_dir    awips2.edex/Installer.edex-dataplugins
%define _component_zip            com.raytheon.uf.edex.dataplugins.feature-edex.zip
%define _component_default_prefix /awips2
#
# AWIPS II Edex Dataplugins Spec File
#
...
AutoReq: no
provides: awips2-edex-dataplugins
requires: awips2
...
%description
AWIPS II Edex Installation - Installs The AWIPS II Edex Dataplugins Plugins.
...
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;34m\| Installing AWIPS II Edex Dataplugins Plugins...\e[m"
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
...
#---------------------------------------------------------------------------#
echo -e "\e[1;32m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;32m\| AWIPS II Edex Dataplugins Plugin Installation - COMPLETE\e[m"
echo -e "\e[1;32m--------------------------------------------------------------------------------\e[m"
...
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
echo -e "\e[1;34m\| AWIPS II Edex Dataplugins Plugins Have Been Successfully Removed\e[m"
echo -e "\e[1;34m--------------------------------------------------------------------------------\e[m"
