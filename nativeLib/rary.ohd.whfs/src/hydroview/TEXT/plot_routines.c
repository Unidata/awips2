...
*         2        4/12/2006     Bryon Lawrence    Modified to not color radar
*                                                  rings according to
*                                                  radar availability.
********************************************************************************
*/
                         ...
                         Pixmap map , void * pUserData )
{
   ...
   if ( pFile == NULL )
   {
      ...
      fprintf ( stderr , "In routine _draw_radar_rings:\n\n"
                         ...
                         void * pUserData )
{
   ...
   /* Set the radar ring overlay color according to what the user
      specified in the overlay configuration file. */
   mSetColor ( pOverlay->color );
   ...
   for ( i = 0 ; i < NRADARS ; ++ i )
   {
      ...
      height = ( unsigned int ) ( 2 * ( center_ypt - top_ypt ) ) ;
         ...
         XDrawArc ( dpy , map , maplib_gc, left_xpt , top_ypt , 
                             ...
                             Pixmap map , void * pUserData )
{
   ...
   if ( pFile == NULL )
   {
      ...
      fprintf ( stderr , "In routine _draw_radar_locations:\n\n"
                         "Could not open file %s. Aborting the drawing of"
                         "the radar locations.\n" , filename ) ;
      return ;
   }
                                ...
                                Pixmap map , void * pUserData )
{
   ...
   if ( pFile == NULL )
   {
      fprintf ( stderr , "In routine \"_draw_fsl_city_locations\":\n\n"
                       ...
                       Pixmap map , void * pUserData )
{
   ...
   if ( pOverlay == NULL )
   {
      fprintf ( stderr , "In routine \"_draw_hrap_grid\":\n"
                           ...
                           Pixmap map , void * pUserData )
{
   ...
   if ( pOverlay == NULL )
   {
      fprintf ( stderr , "In routine \"_draw_hrap_boundary\":\n"
                         "NULL overlay information was passed into this\n"
                         "routine.  Could not draw the hrap grid.\n" ) ;
      return ;
   }
