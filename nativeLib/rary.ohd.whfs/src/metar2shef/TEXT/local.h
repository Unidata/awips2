...
/* #define assgndev(d, v) v = 0x##d */                    /* dgb:12/07/96 */                                                
...
typedef bool (*ParseBltnFnPtrX) ( MDADdata *mdata,                              
                                  char **rptPtr,                                
                                  char *bbbTypePtr,                             
                                  char **prefixPtr,                             
                                  short *YYPtr,                                 
...
/* void *memccpy(void *, void *, int, unsigned); */        /* dgb:12/07/96 */                                   
