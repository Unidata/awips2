...
c  =====================================================================
      subroutine ungrib(iupr,ibug,mbuf,kbuf,mfld,fld,
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/wfo_rfc/precip_proc/source/gribit/src/RCS/ungrib.f,v $
     . $',                                                             '
     .$Id: ungrib.f,v 1.1 2006/05/03 13:43:59 gsood Exp $
     . $' /
C    ===================================================================
C
c
