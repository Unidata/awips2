...
public:
    ...
    QPID_COMMON_EXTERN void setStagedSize(uint64_t _stagedSize);
    QPID_COMMON_EXTERN uint64_t getStagedSize() const;
    QPID_COMMON_EXTERN bool hasStagedSize() const;
    QPID_COMMON_EXTERN void clearStagedSizeFlag();
