...
public:
    ...
    QPID_COMMON_EXTERN void setFail(bool _fail);
    QPID_COMMON_EXTERN bool getFail() const;
    QPID_COMMON_EXTERN void setSuspend(bool _suspend);
    QPID_COMMON_EXTERN bool getSuspend() const;
