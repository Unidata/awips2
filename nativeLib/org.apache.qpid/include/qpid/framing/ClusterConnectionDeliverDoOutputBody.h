...
public:
    ...
    QPID_COMMON_EXTERN void setLimit(uint32_t _limit);
    QPID_COMMON_EXTERN uint32_t getLimit() const;
    QPID_COMMON_EXTERN bool hasLimit() const;
    QPID_COMMON_EXTERN void clearLimitFlag();
