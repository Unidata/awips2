...
public:
    ...
    QPID_COMMON_EXTERN void setQueues(const Array& _queues);
    QPID_COMMON_EXTERN const Array& getQueues() const;
    QPID_COMMON_EXTERN bool hasQueues() const;
    QPID_COMMON_EXTERN void clearQueuesFlag();
    QPID_COMMON_EXTERN void setDelivered(bool _delivered);
    QPID_COMMON_EXTERN bool getDelivered() const;
