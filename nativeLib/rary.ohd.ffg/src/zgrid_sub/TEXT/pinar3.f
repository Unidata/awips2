...
c  =====================================================================
c
      subroutine pinar3 (ident,istat)
c
c.......................................................................
c
c  Routine to read area definition input file without runoff values.
c
c.......................................................................
...
c
c  Created from pinar2 to read area records containing
c  computation control field and no runoffs.
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ffg/src/zgrid_sub/RCS/pinar3.f,v $
     . $',                                                             '
     .$Id: pinar3.f,v 1.2 2004/01/06 20:03:51 scv Exp $
     . $' /
C    ===================================================================
C
c
      call prbug ('pinar3',1,1,ibug)
c
      istat = 0
c
      artyp = 'affg'
...
c  computation control
      iptr = nxt
      nwid = 2
      call uffir (line,iptr,nwid,iropta,r,nxt,istat)
      if (istat.gt.0) go to 70
c
c  duration
      iptr = nxt
...
c
      write (iutw,40) type,areaid,adesc,iropta,kadurf,bbid
40    format(2x,a4,1x,2a4,1x,5a4,1x,i1,1x,i1,1x,2a4)
c
