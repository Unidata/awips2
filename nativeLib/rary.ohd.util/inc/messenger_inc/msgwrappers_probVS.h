...
**     and Fortran should call writemsgf.  The arguments passed in are the message, of course,
...
/*
**====================================================================================
** INITIALIZER FUNCTIONS (Source code is in Messenger.cxx) 
**====================================================================================
**
...
*/
extern "C" void initmsgf(int* numevents, char* eventnames, char* filename, int* reqdlevels,
                         int* namelen);
...
extern "C" void writemsgf(const int* bitcode, const char* message);       /*Fortra */
...
extern void initmsgf(int* numevents, char* eventnames, char* filename, int* reqdlevels, int* namelen);
extern void writemsg( int  bitcode, const char* format, ... ); 
extern void writemsgf(const int* bitcode, const char* message); 
