C MODULE UPRIMR
C  =====================================================================
C  pgm: UPRIMR .. Read user info
C
C   in: (common) ...... block common UPDAIO contains unit numbers for
C   in:                 i/o routine messages (see subrtn UPRIMO)
C
C  rqd: subrtns: KKSMLS,KKTRIM,UPEXIS,UPOPEN
C  rqd: common:  UPDAIO
C  =====================================================================
      SUBROUTINE UPRIMR(STMT,FMT,AVUN,IUN)


      EXTERNAL      KKSMLS,KKTRIM,UPEXIS,UPOPEN
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/util/src/now/RCS/uprimr.f,v $
     . $',                                                             '
     .$Id: uprimr.f,v 1.6 2004/05/03 21:38:27 hank Exp $
     . $' /
C    ===================================================================
C
...
CDWS    IF( FILCMD .EQ. '    ' ) GO TO 100
        ...
        IF( FILCMD .EQ. 'tty ' ) GO TO 140
          ...
          IF( II.EQ.0 ) CALL UPOPEN(IUN,FILNAM(LBEG:LEND),JRECL,FMT,II)
          IF( II.NE.0 ) IUN = -1
