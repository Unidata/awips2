...
C-----------------------------------------------------------------------
C
C  ROUTINE TO CONVERT CHARACTERS TO REAL*8 VALUES
C
      SUBROUTINE FFA2F8 (IBUF,IPOS,IWIDTH,IDEC,NUM,XLOC,IERR)
C
      CHARACTER*1 IBUF(1)
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/util/src/util_gen1/RCS/ffa2f8.f,v $
     . $',                                                             '
     .$Id: ffa2f8.f,v 1.1 1995/09/17 19:01:56 dws Exp $
     . $' /
C    ===================================================================
C
C
