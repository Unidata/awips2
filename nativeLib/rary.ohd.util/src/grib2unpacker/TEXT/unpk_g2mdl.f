      SUBROUTINE UNPK_G2MDL(KFILDO,jmin,lbit,nov,iwork,A,IA,ND2X3,
     1                      IDAT,NIDAT,RDAT,NRDAT,IS0,NS0,IS1,NS1,
     2                      IS2,NS2,IS3,NS3,IS4,NS4,IS5,NS5,IS6,NS6,
     3                      IS7,NS7,IB,IBITMAP,IPACK,ND5,XMISSP,
     4                      XMISSS,NEW,ICLEAN,L3264B,IENDPK,JER,
     5                      NDJER,KJER)
C
C        
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/util/src/grib2unpacker/RCS/unpk_g2mdl.f,v $
     . $',                                                             '
     .$Id: unpk_g2mdl.f,v 1.1 2004/09/16 16:51:50 dsa Exp $
     . $' /
C    ===================================================================
C
C
...
C        A FATAL ERROR OCCURRED WITH PROGRAM TERMINATION.
      ...
      CALL UNPK_SECT7(KFILDO,jmin,lbit,nov,iwork,A,ND2X3,NX,NY,
     1                IUNPKOPT,IPACK,REF,ND5,IS5,NS5,IS7,NS7,IBITMAP,
     2                IB,XMISSP,XMISSS,BOUST,N,LOCN,IPOS,IER,
     3                ISEVERE,*900)
      LSECT=IS7(1)
C
C        *************************************
