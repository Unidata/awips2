...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/grib2unpacker/RCS/unpk_swap.c,v $";
 static char rcs_id2[] = "$Id: unpk_swap.c,v 1.1 2004/09/16 16:51:50 dsa Exp $";}
/*  ===================================================  */
