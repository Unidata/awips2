...
//$$$
{
      ...
      g2int  i,j,n,nbits,imin,imax,maxdif,nbittot,left;
      g2int  isd,itemp,ilmax,ngwidthref,nbitsgwidth;
      g2int  nglenref,nglenlast,nbutsglen,iofst,ival1,ival2;
      g2int  minsd,nbitsd,maxorig,nbitorig,ngroups;
      g2int  lg,ng,igmax,nitsgref,iwmax,nbitsgref;
      g2int  glength,grpwidth,nbitsglen;
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/g2libc/RCS/compack.c,v $";
 static char rcs_id2[] = "$Id: compack.c,v 1.1 2004/09/16 17:42:10 dsa Exp $";}
/*  ===================================================  */
