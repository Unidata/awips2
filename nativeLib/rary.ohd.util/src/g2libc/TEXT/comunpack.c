...
int comunpack(unsigned char *cpack,g2int idrsnum,g2int *idrstmpl,g2int ndpts,g2float *fld)
...
// 2002-10-29  Gilbert
//
// USAGE:    int comunpack(unsigned char *cpack,g2int idrsnum,g2int *idrstmpl,
...
//$$$//
{
      ...
      g2int   nbitsd,isign;
      g2int  j,iofst,ival1,ival2,minsd,itemp,l,k,n,non;
      g2int  *ifld,*ifldmiss;
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/g2libc/RCS/comunpack.c,v $";
 static char rcs_id2[] = "$Id: comunpack.c,v 1.1 2004/09/16 17:42:10 dsa Exp $";}
/*  ===================================================  */
