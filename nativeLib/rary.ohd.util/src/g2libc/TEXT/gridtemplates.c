...
#include "g2libc_inc/gridtemplates.h"
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/g2libc/RCS/gridtemplates.c,v $";
 static char rcs_id2[] = "$Id: gridtemplates.c,v 1.1 2004/09/16 17:42:10 dsa Exp $";}
/*  ===================================================  */
