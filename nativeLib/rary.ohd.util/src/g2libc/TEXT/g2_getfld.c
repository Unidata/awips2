...
// 2002-10-28  Gilbert
//
// USAGE:    #include "g2libc_inc/grib2.h"
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/g2libc/RCS/g2_getfld.c,v $";
 static char rcs_id2[] = "$Id: g2_getfld.c,v 1.1 2004/09/16 17:42:10 dsa Exp $";}
/*  ===================================================  */
