...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/g2libc/RCS/dec_jpeg2000.c,v $";
 static char rcs_id2[] = "$Id: dec_jpeg2000.c,v 1.1 2004/09/16 17:48:51 dsa Exp $";}
/*  ===================================================  */
