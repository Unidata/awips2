...
//$$$
{
      ...
      g2int iofst,ibeg,lencurr,len,ilen,isecnum;
      g2int   ierr,lengrib;
...
//
      ...
      //    total length, then there is a problem.
        if ( len > lencurr ) {
          ...
          printf("g2_gribend: Sum of section byte counts = \n",len);
          printf("g2_gribend: Total byte count in Section 0 = \n",lencurr);
          ierr=-3;
          return (ierr);
        }
      }
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/g2libc/RCS/g2_gribend.c,v $";
 static char rcs_id2[] = "$Id: g2_gribend.c,v 1.1 2004/09/16 17:42:10 dsa Exp $";}
/*  ===================================================  */
