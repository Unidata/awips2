...
//   using info from the GRIB2 Data Representation Template 5.40000.
//
// PROGRAM HISTORY LOG:
// 2003-08-27  Gilbert
//
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/g2libc/RCS/jpcunpack.c,v $";
 static char rcs_id2[] = "$Id: jpcunpack.c,v 1.1 2004/09/16 17:42:10 dsa Exp $";}
/*  ===================================================  */
