...
int enc_jpeg2000(unsigned char *cin,g2int width,g2int height,g2int nbits,
                 g2int ltype, g2int ratio, char *outjpc, g2int jpclen)
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/g2libc/RCS/enc_jpeg2000.c,v $";
 static char rcs_id2[] = "$Id: enc_jpeg2000.c,v 1.1 2004/09/16 17:48:51 dsa Exp $";}
/*  ===================================================  */
