...

{
      ...
      g2int lensec,ibyttem,isign,newlen;
      g2int *ligds,*ligdstmpl,*lideflist;
      template *mapgrid;
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/g2libc/RCS/g2_unpack3.c,v $";
 static char rcs_id2[] = "$Id: g2_unpack3.c,v 1.1 2004/09/16 17:42:10 dsa Exp $";}
/*  ===================================================  */
