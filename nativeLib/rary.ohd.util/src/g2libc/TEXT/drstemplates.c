...
#include "g2libc_inc/drstemplates.h"
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/g2libc/RCS/drstemplates.c,v $";
 static char rcs_id2[] = "$Id: drstemplates.c,v 1.1 2004/09/16 17:42:10 dsa Exp $";}
/*  ===================================================  */
