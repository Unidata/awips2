...
// fortran call
void udatl_(int time_out[6]) { udatl(time_out); }
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/date_time/RCS/udatl.c,v $";
 static char rcs_id2[] = "$Id: udatl.c,v 1.2 1998/07/02 13:48:38 page Exp $";}
/*  ===================================================  */
