...
int
pngtest_main(int argc, char *argv[])
{
   int multiple = 0;
   int ierror = 0;
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/png_main/RCS/pngtest.c,v $";
 static char rcs_id2[] = "$Id: pngtest.c,v 1.1 2004/09/13 15:02:36 dsa Exp $";}
/*  ===================================================  */
