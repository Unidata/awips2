...
#ifdef TEST_SCAN
/*****************************************************************************
 * The following procedure is included to test scan.c, and only if TEST_SCAN
 * is defined.
 *****************************************************************************
 */
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/grib2lib/RCS/scan.c,v $";
 static char rcs_id2[] = "$Id: scan.c,v 1.1 2004/09/16 17:30:40 dsa Exp $";}
/*  ===================================================  */
