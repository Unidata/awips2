...
GRIB1SurfTable GRIB1Surface[256] = {
   ...
   /* 235 */ {"var235", "reserved", "-", 0},
   /* 236 */ {"var236", "reserved", "-", 0},
   /* 237 */ {"var237", "reserved", "-", 0},
   /* 238 */ {"var238", "reserved", "-", 0},
   ...
   /* 251 */ {"SCBL", "Shallow convective cloud bottom level", "-", 0},
   /* 252 */ {"SCTL", "Shallow convective cloud top level", "-", 0},
   /* 253 */ {"var253", "reserved", "-", 0},
   /* 254 */ {"var254", "reserved", "-", 0},
...
GRIB1ParmTable parm_table_ncep_opn[256] = {
   ...
   /* 119 */ {"LWRAD", "Radiance (with respect to wave number)", "W/m/sr",
              UC_NONE},
   /* 120 */ {"SWRAD", "Radiance (with respect ot wave length)", "W/m^3/sr",
              UC_NONE},
...
/*  ==============  Statements containing RCS keywords:  */
 static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/degrib/RCS/grib1tab.c,v $";
 static char rcs_id2[] = "$Id: grib1tab.c,v 1.1 2004/09/16 17:21:07 dsa Exp $";
/*  ===================================================  */
