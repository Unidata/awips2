 ...
 */
/* $Id: string.c,v 1.1 2004/09/15 20:04:52 dsa Exp $ */

#include "netcdf_inc/nc.h"
#include <stdlib.h>
#include <string.h>
#include <ctype.h>
#include <assert.h>
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/netcdf/RCS/string.c,v $";
 static char rcs_id2[] = "$Id: string.c,v 1.1 2004/09/15 20:04:52 dsa Exp $";}
/*  ===================================================  */
