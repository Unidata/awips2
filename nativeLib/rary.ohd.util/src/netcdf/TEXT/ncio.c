 ...
 */
/* $Id: ncio.c,v 1.1 2004/09/15 20:04:52 dsa Exp $ */

#include "netcdf_inc/ncconfig.h"
#include <assert.h>
#include <stdlib.h>
#include <errno.h>
#ifndef ENOERR
...
#include "netcdf_inc/ncio.h"
#include "netcdf_inc/fbits.h"
#include "netcdf_inc/rnd.h"
...
#ifdef S_IRUSR
  /* In MinGW, S_IRUSR is defined, but S_IRGRP and S_IROTH is not. */
  #ifdef S_IRGRP
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/netcdf/RCS/ncio.c,v $";
 static char rcs_id2[] = "$Id: ncio.c,v 1.1 2004/09/15 20:04:52 dsa Exp $";}
/*  ===================================================  */
