 ...
 */
/* $Id: v2i.c,v 1.1 2004/09/15 20:04:52 dsa Exp $ */
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/netcdf/RCS/v2i.c,v $";
 static char rcs_id2[] = "$Id: v2i.c,v 1.1 2004/09/15 20:04:52 dsa Exp $";}
/*  ===================================================  */
