 ...
 */
/* $Id: t_nc.c,v 1.1 2004/09/15 20:04:52 dsa Exp $ */
...
/*ARGSUSED*/
int
netcdf_t_nc_main(int ac, char *av[])
{
	int ret;
	int	 id;
	char buf[256];
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/netcdf_main/RCS/t_nc.c,v $";
 static char rcs_id2[] = "$Id: t_nc.c,v 1.1 2004/09/15 20:04:52 dsa Exp $";}
/*  ===================================================  */
