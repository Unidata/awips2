 ...
 */
/* $Id: t_ncx.c,v 1.1 2004/09/15 20:04:52 dsa Exp $ */
...
int
netcdf_t_ncx_main(int ac, char *av[])
{
	int status;
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/netcdf_main/RCS/t_ncx.c,v $";
 static char rcs_id2[] = "$Id: t_ncx.c,v 1.1 2004/09/15 20:04:52 dsa Exp $";}
/*  ===================================================  */
