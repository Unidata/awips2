 ...
 */
/* $Id: t_ncio.c,v 1.1 2004/09/15 20:04:52 dsa Exp $ */
...
netcdf_t_ncio_main(int ac, char *av[])
{
	char *path = "";
	ncio *nciop;
	char linebuf[128];
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/util/src/netcdf_main/RCS/t_ncio.c,v $";
 static char rcs_id2[] = "$Id: t_ncio.c,v 1.1 2004/09/15 20:04:52 dsa Exp $";}
/*  ===================================================  */
