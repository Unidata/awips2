...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcinit_prpc/RCS/prp60.f,v $
     . $',                                                             '
     .$Id: prp60.f,v 1.1 1998/04/07 11:57:38 page Exp $
     . $' /
C    ===================================================================
C
...
C        TIDE ADJUSTMENT - VERSION XXXX
...
C           DW ADJUSTED STAGE              XXXXXXXX  XXXX
...
C     PRINT HEADING THEN TITLE INFORMATION FROM P ARRAY
 ...
 501  FORMAT(//,10X,'TIDE ADJUSTMENT    - VERSION ',I4,/,
     +          10X,18A4,/)
...
C     PRINT TIME SERIES INFORMATION FROM P ARRAY
      ...
      II=II+1
  22  PREAL(II) = P(JJ)
      WRITE(IPR,504) (PCHAR(II),II=1,21)
 504  FORMAT(/,10X,'INPUT TIME SERIES',18X,'ID',7X,'CODE',/,
     +     13X,'DWOPER OBSERVED STAGE',9X,2A4,3X,A4,/,
     +     13X,'NOS    FORECAST STAGE',9X,2A4,3X,A4,/,
     +     13X,'TIDE1 BALANCE',17X,2A4,3X,A4,/,
     +     13X,'TIDE2 BALANCE',17X,2A4,3X,A4,/,
     +     13X,'TIDE3 BALANCE',17X,2A4,3X,A4,/,
     +     13X,'TIDE4 BALANCE',17X,2A4,3X,A4,//,
     +     10X,'PRIMARY OUTPUT TIME SERIES',/,
     +     13X,'DW ADJUSTED STAGE',14X,2A4,2X,A4,/)


      IF (ITRACE.GE.1) WRITE(IODBUG,199)
 199  FORMAT('PRP60:  EXITED:')
