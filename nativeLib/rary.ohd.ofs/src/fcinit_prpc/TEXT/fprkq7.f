...
C
      SUBROUTINE FPRKQ7(TAB,NT,IP,IMETR)
C
C.......................................................................
C
C      THIS SUBROUTINE PRINTS A K VS Q TABLE.
C.......................................................................
C
C      SUBROUTINE ORIGINALLY PROGRAMMED BY
C                  GEORGE F. SMITH - HRL   DECEMBER 1979
C                       UPDATED MARCH 1982 TO PRINT METRIC AND
C                        ENGLISH UNITS
C.......................................................................
C
C      VARIABLES IN ARGUMENT LIST
C
C        1. TAB - K VS Q TABLE
C        2. NT  - THE NUMBER OF (K,Q) PAIRS IN TAB
C        3. IP  - THE UNIT NUMBER ON WHICH THE TABLE WILL BE WRITTEN
C        4. IMETR - =0, PRINT Q IN ENGLISH UNITS (CFS)
C                   =1, PRINT Q IN METRIC UNITS (CMS)
C.......................................................................
C
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcinit_prpc/RCS/fprkq7.f,v $
     . $',                                                             '
     .$Id: fprkq7.f,v 1.1 1995/09/17 18:49:32 dws Exp $
     . $' /
C    ===================================================================
C
C
...
C
  ...
  600 FORMAT(16X,11HK   (HOURS),10F10.0)
C
