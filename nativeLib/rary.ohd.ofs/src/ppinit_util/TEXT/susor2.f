...
C-----------------------------------------------------------------------
C
C  SUBROUTINE SUSOR2 SORTS AN ARRAY INTO ASCENDING ORDER.
...
C
      SUBROUTINE SUSOR2 (IDIM,NUM,IWORD1,IWORD2,IARAY1,IARAY2,ISPTR,
     *   ISTAT)
C
C  INPUT VARIABLES:
C
...
C
C
      CHARACTER*4 IARAY1(IDIM,*),IARAY2(IDIM,*),CTEMP
      DIMENSION ISPTR(*)
C
      INCLUDE 'uiox'
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/ppinit_util/RCS/susor2.f,v $
     . $',                                                             '
     .$Id: susor2.f,v 1.3 2002/02/11 20:56:12 dws Exp $
     . $' /
C    ===================================================================
C
C
...
C
      IF (LDEBUG.GT.0) WRITE (LP,140) IDIM,NUM,IWORD1,IWORD2
...
C - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
C
130   FORMAT (' *** ENTER SUSOR2')
140   FORMAT (' IDIM=',I3,3X,'NUM=',I6,3X,'IWORD1=',I3,3X,
     *   'IWORD2=',I3)
150   FORMAT (' NUMBER OF PASSES=',I12,3X,'NUMBER OF SWITCHES=',I12)
160   FORMAT ('0ARRAY SORTED IN ASCENDING ORDER')
170   FORMAT ('0PRINTED IN (I4,1X) FORMAT')
180   FORMAT ('0PRINTED IN (A4,1X) FORMAT')
190   FORMAT (1H ,I5,3X,10(I4,1X))
200   FORMAT (1H ,I5,3X,I5,3X,20(I4,1X))
210   FORMAT (1H ,I5,3X,20(A4,1X))
220   FORMAT (1H ,I5,3X,I5,3X,20(A4,1X))
230   FORMAT (' *** EXIT SUSOR2 : STATUS CODE=',I3)
C
      END
