...
C-----------------------------------------------------------------------
C
C  PGM: PWQS4(MMSA,MMS1,MMS2,MMD1,MMD2,MMD3,MMD4,MMD5,MMLD,NS,MMNO)
C
...
C  =====================================================================
C
      SUBROUTINE PWQS4 (MMSA,MMS1,MMS2,MMD1,MMD2,MMD3,MMD4,MMD5,MMLD,
     *                 NS,MMNO)
C
      INCLUDE 'uiox'
C
      ...
      INTEGER    MMD4(1),MMD5(1),MMLD(1),NS,MMNO
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/ppdutil_dmp24/RCS/pwqs4.f,v $
     . $',                                                             '
     .$Id: pwqs4.f,v 1.2 2002/02/11 20:48:35 dws Exp $
     . $' /
C    ===================================================================
C
C
...
10      IF ( IR.LT.IL+1 ) GO TO 100
          ...
          MMLD(IX) = MMLD(IL)
C
20        CALL PW40BC(MMSA,MMD1,MMD2,MMD3,MMD4,MMD5,MMLD,IX,IJ,NS,ICON)
...
C
          IF ( IJ.LE.II ) GO TO 70
            ...
            II = II+1
C
40          CALL PW40BC(MMSA,MMD1,MMD2,MMD3,MMD4,MMD5,MMLD,IX,II,
     *                  NS,ICON)
