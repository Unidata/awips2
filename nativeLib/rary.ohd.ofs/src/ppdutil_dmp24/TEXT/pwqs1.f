...
C-----------------------------------------------------------------------
C
C  PGM: PWQS1(MMSA,MMS1,MMS2,NS,MMNO) .. QUICK SORT ON STATE-STATION
C
...
C  =====================================================================
C
      SUBROUTINE PWQS1 (MMSA,MMS1,MMS2,NS,MMNO)
C
      INCLUDE 'uiox'
C
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/ppdutil_dmp24/RCS/pwqs1.f,v $
     . $',                                                             '
     .$Id: pwqs1.f,v 1.2 2002/02/11 20:47:48 dws Exp $
     . $' /
C    ===================================================================
C
C
...
10      IF ( IR.LT.IL+1 ) GO TO 100
          ...
          MMS2(IX) = MMS2(IL)
C
20        CALL PW10BC(MMSA,MMS1,MMS2,IX,IJ,NS,ICON)
...
C
          IF ( IJ.LE.II ) GO TO 70
            ...
            II = II+1
C
40          CALL PW10BC(MMSA,MMS1,MMS2,IX,II,NS,ICON)
