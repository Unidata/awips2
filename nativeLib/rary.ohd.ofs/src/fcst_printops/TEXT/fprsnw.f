...
C
      SUBROUTINE FPRSNW(NXD,D,MD,OLDP,MOLDP,IOTIME,ISFG,LINE,ND,NP,NC,
     1   ITITLE)
C.......................................
C     THIS SUBROUTINE PRINTS THE VALUES STORED IN THE D ARRAY BY
C       SUBROUTINE FSVSNW FOR THE SNOW-17 OPERATION AS PART
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcst_printops/RCS/fprsnw.f,v $
     . $',                                                             '
     .$Id: fprsnw.f,v 1.1 1995/09/17 19:04:47 dws Exp $
     . $' /
C    ===================================================================
C
C
...
C     CHECK TRACE LEVEL--TRACE LEVEL=2.
 ...
 900  FORMAT(1H0,17H** FPRSNW ENTERED)
C.......................................
...
C
 ...
 901  FORMAT(1H1,31HSNOW-17 CARRYOVER DISPLAY AS OF,I3,1H/,I2,1H/,
...
C
C  LOP POINTS TO BEGINNING OF INFO FOR NTH SNOW-17 OPERATION IN SEGMENT
C
  151 LOP=LD+13+(N-1)*(13+NP+ND*NC)
      OPNAME(1)=D(LOP)
      OPNAME(2)=D(LOP+1)
C
C  LPM POINTS TO START OF PARAMETERS FOR NTH SNOW-17 OPERATION (MINUS 1)
C
      LPM=LOP+1
C.......................................
...
C     EXIT SUBROUTINE
 ...
 909  FORMAT(1H0,14H** EXIT FPRSNW)
C.......................................
      RETURN
      END
