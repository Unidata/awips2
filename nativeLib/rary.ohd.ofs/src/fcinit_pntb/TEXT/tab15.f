C MEMBER TAB15
C  (from old member FCTAB15)
C
      SUBROUTINE TAB15 (TO,LEFT,IUSET,NXT,LPO,PO,TS,MTS,LWORK,IDT)
C.......................................
...
C     CHANGED TO REVERSE ORDER OF CHECKING INPUT AND OUTPUT TS
C        ERIC ANDERSON - HRL   APRIL 1986
C.......................................
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcinit_pntb/RCS/tab15.f,v $
     . $',                                                             '
     .$Id: tab15.f,v 1.1 1995/09/17 18:49:06 dws Exp $
     . $' /
C    ===================================================================
C
C
C     DATA STATEMENTS
      DATA SNAME/4HTAB1,4H5   /
      DATA AREA/4HAREA/
C.......................................
...
C     LOCATION OF OUTPUT TIME SERIES.
      CALL FINDTS(PO(4),PO(6),IDT,LD,LTS,DIM)
...
C     CHECK FOR DEBUG OUTPUT.
  ...
  900 FORMAT(1H0,33HWEIGH-TS DEBUG--COMPUTATIONAL DT=,I3,/6X,
