...
C-----------------------------------------------------------------------
C
C   LAST UPDATE: 05/24/96
C
      SUBROUTINE TAB48 (TO, LEFT, IUSET, NXT, LPO, PO, LCO, TS, MTS,
     1                  LWORK, IDT)
C-----------------------------------------------------------------------
C   THIS IS THE OPERATIONS TABLE ENTRY ROUTINE FOR THE
C   MULTIPLY AND DIVIDE TIME SERIES 'MULT/DIV' OPERATION.
C
C   ROUTINE INITIALLY WRITTEN BY RUSS ERB - HRL  MAY 1996
C-----------------------------------------------------------------------
C   PASSED ARGUMENTS
C    NAME  I/O
C   ------ ---
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcinit_pntb/RCS/tab48.f,v $
     . $',                                                             '
     .$Id: tab48.f,v 1.1 1996/07/11 20:45:04 dws Exp $
     . $' /
C    ===================================================================
C
C.......................................................................
C   DEBUG INITIALIZATION WITH TRACE LEVEL = 1
      CALL FPRBUG ('TAB48   ', 1, 48, IBUG)
C.......................................................................
...
C   TIME INTERVAL OF ALL TIME SERIES.
      IDELT = PO(5)
C
C   CALL CKINPT AND GET THE LOCATION IN THE D() OF THE FIRST INPUT TS.
      CALL CKINPT (PO(2), PO(4), IDELT, LD, TS, MTS, IERR)
      TO(5) = LD
C
C   CALL CKINPT AND GET THE LOCATION IN THE D() OF THE SECOND INPUT TS.
      CALL CKINPT (PO(6), PO(8), IDELT, LD, TS, MTS, IERR)
      TO(6) = LD
C
C   GET THE LOCATION OF THE OUTPUT TIME SERIES IN THE D()
C   AND SET FLAG INDICATING THAT THIS TIME SERIES CONTAINS DATA VALUES.
      CALL FINDTS (PO(9), PO(11), IDELT, LD, LTS, DIM)
      TO(7) = LD
...
C  CHECK IF DEBUG OUTPUT IS TO BE PRINTED.
 ...
 1000    FORMAT(1H0,'MULT/DIV DEBUG - CONTENTS OF TO()=',8I6)
      END IF
C.......................................................................
C   THE TO ARRAY ENTRIES ARE AS FOLLOWS:
C   POS
C   ---
C    1      I.D. NUMBER OF THE OPERATION (48)
...
C    5      LOCATION OF FIRST INPUT TIME SERIES IN D ARRAY
C    6      LOCATION OF SECOND INPUT TIME SERIES IN D ARRAY
C    7      LOCATION OF OUTPUT TIME SERIES IN D ARRAY
C.......................................................................
      RETURN
      END
