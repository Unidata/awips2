...
C-----------------------------------------------------------------------
C
      SUBROUTINE SU2726 (WORK,IUSEW,LEFTW,IERR)
C
C  SUBROUTINE TO GET PARAMETERS, TIME-SERIES, AND CARRYOVER VALUES
C  FOR SCHEME/UTILITY #27 - DAILY CHANGE OF POOL SCHEME
C
C  ARGUMENTS:
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcinit_pntb/RCS/su2726.f,v $
     . $',                                                             '
     .$Id: su2726.f,v 1.2 2001/06/13 10:13:04 mgm Exp $
     . $' /
C    ===================================================================
C
      DATA ENDSU/4HENDS,4HETDH,4H    /
C
C
...
C
C--------------------------------------------------------------------
C  NOW PROCESS INPUT UP TO 'ENDSETDH', LOOKING FOR, IN ORDER, KEYWORDS
...
C
      CALL PM2726 (WORK,IUSEW,LEFTW,NPARXX,LENDSU,JDEST,IERPM)
C
