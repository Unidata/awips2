C MEMBER SU1526
C  (from old member FCSU1526)
C
      SUBROUTINE SU1526(WORK,IUSEW,LEFTW,IERR)
C
C---------------------------------------------------------------------
C  SUBROUTINE TO GET PARAMETERS, TIME-SERIES, AND CARRYOVER VALUES
C  FOR SCHEME/UTILITY #15 - INFLOW SUMMATION UTILITY
C---------------------------------------------------------------------
C  ARGS:
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcinit_res/RCS/su1526.f,v $
     . $',                                                             '
     .$Id: su1526.f,v 1.1 1995/09/17 18:53:02 dws Exp $
     . $' /
C    ===================================================================
C
C
      DATA ENDSU/4HENDS,4HUM  ,4H    /
C
C
...
C
C--------------------------------------------------------------------
C  NOW PROCESS INPUT UP TO 'ENDSUM  ', LOOKING FOR, IN ORDER, KEYWORDS
...
C
      CALL PM1526(WORK,IUSEW,LEFTW,NPARXX,
     .            LENDSU,JDEST,IERPM)
C
