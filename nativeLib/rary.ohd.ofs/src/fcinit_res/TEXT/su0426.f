C MEMBER SU0426
C  (from old member FCSU0426)
C
      SUBROUTINE SU0426(WORK,IUSEW,LEFTW,IERR)
C
C---------------------------------------------------------------------
C  SUBROUTINE TO GET PARAMETERS, TIME-SERIES, AND CARRYOVER VALUES
C  FOR SCHEME/UTILITY #04 - RULE CURVE SCHEME
C---------------------------------------------------------------------
C  ARGS:
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcinit_res/RCS/su0426.f,v $
     . $',                                                             '
     .$Id: su0426.f,v 1.1 1995/09/17 18:52:51 dws Exp $
     . $' /
C    ===================================================================
C
C
      DATA ENDSU/4HENDR,4HULE ,4H    /
C
C
...
C
C--------------------------------------------------------------------
C  NOW PROCESS INPUT UP TO 'ENDRULE ', LOOKING FOR, IN ORDER, KEYWORDS
...
C
C
      CALL PM0426(WORK,IUSEW,LEFTW,NPARXX,
     .            LENDSU,JDEST,IERPM)
C
C
