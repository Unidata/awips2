C MEMBER SU2326
C  (from old member FCSU2326)
C
      SUBROUTINE SU2326(WORK,IUSEW,LEFTW,IERR)
C
C---------------------------------------------------------------------
C  SUBROUTINE TO GET PARAMETERS, TIME-SERIES, AND CARRYOVER VALUES
C  FOR SCHEME/UTILITY #23 - SET MAXIMUM (OF POOL OR DISCHARGE) UTILITY
C---------------------------------------------------------------------
C  ARGS:
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcinit_res/RCS/su2326.f,v $
     . $',                                                             '
     .$Id: su2326.f,v 1.1 1995/09/17 18:53:09 dws Exp $
     . $' /
C    ===================================================================
C
C
      DATA ENDSU/4HENDS,4HMAX ,4H    /
C
C
...
C
C--------------------------------------------------------------------
C  NOW PROCESS INPUT UP TO 'ENDSMAX ', LOOKING FOR, IN ORDER, KEYWORDS
...
C
      CALL PM2326(WORK,IUSEW,LEFTW,NPARXX,
     .            LENDSU,JDEST,IERPM)
C
