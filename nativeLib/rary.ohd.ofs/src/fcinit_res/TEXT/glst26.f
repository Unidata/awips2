C MEMBER GLST26
C  (from old member FCGLST26)
C
C DESC GET LIST OF ITEMS (INTEGER, REAL OR CHARACTER)
C---------------------------------------------------------------------
      SUBROUTINE GLST26(LTYPE,LENC,IVAL,RVAL,CVAL,NVAL,LISTOK)
C----------------------------------------------------------------------
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcinit_res/RCS/glst26.f,v $
     . $',                                                             '
     .$Id: glst26.f,v 1.1 1995/09/17 18:51:43 dws Exp $
     . $' /
C    ===================================================================
C
C
...
C
      IF (LTYPE.EQ.0) CALL STER26(5,1)
      IF (LTYPE.EQ.1) CALL STER26(4,1)
      LISTOK = .FALSE.
      GO TO 10
C
