C MEMBER SU0726
C  (from old member FCSU0726)
C
      SUBROUTINE SU0726(WORK,IUSEW,LEFTW,IERR)
C
C---------------------------------------------------------------------
C  SUBROUTINE TO GET PARAMETERS, TIME-SERIES, AND CARRYOVER VALUES
C  FOR SCHEME/UTILITY #07 - POOL VS DISCHARGE SCHEME
C---------------------------------------------------------------------
C  ARGS:
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcinit_res/RCS/su0726.f,v $
     . $',                                                             '
     .$Id: su0726.f,v 1.1 1995/09/17 18:52:54 dws Exp $
     . $' /
C    ===================================================================
C
C
      DATA ENDSU/4HENDP,4HOOLQ,4H    /
C
C
...
C
C--------------------------------------------------------------------
C  NOW PROCESS INPUT UP TO 'ENDPOOLQ', LOOKING FOR, IN ORDER, KEYWORDS
...
C
C
      CALL PM0726(WORK,IUSEW,LEFTW,NPARXX,
     .            LENDSU,JDEST,IERPM)
C
