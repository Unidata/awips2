C MEMBER CO0626
C  (from old member FCCO0626)
C
      SUBROUTINE CO0626(WORK,IUSEW,LEFTW,NCO06)
C--------------------------------------------------------------------
C  ROUTINE TO GET AND CHECK CO SPECIFICATIONS FOR S/U #06 -
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcinit_res/RCS/co0626.f,v $
     . $',                                                             '
     .$Id: co0626.f,v 1.1 1995/09/17 18:51:21 dws Exp $
     . $' /
C    ===================================================================
C
C
