C MEMBER SU2226
C  (from old member FCSU2226)
C
      SUBROUTINE SU2226(WORK,IUSEW,LEFTW,IERR)
C
C---------------------------------------------------------------------
C  SUBROUTINE TO GET PARAMETERS, TIME-SERIES, AND CARRYOVER VALUES
C  FOR SCHEME/UTILITY #22 - SET MINIMUM (OF POOL OR DISCHARGE) UTILITY
C---------------------------------------------------------------------
C  ARGS:
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcinit_res/RCS/su2226.f,v $
     . $',                                                             '
     .$Id: su2226.f,v 1.1 1995/09/17 18:53:08 dws Exp $
     . $' /
C    ===================================================================
C
C
      DATA ENDSU/4HENDS,4HMIN ,4H    /
C
C
...
C
C--------------------------------------------------------------------
C  NOW PROCESS INPUT UP TO 'ENDSMIN ', LOOKING FOR, IN ORDER, KEYWORDS
...
C
      CALL PM2226(WORK,IUSEW,LEFTW,NPARXX,
     .            LENDSU,JDEST,IERPM)
C
