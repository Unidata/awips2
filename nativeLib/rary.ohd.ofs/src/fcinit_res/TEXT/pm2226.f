C MEMBER PM2226
C  (from old member FCPM2226)
C
      SUBROUTINE PM2226(WORK,IUSEW,LEFTW,NP22,
     .                  LENDSU,JDEST,IERR)
C--------------------------------------------------------------------
C  ROUTINE TO GET AND CHECK PARAMETERS FOR S/U #22 -
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcinit_res/RCS/pm2226.f,v $
     . $',                                                             '
     .$Id: pm2226.f,v 1.1 1995/09/17 18:52:23 dws Exp $
     . $' /
C    ===================================================================
C
C
