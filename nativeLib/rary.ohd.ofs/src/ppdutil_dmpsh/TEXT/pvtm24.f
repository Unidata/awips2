...
C @PROCESS LVL(77)
C
C  PGM: PVTM24(UNT,STA,IDTYP,JULDB,JULDE,IUNFLG,IMF,ICOND,
C  PGM:        DATA,RDATA,LDATA) .. SHEF-OUT TM24
C
C
...
C  =====================================================================
      SUBROUTINE PVTM24 (UNT,STA,IDTYP,JULDB,JULDE,IUNFLG,IMF,ICOND,
     *                  DATA,RDATA,LDATA)
C
C
C
...
C
      REAL      RDATA(LDATA)
      INTEGER   IDELT(1),ITYPER(1),NVPDT(1),STA(2),IDTYP
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/ppdutil_dmpsh/RCS/pvtm24.f,v $
     . $',                                                             '
     .$Id: pvtm24.f,v 1.1 1995/09/17 19:10:24 dws Exp $
     . $' /
C    ===================================================================
C
C
      ...
      DATA    ITM24,ROUTN / 4HTM24,4HPVTM,4H24   /
C
      DATA    IDOTA,LETE, LETZ, LETDH / 4H.A  ,4HE   ,4HZ   ,4HDH   /
      DATA    LETDU,ISLS, LETS, LETTM / 4HDU  ,4H/   ,4HS   ,4HTAIR /
...
C
        ...
        CALL UMOVEX (LETTM,1,LINE,32,4)
        CALL UMOVEX (LETXZ,1,LINE,36,3)
        CALL UMOVEX (ISLS,1,LINE,47,1)
        CALL UMOVEX (LETTM,1,LINE,48,4)
