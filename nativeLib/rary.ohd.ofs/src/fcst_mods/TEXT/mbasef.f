...
C
C
C   DESC - THIS SUBROUTINE PERFORMS THE BASEF MOD FOR THE BASEFLOW OPER
C   DESC -   SUBROUTINE MBFRAT PERFORMS THE BFRATE MOD FOR THE BASEFLOW
C   DESC -   SUBROUTINE MBASE2 CALLED FOR THE UNIT-HG OPERATION
C
C <><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
C
      SUBROUTINE MBASEF(MP,P,NCARDS,MODCRD,IIDATE,
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcst_mods/RCS/mbasef.f,v $
     . $',                                                             '
     .$Id: mbasef.f,v 1.3 1998/07/02 20:36:38 page Exp $
     . $' /
C    ===================================================================
C
C
...
C
      IMOD=1
C
      CALL FSTWHR(8HMBASEF  ,0,OLDOPN,IOLDOP)
C
C   SET DEBUG FLAG
C
      IBUG=IFBUG(4HMODS)+IFBUG(4HBASE)
C
