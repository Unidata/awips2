C MODULE MUCBAS
C
C     DESC - SUBROUTINE MUCBAS PERFORMS THE UCBASEF MOD
C
C  <><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
C
      SUBROUTINE MUCBAS(NCARDS,MODCRD,P,MP,IDATE,ISTATT,IHZERO)
C
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcst_mods/RCS/mucbas.f,v $
     . $',                                                             '
     .$Id: mucbas.f,v 1.2 1998/07/02 20:51:43 page Exp $
     . $' /
C    ===================================================================
C
C
...
C
      IMOD=1
C
      CALL FSTWHR(8HMUCBAS  ,0,OLDOPN,IOLDOP)
C
C     SET DEBUG SWITCH
C
      IBUG=IFBUG(4HMODS)+IFBUG(4HUCBA)
C
