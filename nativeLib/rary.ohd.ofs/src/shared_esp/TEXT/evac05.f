C MEMBER EVAC05
C  (from old member EEVAC05)
C
      SUBROUTINE EVAC05(IDACC,IHACC,LDACC,LHACC,D,A,NDAYS,NHRS,TSID,
     * TYPE,IDT,NPDT,ITSCAL,IVALUE,CO,KODE,VALUE,DAVG,MDAVG)
C
C ......................................................................
C
C      ACCUMULATOR 05 (MAX INSTANTANEOUS VALUE) SUBROUTINE
C
C THIS IS THE ACCUMULATOR SUBROUTINE FOR FINDING THE MAXIMUM INST
...
C     A = ACCUMULATOR ARRAY. A(1) IS MAX INST VAL, A(2)IS DAYS TO
C         MAX.
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/shared_esp/RCS/evac05.f,v $
     . $',                                                             '
     .$Id: evac05.f,v 1.1 1995/09/17 19:19:22 dws Exp $
     . $' /
C    ===================================================================
C
C
      DATA NAME,SBNAME/4HEACC,4HEVAC,4H05  /
      DATA INTL/4HINTL/
C
C
...
115   FORMAT(1H0,14HEVAC05 ENTERED)
      IBUG=IFBUG(NAME)
C
C
C CHECK A(1)
...
C AND MUST CHECK THAT A(1) IS NOT MISSING.
...
210   FORMAT(/ 1H0,30HA(1) = MAX INSTANTANEOUS VALUE /
...
899   FORMAT(1H0,45H**NOTE** EVAC05 ENCOUNTERED MISSING DATA FOR:,
...
2100  FORMAT(// 1H0,10X,12H** OUTPUT ** / 1H0,14HMAX INST VALUE,
     * 8H A(1) = ,F10.2 / 1H0,24HDAYS TO MAXIMUM, A(2) = ,5X,F10.2 //
