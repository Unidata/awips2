...
public class ContingencyValueRecord extends DbRecord
{
    private String lid;
    ...
    // Copy constructor
    //-----------------------------------------------------------------
    public ContingencyValueRecord(ContingencyValueRecord origRecord)
    {
    ...
    //-----------------------------------------------------------------
    //  get and set methods for all data items in a ContingencyValue record
...
} // end of ContingencyValueRecord class
