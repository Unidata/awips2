...
public class VTECpracticeTable extends DbTable
{
//-----------------------------------------------------------------
//  Private data
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
//  VTECpracticeTable() - constructor to set statement variable and initialize
//		number of records found to zero
//-----------------------------------------------------------------
    public VTECpracticeTable(Database database) 
    {
        //Constructor calls DbTable's constructor
        super(database);
        setTableName("vtecpractice");
    }


    //-----------------------------------------------------------------
    //  select() - this method is called with a where clause and returns
    //		a List of VTECpracticeRecord objects
    //-----------------------------------------------------------------
    public List select(String where) throws SQLException
    {
        ...
        String selectStatement = "SELECT * FROM vtecpractice " + where;
        ...
        while (rs.next())
        {
            // create an instance of a VTECpracticeRecord
            // and store its address in oneRecord
            record = new VTECpracticeRecord();

            // increment the number of records found
            _recordsFound++;

            // assign the data returned to the result set for one
            // record in the database to a VTECpracticeRecord object
            ...
            // add this VTECpracticeRecord object to the list
            recordList.add(record);
        }
        // Close the result set
        rs.close();

        // return a List which holds the VTECpracticeRecord objects
        return recordList;
    ...
    //		a List filled with a maximum of maxRecordCount of VTECpracticeRecord objects 
    //-----------------------------------------------------------------
...
//-----------------------------------------------------------------
//  insert() - this method is called with a VTECpracticeRecord object and..
//-----------------------------------------------------------------
    public int insert(VTECpracticeRecord record)  throws SQLException
    {
        int returnCode=-999;
...
" INSERT INTO vtecpractice VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?        )");
...
//-----------------------------------------------------------------
    public int delete(String where) throws SQLException
    {
        ...
        String deleteStatement = "DELETE FROM vtecpractice " + where;
...
//-----------------------------------------------------------------
//  update() - this method is called with a VTECpracticeRecord object and a where clause..
//-----------------------------------------------------------------
    public int update(VTECpracticeRecord record, String where)  throws SQLException
    {
        int returnCode=-999;
        // Create a SQL update statement and issue it
        // construct the update statement
        PreparedStatement updateStatement = getConnection().prepareStatement(
" UPDATE vtecpractice SET geoid = ?, product_id = ?, producttime = ?, productmode = ?, action = ?, office_id = ?, phenom = ?, signif = ?, etn = ?, begintime = ?, endtime = ?, severity = ?, immed_cause = ?, risetime = ?, cresttime = ?, falltime = ?, record = ?, risets = ?, crests = ?, fallts = ?, crest_value = ?, expiretime = ?        " + where );
...
//                   the number of records deleted
//-----------------------------------------------------------------
    public int delete(VTECpracticeRecord record) throws SQLException
    {
        int returnCode=-999;

        // Create a SQL delete statement and issue it
        // construct the delete statement
        String deleteStatement = "DELETE FROM vtecpractice " + record.getWhereString();
...
//  update() - this method is called with a VTECpracticeRecord object and a where clause..
//-----------------------------------------------------------------
    public int update(VTECpracticeRecord oldRecord, VTECpracticeRecord newRecord)  throws SQLException
    {
        int returnCode=-999;
        // Create a SQL update statement and issue it
        // construct the update statement
        PreparedStatement updateStatement = getConnection().prepareStatement(
" UPDATE vtecpractice SET geoid = ?, product_id = ?, producttime = ?, productmode = ?, action = ?, office_id = ?, phenom = ?, signif = ?, etn = ?, begintime = ?, endtime = ?, severity = ?, immed_cause = ?, risetime = ?, cresttime = ?, falltime = ?, record = ?, risets = ?, crests = ?, fallts = ?, crest_value = ?, expiretime = ?        " + oldRecord.getWhereString() );
...
//-----------------------------------------------------------------
//  insertOrUpdate() - this method is call with a VTECpracticeRecord object.
//                   the number of records inserted or updated
//-----------------------------------------------------------------
    public int insertOrUpdate(VTECpracticeRecord record) throws SQLException
    {
        int returnCode=-999;
        ...
        {
            VTECpracticeRecord oldRecord = (VTECpracticeRecord) recordList.get(0);
            returnCode = update(oldRecord, record);
        }
        return returnCode;
    } // end of insertOrUpdate() 
} // end of VTECpracticeTable class
