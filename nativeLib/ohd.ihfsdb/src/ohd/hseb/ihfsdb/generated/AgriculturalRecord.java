...
public class AgriculturalRecord extends DbRecord
{
    private String lid;
    ...
    // Copy constructor
    //-----------------------------------------------------------------
    public AgriculturalRecord(AgriculturalRecord origRecord)
    {
    ...
    //-----------------------------------------------------------------
    //  get and set methods for all data items in a Agricultural record
...
} // end of AgriculturalRecord class
