...
public class EvaporationRecord extends DbRecord
{
    private String lid;
    ...
    // Copy constructor
    //-----------------------------------------------------------------
    public EvaporationRecord(EvaporationRecord origRecord)
    {
    ...
    //-----------------------------------------------------------------
    //  get and set methods for all data items in a Evaporation record
...
} // end of EvaporationRecord class
