...
public class DpaAdaptRecord extends DbRecord
{
    ...
    private float beam_width;

    private float blockage_thresh;

    private float clutter_thresh;

    private float weight_thresh;

    private float hybrid_scan_thresh;

    private float low_reflect_thresh;

    private float detect_reflect_thr;

    private float detect_area_thresh;

    private float detect_time_thresh;

    private float exclusion_zones;
    ...
    // Copy constructor
    //-----------------------------------------------------------------
    public DpaAdaptRecord(DpaAdaptRecord origRecord)
    {
        ...
        setBeam_width(origRecord.getBeam_width());
        setBlockage_thresh(origRecord.getBlockage_thresh());
        setClutter_thresh(origRecord.getClutter_thresh());
        setWeight_thresh(origRecord.getWeight_thresh());
        setHybrid_scan_thresh(origRecord.getHybrid_scan_thresh());
        setLow_reflect_thresh(origRecord.getLow_reflect_thresh());
        setDetect_reflect_thr(origRecord.getDetect_reflect_thr());
        setDetect_area_thresh(origRecord.getDetect_area_thresh());
        setDetect_time_thresh(origRecord.getDetect_time_thresh());
        setExclusion_zones(origRecord.getExclusion_zones());
    ...
    //-----------------------------------------------------------------
    //  get and set methods for all data items in a DpaAdapt record
    ...
    public float getBlockage_thresh()
    {
        return blockage_thresh;
    }

    public void setBlockage_thresh(float blockage_thresh)
    {
        this.blockage_thresh = blockage_thresh ;
    }

    public float getClutter_thresh()
    {
        return clutter_thresh;
    }

    public void setClutter_thresh(float clutter_thresh)
    {
        this.clutter_thresh = clutter_thresh ;
    }

    public float getWeight_thresh()
    {
        return weight_thresh;
    }

    public void setWeight_thresh(float weight_thresh)
    {
        this.weight_thresh = weight_thresh ;
    }

    public float getHybrid_scan_thresh()
    {
        return hybrid_scan_thresh;
    }

    public void setHybrid_scan_thresh(float hybrid_scan_thresh)
    {
        this.hybrid_scan_thresh = hybrid_scan_thresh ;
    }

    public float getLow_reflect_thresh()
    {
        return low_reflect_thresh;
    }

    public void setLow_reflect_thresh(float low_reflect_thresh)
    {
        this.low_reflect_thresh = low_reflect_thresh ;
    }

    public float getDetect_reflect_thr()
    {
        return detect_reflect_thr;
    }

    public void setDetect_reflect_thr(float detect_reflect_thr)
    {
        this.detect_reflect_thr = detect_reflect_thr ;
    }

    public float getDetect_area_thresh()
    {
        return detect_area_thresh;
    }

    public void setDetect_area_thresh(float detect_area_thresh)
    {
        this.detect_area_thresh = detect_area_thresh ;
    }

    public float getDetect_time_thresh()
    {
        return detect_time_thresh;
    }

    public void setDetect_time_thresh(float detect_time_thresh)
    {
        this.detect_time_thresh = detect_time_thresh ;
    }

    public float getExclusion_zones()
    {
        return exclusion_zones;
    }

    public void setExclusion_zones(float exclusion_zones)
    {
...
//-----------------------------------------------------------------
    public String toString()
    {
        String outString = 
                ...
                getClutter_thresh() + " " +
                getWeight_thresh() + " " +
                getHybrid_scan_thresh() + " " +
                getLow_reflect_thresh() + " " +
                getDetect_reflect_thr() + " " +
                getDetect_area_thresh() + " " +
                getDetect_time_thresh() + " " +
                getExclusion_zones() + " " +
                getMax_stmspd() + " " +
                getMax_timdif() + " " +
                getMin_artcon() + " " +
