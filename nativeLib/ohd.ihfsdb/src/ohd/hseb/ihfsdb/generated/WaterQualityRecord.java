...
public class WaterQualityRecord extends DbRecord
{
    private String lid;
    ...
    // Copy constructor
    //-----------------------------------------------------------------
    public WaterQualityRecord(WaterQualityRecord origRecord)
    {
    ...
    //-----------------------------------------------------------------
    //  get and set methods for all data items in a WaterQuality record
...
} // end of WaterQualityRecord class
