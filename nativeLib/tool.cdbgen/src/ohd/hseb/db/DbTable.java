...
// -------------------------------------------------------------------------------------------
    ...
    //   -------------------------------------------------------------------------------------------
	public void setDateOld(PreparedStatement statement, int index, long value) throws SQLException
	{
	    if (isNull(value))
	    {
    ...
    public void setDate(PreparedStatement statement, int index, long value) throws SQLException
    {
        if (isNull(value))
        {
            statement.setNull(index, Types.DATE);
    ...
    public void setTimeStamp(PreparedStatement statement, int index, long value) throws SQLException
    {
       ...
       //setTimeStampByValueWithCalendar(statement, index, value);
        ...
        // passes unit test
       setTimeStampByValueWithCalendarButWithoutSettingCalendarTime(statement, index, value);
    ...
    private void setTimeStampByString(PreparedStatement statement, int index, long value) throws SQLException
    {
        ...
        {                
            String dateTimeString = DbTimeHelper.getDateTimeStringFromLongTime(value);     
    ...
    private void setTimeStampByValueWithoutCalendar(PreparedStatement statement, int index, long value) throws SQLException
    {
    ...
    private void setTimeStampByValueWithCalendar(PreparedStatement statement, int index, long value) throws SQLException
    {
    ...
    private void setTimeStampByValueWithCalendarButWithoutSettingCalendarTime(PreparedStatement statement, int index, long value) throws SQLException
    {
    ...
    public void setTime(PreparedStatement statement, int index, long value) throws SQLException
    {
        if (isNull(value))
        {
    ...
    public void setString(PreparedStatement statement, int index, String value) throws SQLException
    {
    ...
    public void setArray(PreparedStatement statement, int index, String value) throws SQLException
    {
        //statement.setString(index, value);
    ...
    public void setBytes(PreparedStatement statement, int index, byte[] value) throws SQLException
    {
        if (isNull(value))
        {
    ...
    public void setInt(PreparedStatement statement, int index, int value) throws SQLException
    {
        if (isNull(value))
        {
    ...
    // -------------------------------------------------------------------------------------------
    public void setLong(PreparedStatement statement, int index, long value) throws SQLException
    {
        if (isNull(value))
        {
    ...
    // -------------------------------------------------------------------------------------------
    public void setShort(PreparedStatement statement, int index, short value) throws SQLException
    {
        if (isNull(value))
        {
    ...
    // -------------------------------------------------------------------------------------------
    public void setDouble(PreparedStatement statement, int index, double value) throws SQLException
    {
        if (isNull(value))
        {
    ...
    // -------------------------------------------------------------------------------------------
    public void setFloat(PreparedStatement statement, int index, float value) throws SQLException
    {
        if (isNull(value))
        {
    ...
    // -------------------------------------------------------------------------------------------
    public void setReal(PreparedStatement statement, int index, float value) throws SQLException
    {
        if (isNull(value))
        {
        ...
        {     
            statement.setFloat(index, value); //intentionally set to setFloat, since setReal does not exist
        }
    ...
    {
        return Float.MIN_VALUE;    //real maps to float 
    }
