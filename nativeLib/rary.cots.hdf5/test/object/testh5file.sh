...
/common/awips/jdk1.6.0_05/bin/java -Djava.library.path=$LD_LIBRARY_PATH -Dncsa.hdf.hdf5lib.H5.hdf5lib=$LIBDIR"/linux/libjh4toh5.so" test.object.TestH5File vg_all_test.h5
