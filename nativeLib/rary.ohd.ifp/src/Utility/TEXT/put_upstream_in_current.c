...

{
  ...
  (unsigned char **)&segment_name
     ...
     {
      printf("upstream_segment window property not found - quit\n");
      exit(1);
     }

/*  ==============  Statements containing RCS keywords:  */
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/ifp/src/Utility/RCS/put_upstream_in_current.c,v $";
 static char rcs_id2[] = "$Id: put_upstream_in_current.c,v 1.2 2006/04/07 17:00:11 aivo Exp $";}
/*  ===================================================  */
