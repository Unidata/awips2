...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/ifp/src/IFP_Map/RCS/hrap.c,v $";
 static char rcs_id2[] = "$Id: hrap.c,v 1.1 1995/09/08 14:55:31 page Exp $";}
/*  ===================================================  */
