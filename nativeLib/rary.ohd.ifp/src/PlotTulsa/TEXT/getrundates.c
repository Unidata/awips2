 ...
 * *
 * getrundates(istrhr, ilcdhr, iendhr, isdahr, first_time) :
 *
...
void getrundates(istrhr, ilcdhr, iendhr, isdahr, first_time)
...
if((*first_time)++ < 1)
{
   global_toplevel = XtInitialize("tulplot",
				    "Forecast_Program",
				    NULL, 0, &argc, argv);
}
  ...
  &&
   (XGetWindowProperty
  ...
  )       /*  end logical expression of if statement  */
    {
      ...
      * Pass the month, day, year, hour, and time zone to fcitzc and julda,
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob72/rfc/ifp/src/PlotTulsa/RCS/getrundates.c,v $";
 static char rcs_id2[] = "$Id: getrundates.c,v 1.5 2006/03/28 20:43:50 aivo Exp $";}
/*  ===================================================  */
