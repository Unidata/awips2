...
C
      SUBROUTINE LOCATE (IMO,IYR,LMO,LYR,UNITS,FILEN,TYPE,IT,STAID,
     *     DESCRP,NXREAD,ISEQ)
C
C    ================================= RCS keyword statements ==========
      CHARACTER*68     RCSKW1,RCSKW2
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/calb/src/rdwt3/RCS/locate.f,v $
     . $',                                                             '
     .$Id: locate.f,v 1.1 1996/05/24 16:34:23 dws Exp $
     . $' /
C    ===================================================================
C
C
