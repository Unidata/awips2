C MODULE UPRIMO_MAT
C  =====================================================================
C  pgm: UPRIMO_MAT .. Initialize unit numbers for program "mat"
C
C  use:     CALL UPRIMO_MAT()
C  =====================================================================
      SUBROUTINE UPRIMO_MAT()
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/calb/src/mat/RCS/uprimo_mat.f,v $
     . $',                                                             '
     .$Id: uprimo_mat.f,v 1.4 2002/02/11 18:55:47 dws Exp $
     . $' /
C    ===================================================================
C
