...
C
      FUNCTION ISBUG (CODE)
C
C  ROUTINE TO SET DEBUG LEVEL FOR THE SPECIFIED 4-CHARACTER
C  DEBUG CODE.
C
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/shared_s/RCS/isbug.f,v $
     . $',                                                             '
     .$Id: isbug.f,v 1.1 1995/09/17 19:20:15 dws Exp $
     . $' /
C    ===================================================================
C
C
...
60    ISBUG=ISLDBG(ICODE)
C
70    IF (LDEBUG.GT.0) WRITE (IOSDBG,110) ISBUG
...
110   FORMAT (' *** EXIT ISBUG : ISBUG=',I2)
C
      END
