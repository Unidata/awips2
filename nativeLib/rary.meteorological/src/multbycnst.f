c
c
	subroutine mult_by_cnst(a,const,result,mni,ni,nj)
c
c..... 	Routine to multiply an array by a real constant.  Each i,j in the 
c.....	array is multiplied by the constant. 
c
