/*=========================================================================*/
/*                         FILE NAME:   display_min_temp_prism.c           */
/*                                                                         */
/*  FUNCTIONS CONTAINED IN THIS FILE:   display_min_temp_prism_RFCW        */
...
/***************************************************************************/
/*  FUNCTION NAME:   display_min_temp_prism_RFCW ( )                       */
...
************************************** BEGIN display_min_temp_prism_RFCW ****/

void display_min_temp_prism_RFCW ( Widget w , 
                                   ...
                                   XtPointer calldata ) 
{
   ...
   if (XmToggleButtonGetState (mpeClimo[ MonthlyMinTempItem]))
   {
      ...
      XmToggleButtonSetState(mpeClimo[ MonthlyMinTempItem ],True,False); 
  
      display_min_temp_prism ( * map_number ) ;
   }
   else
   {
...
/***************************************************************************/
/*  FUNCTION NAME:   display_min_temp_prism()                             */
...
void display_min_temp_prism( int map_number )
{
 ...
 /*----------------------------------------------------------------------*/
 mSetCursor ( M_WATCH ) ;
 rad_data[ map_number ].field_type = display_mintempPrism;

 strcpy(cv_use,"MIN_TEMP_PRISM");
 strcpy(rad_data[map_number].cv_use,"MIN_TEMP_PRISM");
 cv_duration = 0;
...
/*----------------------------------*/
 ...
 if ( first == 1 )
 {
    /* Load and store the token values required to build the PRISM
       file path. */
 ...
 sprintf ( fname, "%s/prism_min_temp_%s_%s", dirname, mpe_site_id,
                  month_name );
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob82/ohd/pproc_lib/src/MPEGui/RCS/display_min_temp_prism.c,v $";
 static char rcs_id2[] = "$Id: display_min_temp_prism.c,v 1.4 2007/07/11 16:53:28 lawrence Exp $";}
/*  ===================================================  */

}
/************************************* END display_min_temp_prism **********/
