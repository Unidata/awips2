...
static void  read_station_file ( )
{
   ...
   getAppsDefaults ( rfcwide_gageloc_dir_token, station_dir ); 
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob83/ohd/pproc_lib/src/MPEGui/RCS/get_loc_latlon.c,v $";
 static char rcs_id2[] = "$Id: get_loc_latlon.c,v 1.3 2007/10/16 13:36:13 varmar Exp $";}
/*  ===================================================  */
