/*=========================================================================*/
/*                         FILE NAME:   display_lmosaic.c                  */
/*                                                                         */
/*  FUNCTIONS CONTAINED IN THIS FILE:   display_lmosaic                    */
/*=========================================================================*/
...
/***************************************************************************/
/*  FUNCTION NAME:   display_lmosaic_RFCW()                                 */
/*       FUNCTION:   A X/Motif wrapper around the "display_lmosaic"         */
                            ...
                            XtPointer calldata ) 
{
   ...
   display_lmosaic ( * map_number ) ;
}


/***************************************************************************/
/*  FUNCTION NAME:   display_lmosaic()                                     */
/*       FUNCTION:   display lmosaic value                                 */
/***************************************************************************
...
Called by function:
   callback from LMosaic button (under Display)
...
void display_lmosaic( int map_number )
{
 ...
 rad_data [ map_number ].field_type = display_lMosaic ;

 strcpy(cv_use,"LMOSAIC");
 strcpy(rad_data[map_number].cv_use,"LMOSAIC");
 cv_duration = 3600;
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob82/ohd/pproc_lib/src/MPEGui/RCS/display_lmosaic.c,v $";
 static char rcs_id2[] = "$Id: display_lmosaic.c,v 1.11 2007/07/12 19:08:52 lawrence Exp $";}
/*  ===================================================  */
