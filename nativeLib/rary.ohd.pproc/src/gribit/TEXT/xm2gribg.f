c  =====================================================================
c  pgm:  xm2gribg (iutw,iupr,iud,xver,user,proces,isearch,ivalhr,
...
c  =====================================================================
c
      subroutine xm2gribg (iutw,iupr,iud,xver,user,proces,isearch,
     +          ivalhr,imo,ida,iyr,ihr,imn,
...
c
c.......................................................................
c  xm2grib Initially written by
c       Tim Sweeney, HRL                                 Jan 2000
c
c  Adapted by
c       David T. Miller, RSIS, OHD/HSEB                  Nov 2007
c       only a few debugging statements added for more 
c       processes and cleaned up block formatting which was
c       a bit difficult to read
c.......................................................................
c
c
      include 'xmrg_tbl'
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob82/ohd/pproc/src/gribit/RCS/xm2grib.f,v $
     . $',                                                             '
     .$Id: xm2grib.f,v 1.1 2006/10/19 16:06:04 dsa Exp $
     . $' /
C    ===================================================================
C
...
c
      if (ibug.eq.1) write (iutw,*) 'in xm2gribg - senof=',senof
