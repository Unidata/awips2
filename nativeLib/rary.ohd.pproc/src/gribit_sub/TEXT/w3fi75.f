      SUBROUTINE W3FI75_SUB (IBITL,ITYPE,ITOSS,FLD,IFLD,IBMAP,IBDSFL,
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob81/ohd/pproc/src/gribit_sub/RCS/w3fi75.f,v $
     . $',                                                             '
     .$Id: w3fi75.f,v 1.1 2006/10/19 16:06:04 dsa Exp $
     . $' /
C    ===================================================================
C
C
...
C
      RETURN
      END
      SUBROUTINE FI7501_SUB (IWORK,IPFLD,NPTS,IBDSFL,BDS11,
     *           LEN,LENBDS,PDS,REFNCE,ISCAL2,KWIDE)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C                .      .    .                                       .
...
C
      RETURN
      END
      SUBROUTINE FI7502_SUB (IWORK,ISTART,NPTS,ISAME)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C                .      .    .                                       .
...
C  -------------------------------------------------------------
  ...
  100 CONTINUE
      RETURN
      END
      SUBROUTINE FI7503_SUB (IWORK,IPFLD,NPTS,IBDSFL,BDS11,
     *           LEN,LENBDS,PDS,REFNCE,ISCAL2,KWIDE,IGDS)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C                .      .    .                                       .
...
C
 ...
 1000 CONTINUE
      RETURN
      END
      SUBROUTINE FI7513_SUB (IWORK,ISTART,NPTS,MAX,MIN,INRNGE)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C                .      .    .                                       .
...
C                           GET NEXT BLOCK A
 9000 CONTINUE
      RETURN
      END
      SUBROUTINE FI7516_SUB (IWORK,NPTS,INRNG,ISTART,MAX,MIN,MXVAL,LWIDTH)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C                .      .    .                                       .
...
C             PRINT *,'RETURNED',INRNG,' VALUES'
 ...
 9000 CONTINUE
      RETURN
      END
      SUBROUTINE FI7517_SUB (IRET,IWORK,NPTS,ISTRTB,INRNGA,
     *                           MAXB,MINB,MXVALB,LWIDEB)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C                .      .    .                                       .
...
C
 9000 CONTINUE
      RETURN
      END
      SUBROUTINE FI7518_SUB (IRET,IWORK,NPTS,ISTRTA,INRNGA,INRNGB,
