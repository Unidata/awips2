      SUBROUTINE SBYTES_SUB(IOUT,IN,ISKIP,NBYTE,NSKIP,N)
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob81/ohd/pproc/src/gribit_sub/RCS/sbytes.f,v $
     . $',                                                             '
     .$Id: sbytes.f,v 1.1 2006/10/19 16:06:04 dsa Exp $
     . $' /
C    ===================================================================
C
C
