      SUBROUTINE W3FI63_SUB(MSGA,KPDS,KGDS,KBMS,DATA,KPTR,KRET)
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob81/ohd/pproc/src/gribit_sub/RCS/w3fi63.f,v $
     . $',                                                             '
     .$Id: w3fi63.f,v 1.1 2006/10/19 16:06:04 dsa Exp $
     . $' /
C    ===================================================================
C
C  *****************************************************************
...
C
  900 RETURN
      END
      SUBROUTINE FI631_SUB(MSGA,KPTR,KPDS,KRET)
C$$$  SUBPROGRAM DOCUMENTATION  BLOCK
C                .      .    .                                       .
...
C     PRINT *,'KPTR',(KPTR(I),I=1,16)
      RETURN
      END
      SUBROUTINE FI632_SUB(MSGA,KPTR,KPDS,KRET)
C$$$  SUBPROGRAM DOCUMENTATION  BLOCK
C                .      .    .                                       .
...
C                         PRINT *,' W/NMC42)'
      ...
      RETURN
      END
      SUBROUTINE FI633_SUB(MSGA,KPTR,KGDS,KRET)
C$$$  SUBPROGRAM DOCUMENTATION  BLOCK
C                .      .    .                                       .
...
C
  ...
  910     CONTINUE
      ...
      RETURN
      END
      SUBROUTINE FI634_SUB(MSGA,KPTR,KPDS,KGDS,KBMS,KRET)
C$$$  SUBPROGRAM DOCUMENTATION  BLOCK
C                .      .    .                                       .
...
C     PRINT *,'EXIT FI634'
      ...
      END
C-----------------------------------------------------------------------
      SUBROUTINE FI634X_SUB(NPTS,NSKP,MSGA,KBMS)
C$$$  SUBPROGRAM DOCUMENTATION  BLOCK
C                .      .    .                                       .
...
C - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      END
      SUBROUTINE FI635_SUB(MSGA,KPTR,KPDS,KGDS,KBMS,DATA,KRET)
C$$$  SUBPROGRAM DOCUMENTATION  BLOCK
C                .      .    .                                       .
...
C     PRINT *,'EXIT FI635'
      RETURN
      END
      SUBROUTINE FI636_SUB (DATA,MSGA,KBMS,REFNCE,KPTR,KPDS,KGDS)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C                .      .    .                                       .
...
C     PRINT *,'EXIT FI636'
      RETURN
      END
      SUBROUTINE FI637_SUB(J,KPDS,KGDS,KRET)
C$$$  SUBPROGRAM DOCUMENTATION  BLOCK
C                .      .    .                                       .
