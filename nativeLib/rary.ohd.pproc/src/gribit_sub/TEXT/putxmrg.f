...
c  =====================================================================
c
      subroutine putxmrg_sub (iuout,iudm,ibug,sdatim,fld,kptr,kpds,
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob81/ohd/pproc/src/gribit_sub/RCS/putxmrg.f,v $
     . $',                                                             '
     .$Id: putxmrg.f,v 1.1 2006/10/19 16:06:04 dsa Exp $
     . $' /
C    ===================================================================
C
