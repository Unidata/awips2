      SUBROUTINE W3FI74_SUB (IGDS,ICOMP,GDS,LENGDS,NPTS,IGERR)
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob81/ohd/pproc/src/gribit_sub/RCS/w3fi74.f,v $
     . $',                                                             '
     .$Id: w3fi74.f,v 1.1 2006/10/19 16:06:04 dsa Exp $
     . $' /
C    ===================================================================
C
C
