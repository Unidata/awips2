...
c  =====================================================================
      subroutine ungrib2sub (iupr,iud,ibug,nd5,ipack,mfld,fld,L3264B,ier)
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob81/ohd/pproc/src/gribit_sub/RCS/ungrib2.f,v $
     . $',                                                             '
     .$Id: ungrib2.f,v 1.1 2006/10/19 16:06:04 dsa Exp $
     . $' /
C    ===================================================================
C
      data blnk/ ' ' /
