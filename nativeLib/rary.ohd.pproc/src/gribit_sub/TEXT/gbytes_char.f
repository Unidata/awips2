      SUBROUTINE GBYTEC_SUB(IN,IOUT,ISKIP,NBYTE)
      character*1 in(*)
      integer iout(*)
C
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob81/ohd/pproc/src/gribit_sub/RCS/gbytes_char.f,v $
     . $',                                                             '
     .$Id: gbytes_char.f,v 1.1 2006/10/19 16:06:04 dsa Exp $
     . $' /
C    ===================================================================
C
      CALL GBYTESC_SUB(IN,IOUT,ISKIP,NBYTE,0,1)
      RETURN
      END

      SUBROUTINE SBYTEC_SUB(OUT,IN,ISKIP,NBYTE)
      character*1 out(*)
      integer in(*)
      CALL SBYTESC_SUB(OUT,IN,ISKIP,NBYTE,0,1)
      RETURN
      END

      SUBROUTINE GBYTESC_SUB(IN,IOUT,ISKIP,NBYTE,NSKIP,N)
