                 ...
                 int *    radarAvailFlag)
{
    ...
    *radarAvailFlag = 0 ;
    ...
    /*
     * read record from DHRRadar table
     */

    readDHRRadar(radarID, datetime, dhr_wind,
                 &prev_bias, &post_bias,
    ...
    else if(status == 0)
    {
        if( (prev_offset == 0) && (post_offset == 0) )
        {
            *radarAvailFlag = 1 ;
            ...
            readDecodedDHR(prev_filename, prev_radar, &status);
                 ...
                 (post_offset < INT_MAX))
        {
            *radarAvailFlag = 1 ;
            ...
            readDecodedDHR(post_filename, post_radar, &status);
