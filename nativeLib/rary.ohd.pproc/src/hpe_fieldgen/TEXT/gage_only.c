...
void gage_only(const geo_data_struct * pGeoData ,
               ...
               int * errFlag)
{
    ...
    /*
     * consider HRAP and quarter HRAP cases
     * -- gzhou 01-2007
     */
     ...
     **/
    double cvg ;
    coef_var_g(gageSize, zg, rain_min, &cvg, errFlag) ;
            ...
            else
            {
                ...
                else
                {
                    ...
                    if(itype == 1)
                    {
                         ...
                         * perform RDS.
                         **/
                        go_rds(rowSize, colSize, isrch_g, nbrs_g,
                    ...
                    else
                    {
                        ...
                        go_soe(rowSize, colSize, isrch_g, cvg,
...
void go_rds(const int rowSize , const int colSize ,
...
void go_soe(const int rowSize , const int colSize ,
            ...
            double * est)
{
    ...
    **/
    ...
    if(f0 < 1.0)
    {
        ...
        **/
        covmatgo(isrch_g, 1.0, nbrs_g, dist_min, cor0pi, cor0i,
            rngi, iug, ivg, ilist_g, covi) ;

        /**
         * construct indicator correlation vector
         **/
        covvecgo(isrch_g, i, j, 1.0, nbrs_g, dist_min, cor0pi,
     ...
     * construct conditional correlation matrix
     **/
    covmatgo(isrch_g, 1.0, nbrs_g, dist_min, cor0pc, cor0c,
        rngc, iug, ivg, ilist_g, cov) ;

    /**
     * construct indicator correlation vector
     **/
    covvecgo(isrch_g, i, j, 1.0, nbrs_g, dist_min, cor0pc,
...
void covmatgo(const int isrch_g , const double varg, 
...
void covvecgo(const int isrch_g , const int iu0, const int iv0, 
