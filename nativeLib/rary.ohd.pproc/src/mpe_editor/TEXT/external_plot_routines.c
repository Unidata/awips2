                            ...
                            Boolean * fillarea )
{
   ...
   * seg = NULL ;
   ...
   { 
      ...
      if ( points == NULL )
      {
         flogMessage ( stderr , "In routine _plot_binfile_basins:\n"
                            ...
                            Boolean * fillarea )
{
   ...
   * seg = NULL ;
   ...
   {   
      ...
      if ( points == NULL )
      {
         flogMessage ( stderr , "In routine _plot_binfile_lakes:\n"
                        "attempt to malloc memory failed.\n" ) ;
         * seg = NULL ;
         return ;
      }
   ...
   * seg = NULL ;
   ...
   {  
      ...
      {   
         ...
         if ( points == NULL )
         {
            flogMessage ( stderr , "In routine _plot_binfile_streams:\n"
                        "attempt to malloc memory failed.\n" ) ;
            * seg = NULL ;
            return ;
         }
   ...
   * seg = NULL ;
   ...
   if ( overlay == M_HIGHWAYS )
   {
      ...
      {   
         ...
         if ( points == NULL )
         {
            flogMessage ( stderr , "In routine _plot_binfile_hiways_roads:\n"
                        "attempt to malloc memory failed.\n" ) ;
            * seg = NULL ;
            return ;
         }
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob83/ohd/pproc/src/mpe_editor/RCS/external_plot_routines.c,v $";
 static char rcs_id2[] = "$Id: external_plot_routines.c,v 1.6 2007/02/28 13:25:43 lawrence Exp $";}
/*  ===================================================  */
