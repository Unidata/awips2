...
*
* Description:
* Contains routine for inserting a record into the DHRAdapt table.
*
* Modules:
* wrtodb_DHRAdapt
*
...
*
* Description:
*   This subroutine inserts a record into the DHRAdapt table.
*
*    calling function: decodeDPA
*
* Calling Arguments:
* Name         Input/Output Type          Description
* obstime      Input        char[22]      The obstime string
                     ...
                     const char param46[2])
{
    ...
    if(status != 0)
    {
        ...
        printf("-- record not written to DHRAdapt table\n");
        return;
    }
