...
********************************************************************************
*/
void MPEFieldGen_readRWBiasStat ( RWBiasStat * pRWBiasStat, 
                      const char * site_id,
                      long int * ircbia )
{
   ...
   * ircbia = 0 ;
   ...
   sprintf ( where_clause, "WHERE office_id = '%s'", site_id ); 
   
   sprintf  ( message, "SELECT * from RWBiasStat %s\n", where_clause );
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob83/ohd/pproc_lib/src/MPEFieldGen/RCS/read_rwbiasstat.c,v $";
 static char rcs_id2[] = "$Id: read_rwbiasstat.c,v 1.1 2007/10/15 12:19:13 dsa Exp $";}
/*  ===================================================  */
