...
* functions called: read_rwbiasdyn2, gageRadarPairsQC,
                    ...
                    double * memSpanBias )
{
    ...
    MPEFieldGen_read_rwbiasdyn2(radarID, pMPEParams->fxa_local_site, datetime,
    ...
    *meanBias = 1.0 ;
    ...
    MPEFieldGen_write_rwbiasdyn(radarID, pMPEParams->fxa_local_site, datetime,
...
{static char rcs_id1[] = "$Source: /fs/hseb/ob83/ohd/pproc_lib/src/MPEFieldGen/RCS/calculate_mean_bias.c,v $";
 static char rcs_id2[] = "$Id: calculate_mean_bias.c,v 1.1 2007/10/15 12:19:06 dsa Exp lawrence $";}
/*  ===================================================  */
