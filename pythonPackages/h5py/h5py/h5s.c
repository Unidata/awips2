/* Generated by Cython 0.12 on Sun Mar 14 21:50:24 2010 */
...
/* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":111
 * IF H5PY_18API:
 * 
 *     def decode(buf):             # <<<<<<<<<<<<<<
 *         """(STRING buf) => SpaceID
...
static PyObject *__pyx_pf_4h5py_3h5s_decode(PyObject *__pyx_self, PyObject *__pyx_v_buf) {
  ...
  /* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":117
 *         Python pickling machinery to do this.
 *         """
 *         cdef char* buf_ = buf             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":118
 *         """
 *         cdef char* buf_ = buf
 *         return SpaceID(H5Sdecode(buf_))             # <<<<<<<<<<<<<<
 * 
...
/* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":164
 *     IF H5PY_18API:
 * 
 *         def encode(self):             # <<<<<<<<<<<<<<
 *             """() => STRING
...
static PyObject *__pyx_pf_4h5py_3h5s_7SpaceID_encode(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":170
 *             can also use the native Python pickling machinery to do this.
 *             """
 *             cdef void* buf = NULL             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":171
 *             """
 *             cdef void* buf = NULL
 *             cdef size_t nalloc = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":173
 *             cdef size_t nalloc = 0
 * 
 *             H5Sencode(self.id, NULL, &nalloc)             # <<<<<<<<<<<<<<
 *             buf = emalloc(nalloc)
 ...
 */
  ...
  /* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":174
 * 
 *             H5Sencode(self.id, NULL, &nalloc)
 *             buf = emalloc(nalloc)             # <<<<<<<<<<<<<<
 *             try:
 ...
 */
  __pyx_t_1 = __pyx_f_4h5py_5utils_emalloc(__pyx_v_nalloc); if (unlikely(__pyx_t_1 == NULL && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 174; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_buf = __pyx_t_1;

  /* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":175
 *             H5Sencode(self.id, NULL, &nalloc)
 *             buf = emalloc(nalloc)
 *             try:             # <<<<<<<<<<<<<<
 *                 H5Sencode(self.id, buf, &nalloc)
 ...
 */
  /*try:*/ {
    ...
    /* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":176
 *             buf = emalloc(nalloc)
 *             try:
 *                 H5Sencode(self.id, buf, &nalloc)             # <<<<<<<<<<<<<<
 *                 pystr = PyString_FromStringAndSize(<char*>buf, nalloc)
 ...
 */
    ...
    /* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":177
 *             try:
 *                 H5Sencode(self.id, buf, &nalloc)
 *                 pystr = PyString_FromStringAndSize(<char*>buf, nalloc)             # <<<<<<<<<<<<<<
 *             finally:
 *                 efree(buf)
 */
    __pyx_t_2 = PyString_FromStringAndSize(((char *)__pyx_v_buf), __pyx_v_nalloc); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 177; __pyx_clineno = __LINE__; goto __pyx_L6;}
    __Pyx_GOTREF(__pyx_t_2);
  ...
  /*finally:*/ {
    ...
    /* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":179
 *                 pystr = PyString_FromStringAndSize(<char*>buf, nalloc)
 *             finally:
 *                 efree(buf)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":181
 *                 efree(buf)
 * 
 *             return pystr             # <<<<<<<<<<<<<<
 * 
...
/* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":187
 * 
 * 
 *         def __reduce__(self):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_4h5py_3h5s_7SpaceID___reduce__(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":188
 * 
 *         def __reduce__(self):
 *             return (type(self), (-1,), self.encode())             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = ((PyObject *)__Pyx_Type(__pyx_v_self)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 188; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_3 = PyObject_GetAttr(__pyx_v_self, __pyx_n_s__encode); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 188; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
...
/* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":191
 * 
 * 
...
static PyObject *__pyx_pf_4h5py_3h5s_7SpaceID___setstate__(PyObject *__pyx_v_self, PyObject *__pyx_v_state) {
  ...
  /* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":192
 * 
 *         def __setstate__(self, state):
 *             cdef char* buf = state             # <<<<<<<<<<<<<<
 *             self.id = H5Sdecode(buf)
 ...
 */
  ...
  /* "/home/tachyon/slave/unix-release/build/h5py/h5s.pyx":193
 *         def __setstate__(self, state):
 *             cdef char* buf = state
 *             self.id = H5Sdecode(buf)             # <<<<<<<<<<<<<<
 * 
