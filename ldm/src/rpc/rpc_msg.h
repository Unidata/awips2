...
#include "auth.h"	/* struct opaque_auth */
#include "clnt.h"	/* struct rpc_err */
 ...
 * 	struct rpc_msg *cmsg;
 */
#define xdr_callmsg	my_xdr_callmsg
 ...
 * 	struct rpc_msg *cmsg;
 */
#define xdr_callhdr	my_xdr_callhdr
 ...
 * 	struct rpc_msg *rmsg;
 */
#define xdr_replymsg	my_xdr_replymsg
 ...
 */
#define _seterr_reply	my__seterr_reply
