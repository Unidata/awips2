# Raytheon: System Manager's Manual (13.4.1)
...
<!---
 Use the 'view=fit' parameter because this pdf contains some pages that are landscape, so without the flag, the portrait pages are offcentered.
-->
