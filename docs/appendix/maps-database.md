...
|the_geom_0|geometry(POINT,4326)|


## mapdata.alaska_marine
|   Column   |            Type             |
|------------|-----------------------------|
|id|character varying()|
|wfo|character varying()|
...
|the_geom_0|geometry(MULTILINESTRING,4326)|
|the_geom_0_064|geometry(MULTILINESTRING,4326)|
|the_geom_0_016|geometry(MULTILINESTRING,4326)|
|the_geom_0_004|geometry(MULTILINESTRING,4326)|
|the_geom_0_001|geometry(MULTILINESTRING,4326)|
...
|name|character varying(30)|
|route|character varying(25)|
|hwy_symbol|character varying(50)|
|the_geom|geometry(MULTILINESTRING,4326)|
|the_geom_0|geometry(MULTILINESTRING,4326)|
|the_geom_0_064|geometry(MULTILINESTRING,4326)|
|the_geom_0_016|geometry(MULTILINESTRING,4326)|
...
|------------|-----------------------------|
|objectid|integer|
|fips_10_4|character varying(4)|
|st_id|double precision|
...
|------------|-----------------------------|
|objectid|integer|
|wfo|character varying(50)|
|cwa|character varying(50)|
|buff_dist|numeric|
|orig_fid|integer|
|shape_leng|numeric|
|shape_area|numeric|
...
|first_coun|character varying(4)|
