...
ALTER TABLE activetable ADD CONSTRAINT activetable_pkey PRIMARY KEY (etn, issueyear, officeid, phen, sig, ugczone);
...
ALTER TABLE practice_activetable ADD CONSTRAINT practice_activetable_pkey PRIMARY KEY (etn, issueyear, officeid, phen, sig, ugczone);
