...
#
# This script capitalize name elements in counties.xml
# Run this script in /awips2/edex/data/utility/common_static/[site/user]/XXX/psh/setup
# Usage: python convertCounty.py
...
print ("The county names in file "+FILE_NAME+" have been capitalized. Please verify that they are correct and edit if necessary.")
