...
public class EventLogger extends RadarEventAdapter {
        ...
        case RadarEvent.MESSAGE_RECEIVED:
            {
                ...
                } else if (messageCode == Message.COMMAND_PARAMETER_MESSAGE) {
                    s.append(' ');
                    CPM cpm = null;
                    try {
                        cpm = CPM.decode(msg);
    ...
    protected final String[] rpgAlarmStr = {
            ...
            null, "store-load-shed", null, null, "backup-comms", "link-fail", "redundant-channel-error",
    ...
    protected final String[] prrStr = {
            ...
            "inval-prod-param", "data-seq-error", "task-term", "cmd-not-authorized",
            "cmd-rejected"
    };
    ...
    protected String formatCPM(CPM cpm) {
        StringBuilder o = new StringBuilder();

        o.append("numClearAirVcps=" + cpm.clearAirVcps.length);
        o.append(" clearAirVcps=" + Arrays.toString(cpm.clearAirVcps));
        o.append(" numPrecipVcps=" + cpm.precipVcps.length);
        o.append(" precipVcps=" + Arrays.toString(cpm.precipVcps));
        o.append(" maxSailsCuts=" + cpm.maxSailsCuts);
