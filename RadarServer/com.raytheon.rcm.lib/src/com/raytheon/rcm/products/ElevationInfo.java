...
public class ElevationInfo {
    ...
    public static final List<String> ELEVATION_LIST_RESOURCE_NAMES = Arrays
            .asList("elevationLists.txt", "tdwrElevations.txt",
            ...
            synchronized (ElevationInfo.class) {
                ...
                if (result == null) {
                    if (invalidateInstance == null) {
                        ...
                        RcmResourceProvider provider = RcmResourceProvider
                                .getInstance();
                        for (String resource : ELEVATION_LIST_RESOURCE_NAMES) {
                            provider.addResourceChangeListener(resource,
                                    invalidateInstance);
                        }
                    }
    ...
    static class Sel {
        ...
        public boolean equals(Object obj) {
            if (obj == this)
                ...
                Sel oth = (Sel) obj;
                return ((radarID == null && oth.radarID == null) || radarID != null
                        && oth.radarID != null
    ...
    /* package */ElevationInfo() {
        ...
        s = RcmResourceProvider.getInstance().getResourceAsStream(
                "elevationLists.txt");
        fs = new Scanner(s);
        try {
    ...
    public static final int OTR_CODE = -1;
    public static final int RMR_CODE = -2;
    public static final int OTR_TDWR_CODE = -3;
    public static final int RMR_TDWR_CODE = -4;
     ...
     * @param radarID
     * @param vcp
     *            the VCP number or {@code OTR or RMR code} for a set of generic
     *            angles
