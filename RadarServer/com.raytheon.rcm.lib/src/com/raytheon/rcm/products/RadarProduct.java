...
public class RadarProduct implements Cloneable {
    public enum Format {
        GSM, PRR, PTL, CCM, RADIAL, RASTER, GRAPHIC, TEXT, GENERIC, UNKNOWN
    }

    public enum Param {
        ELEVATION, ALTITUDE, BASELINE, WINDOW_AZ_RAN, STORM_SPEED_DIR, MINI_VOLUME, TIME_SPAN, TIME_SPAN_MINUTES, LAYER, CFC_BITMAP
    }
