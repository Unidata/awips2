...
public class ReplyObj {
    ...
    @XmlRootElement
    public static class CcmReqReply extends ReplyObj {
    ...
    public static ReplyObj toGetRadarStatusMessages(
            Collection<ROStatus> radarStatus) {
        StatusMessagesReply r = new StatusMessagesReply(radarStatus);
        return r;
    }
