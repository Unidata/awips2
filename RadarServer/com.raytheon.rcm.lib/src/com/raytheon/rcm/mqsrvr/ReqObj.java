 ...
 *
 */
@XmlSeeAlso({ ReqObj.GetRadarList.class, ReqObj.GetRadarConfig.class,
        ReqObj.SetRadarConfig.class, ReqObj.GetRadarStatus.class,
        ReqObj.GetRadarStatusMessages.class, ReqObj.SendOneTimeRequests.class,
        ReqObj.DebugCommand.class, ReqObj.DebugHandleMessage.class,
        ReqObj.SendRpsList.class, ReqObj.SendRpsListData.class,
        ReqObj.GetRpsList.class, ReqObj.GetGlobalConfig.class,
        ReqObj.SetGlobalConfig.class, ReqObj.ActivateRMR.class,
        ReqObj.CancelRMR.class, ReqObj.GetActiveRMRs.class,
        ReqObj.GetCcmRequest.class, ReqObj.SendCcmRequest.class,
        ReqObj.SendMessageToRPG.class, ReqObj.SendConfigFile.class })
public class ReqObj {
    @XmlRootElement
    ...
    public static class RpsListReq extends ReqObj {
        ...
        public boolean isStore() {
            return store != null && store.booleanValue();
        }

        public String toString() {
            return String.format("%s(%s, vcp=%d, store=%s,...)", getClass()
                    .getSimpleName(), radarIDs, vcp, isStore());
        }
    }
    ...
    @XmlRootElement
    public static class GetCcmRequest extends RadarReq {
        // nothing
    }

    @XmlRootElement
    public static class SendCcmRequest extends RadarReq {
        public CcmRequestDefinition ccmRequest;
    }
