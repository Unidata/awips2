/**
 * This class sets the BUFR BufrSsha section 4 data in an array for parsing. 
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
import gov.noaa.nws.ncep.edex.plugin.bufrssha.util.BufrSshaDescriptorDelegate;
...
public class BufrSshaSeparator extends AbstractRecordSeparator implements
    ...
    private void decodeBUFRData() {
        BUFRFile bfile = new BUFRFile(messageData,
                new BufrSshaDescriptorDelegate(this));
