...
import gov.noaa.nws.ncep.edex.plugin.bufrssha.decoder.BufrSshaSeparator;
...
public class BufrSshaParser {
	 ...
	 */
	public static BufrSshaRecord processBufrSsha(BufrSshaSeparator sep,
			int subsetNum) {
		int year = -1;
		int month = -1;
		int day = -1;
		...
		if (record != null) {
			...
			if (parameterList != null) {
				...
				System.out.println("Info: There is no data in bufrssha bulletin.");
			}
		}
		return sshaRec;
	}
