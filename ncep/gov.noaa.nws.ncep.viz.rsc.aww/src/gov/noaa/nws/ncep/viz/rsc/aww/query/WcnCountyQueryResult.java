...
import gov.noaa.nws.ncep.viz.rsc.aww.wcn.WcnResource.WcnRscDataObj;
	...
	public void populateMap(){
		...
		try{
			...
			if(query.length() > 0){
				...
				System.out.println("last index of OR is : "+ query.lastIndexOf("OR") );
				String wholeQueryEnd = wholeQuery.substring( query.lastIndexOf("OR")-50 );
				System.out.println("len is "+ wholeQuery.length()+" " + wholeQueryEnd);
