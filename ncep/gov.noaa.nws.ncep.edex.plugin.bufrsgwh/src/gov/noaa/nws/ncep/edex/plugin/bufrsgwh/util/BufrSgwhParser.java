...
import gov.noaa.nws.ncep.edex.plugin.bufrsgwh.decoder.BufrSgwhSeparator;
...
public class BufrSgwhParser {
	...
	public static BufrSgwhRecord processBufrSgwh(BufrSgwhSeparator sep,
			int subsetNum) {
		int year = -1;
		int month = -1;
		int day = -1;
	...
	private static void processSubListGrp1(List<IBUFRDataPacket> singleRepList,
			BufrSgwhRecord sgwhRec, int repIndex) {
