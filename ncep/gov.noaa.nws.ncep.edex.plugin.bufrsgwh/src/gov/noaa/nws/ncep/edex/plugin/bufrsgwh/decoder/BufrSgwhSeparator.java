...
import gov.noaa.nws.ncep.edex.plugin.bufrsgwh.util.BufrSgwhDescriptorDelegate;
...
public class BufrSgwhSeparator extends AbstractRecordSeparator implements
    ...
    private void decodeBUFRData() {
        BUFRFile bfile = new BUFRFile(messageData,
                new BufrSgwhDescriptorDelegate(this));
