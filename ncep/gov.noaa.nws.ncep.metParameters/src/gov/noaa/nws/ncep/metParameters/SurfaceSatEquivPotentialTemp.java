...
public class SurfaceSatEquivPotentialTemp extends AbstractMetParameter implements
	...
	public SurfaceSatEquivPotentialTemp() {
 	...
 	@DeriveMethod
	public SurfaceSatEquivPotentialTemp derive( SurfacePressure p, AirTemperature t, AirTemperature t2 ) throws InvalidValueException, NullPointerException, InvalidRangeException {
