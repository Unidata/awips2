...
public class MergeSounding {
    ...
    public List<NcSoundingLayer> mergeUairSounding(String level,
        ...
        /*
         * ///for debug System.out.println("TTAA:"); for (NcSoundingLayer l:
         * ttaa){
         * System.out.println("P="+l.getPressure()+"H="+l.getGeoHeight()+"T="
         * +l.getTemperature
         * ()+"D="+l.getDewpoint()+"Wd="+l.getWindDirection()+"Ws="
         * +l.getWindSpeed()); } System.out.println("TTBB:"); for
         * (NcSoundingLayer l: ttbb){
         * System.out.println("P="+l.getPressure()+"H="
         * +l.getGeoHeight()+"T="+l.getTemperature
         * ()+"D="+l.getDewpoint()+"Wd="+l
         * .getWindDirection()+"Ws="+l.getWindSpeed()); }
         * System.out.println("PPAA:"); for (NcSoundingLayer l: ppaa){
         * System.out
         * .println("P="+l.getPressure()+"H="+l.getGeoHeight()+"T="+l.getTemperature
         * (
         * )+"D="+l.getDewpoint()+"Wd="+l.getWindDirection()+"Ws="+l.getWindSpeed
         * ()); } System.out.println("PPBB:"); for (NcSoundingLayer l: ppbb){
         * System.out.println("P="+l.getPressure()+"H="+l.getGeoHeight()+"T="+l.
         * getTemperature
         * ()+"D="+l.getDewpoint()+"Wd="+l.getWindDirection()+"Ws="
         * +l.getWindSpeed()); }
         */
    ...
    public NcSoundingLayer getSurfaceData(List<NcSoundingLayer> man,
         ...
         * significant level pressure to be less than or equal to pman
         * eliminates using wildly erroneous data.
         */
        ...
        for (int lev = 0; lev < sndata.size(); lev++) {
            ...
            if (blev != IMISSD && tlev != IMISSD) {
                for (int kk = blev + 1; kk < tlev; kk++) {
                    ...
                    if (sndata.get(kk).getGeoHeight() != RMISSD) {
                        float ppp = (float) (pb * Math.exp(((z - zb)
