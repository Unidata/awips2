...
import gov.noaa.nws.ncep.edex.plugin.h5uair.decoder.H5UairSeparator;
...
public class UairSeparatorTest {
	H5UairSeparator sep;
	char[] cbuf;
	int ntime = 0;
	...
	public void initialize () {	
		...
		sep = new H5UairSeparator();
		File file = new File ("unit-test/gov/noaa/nws/ncep/edex/plugin/h5uair/decoder/20100327.uair");
