...
public class PafmSeparator extends AbstractRecordSeparator {
    ...
    public static PafmSeparator separate(byte[] data, Headers headers) {
        PafmSeparator pafmSeparator = new PafmSeparator();
