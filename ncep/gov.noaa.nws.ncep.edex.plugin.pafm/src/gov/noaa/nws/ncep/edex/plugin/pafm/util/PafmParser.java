...
package gov.noaa.nws.ncep.edex.plugin.pafm.util;

import static com.raytheon.uf.common.localization.LocalizationContext.LocalizationType.EDEX_STATIC;
import gov.noaa.nws.ncep.common.dataplugin.pafm.PafmFips;
import gov.noaa.nws.ncep.common.dataplugin.pafm.PafmParameters;
...
public class PafmParser {
     ...
     * @return a PafmRecord
     */
    public static PafmRecord processWMO(String wmoline, Calendar mndTime) {
     ...
     * @return a PafmUgc table
     */
    public static PafmUgc processUgc(String ugcline, String segment,
            Calendar mndTime) {
        ...
        PafmUgc currentUgc = new PafmUgc();
        /*
        ...
        PafmParser.processFips(ugcline, elev, currentUgc, mndTime);
        /*
        ...
        for (int idx = 0; (idx < frameIndex) && (idx < maxFrame); idx++) {
            ...
            if (idx == 0) {
                ...
                if (frameMatcher.find() && findSegMndTime) {
                     ...
                     */
                    PafmParser.processParameters(frame[idx], ndxFcstHr,
    ...
    public static void processParameters(String matrixF, int ndxFcstHr,
            PafmUgc UGC, Calendar mndTime, Matcher segMndTimeMatcher) {
            ...
            if (jdxsv2 > 1 && jdxsv2 < rowIndex + 2) {
                ...
                for (int idx = 3; idx < rowIndex; idx++) {
                    ...
                    if (row[idx].length() > 13) {
                         ...
                         */
                        case DEWPT:
                            PafmParser.parseFlParmRow(row[idx], idxst, ndxLast,
                         ...
                         */
                        case MAX_QPF:
                            PafmParser.parseFlRangeParmRow(row[idx],
                        ...
                        case MX_MN:
                        case MN_MX:
                            PafmParser.parseMaxMinParmRow(row[idx], idxst,
                         ...
                         */
                        case SNOW_12HR:
                            PafmParser.parseSnowRangeParmRow(row[idx],
                         ...
                         */
                        case AVG_CLOUDS:
                            PafmParser.parseStrParmRow(row[idx], idxst,
                        ...
                        case WINTER_STORM:
                        case WINTER_WEATH:
                            PafmParser.parseHazardParmRow(row[idx], parmStr,
     ...
     */
    public static void processFips(String ugc, Float elev, PafmUgc UGC,
            Calendar mndTime) {
        ...
        while (fipsTokens.hasMoreTokens()) {
            ...
            if (first) {
                ...
                if (fipsToken.length() == 6) {
                    ...
                    // Format in NAMDDD
                    PafmFips currentFips = PafmFips.setFIPS(countyFips);
     ...
     * fields and add them to the PafmUgc (DB)
     * 
     * @param UGC
     */
    public static void addCurrParameters(PafmUgc UGC) {
        for (int nx = 0; nx < ndxLast; nx++) {
            PafmParameters currentParameters = new PafmParameters();
