 ...
 * PafmParserTest
 * 
 * This class contains the JUnit testing for PafmParser
 * 
 * <pre>
 *      
 * SOFTWARE HISTORY
...
public class PafmParserTest {
	...
	public void testProcessWMO() {
      ...
      // Set MND (Mass News Disseminator) time string and convert it into Calendar object
         ...
         record = PafmParser.processWMO(testBull, mndTime);
	...
	public void testParseFlParmRow() {
		...
		PafmParser.parseFlParmRow(row, ndxSt, ndxLast, locStNdx, locEnNdx, tempAr);
	...
	public void testParseSnowRangeParmRow() {
		...
		PafmParser.parseSnowRangeParmRow(row, snow12ValPattern, ndxSt, ndxLast, locStNdx, locEnNdx, tempMnAr, tempMxAr);
	...
	public void testParseStrParmRow() {
		...
		PafmParser.parseStrParmRow(row, ndxSt, ndxLast, locStNdx, locEnNdx, cloudsAr);
