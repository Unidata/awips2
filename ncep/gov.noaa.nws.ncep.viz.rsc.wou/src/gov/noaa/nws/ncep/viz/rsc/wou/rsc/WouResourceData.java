...
@XmlType(name="NC-WouResourceData")
public  class WouResourceData extends AbstractNatlCntrsRequestableResourceData
...
//    protected int timeInterval;
     ...
     * @throws VizException
     */
    public WouResourceData() throws VizException {
        super();
	...
	protected AbstractVizResource<?, ?> constructResource(
			...
			throws VizException {
		return new WouResource( this, loadProperties );
	}
