 ...
 * 
 * A raw message record looks like this xxx (some 3 digit number) TTAAii CCCC
 * YYGGgg BBB (WMO header) NNNXXX (AWIPS Id) ABCDEFG................(Data from
 * this line) .......... ... ..XYZ.. ^C (Data end with Ctl-C)
 * 
 * <pre>
 * SOFTWARE HISTORY
 * 
 ...
 */
@org.hibernate.annotations.Table(appliesTo = "nctext", indexes = { @Index(name = "nctext_refTimeIndex", columnNames = {
...
public class NctextRecord extends PluginDataObject {
    ...
    /**
     * GMT date and time of report issued, combination of ingest text file
     * name's first 8 letters which stand for yyyyMMdd and YYGG part of wmo
     * header which stand for HHmm
     */
    @Column
    @XmlElement
    @DynamicSerializeElement
    ...
    /**
     * @param uri
     *            - dataUri=/pluginname(nctext)/dataTime/TTAAii/CCCC/AWIPSid/
     *            producttype
     */
