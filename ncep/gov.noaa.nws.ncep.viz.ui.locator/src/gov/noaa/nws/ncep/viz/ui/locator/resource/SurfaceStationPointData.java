...
public class SurfaceStationPointData {
	...
	private static List<LocatorPointData> pointList;
	private static double latitude,longitude;
	public SurfaceStationPointData() {
		// TODO Auto-generated constructor stub
	}

	/*private  static List<LocatorPointData>  stationIdQuery(Coordinate co){
		longitude = co.x;
		latitude = co.y;
		try {
			return stationIdQuery(latitude,longitude);
	...
	private static List<LocatorPointData>  stationIdQuery(double lat,double lon)
	throws DataAccessLayerException {
		String query1,query2;
		QueryResultRow[] stnResults = null;
		double corr = 0.2;
		List<LocatorPointData> rtnPointList = new ArrayList<LocatorPointData>();
	...
	private static int getNearestPointStnIndex(){
		...
		int i=0;
		for (LocatorPointData point:  pointList){
