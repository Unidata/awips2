...
public class AirepPointDataTransform {
     ...
     * compatibility
     */
    private static final String[] ALL_PARAMS = { DATAURI, TIME_OBS, OBS_ID,
            REPORT_TYPE, STATION_ID, WMO_HEADER, FLIGHT_HAZARD, FLIGHT_WEATHER,
            FLIGHT_CONDITIONS, LONGITUDE, LATITUDE, FLIGHT_LEVEL,
            CORRECTION_CODE, TEMPERATURE, WIND_SPEED, WIND_DIR, TURB_INTEN,
            TURB_TYPE, TURB_FREQ, ICE_INTEN, ICE_TYPE, SKY_COVER,
