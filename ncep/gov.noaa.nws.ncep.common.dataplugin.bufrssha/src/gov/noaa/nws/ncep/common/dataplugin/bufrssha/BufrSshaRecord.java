 ...
 * BufrsshaRecord
 * 
 * This java class performs the mapping to the database for BufrSsha.
 * 
 * <pre>
 * SOFTWARE HISTORY
 * 
...
@Entity
@Table(name = "bufrssha", uniqueConstraints = { @UniqueConstraint(columnNames = { "dataURI" }) })
@XmlRootElement
@XmlAccessorType(XmlAccessType.NONE)
@DynamicSerialize

public class BufrSshaRecord extends PluginDataObject implements IDecoderGettable {
    ...
    @Column
    /* 
     * Sea surface height anomalies are from blended TOPEX/Poseidon, Jason-1, ERS 1,
     * ERS 2m GPO and Envisat ocean altimetry satellites, therefore said should
     * be a primary key.
     */
    @DataURI(position=4)
    @XmlElement
    ...
    /** 20 Hz RMS Ku Band Net Instrumental Correction For Significant Wave Height (m) */
    @Column
    @XmlElement
    @DynamicSerializeElement
    private Double kncs;
   ...
   /** Non-equilibrium long period tide height (m) */
     ...
     */
    public BufrSshaRecord (String uri) {
        super(uri);
    }
	...
	/**
	 * @param said the Satellite Identifier to set
	 */
	...
	/**
	 * @param siid the Satellite Instruments to set
	 */
	...
	/**
	 * @param staq the Station Acquisition to set
	 */
	...
	/**
	 * @param softv  the Software Id and Version to set
	 */
	...
	/**
	 * @param sacyln the Satellite Cycle Number to set
	 */
	...
	/**
	 * @param numid the Numerical Model Identifier to set
	 */
	...
	/**
	 * @param clath the latitude to set
	 */
	...
	/**
	 * @param clonh the longitude to set
	 */
	...
	/**
	 * @param rsst the Remote Sensed Surface Type to set
	 */
	...
	/**
	 * @param aetp the Altimeter Echo Type to set
	 */
	...
	/**
	 * @param dsst the Radiometer Sensed Surface Type to set
	 */
	...
	/**
	 * @param intf the Interpolation Flag to set
	 */
	...
	/**
	 * @param eeno the  Three-dimensional Error Estimate of the Navigator Orbit to set
	 */
	...
	/**
	 * @param adqf the Altimeter Data Quality Flag to set
	 */
	...
	/**
	 * @param arqf the Altimeter Correction Quality Flag to set
	 */
	...
	/**
	 * @param alrf the Altimeter Rain Flag to set
	 */
	...
	/**
	 * @param rdqf the Radiometer Data Quality Flag to set
	 */
	...
	/**
	 * @param rbif the Radiometer Brightness Temperature Interpretation to set
	 */
	...
	/**
	 * @param ipin the Ice Presence Indicator to set
	 */
	...
	/**
	 * @param aasf the Auxillliary Altimeter State Flags to set
	 */
	...
	/**
	 * @param mmap the Meteorological Map Availablity to set
	 */
	...
	/**
	 * @param ifdt the Interpolation Flag For Mean Diurnal Tide to set
	 */
	 ...
	 * 
	 * @param kbor Ku Band Ocean Range to return
	 */
	public Double getKbor() {
		return kbor;
	}
	/**
	 * @param kbor Ku Band Ocean Range to set
	 */
	 ...
	 * 
	 * @param rkbor RMS of 20 Hz Ku Band Ocean Range to return
	 */
	public Double getRkbor() {
		return rkbor;
	}
	/**
	 * @param rkbor RMS of 20 Hz Ku Band Ocean Range to set
	 */
	...
	/**
	 * @param nvpk2 the Number of 20 Hz valid points for Ku Band to set
	 */
	 ...
	 * 
	 * @param kbic Ku Band Net Instrumental Correction to return
	 */
	public Double getKbic() {
		return kbic;
	}
	/**
	 * @param kbic Ku Band Net Instrumental Correction to set
	 */
	 ...
	 * 
	 * @param sbck Sea State Bias Correction On Ku Band to return
	 */
	...
	/**
	 * @param sbck Sea State Bias Correction On Ku Band to set
	 */
	 ...
	 * 
	 * @param kbsw Ku Band Significant Wave Height to return
	 */
	public Double getKbsw() {
		return kbsw;
	}
	/**
	 * @param kbsw Ku Band Significant Wave Height to set
	 */
	 ...
	 * 
	 * @param rksw RMS 20 Hz Ku Band Significant Wave Height
	 */
	public Double getRksw() {
		return rksw;
	}
	/**
	 * @param rksw 20 Hz RMS Ku Band Significant Wave Height to set
	 */
     ...
     * 
     * @return the Number of 20 Hz valid points for Ku Band Significant Wave Height
     */
    public Long getNvksw() {
        return nvksw;
    }
	/**
	 * @param nvksw the Number of 20 Hz valid points for Ku Band Significant Wave Height to set
	 */
	 ...
	 * 
	 * @param kncs RMS 20 Hz Ku Band Net Instrumental Correction For Significant Wave Height
	 */
	public Double getKncs() {
		return kncs;
	}
	/**
	 * @param kncs 20 Hz RMS Ku Band Net Instrumental Correction For Significant Wave Height to set
	 */
	 ...
	 * 
	 * @param kobc Ku Band Corrected Ocean Backscatter coefficient
	 */
	public Double getKobc() {
		return kobc;
	}
	/**
	 * @param kobc Ku Band Corrected Ocean Backscatter coefficient to set
	 */
	 ...
	 * 
	 * @param kobc STD Ku Band Corrected Ocean Backscatter coefficient
	 */
	public Double getSkobc() {
		return skobc;
	}
	/**
	 * @param skobc STD Ku Band Corrected Ocean Backscatter coefficient to set
	 */
	...
	/**
	 * @param nvpkb the Number of valid points for Ku Band Backscatter to set
	 */
	 ...
	 * 
	 * @param knic Ku band net instrumental correction for AGC
	 */
	public Double getKnic() {
		return knic;
	}
	/**
	 * @param knic Ku band net instrumental correction for AGC to set
	 */
	 ...
	 * 
	 * @param acrs1 Attenuation 1 Correction On Sigma-0
	 */
	public Double getAcrs1() {
		return acrs1;
	}
	/**
	 * @param acrs1 Attenuation Correction 1 On Sigma-0
	 */
	 ...
	 * 
	 * @param acrs2 Attenuation Correction 2 On Sigma-0
	 */
	 ...
	 * 
	 * @param kagc Ku Band Automatic Gain Control
	 */
	 ...
	 * 
	 * @param rkagc RMS Ku Band Automatic Gain Control
	 */
     ...
     * 
     * @return nvkg the Number of valid points for Ku Band Automatic Gain Control
     */
    public Long getNvkg() {
        return nvkg;
    }
	/**
	 * @param nvkg the Number of valid points for Ku Band Automatic Gain Control to set
	 */
	 ...
	 * C Band Ocean Range
	 * 
	 * @param cbor C Band Ocean Range to return
	 */
	public Double getCbor() {
		return cbor;
	}
	/**
	 * @param cbor C Band Ocean Range to set
	 */
	 ...
	 * 
	 * @param rcbor RMS of C Band Ocean Range to return
	 */
	public Double getRcbor() {
		return rcbor;
	}
	/**
	 * @param rcbor  RMS of C Band Ocean Range to set
	 */
	...
	/**
	 * @param nvpc the Number of 20 Hz valid points for C band to set
	 */
	 ...
	 * 
	 * @param cbic C band net instrumental correction to return
	 */
	public Double getCbic() {
		return cbic;
	}
	/**
	 * @param cbic C band net instrumental correction to set
	 */
	 ...
	 * 
	 * @param sbcc Sea state bias correction on C band to return
	 */
	public Double getSbcc() {
		return sbcc;
	}
	/**
	 * @param sbcc Sea state bias correction on C band to set
	 */
	 ...
	 * 
	 * @param cbsw C band significant wave height to return
	 */
	public Double getCbsw() {
		return cbsw;
	}
	/**
	 * @param cbsw C band significant wave height to set
	 */
	 ...
	 * 
	 * @param rcsw RMS 20 Hz C band significant wave height to return
	 */
	public Double getRcsw() {
		return rcsw;
	}
	/**
	 * @param rcsw RMS 20 Hz C band significant wave height to set
	 */
	...
	/**
	 * @param nvcsw the Number of 20 Hz valid points for C band significance to set
	 */
	 ...
	 * 
	 * @param cncs C band net instrumental correction for significance to return
	 */
	public Double getCncs() {
		return cncs;
	}
	/**
	 * @param cncs  C band net instrumental correction for significance to set
	 */
	 ...
	 * 
	 * @param ccob C band corrected ocean backscatter coefficient to return
	 */
	public Double getCcob() {
		return ccob;
	}
	/**
	 * @param ccob  C band corrected ocean backscatter coefficient to set
	 */
	 ...
	 * 
	 * @param rccob RMS C band corrected ocean backscatter coefficient to return
	 */
	public Double getRccob() {
		return rccob;
	}
	/**
	 * @param rccob RMS C band corrected ocean backscatter coefficient to set
	 */
	...
	/**
	 * @param nvpcb the Number of valid points for C band backscatter to set
	 */
	 ...
	 * 
	 * @param cnia C band net instrumental correction for AGC to return
	 */
	public Double getCnia() {
		return cnia;
	}
	/**
	 * @param cnia C band net instrumental correction for AGC to set
	 */
	 ...
	 * 
	 * @param cagc C band automatic gain control to return
	 */
	public Double getCagc() {
		return cagc;
	}
	/**
	 * @param cagc C band automatic gain control to set
	 */
	 ...
	 * 
	 * @param rcagc RMS C band automatic gain control to return
	 */
	public Double getRcagc() {
		return rcagc;
	}
	/**
	 * @param rcagc RMS C band automatic gain control to set
	 */
	...
	/**
	 * @param nvpca the Number of valid points for C band automatic gain to set
	 */
	 ...
	 * 
	 * @param sccf1 Satellite channel center frequency 1
	 */
	 ...
	 * Satellite channel center frequency 1
	 * 
	 * @param sccf2 Satellite channel center frequency 2
	 */
	 ...
	 * 
	 * @param sccf1 Satellite channel center frequency 3
	 */
	public Double getSccf3() {
		return sccf3;
	}
	/**
	 * @param sccf3 Satellite channel center frequency 3
	 */
	 ...
	 * 
	 * @param tmbrst1 Brightness temperature 1
	 */
	 ...
	 * 
	 * @param tmbrst2 Brightness temperature 2
	 */
	 ...
	 * 
	 * @param tmbrst3 Brightness temperature 3
	 */
	 ...
	 * 
	 * @param rwvc Radiometer water vapor content to return
	 */
	public Double getRwvc() {
		return rwvc;
	}
	/**
	 * @param rwvc Radiometer water vapor content to set
	 */
	 ...
	 * 
	 * @param hmsl Height or altitude 1 to return
	 */
	public Double getHmsl1() {
		return hmsl1;
	}
	/**
	 * @param hmsl Height or altitude 1 to set
	 */
	 ...
	 * 
	 * @param hmsl Height or altitude 2 to return
	 */
	public Double getHmsl2() {
		return hmsl2;
	}
	/**
	 * @param hmsl Height or altitude 2 to set
	 */
	 ...
	 * Wind speed from altimeter (m/s)
	 * 
	 * @param wspa Wind speed from altimeter to return
	 */
	public Double getWspa() {
		return wspa;
	}
	/**
	 * @param wspa Wind speed from altimeter to set
	 */
	 ...
	 * Wind speed from radiometer (m/s)
	 * 
	 * @param wspr Wind speed from radiometer to return
	 */
	public Double getWspr() {
		return wspr;
	}
	/**
	 * @param wspr Wind speed from radiometer to set
	 */
	 ...
	 * u-component of the model wind vector (m/s)
	 * 
	 * @param umwv u-component of the model wind vector to return
	 */
	public Double getUmwv() {
		return umwv;
	}
	/**
	 * @param umwv u-component of the model wind vector to set
	 */
	 ...
	 * u-component of the model wind vector (m/s)
	 * 
	 * @param vwmv u-component of the model wind vector to return
	 */
	public Double getVwmv() {
		return vwmv;
	}
	/**
	 * @param vwmv u-component of the model wind vector to set
	 */
	...
	/**
	 * @param mdyt Mean dynamic topography to set
	 */
	 ...
	 * Altitude of COG above reference ellipsoid (m)
	 * 
	 * @param alre Altitude of COG above reference ellipsoid
	 */
	public Double getAlre() {
		return alre;
	}
	/**
	 * @param alre Altitude of COG above reference ellipsoid to set
	 */
	 ...
	 * Instantaneous altitude rate (m/s)
	 * 
	 * @param ialr Instantaneous altitude rate to return
	 */
	public Double getIalr() {
		return ialr;
	}
	/**
	 * @param ialr Instantaneous altitude rate to set
	 */
	 ...
	 * Squared off nadir angle of the satellite from platform data (degree**2)
	 * 
	 * @param onap Squared off nadir angle of the satellite from platform data to set
	 */
	 ...
	 * Squared off nadir angle of the satellite from waveform data (degree**2)
	 * 
	 * @param sonaw Squared off nadir angle of the satellite from waveform data to return
	 */
	public Double getSonaw() {
		return sonaw;
	}
	/**
	 * @param sonaw Squared off nadir angle of the satellite from waveform data to set
	 */
	 ...
	 * Ionospheric correction from model on Ku band (m)
	 * 
	 * @param icmk Ionospheric correction from model on Ku band to return
	 */
	public Double getIcmk() {
		return icmk;
	}
	/**
	 * @param icmk Ionospheric correction from model on Ku band to set
	 */
	 ...
	 * Ionospheric correction from model on Ku band (m)
	 * 
	 * @param aick Ionospheric correction from model on Ku band to return
	 */
	public Double getAick() {
		return aick;
	}
	/**
	 * @param aick Ionospheric correction from model on Ku band to set
	 */
	 ...
	 * Model dry tropospheric correction (m)
	 * 
	 * @param mdtc Model dry tropospheric correction to return
	 */
	public Double getMdtc() {
		return mdtc;
	}
	/**
	 * @param mdtc Model dry tropospheric correction to set
	 */
	 ...
	 * Model wet tropospheric correction (m)
	 * 
	 * @param mwtc Model wet tropospheric correction to return
	 */
	public Double getMwtc() {
		return mwtc;
	}
	/**
	 * @param mwtc Model wet tropospheric correction to set
	 */
	 ...
	 * Radiometer wet tropospheric correction (m)
	 * 
	 * @param rwtc Radiometer wet tropospheric correction to return
	 */
	public Double getRwtc() {
		return rwtc;
	}
	/**
	 * @param rwtc Radiometer wet tropospheric correction to set
	 */
	 ...
	 * Mean sea-surface height (m)
	 * 
	 * @param mssh Mean sea-surface height to return
	 */
	public Double getMssh() {
		return mssh;
	}
	/**
	 * @param mssh Mean sea-surface height to set
	 */
	 ...
	 * Mean sea-surface height from altimeter only (m)
	 * 
	 * @param msha Mean sea-surface height from altimeter only to return
	 */
	public Double getMsha() {
		return msha;
	}
	/**
	 * @param msha Mean sea-surface height from altimeter only to set
	 */
	 ...
	 * Geoid's height (m)
	 * 
	 * @param geodh Geoid's height to return
	 */
	public Double getGeodh() {
		return geodh;
	}
	/**
	 * @param odle Ocean depth/land elevation (m)
	 */
	 ...
	 * Ocean depth/land elevation (m)
	 * 
	 * @param odle Ocean depth/land elevation to return
	 */
	public Double getOdle() {
		return odle;
	}
	/**
	 * @param odle Ocean depth/land elevation to set
	 */
	 ...
	 *  Solid earth tide height (m)
	 * 
	 * @param seth Solid earth tide height to return
	 */
	public Double getSeth() {
		return seth;
	}
	/**
	 * @param seth Solid earth tide height to set
	 */
	 ...
	 *   Total geocentric ocean tide height solution 1 (m)
	 * 
	 * @param tgoth1 Total geocentric ocean tide height solution 1 to return
	 */
	public Double getTgoth1() {
		return tgoth1;
	}
	/**
	 * @param tgoth1 Total geocentric ocean tide height solution 1 to set
	 */
	 ...
	 *   Total geocentric ocean tide height solution 2 (m)
	 * 
	 * @param tgoth2 Total geocentric ocean tide height solution 2 to return
	 */
	public Double getTgoth2() {
		return tgoth2;
	}
	/**
	 * @param tgoth2 Total geocentric ocean tide height solution 2 to set
	 */
	 ...
	 *   Loading tide height geocentric ocean tide solution 1 (m)
	 * 
	 * @param lths1 Loading tide height geocentric ocean tide solution 1 to return
	 */
	public Double getLths1() {
		return lths1;
	}
	/**
	 * @param lths1 Loading tide height geocentric ocean tide solution 1 to set
	 */
	 ...
	 *   Loading tide height geocentric ocean tide solution 2 (m)
	 * 
	 * @param lths2 Loading tide height geocentric ocean tide solution 2 to return
	 */
	public Double getLths2() {
		return lths2;
	}
	/**
	 * @param lths2 Loading tide height geocentric ocean tide solution 2 to set
	 */
	 ...
	 *   Long period tide height (m)
	 * 
	 * @param lpth Long period tide height to return
	 */
	public Double getLpth() {
		return lpth;
	}
	/**
	 * @param lpth Long period tide height to set
	 */
	 ...
	 *   Non-equilibrium long period tide height (m)
	 * 
	 * @param nlth Non-equilibrium long period tide height to return
	 */
	public Double getNlth() {
		return nlth;
	}
	/**
	 * @param nlth Non-equilibrium long period tide height to set
	 */
	 ...
	 * Geocentric pole tide height (m)
	 * 
	 * @param gpth Geocentric pole tide height to return
	 */
	public Double getGpth() {
		return gpth;
	}
	/**
	 * @param gpth Geocentric pole tide height to set
	 */
	 ...
	 * Inverted barometer correction (m)
	 * 
	 * @param ibco  Inverted barometer correction to return
	 */
	public Double getIbco() {
		return ibco;
	}
	/**
	 * @param ibco  Inverted barometer correction to set
	 */
	 ...
	 * High frequency fluctuations of the sea surface topography correction (m)
	 * 
	 * @param hfstc High frequency fluctuations of the sea surface topography correction
	 * 
	 */
	...
	/**
	 * @param hfstc High frequency fluctuations of the sea surface topography correction to set
	 */
	 ...
	 * 
	 * @param ssha Sea Surface Height Anomoly to return
	 */
	public Double getSsha() {
		return ssha;
	}
	/**
	 * @param ssha Sea Surface Height Anomoly to set
	 */
