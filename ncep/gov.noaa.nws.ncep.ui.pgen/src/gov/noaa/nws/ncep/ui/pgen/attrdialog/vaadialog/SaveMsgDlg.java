...
public class SaveMsgDlg extends CaveJFACEDialog {
    ...
    /**
     * the Text field displaying the name of the file of to be saved text
     * product.
     */
    Text txtSave;
     ...
     * 
     * @param vaDlg
     *            : the VolcannoVaaAttrDlg instance to be set
     */
    ...
    public Control createDialogArea(Composite parent) {
        ...
        this.volcano = this.volAttrDlgInstance.getVolcano();// TODO: already set
                                                            // in attrDlg before
                                                            // this is open
                                                            // 20100309
    ...
    private String getVolNameId() {
        ...
        return volcano == null ? "" : volcano.getName() + VaaInfo.SEPERATER
                + volcano.getNumber();
    }
