...
public abstract class AbstractPgenDrawingTool extends AbstractPgenTool {
    ...
    /**
     * PGEN class of the current element, such as Lines, Front, Symbol, Marker, Text, etc.
     */  
...
//    		mapEditor = null;
    	...
    	/*
    	 * get pgenType and pgenCategory from ExecutionEvent parameters.
    	 * They are set when Object button is selection on the Palette.
    	 */
    	String param;
        ...
        if ( attrDlg == null ){
        	...
        	attrDlg = AttrDlgFactory.createAttrDlg( pgenType, null,
        			PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell() );
        ...
        if ( attrDlg != null ) {
        	...
        	attrDlg.setMouseHandlerName(this.getMouseHandler().getClass().getName());        	
        	/*
        ...
        if ( this.mouseHandler != null && mapEditor!=null) {
        	
            mapEditor.unregisterMouseHandler( this.mouseHandler );
            
        }
        
        this.mouseHandler = getMouseHandler();
        if ( this.mouseHandler != null && mapEditor!=null)
