...
public class Line extends MultiPointElement  implements ILine{
	 ...
	 * @param pgenType
	 */
	public Line(Coordinate[] range, Color[] colors,
	...
	public void update(IAttribute iattr) {
		if ( iattr instanceof ILine ){
			...
			if ( attr.isFilled()!= null &&  attr.isFilled()) this.setFillPattern(attr.getFillPattern());
		}
	}
	...
	/**
	 * Returns the coordinate of the centroid constructed from the points of this line. 
	 * 
	 * @return
	 */
