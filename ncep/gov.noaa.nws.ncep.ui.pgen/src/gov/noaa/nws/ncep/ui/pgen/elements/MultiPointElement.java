 ...
 * @version	0.0.1
 */
public abstract class MultiPointElement extends DrawableElement implements IMultiPoint {
	 ...
	 * @param linePattern
	 */
	protected MultiPointElement(Coordinate[] range,
			Color[] colors, float lineWidth, double sizeScale, boolean closed,
			boolean filled, List<Coordinate> linePoints, int smoothFactor,
	...
	/**
	 * IAttribute getter/setter for SIGMET
	 * gzhang
	 */
	...
	/**
	 * pgenCategory getter for SIGMET
	 * gzhang
	 */
