/*
 * gov.noaa.nws.ncep.ui.pgen.productManage.LayeringLpfFileDialog
 * 
 * Sept 2010
 *
 ...
 * and path of a PGEN layer.
 * 
 * <pre>
 * SOFTWARE HISTORY
 * Date         Ticket#    Engineer    Description
 * ------------ ---------- ----------- --------------------------
 * 09/10  		#151      	J. Wu 		Initial creation. 
 * </pre>
 * 
 * @author jwu
 * @version 1.0
...
/*    	String title = prdManageDlg.getLpfFileLayerName();
    	
   	    if ( title == null )	{
            title = "Layer Input/Output File";       
   	    }
   	    else {
...
//    	initialInput = prdManageDlg.getLayerForLpfFile().getInputFile();
//		initialOutput = prdManageDlg.getLayerForLpfFile().getOutputFile();
