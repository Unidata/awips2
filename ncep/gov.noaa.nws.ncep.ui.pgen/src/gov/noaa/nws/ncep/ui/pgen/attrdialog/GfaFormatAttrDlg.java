...
//	private final static Logger logger = Logger.getLogger(GfaFormatAttrDlg.class);
	...
	/**
	 * Creates an extrapolation dialog if the dialog does not exist and returns the instance. If the
	 * dialog exists, return the instance.
	 * 
	 * @param parShell
	 * @return
	 */
...
//				logger.error(e);
	...
	public void okPressed() {
		...
		StringBuilder sb;
		try {
			sb = pgenGfaFormatTool.generate(drawingLayer, allGfa, areas, categories);
