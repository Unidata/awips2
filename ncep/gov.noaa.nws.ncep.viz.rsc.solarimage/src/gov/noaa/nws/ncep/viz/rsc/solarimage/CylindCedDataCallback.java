...
public class CylindCedDataCallback implements IColorMapDataRetrievalCallback {
     ...
     * @throws VizException 
     */
    public CylindCedDataCallback(SolarImageRecord record, ImageData imgData) throws VizException {
        this.record = record;
    ...
    public ColorMapData getColorMapData() throws VizException {
        ...
        int[] dimensions = new int[] { 360, 180}; //imgData.getNx(), imgData.getNy() };//new dimensions
        FloatBuffer buffer = FloatBuffer.wrap(imgData.getImageValues());//new imageData
