...
public class NctextuiMouseHandler extends InputHandlerDefaultImpl {
     ...
     * NctextuiResource.getMapEditor(); if(mapEditor!= null){ IDisplayPane[]
    ...
    public boolean handleMouseUp(int x, int y, int button) {
        ...
        if (!NctextuiResource.getNctextuiResource().isEditable())
            return false;
        ...
        if (button == 1) {
            ...
            if (mapEditor != null) {
                ...
                if (loc == null)
    				return false;
                NctextuiPaletteWindow nctextuiPaletteWindow = NctextuiPaletteWindow
                        .getAccess();
                if (nctextuiPaletteWindow != null) {
                    // get the stn (point) list
                    List<NctextStationInfo> points = nctextuiPaletteWindow
                            .getPoints();
                    if (points.isEmpty() == false) {

                        // get the stn close to loc "enough" and retrieve text
                        // report for it
                        NctextStationInfo StnPt = getPtWithinMinDist(points,
                                loc);
    					...
    					/*
                             ...
                             * List<NctextStationInfo> rtnStateStnLst = new
                             * ArrayList<NctextStationInfo> ();
                             ...
                             * = nctextuiPaletteWindow.getText();
                             * if(nctextuiPaletteWindow.isReplaceText() ==
                             * false){ //APPEND mode //List<NctextStationInfo>
                             * prevPickedStnLst =
                             * nctextuiPaletteWindow.getNctextuiResource
                             * ().getPickedStnPt(); List<NctextStationInfo>
                             * prevPickedStnLst =
                             ...
                             * NctextuiResource
                             * .getNctextuiResource().setPickedStnPt
                             * (rtnStateStnLst); mapEditor.refresh();
                             * NctextuiModalTool.setModal(); // QUERY DB
                             * now....Object[0] = Rawrecord text data, Object[1]
                             * = issuesite List<List<Object[]>> rptLstList =
                             * query
                             * .getProductDataListList(nctextuiPaletteWindow
                             ...
                             * if(nctextuiPaletteWindow.isState()){ //SelectBy
                             ...
                             * nctextuiPaletteWindow.setCurrentTextIndex
                             ...
                             * nctextuiPaletteWindow.enablePrevBtn(true); } else
     ...
     * @return
     */
    protected NctextStationInfo getPtWithinMinDist(
            List<NctextStationInfo> points, Coordinate pt) {
