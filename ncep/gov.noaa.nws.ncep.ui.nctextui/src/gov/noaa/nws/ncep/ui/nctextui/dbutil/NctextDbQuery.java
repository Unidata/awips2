...
public class NctextDbQuery {
     ...
     */
    // private final String NCTEXT_STATION_GP_TABLE_NAME =
    ...
    private static Map<String, List<NctextStationInfo>> productAllStationInfoListMap = new HashMap<String, List<NctextStationInfo>>(); // <key:productName,
                                                                                                                                       // value:List<NctextStationInfo>>

    // Map, from a data productName to its stationInfo list of a state,
    // key:productname+state, value:its state stn info list
    private static Map<String, List<NctextStationInfo>> productStateStationInfoListMap = new HashMap<String, List<NctextStationInfo>>(); // <key:productName,
                                                                                                                                         // value:List<NctextStationInfo>>
    ...
    private String createProductDataQuery(String productName,
        ...
        if ((productName != null) && (sta != null)) {
            ...
            if ((fileType != null) && (fileType.equals("R"))) {
                ...
                // queryStr = new
                // StringBuilder("Select rawrecord FROM "+NCTEXT_DATA_DB_TABLE+" WHERE issuesite='"+gpStn+"' AND producttype='"+productType+"'");
