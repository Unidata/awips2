...
public class PointOverlayAttributesDialog extends AbstractEditResourceAttrsDialog {
    ...
    private RscAttrValue maxMarkerDisplayWidth = null; 
    private RscAttrValue maxLabelDisplayWidth = null; 
    ...
    public PointOverlayAttributesDialog( Shell parentShell, INatlCntrsResourceData rd, Boolean apply ) {
	...
	public Composite createDialog(Composite composite) {
        ...
        maxMarkerDisplayWidth = editedRscAttrSet.getRscAttr("maxSymbolDisplayWidth");
        maxLabelDisplayWidth = editedRscAttrSet.getRscAttr("maxLabelDisplayWidth");
        ...
        Group markerZoomLevelGrp = new Group ( composite, SWT.SHADOW_NONE );
        markerZoomLevelGrp.setText("Display Threshold for Symbols");
        
        GridLayout markerZoomLvlGridLayout = new GridLayout();
        markerZoomLvlGridLayout.numColumns = 2; 
        markerZoomLvlGridLayout.marginLeft = 12;
        markerZoomLvlGridLayout.marginRight = 12;
        markerZoomLevelGrp.setLayout(markerZoomLvlGridLayout);
        ...
        markerZoomLevelGrp.setLayoutData(formData6);
    
        
        Group lblZoomLevelGrp = new Group ( composite, SWT.SHADOW_NONE );
        lblZoomLevelGrp.setText("Display Threshold for Labels");
        ...
        lblZoomLevelGrp.setLayout(markerTxtAppZoomLvlGridLayout);
        
        FormData formData33 = new FormData();
        formData33.top   = new FormAttachment(markerZoomLevelGrp, 10);
        formData33.left  = new FormAttachment(2, 0);
        formData33.right = new FormAttachment(98,0);        
        lblZoomLevelGrp.setLayoutData(formData33);
        ...
        // Display Thresholds for Markers and Labels
        
	    final Label maxMarkerDisplayWidthSliderText = new Label(markerZoomLevelGrp, SWT.NONE);
	    GridData gridData3 = new GridData();
	    gridData3.horizontalIndent = 100;
	    gridData3.horizontalAlignment = GridData.FILL;	                 
	    gridData3.grabExcessHorizontalSpace = true;   
	    maxMarkerDisplayWidthSliderText.setLayoutData(gridData3);
	    
	    Button markerApplyCurZoomLvlBtn = new Button(markerZoomLevelGrp, SWT.PUSH);
        gridData3 = new GridData();	
        gridData3.heightHint = 26;
        gridData3.widthHint = 25;
        gridData3.horizontalIndent = 10;       
        markerApplyCurZoomLvlBtn.setImage(new Image(Display.getCurrent(), applyZoomImageFile.getAbsolutePath()));
        markerApplyCurZoomLvlBtn.setToolTipText("Set to Current Map Width");
        markerApplyCurZoomLvlBtn.setLayoutData(gridData3);
        
	    final Slider maxMarkerDisplayWidthSlider = new Slider( markerZoomLevelGrp, SWT.HORIZONTAL);
    	gridData3 = new GridData(GridData.HORIZONTAL_ALIGN_CENTER);
    	maxMarkerDisplayWidthSlider.setToolTipText(
    			"Markers will only be displayed if the width in kilometers\n"+
    			"of the current screen display is less than this threshold.");
	    gridData3.horizontalAlignment = GridData.FILL;	                 
	    maxMarkerDisplayWidthSlider.setLayoutData(gridData3);
	    maxMarkerDisplayWidthSlider.setMinimum(100);
	    maxMarkerDisplayWidthSlider.setMaximum(40200);
	    maxMarkerDisplayWidthSlider.setIncrement(10);
	    maxMarkerDisplayWidthSlider.setPageIncrement(1000);
    	Integer markerDispWidth = (Integer)maxMarkerDisplayWidth.getAttrValue();
    	maxMarkerDisplayWidthSlider.setSelection( markerDispWidth );
    	maxMarkerDisplayWidthSlider.addSelectionListener(new SelectionAdapter() {
	        public void widgetSelected(SelectionEvent event) {
	        	maxMarkerDisplayWidth.setAttrValue( ((Integer)maxMarkerDisplayWidthSlider.getSelection() ) );
	        	maxMarkerDisplayWidthSliderText.setText( maxMarkerDisplayWidth.getAttrValue().toString() +" km");
	        	maxMarkerDisplayWidthSliderText.redraw();
	        	maxMarkerDisplayWidthSliderText.update();
	        }
	    });
    	
    	maxMarkerDisplayWidthSliderText.setText( maxMarkerDisplayWidth.getAttrValue().toString() +" km");
	   	
	    markerApplyCurZoomLvlBtn.addSelectionListener( new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {				
				AbstractEditor activeEd = NcDisplayMngr.getActiveNatlCntrsEditor();
				IDisplayPane dispPane = NcEditorUtil.getSelectedPanes(activeEd)[0];
				
				if( !(dispPane.getDescriptor() instanceof MapDescriptor) ) {
					return;
				}
				
				Double currMapWidth = dispPane.getZoomLevel() *
								((MapDescriptor)dispPane.getDescriptor()).getMapWidth() /1000.0;
								
				maxMarkerDisplayWidth.setAttrValue( currMapWidth.intValue() );
				maxMarkerDisplayWidthSliderText.setText( maxMarkerDisplayWidth.getAttrValue().toString() +" km");
				maxMarkerDisplayWidthSliderText.redraw();
				maxMarkerDisplayWidthSliderText.update();
				maxMarkerDisplayWidthSlider.setSelection( currMapWidth.intValue() );				
			}
		});

        
	    final Label maxLabelDisplayWidthSliderText = new Label(lblZoomLevelGrp, SWT.NONE);
	    /*GridData*/ gridData3 = new GridData();
	    gridData3.horizontalIndent = 100;
	    gridData3.horizontalAlignment = GridData.FILL;	                 
	    gridData3.grabExcessHorizontalSpace = true;   
	    maxLabelDisplayWidthSliderText.setLayoutData(gridData3);
	    
	    Button applyCurZoomLvlBtn = new Button(lblZoomLevelGrp, SWT.PUSH);
        gridData3 = new GridData();	
        gridData3.heightHint = 26;
        gridData3.widthHint = 25;
        gridData3.horizontalIndent = 10;       
        applyCurZoomLvlBtn.setImage(new Image(Display.getCurrent(), applyZoomImageFile.getAbsolutePath()));
        applyCurZoomLvlBtn.setToolTipText("Set to Current Map Width");
        applyCurZoomLvlBtn.setLayoutData(gridData3);
        
	    final Slider maxLabelDisplayWidthSlider = new Slider(lblZoomLevelGrp, SWT.HORIZONTAL);
    	gridData3 = new GridData(GridData.HORIZONTAL_ALIGN_CENTER);
    	maxLabelDisplayWidthSlider.setToolTipText(
    			"Labels will only be displayed if the width in\n"+
    			"kilometers of the current screen display is less than this threshold.");
	    gridData3.horizontalAlignment = GridData.FILL;	                 
	    maxLabelDisplayWidthSlider.setLayoutData(gridData3);
	    maxLabelDisplayWidthSlider.setMinimum(100);
	    maxLabelDisplayWidthSlider.setMaximum(40200);
	    maxLabelDisplayWidthSlider.setIncrement(10);
	    maxLabelDisplayWidthSlider.setPageIncrement(1000);
    	Integer lblDispWidth = (Integer)maxLabelDisplayWidth.getAttrValue();
    	maxLabelDisplayWidthSlider.setSelection( lblDispWidth );
    	maxLabelDisplayWidthSlider.addSelectionListener(new SelectionAdapter() {
	        public void widgetSelected(SelectionEvent event) {
	        	maxLabelDisplayWidth.setAttrValue( ((Integer)maxLabelDisplayWidthSlider.getSelection() ) );
				maxLabelDisplayWidthSliderText.setText( maxLabelDisplayWidth.getAttrValue().toString() +" km");
	        	maxLabelDisplayWidthSliderText.redraw();
	        	maxLabelDisplayWidthSliderText.update();
	        }
	    });
	    ...
	    applyCurZoomLvlBtn.addSelectionListener( new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {				
				...
				maxLabelDisplayWidth.setAttrValue( currMapWidth.intValue() );
				maxLabelDisplayWidthSliderText.setText( maxLabelDisplayWidth.getAttrValue().toString() +" km");
				maxLabelDisplayWidthSliderText.redraw();
				maxLabelDisplayWidthSliderText.update();
				maxLabelDisplayWidthSlider.setSelection( currMapWidth.intValue() );				
			}
		});
