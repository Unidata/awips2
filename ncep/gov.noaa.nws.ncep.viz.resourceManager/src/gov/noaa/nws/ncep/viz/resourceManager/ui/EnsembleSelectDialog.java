...
import gov.noaa.nws.ncep.viz.resourceManager.ui.ModelListInfo.ModelInfo;
...
//    	addSeparator();
    ...
    private void readEnsemblTable() {
    	...
    	ensInfo1.memberNumber = 3;
//    	ensInfo1.cycles = new String[4];
    	ensInfo1.cycles[0] = "18";
    	ensInfo1.cycles[1] = "12";
    	ensInfo1.cycles[2] = "06";
    	ensInfo1.cycles[3] = "00";
    	
    	
    	ensInfo1.members = new EnsembleInfo[ensInfo1.memberNumber];
    	ensInfo1.members[0] = new EnsembleInfo();
    	ensInfo1.members[0].name = "gefs:01";
    	ensInfo1.members[0].hasMembers = false;
    	ensInfo1.members[0].isFirst = false;
    	
    	ensInfo1.members[1] = new EnsembleInfo();
    	ensInfo1.members[1].name = "gefs:03";
    	ensInfo1.members[1].hasMembers = false;
    	ensInfo1.members[1].isFirst = false;
    	
    	ensInfo1.members[2] = new EnsembleInfo();
    	ensInfo1.members[2].name = "gefs:05";
    	ensInfo1.members[2].hasMembers = false;
    	ensInfo1.members[2].isFirst = false;
    	...
    	ensInfo2.cycles = new String[4];
    	ensInfo2.cycles[0] = "18";
    	ensInfo2.cycles[1] = "12";
    	ensInfo2.cycles[2] = "06";
    	ensInfo2.cycles[3] = "00";
    	
    	ensInfoList.add(ensInfo2);
    	
    	EnsembleInfo ensInfo3 = new EnsembleInfo();
    	ensInfo3.name = "gfs";
    	ensInfo3.hasMembers = false;
    	ensInfo3.isFirst = false;
    	ensInfo3.cycles = new String[4];
    	ensInfo3.cycles[0] = "18";
    	ensInfo3.cycles[1] = "12";
    	ensInfo3.cycles[2] = "06";
    	ensInfo3.cycles[3] = "00";
    	
    	ensInfoList.add(ensInfo3);
    ...
    private void createModelListControls() {
        ...
        gd.heightHint = 5 * HEIGHT_PER_LINE;
    	...
    	if (isMember) hasMembers = false;
     	...
     	if (isMember) {
     		...
     		for (int jj = 0; jj < ensInfoList.get(index).members[memberIndex].cycleNumber; jj++) {
         		...
         		ensInfoList.get(index).members[memberIndex].cycleButtons[jj].setText("10/" + ensInfoList.get(index).cycles[jj]+ "      ");
     	 ...
     	 */
     		...
     		for (int jj = 0; jj < ensInfoList.get(index).cycleNumber; jj++) {
     			...
     			ensInfoList.get(index).cycleButtons[jj].setText("10/" + ensInfoList.get(index).cycles[jj]+ "      ");
