...
public class ScdSeparator extends AbstractRecordSeparator {
    ...
    public static ScdSeparator separate(byte[] data, Headers headers) {
        ScdSeparator ds = new ScdSeparator();
