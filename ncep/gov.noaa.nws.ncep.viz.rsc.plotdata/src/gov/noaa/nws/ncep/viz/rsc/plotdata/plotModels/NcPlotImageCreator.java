 ...
 */
 ...
 public class NcPlotImageCreator {
     ...
     private static String[] skycSymbolNames         = new String[]{"SKY_COVER_00","SKY_COVER_01","SKY_COVER_02","SKY_COVER_03",
		                                                   "SKY_COVER_04","SKY_COVER_05","SKY_COVER_06","SKY_COVER_07",
		                                                   "SKY_COVER_08","SKY_COVER_09","SKY_COVER_10"}; 
     private static String[] presWxSymbolNames       = new String[]{"PRESENT_WX_080","PRESENT_WX_081","PRESENT_WX_082","PRESENT_WX_085","PRESENT_WX_086","PRESENT_WX_095","PRESENT_WX_097",
    	                                                            "PRESENT_WX_066","PRESENT_WX_010","PRESENT_WX_048","PRESENT_WX_041","PRESENT_WX_044","PRESENT_WX_045","PRESENT_WX_019",
    	                                                            "PRESENT_WX_008","PRESENT_WX_036","PRESENT_WX_037","PRESENT_WX_039","PRESENT_WX_004","PRESENT_WX_005","PRESENT_WX_006",
    	                                                            "PRESENT_WX_007","PRESENT_WX_009","PRESENT_WX_056","PRESENT_WX_067","PRESENT_WX_057","PRESENT_WX_088","PRESENT_WX_078",
    	                                                            "PRESENT_WX_079","PRESENT_WX_087","PRESENT_WX_058","PRESENT_WX_069","PRESENT_WX_061","PRESENT_WX_065","PRESENT_WX_063",
    	                                                            "PRESENT_WX_051","PRESENT_WX_055","PRESENT_WX_053","PRESENT_WX_071","PRESENT_WX_075","PRESENT_WX_073","PRESENT_WX_203",
    	                                                            "PRESENT_WX_079","PRESENT_WX_077","PRESENT_WX_201","PRESENT_WX_044"};
     private static String[] icingSymbolNames        = new String[]{"ICING_00","ICING_01","ICING_02","ICING_03","ICING_04","ICING_05","ICING_06","ICING_08"};

     private static String[] turbSymbolNames         = new String[]{"TURBULENCE_0","TURBULENCE_1","TURBULENCE_2","TURBULENCE_3","TURBULENCE_4","TURBULENCE_5","TURBULENCE_6","TURBULENCE_7"};

     private static String[] presTendencySymbolNames = new String[]{"PRESSURE_TENDENCY_00","PRESSURE_TENDENCY_01","PRESSURE_TENDENCY_02","PRESSURE_TENDENCY_03","PRESSURE_TENDENCY_04",
    	                                                            "PRESSURE_TENDENCY_05","PRESSURE_TENDENCY_06","PRESSURE_TENDENCY_07","PRESSURE_TENDENCY_08"};
	 ...
	 private static final File COURIER_NORMAL_FONT_FILE         = NcPathManager.getInstance().getStaticFile (NcPathManager.NcPathConstants.FONT_FILES_DIR + "cour.pfa");
	 private static final File SERIF_NORMAL_FONT_FILE           = NcPathManager.getInstance().getStaticFile (NcPathManager.NcPathConstants.FONT_FILES_DIR + "VeraSe.ttf");
	 private static final File SERIF_BOLD_FONT_FILE             = NcPathManager.getInstance().getStaticFile (NcPathManager.NcPathConstants.FONT_FILES_DIR + "l049016t.pfa");
	 private static final File SERIF_ITALIC_FONT_FILE           = NcPathManager.getInstance().getStaticFile (NcPathManager.NcPathConstants.FONT_FILES_DIR + "l049033t.pfa");
	 private static final File SERIF_BOLD_ITALIC_FONT_FILE      = NcPathManager.getInstance().getStaticFile (NcPathManager.NcPathConstants.FONT_FILES_DIR + "l049036t.pfa");    
	    
	 private static final File SANS_SERIF_NORMAL_FONT_FILE      = NcPathManager.getInstance().getStaticFile (NcPathManager.NcPathConstants.FONT_FILES_DIR + "luxisr.ttf");
	 private static final File SANS_SERIF_ITALIC_FONT_FILE      = NcPathManager.getInstance().getStaticFile (NcPathManager.NcPathConstants.FONT_FILES_DIR + "luxisri.ttf");
	 private static final File SANS_SERIF_BOLD_FONT_FILE        = NcPathManager.getInstance().getStaticFile (NcPathManager.NcPathConstants.FONT_FILES_DIR + "luxisb.ttf");
	 private static final File SANS_SERIF_BOLD_ITALIC_FONT_FILE = NcPathManager.getInstance().getStaticFile (NcPathManager.NcPathConstants.FONT_FILES_DIR + "luxisbi.ttf");	 
	 ...
	 public NcPlotImageCreator( IPointInfoRenderingListener listener, PlotModel plotModel, double initialDensity ){
		  defaultColor                  = new RGB(255, 255, 255); 
          this.plotModel                = plotModel;
    	  plotParameterDefinitions      = PlotParameterDefnsMngr.getInstance().getPlotParamDefns(plotModel.getPlugin());
    	  imageCreationJobPool          = new JobPool("Creating station plots", 8, false);
	...
	public  synchronized void queueStationsToCreateImages(DataTime dt, Collection<Station> stations, double thePlotDensity){
		 QueueEntry qe = new QueueEntry(dt, stations);
		 timeLogger.append("\nAbout to queue "+stations.size() + " stations from frame "+dt.toString()+" for image creation\n");
	 ...
	 private void runCreateImageTask(double thePlotDensity){
	    	...
	    	while( queueOfStations.peek() != null ){
	    		...
	    		timeLogger.append("\nAbout to schedule image drawing task for "
	    				             + qe.getStations().size() 
	    				             + " stations from frame "
	    				             +qe.getDataTime().toString()+ "\n");
	    		
	    		CreateDrawableStringsTask task = new CreateDrawableStringsTask(qe.getDataTime(), qe.getStations(), thePlotDensity);
	    		imageCreationJobPool.schedule(task);
	    	}
	 }
	 
	 private void initializeFonts(){
		 IDisplayPane displayPane  = NcDisplayMngr.getActiveNatlCntrsEditor().getActiveDisplayPane();
		 IGraphicsTarget target    = displayPane.getTarget();
		 COURIER_BOLD_FONT         = target.initializeFont( COURIER_NORMAL_FONT_FILE, IFont.FontType.TYPE1, initialFontSize, new IFont.Style[]{IFont.Style.BOLD} );
		 COURIER_BOLD_ITALIC_FONT  = target.initializeFont( COURIER_NORMAL_FONT_FILE, IFont.FontType.TYPE1, initialFontSize, new IFont.Style[]{IFont.Style.BOLD, IFont.Style.ITALIC} );
         COURIER_ITALIC_FONT       = target.initializeFont( COURIER_NORMAL_FONT_FILE, IFont.FontType.TYPE1, initialFontSize, new IFont.Style[]{IFont.Style.ITALIC} );    
		 COURIER_NORMAL_FONT       = target.initializeFont( COURIER_NORMAL_FONT_FILE, IFont.FontType.TYPE1, initialFontSize, null );
		 
		 SERIF_BOLD_FONT           = target.initializeFont( SERIF_BOLD_FONT_FILE, IFont.FontType.TYPE1, initialFontSize, new IFont.Style[]{IFont.Style.BOLD} );
		 SERIF_BOLD_ITALIC_FONT    = target.initializeFont( SERIF_BOLD_ITALIC_FONT_FILE, IFont.FontType.TYPE1, initialFontSize, new IFont.Style[]{IFont.Style.BOLD, IFont.Style.ITALIC} );
		 SERIF_ITALIC_FONT         = target.initializeFont( SERIF_ITALIC_FONT_FILE, IFont.FontType.TYPE1, initialFontSize, new IFont.Style[]{IFont.Style.ITALIC} );
		 SERIF_NORMAL_FONT         = target.initializeFont( SERIF_NORMAL_FONT_FILE, IFont.FontType.TRUETYPE, initialFontSize, null );
		 
		 SANS_SERIF_BOLD_FONT           = target.initializeFont( SANS_SERIF_BOLD_FONT_FILE, IFont.FontType.TRUETYPE, initialFontSize, new IFont.Style[]{IFont.Style.BOLD} );
		 SANS_SERIF_BOLD_ITALIC_FONT    = target.initializeFont( SANS_SERIF_BOLD_ITALIC_FONT_FILE, IFont.FontType.TRUETYPE, initialFontSize, new IFont.Style[]{IFont.Style.BOLD, IFont.Style.ITALIC} );
		 SANS_SERIF_ITALIC_FONT         = target.initializeFont( SANS_SERIF_ITALIC_FONT_FILE, IFont.FontType.TRUETYPE, initialFontSize, new IFont.Style[]{IFont.Style.ITALIC} );		 
		 SANS_SERIF_NORMAL_FONT         = target.initializeFont( SANS_SERIF_NORMAL_FONT_FILE, IFont.FontType.TRUETYPE, initialFontSize, null );
	 }
	 
	  public Position getPositionFromPlotModelElementPosition(String plotModelElementPosition){
	  ...
	  private void setUpPlotModelElementToPlotColorMapping( Position p, PlotModelElement pme ){
		  if(pme != null ){
			 gov.noaa.nws.ncep.viz.rsc.plotdata.plotModels.elements.Color pmeColor = pme.getColor();
			 RGB oldColor = plotPosToColorMap.get(p);
			 if( oldColor == null
					 || ((oldColor.red != pmeColor.getRed())
					 || (oldColor.green != pmeColor.getGreen())
					 ||(oldColor.blue != pmeColor.getBlue()))){
 			    RGB newColor = new RGB(pmeColor.getRed(),
 					                pmeColor.getGreen(),
 					                pmeColor.getBlue());
	  ...
	  private void setUpPlotModelToSymbolSizeMapping(Position p, PlotModelElement pme){
		  if( pme != null ){
			  Double newSymbolSize = pme.getSymbolSize();
			  Double oldSymbolSize = plotPosToSymbolSizeMap.get(p);
			  if( oldSymbolSize == null 
					|| ( Math.abs( oldSymbolSize.doubleValue() - newSymbolSize.doubleValue() ) > 0.001 ))
		     ...
		     int fontSize     = Integer.parseInt( pme.getTextSize() );
 			 ...
 			 if(prevFont == null ){
 				 ...
 				 prevFont   = font;
 				   ...
 				   /*Change the font only if the style/size/font name do not match the previous font*/
	  ...
	  public void setUpPlotPositionToPlotModelElementMapping(PlotModel pm){
		  List<PlotModelElement> plotModelElementsList = pm.getAllPlotModelElements();
	         if( plotModelElementsList != null && !plotModelElementsList.isEmpty() ){
	        	 synchronized( plotModelElementsList ){
	        	    for( PlotModelElement pme :  plotModelElementsList ){
	        		     Position position    = getPositionFromPlotModelElementPosition(pme.getPosition());
    	      ...
    	      for( Position p : posToRemove ){
    		       ...
    		       if( p == Position.WD ){
    		    	   ...
    		    	   if( dataTimeToText != null && !dataTimeToText.isEmpty() ){
       	    	          Set<DataTime> frameTimeSet = dataTimeToText.keySet();
       	    	          if( frameTimeSet != null && !frameTimeSet.isEmpty()){
       	    	              synchronized(frameTimeSet){
       	    	        	     for( DataTime  dt : frameTimeSet ){
       	    	        	        Map<Position, Map<String, DrawableString>> mapOfStrPosition = dataTimeToText.get(dt);
       	    	        	        if( mapOfStrPosition != null && !mapOfStrPosition.isEmpty()){
       	    	        		       mapOfStrPosition.remove(p);
       	    	        		       dataTimeToText.put(dt, mapOfStrPosition);
       	    	        	        }
       	    	                 }
       	    	              }  
       	    	           }
    	   	    	 ...
    	   	    	 if(mapOfSymbolsPerPlotPosPerFrame != null && 
       	    	        ...
       	    	        Set<DataTime>  frameTimeSet = mapOfSymbolsPerPlotPosPerFrame.keySet();
       	    	        if( frameTimeSet != null && !frameTimeSet.isEmpty() ){
       	    	            synchronized(frameTimeSet){
        	    	        	   for( DataTime  dt : frameTimeSet ){
        	    	        	        Map<Position, List<SymbolLocationSet>> mapOfSymbolsToEachPosition = mapOfSymbolsPerPlotPosPerFrame.get(dt);
        	    	        	        if( mapOfSymbolsToEachPosition != null && 
        	    	        	        		!mapOfSymbolsToEachPosition.isEmpty()){
        	    	        		        mapOfSymbolsToEachPosition.remove(p);
        	    	        		        mapOfSymbolsPerPlotPosPerFrame.put(dt, mapOfSymbolsToEachPosition);
        	    	        	        }
        	    	                }
        	    	            }      	    	        	
       	    	        }    		    	   
	 ...
	 public void setUpSymbolMappingTables(){
		 ...
		 for( Position position :  positionSet ){
        	 ...
        	 PlotParameterDefn thisPlotParamDefn = plotParameterDefinitions.getPlotParamDefn( plotParamName );
        	 if( thisPlotParamDefn == null ){
        		 System.out.println("Unable to find " + plotParamName + " in the list of plot parameter definitions for " 
        					             + plotModel.getPlugin() + ":" + plotModel.getName());
        		 continue;
        	 }

        	if ( thisPlotParamDefn.getPlotMode().compareToIgnoreCase("table") == 0 ){
        		 PlotSymbolType symbolType = getPlotSymbolType( pme.getParamName() );
        	     if( symbolType != PlotSymbolType.INVALID ){
        			    	  ...
        			    	  StringLookup lookupTable = StringLookup.readS2SFile(thisPlotParamDefn.getPlotLookupTable());
		    				  symbolLookupTable.put(symbolType, lookupTable);
		    				  String[] arrayToSearch = new String[0];
        			    	  switch( symbolType ){
		    				  case WSYM:
		    					  arrayToSearch = Arrays.copyOf(presWxSymbolNames, presWxSymbolNames.length);
		    					  break;
		    				  case SKYC:
		    					  arrayToSearch = Arrays.copyOf(skycSymbolNames, skycSymbolNames.length);
		    					  break;
		    				  case ICSY:
		    					  arrayToSearch = Arrays.copyOf(icingSymbolNames, icingSymbolNames.length);
		    					  break;
		    				  
		    				  case TBSY:
		    					  arrayToSearch = Arrays.copyOf(turbSymbolNames, turbSymbolNames.length);
		    					  break;

		    				  case PTSY:
		    					  arrayToSearch = Arrays.copyOf(presTendencySymbolNames, presTendencySymbolNames.length);
		    					  break;
		    				    default:
		    				    	break;
		    				  }
        			    	  ...
        			    	  if( arrayToSearch.length > 0 ){
        			    		  ...
        			    		  Color symbolColor          = new Color( rgb.red,rgb.green,rgb.blue);
        			    		  Color[] colorArray         = new Color[]{symbolColor};
                                  Coordinate dummyCoordinate = new Coordinate(0.0,0.0);
                                  float symbolSize           = plotPosToSymbolSizeMap.get(position).floatValue();
                                  /*
                                   * Create each symbol once to render it at different locations as needed
                                   */
                                  synchronized(arrayToSearch){
                                     for( String symbolName : arrayToSearch ){
                                	      Symbol symbol = symbolNameToSymbolMap.get( symbolName );
      	                                  if( symbol == null ){
      		                                  symbol = new Symbol( null, colorArray,
      	                        	    	  	                   symbolSize,symbolSize,
                                                                   true, dummyCoordinate, "Symbol", symbolName );
                                          } else{
      	                        	    	      if(!symbolColor.equals(symbol.getColors()[0]))
                                        	          symbol.setColors(colorArray);
      	                        	    	      if( Math.abs( symbolSize - symbol.getSizeScale() ) > 0.01 )  {  
      	                        	    	          symbol.setSizeScale( symbolSize );
      	                        	    	          plotPosToSymbolSizeMap.put(position, new Double(symbolSize));
      	                        	    	      }
      	                        	      }
      	                                  symbolNameToSymbolMap.put( symbolName, symbol );
                                     }
        			    	     }
...
//		 }		 
	...
	public static interface IPointInfoRenderingListener {
	        public void renderingComplete(DataTime time, Collection<Station> disclosed, List<DrawableString> listOfStrinsToDraw, List<IVector> listOfWindVectors, List<SymbolLocationSet> listOfSymbolLocSet );
	} 	
	...
	private final class CreateDrawableStringsTask implements Runnable{
		...
		public CreateDrawableStringsTask(DataTime time, Collection<Station> listOfStationsToDrawImages, double thePlotDensity){
//			System.out.println("Creating a CreateDrawableStringsTask for the frame time: " + time.toString());
			this.dataTime       = new DataTime(time.getRefTime());
			this.listOfStations = new ArrayList<Station>(listOfStationsToDrawImages);
            activePane          = NcDisplayMngr.getActiveNatlCntrsEditor().getActiveDisplayPane();
			...
			if ( lastZoomLevel == Double.MIN_VALUE  || ( Math.abs( renderableDisplay.getZoom()  - lastZoomLevel) > ZOOM_TOLERANCE) ){
...
//			System.out.println("Created key = " + key);
	    ...
	    private Map<Coordinate,IVector> createWindVectors( Collection<Station> stnColl, String plotUnit, double symbolSize, 
	    		                        Color[] windVectorColorArray, String metPrm1, String metPrm2, PlotModelElement pme ){
			 Map<Coordinate,IVector> localVectorPosToVectorMap = new HashMap<Coordinate, IVector>(0);
			 Semaphore ss = new Semaphore(1);
			 ss.acquireUninterruptibly();
			 mapDescriptor = NcDisplayMngr.getActiveNatlCntrsEditor().getActiveDisplayPane().getDescriptor();
			 synchronized(stnColl){
			 for( Station currentStation : stnColl ){
	    		 
				    double[] stationWorldLoc      = {currentStation.info.longitude, currentStation.info.latitude};
	  		         ...
	  		         try{
			        	      ...
			        	      synchronized (currentStation.listOfParamsToPlot ){
		  		                 for ( AbstractMetParameter metPrm :  currentStation.listOfParamsToPlot ){
		  		            		if(metPrm.getMetParamName().compareToIgnoreCase(metPrm1) == 0 )
		  		            			vectorParam1 = metPrm;
		  		            		
		  		            		if ( metPrm.getMetParamName().compareToIgnoreCase( metPrm2 ) == 0 )
		  		            			vectorParam2 = metPrm;
		  		            		
		  		            		if(vectorParam1 != null && vectorParam2 != null ){
		  		            			RGB rgb = null;
		  		            	        if(pme.hasAdvancedSettings()){
		  		            	        	rgb = getConditionalColor(currentStation, pme);
		  		            	        }
		  		            			
		  		            	        if( rgb != null) {
		  		            	        	windVectorColorArray = new Color[]{new Color(rgb.red, rgb.green, rgb.blue)};
		  		            	        }
		  		            	        
		  		            			vector =  processBarbDirective(vectorParam1, vectorParam2, plotUnit, symbolSize,
		  		            					                       windVectorColorArray, stationWorldLoc);   
		  		            			break;
		  		            		}
			        	          ...
			        	          if( vector != null  ){
			        	        	  //timeLogger.append("\nAdding a wind barb for " + currentStation.info.stationId );
			        	        	  localVectorPosToVectorMap.put(vector.getLocation(), vector);
//			        	        	  System.out.println("Created vector for " + currentStation.info.stationId);
			        	          }
			                	...
			                	//System.out.println("ArithmeticException instead of azimuth for station : " + currentStation.info.stationId);
			                	ss.release();
	                      }
	  		            
	  		            catch(IllegalStateException ise){
			                	//System.out.println("IllegalStateException instead of azimuth for station : " + currentStation.info.stationId);
			                	ss.release();
			                }
			                catch(NullPointerException npe){
			                	//System.out.println("NullPointerException for " + currentStation.info.stationId);
			                	ss.release();
			                }
                           catch(Exception e){
                        	   ss.release();
...
//					}
	    ...
	    private IVector processBarbDirective( AbstractMetParameter metParam1,
	           ...
	           double[] stationLoc ) {
		        ...
		        double cWindSpeed = windSpeed.getValueAs( plotUnit ).doubleValue();
		        double dWindSpeed = Double.MIN_VALUE;
		        Unit<?> unit;
				
					unit = ( Unit<?>) UnitFormat.getUCUMInstance().parseObject( plotUnit );
			        double cWindSpeedThresh = WIND_SPD_3KNOTS.getValueAs( unit ).doubleValue();

			        	if( cWindSpeed >= cWindSpeedThresh ) 
			        	    dWindSpeed = windNormalizer(cWindSpeed);
			        	
			        	vector = new Vector( null, windVectorColorArray,1.0f,symbolSize, false, 
			                    new Coordinate(stationLoc[0], stationLoc[1]), 
			                    VectorType.WIND_BARB, dWindSpeed, dWindDir, 2.0, 
			                    true, "Vector", "Barb");			        	
		...
		private final synchronized void createRenderableData(){
			 if(listOfStations == null || listOfStations.isEmpty() )
					return;
//			      System.out.println("\nAbout to create renderable data for frame: " + dataTime.toString());     
				  ...
				  List<SymbolLocationSet> symLocSetList         = new ArrayList<SymbolLocationSet>(0);
				  Map<Coordinate, IVector> vectorPosToVectorMap = null; 

				 if( dataTimeToText.get( dataTime ) != null )
					 localDMap = new HashMap< Position, Map<String,DrawableString>>( dataTimeToText.get( dataTime ) );
				 else
				     localDMap = new HashMap< Position, Map<String,DrawableString>>();
				 
				 Set<Position> positionSet       = plotModelPositionMap.keySet();
				 Map<String, Station> stationMap = new HashMap< String, Station>( listOfStations.size() );
				 Semaphore sm = new Semaphore(1);
				 
				 sm.acquireUninterruptibly();
//				 System.out.println("From createRenderableData()  - list of parameters plotted per station for frame: " + dataTime.toString());
				 /*Create a map of stations that have been currently disclosed*/
		    	 for( Station station : listOfStations ){
		    		 
		    		         String key = createStationMapKey( station.info.longitude, station.info.latitude)  
...
//			    		                		    + " : " );
			    		                   synchronized( station.stnPlotMap ){
			    		                	   Set<Position> stnPosSet = station.stnPlotMap.keySet();
			    		                	   synchronized(stnPosSet){
			    		                	       for( Position p : stnPosSet ){
			    		                		        DrawableBasics dbs = station.stnPlotMap.get(p);
//			    		                		        System.out.println(p.toString() + " - " + dbs.x + "," + dbs.y);
			    		                	        }
			    		                	   }
			    		                   }
//			    		                   System.out.println( "\nFor frame "+ dataTime.toString() 
//			    		                		             + " "
//			    		                		             + station.info.stationId 
//			    		                		             + " at time " 
//			    		                		             + station.info.dataTime.toString() 
...
//			    		                	             System.out.println(station.listOfParamsToPlot);
//			    		                   }		    		                	   
		    		                   }catch(Exception e){
...
//		    		    }
		    	 ...
		    	 Map<String ,Station> prevStationMap = mapOfStnsToDataTime.get( dataTime ); 
				 ...
				 Rectangle2D r = aTarget.getStringsBounds(new DrawableString("M",defaultColor));
				 double width  = r.getWidth();
				 
				 Rectangle2D r2 = aTarget.getStringsBounds(new DrawableString("'y",defaultColor)); 
				 double height  = r2.getHeight();
				 Rectangle textBounds = new Rectangle(0,0,(int)width,(int) height);  			
	             ...
	             double currZoomLevel = mapDescriptor.getRenderableDisplay().getZoom();
	    	     
                 /*If the extents or the zoom level have changed since the last time...*/
		         if (   Math.abs( currViewExtent.getEnvelope().getMinX() - lastViewExtent.getEnvelope().getMinX())> TOLERANCE 
		    	     || Math.abs( currViewExtent.getEnvelope().getMaxX() - lastViewExtent.getEnvelope().getMaxX())> TOLERANCE
		    	     || Math.abs( currViewExtent.getEnvelope().getMinY() - lastViewExtent.getEnvelope().getMinY())> TOLERANCE
		    	     || Math.abs( currViewExtent.getEnvelope().getMaxY() - lastViewExtent.getEnvelope().getMaxY())> TOLERANCE
...
//		        	 System.out.println("station density changed");
			    	      ...
			    	      if(prevStationMap != null && !prevStationMap.isEmpty()){
			    	    	  synchronized(prevStationMap){
				    	        ...
				    	        for( String oldStnKey : prevStationKeySet ){
				    	    	   /*For each station in the map of stations previously processed, 
				    	    	    *if it is not present in the current map of stations, add it to a separate list of stations 
				    	    	    *that will eventually be discarded in the current run*/
		    	 ...
		    	 for ( Position position : positionSet ){
					 ...
					 /*Get the formatting information from the PlotModelElement for the current plot position*/
			    	 PlotModelElement pme = plotModelPositionMap.get(position);
...
//			    	 }
	    			 ...
	    			 /*Get the data retrieval information from the PlotParameterDefn corresponding to the current PlotModelElement*/
	    			 PlotParameterDefn  plotParamDefn  = plotParameterDefinitions.getPlotParamDefn( pme.getParamName() );
	    			 
		    		 boolean drawVector = ( position == Position.WD );
		    		 boolean drawSymbol = ( posToSymbolTypeMap.get(position) != null);
		    		 boolean drawTextOnly = ( plotParamDefn.getPlotMode().compareTo("table") != 0 ) 
		    				                  && ( plotParamDefn.getPlotMode().compareTo("barb") != 0 );

		    		 
		    		 if ( drawTextOnly ){
		    			  Map<String, DrawableString> mapOfStrPositions =   localDMap.get( position ) ;
		    			  ...
		    			  if( drawTextFirstTime ){
						    	 ...
						    	 sm.acquireUninterruptibly();
						    	 /*Loop thru all the stations to create the a list of DrawableString for each position*/ 
						    	 ...
						    	 synchronized(stnKeySet){
			        			  for( String key : stnKeySet ){
			        				   ...
			        				   //Sanity check - shouldn't happen since this is already taken care of after querying the data from Postgres
			        				   if(station.info.longitude > 180 
			        				    		|| station.info.longitude < -180 
			        				    		|| station.info.latitude > 90 
			        				    		|| station.info.latitude < -90){
//			        				    	System.out.println("Skipping the station: " 
//			        				    		+ station.info.stationId + " since it has invalid or missing coordinates");
			        				    	continue;
			        				    }
			        				  
		      				           double worldLoc[]     = new double[]{station.info.longitude, station.info.latitude};
		 					           double[] tempPixLoc   = mapDescriptor.worldToPixel( worldLoc );
		 					           station.pixelLocation = new Coordinate( tempPixLoc[0], tempPixLoc[1] );
		    				      
		 					       
		 					           /*Create the string to be rendered*/
		 					           DrawableString drawableString = getDrawableStringForStation( station, plotParamDefn, font, 
		 					    		                                                        pmeColor, position,  aTarget, pme );
		    				 
		    				           if( drawableString != null ){
                                           
		    				        	   
		    				    	        /*For each station - Store the pixel coordinates of the string to be rendered, mapped to the position at which it needs to be rendered */
		    				    	        station.stnPlotMap.put(position, drawableString.basics );
		    				    	      
		    				    	        /*Add the pixel coordinates and the string to render to the Map<DrawableBasics, DrawableString> */
		    				    	        String dbKey = createKeyFromTextCoordinates(drawableString.basics);
		    				    	        mapOfStrPositions.put(dbKey, drawableString);
...
//     				    		               + " for station: " 
//     				    		               + station.info.stationId  + " for frame: " + dataTime.toString() );
//
//		    				    	         //continue;
//		    				           }
		    				           
	    				    	        /*Update the stationMap with the current station*/ 
	    				    	        stationMap.put(key, station);
...
//		    				       }
		    				      if( hasStationDensityChanged ){
		    				    	  ...
		    				    	  for(String stnid : setOfKeysfOfStationsNotDisclosed ){
		    				    		  Station obsoleteStation = prevStationMap.get(stnid);
         			    	    		  /*Remove the corresponding string that was previously rendered at the current plot position
        			    	    		    *for this station*/		    				    		  
		    				    		  if( obsoleteStation != null && obsoleteStation.stnPlotMap != null ){
		    				    		      DrawableBasics dbStn    = obsoleteStation.stnPlotMap.get( position );
		    				    		      DrawableString str = mapOfStrPositions.get( createKeyFromTextCoordinates( dbStn ) ); 
		    				    		      mapOfStrPositions.remove( dbStn );
//		    				    		      if( str != null )
//		    				    		          System.out.println( dataTime.toString() + " " + position.toString() + " : "
//		    				    		              + plotParamDefn.getPlotParamName() + " - Removing " 
//		    				    		        	  + str.getText()[0] + " for obsolete station: " 
//		    				    		              + obsoleteStation.info.stationId 
//		    				    		              + " from the pixel position: "
//		    				    		              + dbStn.x
//		    				    		              + dbStn.y);
		    				    		      /*Also remove the obsolete pixel position from the station's plot position map*/
		    				    	  ...
		    				    	  sm.release();
	         			    	      ...
	         			    	      /*Loop through the remaining strings at the current plot position and if they don't
	         			    	       * lie within the current extents, discard them - this takes care of removing strings for 
	         			    	       * stations that are currently disclosed - whose previously rendered strings 
	         			    	       * need to be repositioned per the current pixel position of the station*/
	         			    	    	...
	         			    	    	synchronized( dbSet ){
	         			    	    		try{
	         			    	    		      for(  String db : dbSet ){
	         			    	    		    	    ...
	         			    	    		    	    double dbx = Double.parseDouble(coords[0])/1000;
	         			    	    		    	    double dby = Double.parseDouble(coords[1])/1000;
	         			    	    	                if ( !view.getExtent().contains( new double[]{ dbx, dby } ) ){
	            	                               ...
	            	                               synchronized( pixPosToRemoveList ){
	            	                                 	for( String db : pixPosToRemoveList ){
	            	                                 		   ...
	            	                                 		   DrawableString str = mapOfStrPositions.get(db);
//	            	                                 		   if( str != null )
//	            	                                 			   System.out.println( dataTime.toString() 
//	            	                                 			   + " " 
//	            	                                 			   + position.toString() + " : "
...
//				        				    		+ station.info.stationId + " since it has invalid or missing coordinates");
							    	       ...
							    	       /*For each station, update its pixel coordinates per the current map descriptor*/
				      				       double worldLoc[]       = new double[]{ station.info.longitude, station.info.latitude };
				 					       double[] tempPixLoc     = mapDescriptor.worldToPixel( worldLoc );
				 					       station.pixelLocation.x = tempPixLoc[0];
				 					       station.pixelLocation.y = tempPixLoc[1];

				 					       /*Working off of the pixel coordinates at each position per station */
							    		   DrawableBasics dbStn    =  station.stnPlotMap.get( position );

							    		   if(dbStn != null ){
							    			  
							    			  /*Fetch the corresponding string from the Map<DrawableBasics, DrawableString>*/
							    			  String strPosKey = createKeyFromTextCoordinates( dbStn );
							    		      DrawableString strToReposition = mapOfStrPositions.get( strPosKey );
							    		      
							    		      if( strToReposition != null ){
//							    		    	  System.out.println(  dataTime.toString() + " Removing "
...
//							    		    			             + station.info.stationId);
							    		    	  ...
							    		    	  /*If the string exists update its coordinates*/
//					    	        			   System.out.println(  dataTime.toString() 
//					    	        					   + " " + position.toString() + " : "
//							    		    	           + plotParamDefn.getPlotParamName() 
...
//		    	        					               + " at " + dataTime.toString());
					    	        			   ...
					    	        			   Rectangle2D rr = aTarget.getStringsBounds( new DrawableString("'" 
					    	        			                            + strToReposition.getText()[0]
					    	        			                            + "y", strToReposition.getColors()[0]));
					    	        			   textBounds = new Rectangle(0,0,(int)rr.getWidth(), (int)rr.getHeight());
							    		    	   double[] pixLoc = getUpdatedCoordinates(textBounds, station.pixelLocation.x,
				                                             station.pixelLocation.y,
				                                             view, canvasBounds, position);
					    	        			    
							    		    	   
							    		    	   strToReposition.setCoordinates(pixLoc[0], pixLoc[1]);
							    		    	    
					    	        			   /*Update the map of strings to be rendered as well as the stationMap*/

					    	        			   
					    	        			   RGB oldColor = strToReposition.getColors()[0];
					    	        			   if( (!pme.hasAdvancedSettings()) && ( oldColor != null ) && (oldColor.red != pmeColor.red 
					    	        					   || oldColor.green != pmeColor.green
					    	        					   || oldColor.blue != pmeColor.blue)){
					    	        				   strToReposition.setText(strToReposition.getText(), pmeColor);
					    	        			   }else if(pme.hasAdvancedSettings()){
					    	        				      RGB rgb  = getConditionalColor(station, pme); 
					    	        				      strToReposition.setText(strToReposition.getText(), rgb);
					    	        			   }
					    	        			   
	    	        			                   if( ( font.getFontName().compareTo( strToReposition.font.getFontName()) != 0) 
					    	        					   || ( Math.abs ( font.getFontSize()  - strToReposition.font.getFontSize()) > TOLERANCE )
					    	        					   || ( font.getStyle() != null 
					    	        					             && strToReposition.font.getStyle() != null
					    	        					             && font.getStyle().length > 0 
					    	        					             && strToReposition.font.getStyle().length > 0
					    	        					             && font.getStyle()[0] != strToReposition.font.getStyle()[0] )
					    	        					   || ( ( font.getStyle() == null || font.getStyle().length == 0 )
					    	        							   && strToReposition.font.getStyle() != null )         /*The style is set to null for plain style fonts*/
					    	        					   || ( font.getStyle() != null 
					    	        					                 && ( strToReposition.font.getStyle() == null 
					    	        					                   || strToReposition.font.getStyle().length == 0 )))
					    	        			   ...
					    	        			   synchronized( strToReposition.basics ){
						    	        			   ...
						    	        			   station.stnPlotMap.put(  position, strToReposition.basics );
...
//						    	        			                                  + station.stnPlotMap.get(position).y );
						    	        			   ...
						    	        			   mapOfStrPositions.put( localDbKey, strToReposition );
//						    	        			   if(mapOfStrPositions.get( localDbKey) != null ){
//						    	        			          System.out.println(  dataTime.toString() 
//						    	        					            + " For string: " 
//						    	        					            + mapOfStrPositions.get( localDbKey).getText()[0] 
//						    	        					            + " :: " );
//						    	        			   
//						    	        			          System.out.println( " Updated pix pos: " 
...
//						    	        			   }
							    			         ...
							    			         /*If none exists - create it - maybe the station reports this parameter only at a designated time*/   
							    			         DrawableString drawableString = getDrawableStringForStation(station, plotParamDefn, font, pmeColor, position,  aTarget, pme);
			                                         if (  drawableString != null ){
...
//			                                        			               + "::New parameter " 
//			                                        			               + plotParamDefn.getPlotParamName() + " = " 
//			                                        	                       + drawableString.getText()[0] + " reported by " 
//			                                        			               + station.info.stationId);
			                                        	   
			                                        	   station.stnPlotMap.put( position, drawableString.basics );
			                                        	   String keydb = createKeyFromTextCoordinates(  drawableString.basics );
						    				    	       mapOfStrPositions.put( keydb, drawableString );
			                                         }
//			                                         else{
//			  			         				           System.out.println(  dataTime.toString() 
...
//			                                         }
							    		      ...
							    		      stationMap.put( key, station);
							    			      ...
							    			      /*This could either be a new station or the previous pixel position could be obsolete. 
							    			       * So create the string to be rendered*/
//							    			      System.out.println(  dataTime.toString() + " Trying to create the met parameter value for a new station ?");
  							    			       DrawableString drawableString = getDrawableStringForStation( station, plotParamDefn, font, pmeColor, position,  aTarget, pme);
...
//						   
//						    				       }
						    				       /*And if it is not null - update the map of strings to be rendered as well as the stationMap*/
						    				       if( drawableString != null ){ 
						    				    	     
						    				    	      RGB oldColor = drawableString.getColors()[0];
							    	        			  if( (!pme.hasAdvancedSettings()) && (oldColor.red != pmeColor.red 
							    	        					   || oldColor.green != pmeColor.green
							    	        					   || oldColor.blue != pmeColor.blue)){
							    	        				       drawableString.setText( drawableString.getText(), pmeColor );
							    	        			  }else if( pme.hasAdvancedSettings() ){
						    	        				            RGB rgb  = getConditionalColor( station, pme ); 
						    	        				            drawableString.setText( drawableString.getText(), rgb );
						    	        			       }
							    	        			  
			    	        			                   if( ( font.getFontName().compareTo( drawableString.font.getFontName()) != 0) 
							    	        					   || ( Math.abs ( font.getFontSize()  - drawableString.font.getFontSize()) > TOLERANCE )
							    	        					   || ( font.getStyle() != null 
							    	        					             && drawableString.font.getStyle() != null
							    	        					             && font.getStyle().length > 0 
							    	        					             && drawableString.font.getStyle().length > 0
							    	        					             && font.getStyle()[0] != drawableString.font.getStyle()[0] )
							    	        					   || ( ( font.getStyle() == null || font.getStyle().length == 0 )
							    	        							   && drawableString.font.getStyle() != null )         /*The style is set to null for plain style fonts*/
							    	        					   || ( font.getStyle() != null 
							    	        					                 && ( drawableString.font.getStyle() == null 
							    	        					                   || drawableString.font.getStyle().length == 0 )))
...
//								    	        			   System.out.println(  plotParamDefn.getPlotParamName() 
//								    	        					                + dataTime.toString()
//								    	        					                + " Station "+ station.info.stationId + " : "
//										    	        			                + position.toString()  
//										    	        			                + " - Created " 
//										    	        			                + drawableString.getText()[0]
//										    	        			                + " at pix pos: " 
...
//							    	        					              + position.toString() + ":" 
//							    	        					              + plotParamDefn.getPlotParamName() 
//							    	        					              + " - Created " + drawableString.getText()[0] 
//							    	        					              + " for station " + station.info.stationId 
//							    	        					              + " at time " + dataTime.toString() );
		    			  ...
		    			  /* After looping thru all stations, for each position, update the Map<Position, Map<DrawableBasics, DrawableString>> */ 
					    	localDMap.put(position, mapOfStrPositions); 
					    	
					    	
//					    	sm.acquireUninterruptibly();
//					    	try{
//						    	 Map<String, DrawableString> dMap = localDMap.get(position); 
//					    	     synchronized( dMap ){
//					    	    	  Set<String> dbSet =  dMap.keySet();
//					    	    	  System.out.println(  dataTime.toString() + " After completing all processing for position "+  position.toString());
//					    	    	  
//					    	    	  for( String d : dbSet ){
//					    	    		   DrawableString str = dMap.get(d);
//					    	    		   System.out.println(" String " + str.getText()[0] + " at " + d);
//					    	    	  }
//					    	      }	
//					    	     
//					    	     System.out.println(  dataTime.toString() + " - " +  position.toString() + ":" + dMap.size());
//					    	}catch(Exception e){
//					    		 sm.release();	
//					    	}
//
...
//				    	     sm.release();
		    		 ...
		    		 if(drawVector){
		    			 ...
		    			 drawVectorsFirstTime = ( vectorPosToVectorMap == null );
	  		             String[] vectorPrmNames = plotParamDefn.getMetParamNamesForVectorPlot();
			    		 ...
			    		 Color[] windVectorColorArray = new Color[]{new Color(pmeColor.red,pmeColor.green,pmeColor.blue)};
...
//			    		 }
			    		 ...
			    		 if(drawVectorsFirstTime ){
		    				 ...
		    				 vectorPosToVectorMap = new HashMap<Coordinate, IVector>(createWindVectors(stnColl, plotParamDefn.getPlotUnit(), symbolSize,
                            		                windVectorColorArray, metPrm1, metPrm2, pme));
				    		  ...
				    		  sm.release();	  
		    				    ...
		    				    if( hasStationDensityChanged ){
		    				    	/*If the station density is different from the previous time this method was called, remove the obsolete wind vectors*/
		    				    	 sm.acquireUninterruptibly();
		    				    	 int counter = 0;
		    				    	 if( prevStationMap != null && !prevStationMap.isEmpty()){
			    				    	  for( String stnKey : setOfKeysfOfStationsNotDisclosed ){
				    				    		
			    				    		  Station obsoleteStation = prevStationMap.get(stnKey);
			    				    		  if( obsoleteStation != null ){
			    				    		      Coordinate coord        = new Coordinate ( obsoleteStation.info.longitude,
			    				    				                             obsoleteStation.info.latitude );
			    				    		      IVector vectToRemove = vectorPosToVectorMap.get(coord);
			    				    		      if( vectToRemove != null ){
			    				    		    	  vectorPosToVectorMap.remove(coord);
//			    				    		    	  System.out.println("Removing barb from obsolete station: "+ obsoleteStation.info.stationId);
			    				    		    	  counter++;
			    				    		      }
		    				    	 ...
		    				    	 /*Removing vectors that are no longer within the current screen extents*/

		    				    	 try{
			    				    	 Set<Coordinate> vectorsToRemove  = new HashSet<Coordinate>();
			    				    	 Set<Coordinate> prevVectorCoordSet = vectorPosToVectorMap.keySet();
			    				    	 if( prevVectorCoordSet != null && !prevVectorCoordSet.isEmpty()){
			    				    		 synchronized( prevVectorCoordSet ){
			    				    			 for( Coordinate c : prevVectorCoordSet ){
			    				    				  double[] tempPixLoc     = mapDescriptor.worldToPixel( new double[]{c.x, c.y} );
			    				    				  if(!view.getExtent().contains( tempPixLoc ) ){
		    				    	 ...
		    				    	 //System.out.println("Remaining number of barbs for frame: "+ dataTime.toString() + " - " + vectorPosToVectorMap.size());
		    				    	 Map<Coordinate, IVector> vecMap = new HashMap<Coordinate, IVector>( createWindVectors( stnColl, plotParamDefn.getPlotUnit(), symbolSize,
          		                           windVectorColorArray, metPrm1, metPrm2, pme ) );
		    				    	 vectorPosToVectorMap.putAll(vecMap );
		    				    	 //System.out.println("\nAdded " + vecMap.size() + " barbs for frame "+ dataTime.toString());
		    				         sm.release();
		    				    }
		    				    else{
		    				    	  
		    				    	 Set<Coordinate> coordSet = vectorPosToVectorMap.keySet();
		    				    	 sm.acquireUninterruptibly();
		    				    	 synchronized(coordSet){ 
		    				    	    for( Coordinate c : coordSet ){
		    				    		     Vector vector = (Vector) vectorPosToVectorMap.get(c);
		    				    		     if( Math.abs( vector.getSizeScale() - symbolSize) > 0.01)
		    				    			       vector.setSizeScale(symbolSize);
		    				    		     if (! vector.getColors()[0].equals(windVectorColorArray[0]))
		    		 ...
		    		 if(drawSymbol){
                         /*Since the Symbol associated with each SymbolLocationSet is passed
                          * in as an argument to the constructor there is no explicit method to set the symbol
                          * should its attributes change. Hence the symbols get recreated afresh each time. 
                          */
		    			 mapOfAllSymbolsAtEachPlotPosition = mapOfSymbolsPerPlotPosPerFrame.get(dataTime);
		    			  PlotSymbolType symbolType = posToSymbolTypeMap.get(position);

		    			  String metParamName = plotParamDefn.getMetParamName();
		    			  if(symbolType != null ){
		    				 
		    				  StringLookup lookupTable    = symbolLookupTable.get( symbolType );
			    					  ...
			    					  synchronized(station.listOfParamsToPlot){
			    					   try{
			    						  for ( AbstractMetParameter metPrm :  station.listOfParamsToPlot ){
			      		            	   	  if(metParamName.compareTo( metPrm.getMetParamName() ) == 0 ){
			    					    ...
			    					    if( tableParamToPlot != null ){
											...
											try {
												formattedString   = getFormattedValueToPlot( plotParamDefn, tableParamToPlot );
												
												if(formattedString == null || formattedString.isEmpty()){
													continue;
												}
												if(lookupTable == null || lookupTable.recursiveTranslation(formattedString) == null){
													continue;
												}
												
												symbolPatternName = new String(lookupTable.recursiveTranslation(formattedString));
												if( symbolPatternName == null || symbolPatternName.isEmpty()){
													continue;
												}
												
												Symbol symbol     = symbolNameToSymbolMap.get(symbolPatternName);
												RGB rgb = null;
												/*
												 * Get the conditional color for the symbol if applicable
												 */
												if( pme.hasAdvancedSettings() ){
												...
												if(symbol == null )
						      				       ...
						      				       double worldLoc[]       = new double[]{ station.info.longitude, station.info.latitude };
						 					       double[] tempPixLoc     = mapDescriptor.worldToPixel( worldLoc );
						 					       tempPixLoc = getUpdatedCoordinates(textBounds, tempPixLoc[0], tempPixLoc[1], 
														        view, canvasBounds, position);
												   worldLoc = mapDescriptor.pixelToWorld(tempPixLoc);
												   listOfCoords = symbolToSetOfCoordsMap.get(symbol);
												   if( listOfCoords == null ){
												        listOfCoords = new ArrayList<Coordinate>();
												   }
												   
												   listOfCoords.add(new Coordinate(worldLoc[0], worldLoc[1]));

												   if( rgb!= null ){
													      symbol.setColors(new Color[]{ new Color( rgb.red, rgb.blue, rgb.green ) });
													      
//												    	  symbol = new Symbol( null, new Color[]{ new Color( rgb.red, rgb.blue, rgb.green ) },
//									    			               symbol.getLineWidth(), symbol.getSizeScale(), true, new Coordinate(0,0,0), 
//									    			               "Symbol", symbol.getPatternName()  );
												   }else{
													      Color currSymbolColor = symbol.getColors()[0];
													      rgb = new RGB (currSymbolColor.getRed(),currSymbolColor.getGreen(), currSymbolColor.getBlue());
													      if(!rgb.equals(pmeColor)){
													    	  symbol.setColors(new Color[]{ new Color( pmeColor.red, pmeColor.blue, pmeColor.green ) });
//													    	  symbol = new Symbol( null, new Color[]{ new Color( pmeColor.red, pmeColor.blue, pmeColor.green ) },
//													    			               symbol.getLineWidth(), symbol.getSizeScale(), true, new Coordinate(0,0,0), 
//													    			               "Symbol", symbol.getPatternName()  );
													    	 
													      }
												   }												   
												   double prevSizeOfSymbol = symbol.getSizeScale();
												   double expectedSymbolSize = plotPosToSymbolSizeMap.get(position).doubleValue();
												   if (Math.abs(expectedSymbolSize - prevSizeOfSymbol) > TOLERANCE)
													   symbol.setSizeScale(expectedSymbolSize);
												   
												   symbolToSetOfCoordsMap.put(symbol, listOfCoords);
			    				  ...
			    				  for( Symbol symbol : symSet){
			    					  List<Coordinate> coordSet = symbolToSetOfCoordsMap.get(symbol);
			    					  if(symbol == null )
			    						  continue;
			    					  SymbolLocationSet sset = new SymbolLocationSet(symbol, coordSet.toArray(new Coordinate[0]));
			    					  listOfSymLocSet.add(sset);
			    				  }
			    				  mapOfAllSymbolsAtEachPlotPosition.put(position, listOfSymLocSet);
			    				  mapOfSymbolsPerPlotPosPerFrame.put(dataTime, mapOfAllSymbolsAtEachPlotPosition);
			    				  sm.release();
                ...
                try{
	             synchronized(positionSet){
	                 for( Position pos : positionSet ){
					      Map<String, DrawableString> mapOfStrPositions = localDMap.get(pos);
					      if( mapOfStrPositions != null && !mapOfStrPositions.isEmpty()){
					    	  synchronized(mapOfStrPositions){
					                synchronized(listOfStringsToDraw){
					    		        listOfStringsToDraw.addAll( mapOfStrPositions.values());
					                }
					    	  }
					      } 
				      }
	               ...
	               if( vectorPosToVectorMap != null && !vectorPosToVectorMap.isEmpty() && vectorPosToVectorMap.size() > 0 ){
	            	       synchronized( vectorPosToVectorMap ){
	            	    	   synchronized( listOfWindVectors ){
	            	    		    Collection<IVector> vColl = vectorPosToVectorMap.values();
	            	    		    synchronized( vColl ){
	            	    		    	try{
	                	                  listOfWindVectors = new ArrayList<IVector>(vColl );
	            	    		    	}catch(Exception e){
                   ...
                   synchronized (symLocSetList  ){
                	   for( Position pos : positionSet ){
                		   if( mapOfAllSymbolsAtEachPlotPosition == null || mapOfAllSymbolsAtEachPlotPosition.get( pos ) == null )
                			   continue;
                		   synchronized(mapOfAllSymbolsAtEachPlotPosition){
                		         List<SymbolLocationSet> symbolLocSetList =
                		        	 new ArrayList<SymbolLocationSet>( mapOfAllSymbolsAtEachPlotPosition.get( pos )) ;
				   ...
				   if( prevStationMap != null){  /*To update the map of stations last processed*/
		    	       
					     synchronized( prevStationMap ){   
					     /*Remove the stations not currently disclosed*/
					     if(setOfKeysfOfStationsNotDisclosed != null && !setOfKeysfOfStationsNotDisclosed.isEmpty()){
				         ...
				         for ( String eachStnKey : setOfCurrentStnKeys ){
		    		           prevStationMap.put(eachStnKey, stationMap.get(eachStnKey) );
		    	          }
		    	       }
				   }
...
//		  		    	  System.out.println("Ending with this list of stations in prevStationMap for the frame time: "  + dataTime.toString() );
...
//		  		    	  }
				   ...
				   /*Update the map of wind-barbs with the latest list of wind barbs for this frame*/
				   if( mapOfWindBarbsPerFrame!= null && vectorPosToVectorMap != null ){
		    	       timeLogger.append("\nStoring  " + vectorPosToVectorMap.size() + " barbs for frame at: "  + dataTime.toString());
					   mapOfWindBarbsPerFrame.put(dataTime, vectorPosToVectorMap);
				   }
		    
				   sm.release();
//				   System.out.println("\nFinished creating renderable data for frame: " + dataTime.toString()); 
				   /*Inform the resource that the data is ready for rendering*/
 				   iPointInfoRenderingListener.renderingComplete( dataTime, stationMap.values(), listOfStringsToDraw, listOfWindVectors, symLocSetList );
		}


		/**
		 * Creates and formats the string to be plotted at the input plot position for the input station 
		 * @param station
		 * @param plotParamDefn
		 * @param font
		 * @param textColor
		...
		private DrawableString getDrawableStringForStation( Station station, PlotParameterDefn plotParamDefn, IFont font, 
				                                            RGB textColor,   Position position, IGraphicsTarget aTarget, PlotModelElement pme){
			...
			for( AbstractMetParameter metParamToPlot : station.listOfParamsToPlot ){
	    	   if( metParamToPlot.getMetParamName().compareTo( metParamName ) == 0 ){

	    		   try {
					        String formattedString             = getFormattedValueToPlot( plotParamDefn, metParamToPlot );
					        if( formattedString == null ){
					           return null;
					        }
					        
					        drawableString                     = new DrawableString( formattedString, textColor );
				            ...
				            Rectangle2D bounds = aTarget.getStringsBounds( new DrawableString ( "'" 
				                                                          + drawableString.getText()[0]
				                                                          + "y", drawableString.getColors()[0]));
				            Rectangle textBounds = new Rectangle(0,0, (int) bounds.getWidth(), (int) bounds.getHeight());
				            double[] pixLoc = getUpdatedCoordinates(textBounds, station.pixelLocation.x, station.pixelLocation.y, lastView, canvasBounds, position);
					        if(pixLoc != null)
					            drawableString.setCoordinates( pixLoc[0], pixLoc[1] );
					        else
					    	    drawableString.setCoordinates( station.pixelLocation.x, station.pixelLocation.y );
    ...
    private String getFormattedValueToPlot(PlotParameterDefn plotParamDefn, AbstractMetParameter metPrm) throws VizException {
			...
			if( !metPrm.hasValidValue() ) {    		
  	    		...
  	    		if(plotUnit == null ){
  	    			if(metPrm.hasStringValue()){
  	    			  if(metPrm.getStringValue() != null && !metPrm.getStringValue().isEmpty())
						...
						try {
							Unit<?>  newUnit = new UnitAdapter().unmarshal(plotUnit);
          	    		       ...
          	    		       if ( newUnit.isCompatible(metPrm.getUnit())
          	    			     ...
          	    			     String formattedStr = new String(metPrm.getFormattedString(plotParamDefn.getPlotFormat()).trim());
          	    			     String plotTrim = plotParamDefn.getPlotTrim();
          	    			     if( plotTrim != null && !plotTrim.isEmpty()){
          	    				     int plotTrimVal = Integer.parseInt(plotTrim);
          	    				      formattedStringToPlot = new String (formattedStr.substring(plotTrimVal));  	
          	    			     }else
    ...
    public synchronized double[] getUpdatedCoordinates( Rectangle textBounds, double xPos, 
    ...
    private RGB getConditionalColor( Station currentStation, PlotModelElement pme ){
  		PlotParameterDefn condPlotParamDefn = PlotParameterDefnsMngr.getInstance()
  		...
  		if(! currentStation.setOfConditionalColorParams.isEmpty() ){
  		   synchronized( currentStation.setOfConditionalColorParams ){
  			 for ( AbstractMetParameter condColorMetPrm : currentStation.setOfConditionalColorParams ){
  				 ...
  				 if(condColorMetPrm.getMetParamName().compareTo(condPlotParamDefn.getMetParamName() )== 0 ){
  					 String condParamValue = getConditionalParameterValue(condPlotParamDefn, condColorMetPrm);
  					 if(condParamValue != null && !condColorMetPrm.hasStringValue()){
  						 float value = Float.parseFloat(condParamValue);
  						 if(pme.getConditionalColorBar()!= null ){
  							rgb =  pme.getConditionalColorBar().getRGBForInterval(value);
  						    break;
  						 }
  					 }
  				 }
    ...
    public void removeObsoletePlotEntriesAtThisPositionForAllFrames(Position p){
    	...
    	if(dataTimeToText != null && !dataTimeToText.isEmpty()){
    		...
    		synchronized( dtSet ){   
    		   for( DataTime dt : dtSet ){
    			   Map<Position, Map<String, DrawableString>> mapOfStrPos =  dataTimeToText.get( dt );
    			   if( ( mapOfStrPos != null && !mapOfStrPos.isEmpty() && mapOfStrPos.containsKey( p ))
    					&& ( p != Position.SC ) && ( p != Position.WD )){
    	...
    	ss1.acquireUninterruptibly();
    	if( mapOfWindBarbsPerFrame != null && 
    			!mapOfWindBarbsPerFrame.isEmpty() && (p == Position.WD)){
    		mapOfWindBarbsPerFrame.clear();
    	}
    	if( ( mapOfSymbolsPerPlotPosPerFrame != null ) && (!mapOfSymbolsPerPlotPosPerFrame.isEmpty())){
    		  Set<DataTime> dtSet = mapOfSymbolsPerPlotPosPerFrame.keySet();
    		  synchronized(dtSet){
    			  for( DataTime dt : dtSet )
    			  {
    				  Map<Position, List<SymbolLocationSet>> symbolPosMap = mapOfSymbolsPerPlotPosPerFrame.get( dt );
    ...
    public boolean areThereSymbolsToBeRenderedInTheCurrentFrame(DataTime dt){
    	return ( ( posToSymbolTypeMap != null  && !posToSymbolTypeMap.isEmpty()) && (mapOfSymbolsPerPlotPosPerFrame != null && !mapOfSymbolsPerPlotPosPerFrame.isEmpty() && mapOfSymbolsPerPlotPosPerFrame.get(dt) != null ) );
    }
    ...
    public boolean areThereTextElementsToBeRenderedInTheCurrentFrame( DataTime dt ){
    	...
    	if( plotModelPositionMap != null && !plotModelPositionMap.isEmpty()){
    		 ...
    		 for( Position p : posSet ){
    			  ...
    			  if( plotParameterDefinitions != null ){
    				  String plotMode = plotParameterDefinitions.getPlotParamDefn(pme.getParamName()).getPlotMode();
    	...
    	return ( anyTextElementsInPlotModel && ( dataTimeToText != null && !dataTimeToText.isEmpty() && dataTimeToText.get( dt ) != null ));
    }
    
    public boolean areThereVectorsToBeRenderedInTheCurrentFrame(DataTime dt){
    	return( ( plotModelPositionMap != null && plotModelPositionMap.containsKey( Position.WD ) ) &&  (mapOfWindBarbsPerFrame != null && !mapOfWindBarbsPerFrame.isEmpty() && mapOfWindBarbsPerFrame.get(dt) != null ) );
    }
 }
