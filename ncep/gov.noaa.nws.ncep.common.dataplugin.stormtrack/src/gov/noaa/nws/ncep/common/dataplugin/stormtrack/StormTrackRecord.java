 ...
 * ------------ --------- ----------- --------------------------
 * Jun 23, 2010 283       F. J. Yen   Initial creation
 * 07/2011                T. Lee      ATCF and Ensemble storm tracks
 * Oct 19, 2011 858       Greg Hull   remove forecastHr
 ...
 */
@org.hibernate.annotations.Table(appliesTo = "stormtrack", indexes = { @Index(name = "stormtrack_refTimeIndex", columnNames = {
