...
public class PgenResourceData extends AbstractNatlCntrsRequestableResourceData
...
//    private static final RGB    RESOURCE_LEGEND_COLOR = new RGB(155, 155, 155);
     ...
     * @throws VizException
     */
    public PgenResourceData() throws VizException {
        super();
...
//    }
//
//	// TODO : not sure if this is used but if it is then assuming that we'll 
//	// also want to change the legend color.
