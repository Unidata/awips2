package gov.noaa.nws.ncep.edex.ingest.grib.web;
...
public class NcepLoggerSettingOnEdexIngestServlet extends HttpServlet implements
		Servlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7814637982773404698L;
