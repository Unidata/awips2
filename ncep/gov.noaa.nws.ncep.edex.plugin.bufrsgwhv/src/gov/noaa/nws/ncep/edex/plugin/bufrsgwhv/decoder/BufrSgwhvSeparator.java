/**
 * This class sets the BUFR BufrSgwhv section 4 data in an array for parsing. 
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
import gov.noaa.nws.ncep.edex.plugin.bufrsgwhv.util.BufrSgwhvDescriptorDelegate;
...
public class BufrSgwhvSeparator extends AbstractRecordSeparator implements
    ...
    private void decodeBUFRData() {
        BUFRFile bfile = new BUFRFile(messageData,
                new BufrSgwhvDescriptorDelegate(this));
         ...
         * file may contain multiple bulletins. bufrsgwhvData: Section 4
         * BUFRSGWHV data (BUFRDataDocument) in one bulletin which may contain
         * multiple Bufrs records. record: one BUFRSGWHV record which contains
