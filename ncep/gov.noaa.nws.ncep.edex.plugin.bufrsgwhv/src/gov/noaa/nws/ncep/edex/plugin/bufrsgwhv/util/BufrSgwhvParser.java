...
import gov.noaa.nws.ncep.edex.plugin.bufrsgwhv.decoder.BufrSgwhvSeparator;
...
public class BufrSgwhvParser {
	 ...
	 */
	public static BufrSgwhvRecord processBufrSgwhv(BufrSgwhvSeparator sep,
			int subsetNum) {
		int year = -1;
		int month = -1;
		int day = -1;
