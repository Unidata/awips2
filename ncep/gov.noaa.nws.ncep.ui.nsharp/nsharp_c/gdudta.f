...
C* R. Tian/SAIC		 5/06	Changed to call new DG subroutines	*
C* R. Tian/SAIC		 9/06	Moved DG_SUBG call to get_mdl_snd	*
C************************************************************************
	INCLUDE		'GEMPRM.PRM'
C*
...
c	if (gfunc(1:4) .eq. 'OMEG') then
c	  print*,'Omega at ',lev,' is ',tdata(iloc(kk),i-istrt+1)
c	endif
	            y (npts) = rlvl ( i )
