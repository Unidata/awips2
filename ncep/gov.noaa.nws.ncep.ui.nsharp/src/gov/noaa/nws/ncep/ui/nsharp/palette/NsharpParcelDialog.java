...
import gov.noaa.nws.ncep.ui.nsharp.skewt.rsc.NsharpSkewTResource.ParcelData;
...
public class NsharpParcelDialog extends Dialog {
	...
	private NsharpSkewTResource skewtRsc;
	...
	protected NsharpParcelDialog(Shell parentShell) throws VizException {
		super(parentShell);
		thisDialog = this;
		skewtRsc = NsharpSkewTEditor.getActiveNsharpEditor().getNsharpSkewTDescriptor().getSkewtResource();
		if(skewtRsc!=null){
