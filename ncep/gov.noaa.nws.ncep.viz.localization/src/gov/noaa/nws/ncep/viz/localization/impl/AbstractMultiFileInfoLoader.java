...
public abstract class AbstractMultiFileInfoLoader<T> implements IMultiResourceFileInfoLoader<T> {
	...
	private Map<String, T> getAvailableMultiFileInfoMap(ILoadedFileResourceInfo<T> fileInfo) {
		...
		switch(fileInfo.getLocalizationLevel()) {
			...
			case LocalizationConstants.DEFAULT: 
				loadAvailableFiles(localFilePath, resourceNamePattern, resourceNamePatternMatchStyle, filenameFilter, fileInfoMap); 
				loadAvailableFiles(userFilePath, resourceNamePattern, resourceNamePatternMatchStyle, filenameFilter, fileInfoMap); 
				loadAvailableFiles(userSiteDeskFilePath, resourceNamePattern, resourceNamePatternMatchStyle, filenameFilter, fileInfoMap); 
				loadAvailableFiles(userSiteFilePath, resourceNamePattern, resourceNamePatternMatchStyle, filenameFilter, fileInfoMap); 
				loadAvailableFiles(deskFilePath, resourceNamePattern, resourceNamePatternMatchStyle, filenameFilter, fileInfoMap); 
				loadAvailableFiles(siteFilePath, resourceNamePattern, resourceNamePatternMatchStyle, filenameFilter, fileInfoMap); 
...
//		return genericArray; 
	...
	protected abstract void loadAvailableFiles(String fileParentPathValue, String resourceNamePattern, int patternMatchStyle, FilenameFilter filenameFilter, Map<String, T> fileMap); 
