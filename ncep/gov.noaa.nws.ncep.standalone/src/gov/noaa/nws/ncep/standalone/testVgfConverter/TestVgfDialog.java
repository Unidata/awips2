 ...
 * @version 1
 */
public class TestVgfDialog extends  TitleAreaDialog  {
...
; 
	...
	public TestVgfDialog(Shell parentShell) {
		super(parentShell);		
	}
	...
	protected Control createContents(Composite parent) {
		...
		setTitle("To compare a Vgf file and a Vgf file converted from the XML file.\n" +
				"Please input the two Vgf files in the Original and the Converted text fields.");
		...
		btOK.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent event) {
				...
				if (s1.length() == 0 || s2.length() == 0 ) {
					...
					fileconverted = (new TestVgfConvert().testVgf(s1, s2));
