/*
 * gov.noaa.nws.ncep.standalone.rfop.RFOPDialog
 * 
 ...
 * @author mlaryukhin
 */
public class RFOPDialog extends TitleAreaDialog {
	 ...
	 * @param parentShell
	 */
	public RFOPDialog(Shell parentShell) {
		super(parentShell);
		currentDir = new File(".");
	}
	...
	protected Control createContents(Composite parent) {
		...
		setTitle("Reverse Flood Outlook Product (RFOP)");
		setMessage("This program converts  PGen XML format file into flood locations ASCII file.");
		return contents;
	}
	...
	protected Control createDialogArea(final Composite parent) {
		...
		area.setText(RFOP.getProgramDescription());
		...
		try {
			...
			outputFilename.setText(currentDir.getCanonicalPath() + File.separator + "output");
		} catch (IOException e) {
