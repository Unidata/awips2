...
public class UairParserTest {
	...
	public void testGetDataType() {
		...
		String dataType = UairParser.getDataType(report);
	...
	public void testGetStationNumber() {
		...
		String station = UairParser.getStationNumber(report);
	...
	public void testFindCorIndicator() {
		...
		String nul = null;
		String cor = UairParser.findCorIndicator(report);
		System.out.println(" correction indicator=" + cor);
	...
	public void testGetUairType() {
		...
		Integer uairType = UairParser.getUairType("TTAA");
		System.out.println(" uair type=" + uairType);
