/**
 * ShipMobile - process ship and dropsonde data
 * 
...
public class ShipMobile {
	...
	public static void setCodeMessage(String codeMessage) {
		ShipMobile.codeMessage = codeMessage;
	}
	...
	public static void setStationNumber(String stationNumber) {
		ShipMobile.stationNumber = stationNumber;
	}
	...
	public static void setSurfaceHeight(int surfaceHeight) {
		ShipMobile.surfaceHeight = surfaceHeight;
	}
	...
	public static void setElevation(int elevation) {
		ShipMobile.elevation = elevation;
	}
	...
	public static void setObservationTime(Calendar observationTime) {
		ShipMobile.observationTime = observationTime;
	}
	...
	public static void setSynopticTime(Calendar synopticTime) {
		ShipMobile.synopticTime = synopticTime;
	}
	...
	public static void ShipMobileField(String report, String dataType) {
		...
		stationNumber = null;
		surfaceHeight = IDecoderConstantsN.INTEGER_MISSING;
		elevation = IDecoderConstantsN.INTEGER_MISSING;
