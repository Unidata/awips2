...
public class UairSeparator extends AbstractRecordSeparator {
    ...
    // public static final String UAIR_REPORT =
    // "(TT|PP)(AA|BB|CC|DD) (([0-9]| |/)*\\r\\r\\n){0,15}([0-9]| |/)*=( )?\\r\\r\\n";
    // public static final String UAIR_REPORT =
    // "(TT|PP)(AA|BB|CC|DD) ([0-9]| |/|\\r|\\n)*(NIL)?=";
    // public static final String UAIR_REPORT =
    // "(TT|PP)(AA|BB|CC|DD) .*(NIL)?=";
     ...
     * Constructor.
     */
    public UairSeparator() {
        records = new ArrayList<String>();
        bulletins = new ArrayList<String>();
    }

    public static UairSeparator separate(byte[] data, Headers headers) {
        UairSeparator ds = new UairSeparator();
