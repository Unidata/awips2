...
import gov.noaa.nws.ncep.viz.rsc.wcn.rsc.WcnResource;

@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name="NC-WcnResourceData")
public class WcnResourceData extends AbstractNatlCntrsRequestableResourceData
...
implements   INatlCntrsResourceData, IMiscResourceData {
    ...
    @XmlElement
	@XmlJavaTypeAdapter(RGBColorAdapter.class)
	protected RGB     thunderstormSymbolColor;
    ...
    @XmlElement
	@XmlJavaTypeAdapter(RGBColorAdapter.class)
	protected RGB     tornadoSymbolColor;
    ...
    @XmlElement
	@XmlJavaTypeAdapter(RGBColorAdapter.class)
	protected RGB     Watchxxx0SymbolColor;
    ...
    @XmlElement
	@XmlJavaTypeAdapter(RGBColorAdapter.class)
	protected RGB     Watchxxx1SymbolColor;
    ...
    @XmlElement
	@XmlJavaTypeAdapter(RGBColorAdapter.class)
	protected RGB     Watchxxx2SymbolColor;
    ...
    @XmlElement
	@XmlJavaTypeAdapter(RGBColorAdapter.class)
	protected RGB     Watchxxx3SymbolColor;
    ...
    @XmlElement
	@XmlJavaTypeAdapter(RGBColorAdapter.class)
	protected RGB     Watchxxx4SymbolColor;
    ...
    @XmlElement
	@XmlJavaTypeAdapter(RGBColorAdapter.class)
	protected RGB     Watchxxx5SymbolColor;
    ...
    @XmlElement
	@XmlJavaTypeAdapter(RGBColorAdapter.class)
	protected RGB     Watchxxx6SymbolColor;
    ...
    @XmlElement
	@XmlJavaTypeAdapter(RGBColorAdapter.class)
	protected RGB     Watchxxx7SymbolColor;
    ...
    @XmlElement
	@XmlJavaTypeAdapter(RGBColorAdapter.class)
	protected RGB     Watchxxx8SymbolColor;
    ...
    @XmlElement
	@XmlJavaTypeAdapter(RGBColorAdapter.class)
	protected RGB     Watchxxx9SymbolColor;
    ...
    @XmlElement
    protected boolean watchBoxMarkerEnable;
    @XmlElement
    protected boolean watchBoxOutlineEnable;
    @XmlElement
    protected boolean watchBoxFillEnable;
    @XmlElement
    protected boolean watchBoxUnionEnable;

   
	/**
     * Create a  Watch county notification (WCN) resource.
     * 
     * @throws VizException
     */
    public WcnResourceData() throws VizException {
        super();
	...
	public RGB getThunderstormSymbolColor() {
		return thunderstormSymbolColor;
	}


	public void setThunderstormSymbolColor(RGB thunderstormSymbolColor) {
		this.thunderstormSymbolColor = thunderstormSymbolColor;
	}
	...
	public RGB getTornadoSymbolColor() {
		return tornadoSymbolColor;
	}


	public void setTornadoSymbolColor(RGB tornadoSymbolColor) {
		this.tornadoSymbolColor = tornadoSymbolColor;
	}
	...
	public RGB getWatchxxx0SymbolColor() {
		return Watchxxx0SymbolColor;
	}


	public void setWatchxxx0SymbolColor(RGB watchxxx0SymbolColor) {
		Watchxxx0SymbolColor = watchxxx0SymbolColor;
	}
	...
	public RGB getWatchxxx1SymbolColor() {
		return Watchxxx1SymbolColor;
	}


	public void setWatchxxx1SymbolColor(RGB watchxxx1SymbolColor) {
		Watchxxx1SymbolColor = watchxxx1SymbolColor;
	}
	...
	public RGB getWatchxxx2SymbolColor() {
		return Watchxxx2SymbolColor;
	}


	public void setWatchxxx2SymbolColor(RGB watchxxx2SymbolColor) {
		Watchxxx2SymbolColor = watchxxx2SymbolColor;
	}
	...
	public RGB getWatchxxx3SymbolColor() {
		return Watchxxx3SymbolColor;
	}


	public void setWatchxxx3SymbolColor(RGB watchxxx3SymbolColor) {
		Watchxxx3SymbolColor = watchxxx3SymbolColor;
	}
	...
	public RGB getWatchxxx4SymbolColor() {
		return Watchxxx4SymbolColor;
	}


	public void setWatchxxx4SymbolColor(RGB watchxxx4SymbolColor) {
		Watchxxx4SymbolColor = watchxxx4SymbolColor;
	}
	...
	public RGB getWatchxxx5SymbolColor() {
		return Watchxxx5SymbolColor;
	}


	public void setWatchxxx5SymbolColor(RGB watchxxx5SymbolColor) {
		Watchxxx5SymbolColor = watchxxx5SymbolColor;
	}
	...
	public RGB getWatchxxx6SymbolColor() {
		return Watchxxx6SymbolColor;
	}


	public void setWatchxxx6SymbolColor(RGB watchxxx6SymbolColor) {
		Watchxxx6SymbolColor = watchxxx6SymbolColor;
	}
	...
	public RGB getWatchxxx7SymbolColor() {
		return Watchxxx7SymbolColor;
	}


	public void setWatchxxx7SymbolColor(RGB watchxxx7SymbolColor) {
		Watchxxx7SymbolColor = watchxxx7SymbolColor;
	}
	...
	public RGB getWatchxxx8SymbolColor() {
		return Watchxxx8SymbolColor;
	}


	public void setWatchxxx8SymbolColor(RGB watchxxx8SymbolColor) {
		Watchxxx8SymbolColor = watchxxx8SymbolColor;
	}
	...
	public RGB getWatchxxx9SymbolColor() {
		return Watchxxx9SymbolColor;
	}


	public void setWatchxxx9SymbolColor(RGB watchxxx9SymbolColor) {
		Watchxxx9SymbolColor = watchxxx9SymbolColor;
	}
	...
	public boolean getWatchBoxMarkerEnable() {
		return watchBoxMarkerEnable;
	}


	public void setWatchBoxMarkerEnable(boolean watchBoxMarkerEnable) {
		this.watchBoxMarkerEnable = watchBoxMarkerEnable;
	}
	...
	public boolean getWatchBoxFillEnable() {
		return watchBoxFillEnable;
	}


	public void setWatchBoxFillEnable(boolean watchBoxFillEnable) {
		this.watchBoxFillEnable = watchBoxFillEnable;
	}


	public boolean getWatchBoxUnionEnable() {
		return watchBoxUnionEnable;
	}


	public void setWatchBoxUnionEnable(boolean watchBoxUnionEnable) {
		this.watchBoxUnionEnable = watchBoxUnionEnable;
	}
	...
	public MiscRscAttrs getMiscResourceAttrs() {
		...
		attrs.addAttr( new MiscResourceAttr( "thunderstormSymbolColor", "", 
		...
		attrs.addAttr( new MiscResourceAttr( "tornadoColor", "", 
				EditElement.COLOR_SELECTOR, 2 ));
		attrs.addAttr( new MiscResourceAttr( "tornadoSymbolColor", "", 
				EditElement.COLOR_SELECTOR, 3 ));		
		...
		attrs.addAttr( new MiscResourceAttr( "Watchxxx0Color", "", 
				EditElement.COLOR_SELECTOR, 2 ));
		attrs.addAttr( new MiscResourceAttr( "Watchxxx0SymbolColor", "", 
				EditElement.COLOR_SELECTOR, 3 ));		
		...
		attrs.addAttr( new MiscResourceAttr( "Watchxxx1Color", "", 
				EditElement.COLOR_SELECTOR, 2 ));
		attrs.addAttr( new MiscResourceAttr( "Watchxxx1SymbolColor", "", 
				EditElement.COLOR_SELECTOR, 3 ));		
		...
		attrs.addAttr( new MiscResourceAttr( "Watchxxx2Color", "", 
				EditElement.COLOR_SELECTOR, 2 ));
		attrs.addAttr( new MiscResourceAttr( "Watchxxx2SymbolColor", "", 
				EditElement.COLOR_SELECTOR, 3 ));		
		...
		attrs.addAttr( new MiscResourceAttr( "Watchxxx3Color", "", 
				EditElement.COLOR_SELECTOR, 2 ));
		attrs.addAttr( new MiscResourceAttr( "Watchxxx3SymbolColor", "", 
				EditElement.COLOR_SELECTOR, 3 ));		
		...
		attrs.addAttr( new MiscResourceAttr( "Watchxxx4Color", "", 
				EditElement.COLOR_SELECTOR, 2 ));
		attrs.addAttr( new MiscResourceAttr( "Watchxxx4SymbolColor", "", 
				EditElement.COLOR_SELECTOR, 3 ));		
		...
		attrs.addAttr( new MiscResourceAttr( "Watchxxx5Color", "", 
				EditElement.COLOR_SELECTOR, 2 ));
		attrs.addAttr( new MiscResourceAttr( "Watchxxx5SymbolColor", "", 
				EditElement.COLOR_SELECTOR, 3 ));		
		...
		attrs.addAttr( new MiscResourceAttr( "Watchxxx6Color", "", 
				EditElement.COLOR_SELECTOR, 2 ));
		attrs.addAttr( new MiscResourceAttr( "Watchxxx6SymbolColor", "", 
				EditElement.COLOR_SELECTOR, 3 ));		
		...
		attrs.addAttr( new MiscResourceAttr( "Watchxxx7Color", "", 
				EditElement.COLOR_SELECTOR, 2 ));
		attrs.addAttr( new MiscResourceAttr( "Watchxxx7SymbolColor", "", 
				EditElement.COLOR_SELECTOR, 3 ));		
		...
		attrs.addAttr( new MiscResourceAttr( "Watchxxx8Color", "", 
				EditElement.COLOR_SELECTOR, 2 ));
		attrs.addAttr( new MiscResourceAttr( "Watchxxx8SymbolColor", "", 
				EditElement.COLOR_SELECTOR, 3 ));		
		...
		attrs.addAttr( new MiscResourceAttr( "Watchxxx9Color", "", 
				EditElement.COLOR_SELECTOR, 2 ));
		attrs.addAttr( new MiscResourceAttr( "Watchxxx9SymbolColor", "", 
				EditElement.COLOR_SELECTOR, 3 ));		
		...
		attrs.addAttr( new MiscResourceAttr( "watchBoxTimeEnable", "Time",
				EditElement.CHECK_BOX, 1 ));
		attrs.addAttr( new MiscResourceAttr( "watchBoxLabelEnable", "Label",
				EditElement.CHECK_BOX, 1 ));
		...
		attrs.addAttr( new MiscResourceAttr( "colorCodeEnable", "Color Code",
				EditElement.CHECK_BOX, 1 ));
		attrs.addAttr( new MiscResourceAttr( "watchBoxMarkerEnable", "Marker",
				EditElement.CHECK_BOX, 1 ));
		attrs.addAttr( new MiscResourceAttr( "watchBoxOutlineEnable", "Outline",
				EditElement.CHECK_BOX, 1 ));
		attrs.addAttr( new MiscResourceAttr( "watchBoxFillEnable", "Fill",
				EditElement.CHECK_BOX, 1 ));		
		attrs.addAttr( new MiscResourceAttr( "watchBoxUnionEnable", "Union",
				EditElement.CHECK_BOX, 1 ));			
	...
	protected AbstractVizResource<?, ?> constructResource(
			...
			throws VizException {
		return new WcnResource( this, loadProperties );
	}
