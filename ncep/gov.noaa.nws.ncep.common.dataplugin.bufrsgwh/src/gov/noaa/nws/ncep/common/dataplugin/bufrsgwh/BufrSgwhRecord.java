 ...
 * BufrsgwhRecord
 * 
 * This java class performs the mapping to the database for BUFR BufrSgwh.
 * 
 * <pre>
 * SOFTWARE HISTORY
 * 
...
@Entity
@Table(name = "bufrsgwh", uniqueConstraints = { @UniqueConstraint(columnNames = { "dataURI" }) })
@XmlRootElement
@XmlAccessorType(XmlAccessType.NONE)
@DynamicSerialize

public class BufrSgwhRecord extends PluginDataObject implements IDecoderGettable {
    ...
    @XmlElement
    @DynamicSerializeElement
    private Double selvstdg1r1;
    
    /** Std of Height of station for 2nd replication */
    @Column
    @XmlElement
    @DynamicSerializeElement
    private Double selvstdg1r2;
     ...
     */
    public BufrSgwhRecord (String uri) {
        super(uri);
    }
