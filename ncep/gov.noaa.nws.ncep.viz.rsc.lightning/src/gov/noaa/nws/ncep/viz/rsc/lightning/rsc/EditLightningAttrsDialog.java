...
public class EditLightningAttrsDialog extends AbstractEditResourceAttrsDialog {
    ...
    public Composite createDialog(Composite topComp) {
        ...
        if (colorByIntensityAttr == null
            ...
            System.out
                    .println("colorByIntensity is null or not of expected class Boolean?");
        }
        if (enablePosStrikesAttr == null
                || enablePosStrikesAttr.getAttrClass() != Boolean.class) {
            System.out
                    .println("enablePositiveStrikes is null or not of expected class Boolean?");
        }
        if (enableNegStrikesAttr == null
                || enableNegStrikesAttr.getAttrClass() != Boolean.class) {
            System.out
                    .println("enableNegativeStrikes is null or not of expected class Boolean?");
        }
        if (posSymbolSizeAttr == null
                || posSymbolSizeAttr.getAttrClass() != Integer.class) {
            System.out
                    .println("posSymbolSize is null or not of expected class Integer?");
        }
        if (negSymbolSizeAttr == null
                || negSymbolSizeAttr.getAttrClass() != Integer.class) {
            System.out
                    .println("negSymbolSize is null or not of expected class Integer?");
        }
        if (colorBarAttr == null
                || colorBarAttr.getAttrClass() != ColorBar.class) {
            System.out
                    .println("colorBar is null or not of expected class colorBar?");
        }
        ...
        // final Combo colorByCombo = new Combo( colorBarGrp, SWT.DROP_DOWN |
        // SWT.READ_ONLY );
        // fd = new FormData();
        // fd.left = new FormAttachment( 0, 15 );
        ...
        //
        // colorByCombo.select(
        // ((Boolean)colorByIntensityAttr.getAttrValue()).booleanValue() ? 1 : 0
        // );
        //
        ...
        ColorBarEditor colorBarEditor = new ColorBarEditor(colorBarGrp,
                editedColorBar);
