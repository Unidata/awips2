...
public class LightningResourceData extends
    ...
    // if true this will cause the strikes to be colored useing the colorBar and
    // the intensity
    // values. This will also mean that the timeMatching is changed so that only
    // data for the given
    ...
    public LightningResourceData() {
        ...
        this.nameGenerator = new AbstractNameGenerator() {
            ...
            public String getName(AbstractVizResource<?, ?> resource) {
                if (resource instanceof LightningResource) {
                    return "Lightning ("
                            + ((LightningResource) resource)
                                    .getNumDisplayedStrikes() + " Strikes)";
                } else
                    return "Lightning";
            }
        };
        ...
        // This is done to force all of the data before the frame end time to be
        // matched to the
