...
public class H5ScdSeparator extends AbstractRecordSeparator {
     ...
     * Constructor.
     */
    public H5ScdSeparator() {
        records = new ArrayList<String>();
        bulletins = new ArrayList<String>();
    }

    public static H5ScdSeparator separate(byte[] data, Headers headers) {
        H5ScdSeparator ds = new H5ScdSeparator();
