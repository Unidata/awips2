...
import gov.noaa.nws.ncep.edex.plugin.h5scd.decoder.H5ScdSeparator;
...
public class H5ScdSeparatorTest {
    H5ScdSeparator sep;
    ...
    public void initialize() {
        ...
        sep = new H5ScdSeparator();
        File file = new File(
                "unit-test/gov/noaa/nws/ncep/edex/plugin/h5scd/decoder/2009012900.SCD");
    ...
    public void testHasNext() {
        assertTrue("Find H5SCD separator! ", sep.hasNext());
    }
