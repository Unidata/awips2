 ...
 * ------------- -------- --------- --------------------------------------------
 * May 04, 2009           bgonzale  Initial creation
 * Jul 02, 2019  65608    tjensen   Fix missing parens in formatted time periods
 *
 * </pre>
 *
 * @author bgonzale
...
public class TimeFormatter {
    ...
    private final DateFormat df_HHmm = new SimpleDateFormat("HH:mm");

    private final DateFormat df_dayTime = new SimpleDateFormat("dd.HHmm");

    private final DateFormat df_dayHour = new SimpleDateFormat("dd.HH");

    private final DateFormat df_timeZMonthDate = new SimpleDateFormat(
            "HH:mm'Z' EEE dd-MMM-yy");

    private final DateFormat df_Z = new SimpleDateFormat("Z");

    private final NumberFormat nf_00 = new DecimalFormat("00");

    private final NumberFormat nf_trimZeros = new DecimalFormat("####");
