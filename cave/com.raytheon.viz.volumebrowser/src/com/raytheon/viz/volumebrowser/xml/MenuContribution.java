...
public class MenuContribution extends
        AbstractMenuContributionItem<CommonMenuContribution> implements
        IContribItemProvider {

    public MenuContribution() {
        this.xml = new CommonMenuContribution();
    }
    ...
    public IContributionItem[] getContributionItems(
        ...
        MenuContribution item = new MenuContribution();
        item.xml = (CommonMenuContribution) items;
        return new IContributionItem[] { new MenuContributionItem(item) };
    }
}