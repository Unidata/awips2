 ...
 * @version 1.0
 */
public class ProductTableComp extends Composite implements IProductTable,
        IProductTableAction {
    ...
    /**
     * This is used to get the mouse coordinate when right-clicking on the
     * table.
     */
    private final Point tableMousePt = new Point(0, 0);
     ...
     */
    private final int prodSelTableColumnCount = 3;

    /**
     * Width of the "Times" table column.
     */
    private final int timesColWidth = 100;

    /**
     * Width of the "Inventory" column.
     */
    private final int inventoryColWidth = 150;
     ...
     */
    private HashMap<String, Object> productKeyMap;
    ...
    private void initializeData() {
        ...
        productKeyMap = new HashMap<String, Object>();
        ...
        prodSelTable.addMouseListener(new MouseAdapter() {
            ...
            public void mouseDown(MouseEvent me) {
                if (me.button == 3) {
                    ...
                    tableMousePt.x = me.x;
                    tableMousePt.y = me.y;
                    TableItem item = prodSelTable.getItem(tableMousePt);
    ...
    private void displayInventotyForProduct(TableItem tableItem) {
        ...
        InventoryDlg inventoryDlg = new InventoryDlg(parentComp.getShell(),
                tableData);
        inventoryDlg.open();
    }
    ...
    /**
     * Remove products from the table that match the specified keys.
     * 
     * @param productsKeys
     *            Array of product keys.
     */
    public void removeProducts(String[] productsKeys) {
    ...
    /**
     * Check if the table contains a specified product.
     * 
     * @param key
     *            Product key used to identify the product.
     * @return True if the product is in the table, false otherwise.
     */
    public boolean containsProduct(String key) {
        return productKeyMap.containsKey(key);
    }
    ...
    protected void addProduct(final ProductTableData tblData) {
        ...
        productKeyMap.put(tblData.getSelectedData().getUniqueKey(), null);
        ...
        ti.setFont(2, tiFont);
        ti.setText(2, tblData.getProductInventory().getInventoryStatusString());
     ...
     */
    @Override
    public void addProduct(SelectedData selectedData) {

        IDataCatalogEntry catalogEntry = DataCatalogManager
                .getDataCatalogManager().getDataCatalogEntry(selectedData);
