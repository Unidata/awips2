...
public class ShefIssueMgr {
    ...
    private void readXML() {
        ...
        try {
            ...
            Map<LocalizationLevel, LocalizationFile> shefIssueMap = pm
                    .getTieredLocalizationFile(LocalizationType.COMMON_STATIC,
                            "hydro" + PathManager.SEPARATOR + "shefIssue.xml");
            ...
            if (file != null) {
                xml = jaxb.unmarshalFromXmlFile(file.getFile());
            } else {
    ...
    public void saveXml() {
        ...
        if (!newXmlFile.getFile().getParentFile().exists()) {
            statusHandler.info("Creating new directory");

            if (!newXmlFile.getFile().getParentFile().mkdirs()) {
                statusHandler.warn("Could not create new directory...");
            }
        }
        ...
        try {
            ...
            jaxb.marshalToXmlFile(xml, newXmlFile.getFile().getAbsolutePath());
            newXmlFile.save();
        } catch (Exception e) {
