 ...
 * May 10, 2018    7131    mduff       Changed to get filter values from DQCUtils.
 * </pre>
 * 
 * @author snaples
 */
...
public class GroupEditPrecipStns {
    ...
    public void group_edit_precip_stations(ReferencedCoordinate rcoord) {
        ...
        DailyQcUtils dqcUtils = DailyQcUtils.getInstance();
        ...
        for (i = 0; i < max_stations; i++) {
            ...
            // precip filter
            if (DailyQcUtils.pdata[DailyQcUtils.pcpn_day].stn[i].frain[time_pos].data < dqcUtils
            ...
            // elevation filter
            if (DailyQcUtils.precip_stations.get(i).elev < dqcUtils
