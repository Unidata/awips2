 ...
 *                                  DPARadar removal.
 * Jan 27, 2025  2038346  mapeters  Remove SP Bias and A/B columns
 *
 * </pre>
 *
 * @author snaples
...
public class RadarBiasTableDialog extends Dialog {
    ...
    private static final String[] biasLabelStrings = { "Radar", "DP Bias",
            "Man. DP Bias", "Bias", "Other Office" };
    ...
    private void createBiasColLblComp() {
        ...
        GridLayout bcLblCompLayout = new GridLayout(biasLabelStrings.length,
                true);
    ...
    private void createBiasListComp() {
        ...
        final int numColumns = biasLabelStrings.length;
        ...
        for (int i = 0; i < radIds.length; i++) {
            ...
            MPERadarData daaradarresultdata = radarIdToDPDataMap.get(rid);
            if (daaradarresultdata == null) {
                continue;
            }
            ...
            lbiasDPTxt.addModifyListener(e -> {
