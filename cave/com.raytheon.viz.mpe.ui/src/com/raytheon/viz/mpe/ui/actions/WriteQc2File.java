...
public class WriteQc2File {
    ...
    public void writeQcFile(String type) {
        ...
        try {
            ...
            for (int j = 0; j < DailyQcUtils.qcDays; j++) {
                ...
                fbuf.append(String.format("%s%04d%02d%02d",
                        DailyQcUtils.pcpn_qc_file, gm.get(Calendar.YEAR),
                ...
                for (int m = 0; m < max_stations; m++) {
                    ...
                    pbuf.append(String.format("PPD%s%s", type,
                            DailyQcUtils.precip_stations.get(m).parm.charAt(4)));
                    buf.setLength(0);
                    ...
                    if (DailyQcUtils.pdata[j].stn[m].sflag[4] != 1) {
                        ...
                        if (DailyQcUtils.pdata[j].stn[m].frain[4].qual == 0) {
                            mbuf.append("S");
                        } else if (DailyQcUtils.pdata[j].stn[m].frain[4].qual == 2) {
                            mbuf.append("W");
                        } else if (DailyQcUtils.pdata[j].stn[m].frain[4].qual == 3) {
                            mbuf.append("Q");
                        } else if (DailyQcUtils.pdata[j].stn[m].frain[4].qual == 4) {
                            mbuf.append("D");
                        } else if (DailyQcUtils.pdata[j].stn[m].frain[4].qual == 8) {
                            mbuf.append("V");
                        } else if (DailyQcUtils.pdata[j].stn[m].frain[4].qual == 5) {
                            mbuf.append("E");
                        } else if (DailyQcUtils.pdata[j].stn[m].frain[4].qual == 6) {
                            mbuf.append("L");
                        }
                    }
                    ...
                    // SNOTEL data case
                        ...
                        if (DailyQcUtils.pdata[j].stn[m].frain[4].qual == 8) {
                            mbuf.append("A");
                        } else if (DailyQcUtils.pdata[j].stn[m].frain[4].qual == 0) {
                            mbuf.append("B");
                        } else if (DailyQcUtils.pdata[j].stn[m].frain[4].qual == 3) {
                            mbuf.append("C");
                        }
    ...
    private void runSixHourCase(int j, int m, String type) {
        ...
        for (int k = 0; k < 4; k++) {
            ...
            if (DailyQcUtils.pdata[j].stn[m].frain[k].qual == 8) {
                mbuf.append("V");
            } else if (DailyQcUtils.pdata[j].stn[m].frain[k].qual == 2) {
                mbuf.append("W");
            } else if (DailyQcUtils.pdata[j].stn[m].frain[k].qual == 3) {
                mbuf.append("Q");
            } else if (DailyQcUtils.pdata[j].stn[m].frain[k].qual == 4) {
                mbuf.append("D");
            } else if (DailyQcUtils.pdata[j].stn[m].frain[k].qual == 0) {
                mbuf.append("S");
            } else if (DailyQcUtils.pdata[j].stn[m].frain[k].qual == 5) {
                mbuf.append("E");
            } else if (DailyQcUtils.pdata[j].stn[m].frain[k].qual == 6) {
                mbuf.append("L");
            }
