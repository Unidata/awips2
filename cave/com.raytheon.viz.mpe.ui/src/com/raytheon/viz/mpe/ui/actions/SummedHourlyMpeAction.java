...
public class SummedHourlyMpeAction extends AbstractHandler {
    ...
    SummedHourlyMpeDlg summedHourlyDlg = null;

    @Override
    public Object execute(ExecutionEvent event) throws ExecutionException {

        if (summedHourlyDlg == null || summedHourlyDlg.isDisposed() == true) {
            Shell shell = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell();

            SummedHourlyMpeDlg summedHourlyDlg = new SummedHourlyMpeDlg(shell);
