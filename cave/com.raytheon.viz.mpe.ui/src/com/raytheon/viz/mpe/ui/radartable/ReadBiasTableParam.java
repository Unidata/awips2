...
public class ReadBiasTableParam {
    ...
    public static Float get_rfc_bias_value(String rid, String officeId) {
        ...
        ArrayList<Rwbiasstat> pRWBiasStatList = new ArrayList<>();
        ArrayList<Rwbiasdyn> pRWBiasDynList = new ArrayList<>();
        ...
        if (length > 0) {
            ...
            if (officeId != null && !officeId.isEmpty()
                    && !pFxaLocalSite.equalsIgnoreCase(officeId)) {
