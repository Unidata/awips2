...
public class PointFreezeResourceData extends
		PointResourceData<PointFreezePlotResource> {

	public PointFreezeResourceData() {
	}

	public PointFreezeResourceData(MPEDisplayManager mpeDisplayManager,
	 ...
	 */
    @Override
    public PointFreezePlotResource construct(LoadProperties loadProperties,
            IDescriptor descriptor) throws VizException {
		return new PointFreezePlotResource(this, loadProperties);
    }
