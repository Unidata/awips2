...
public class PointTempResourceData extends
		PointResourceData<PointTempPlotResource> {

	public PointTempResourceData() {
	}

	public PointTempResourceData(MPEDisplayManager mpeDisplayManager,
     ...
     */
    @Override
    public PointTempPlotResource construct(LoadProperties loadProperties,
            IDescriptor descriptor) throws VizException {
		return new PointTempPlotResource(this, loadProperties);
    }
