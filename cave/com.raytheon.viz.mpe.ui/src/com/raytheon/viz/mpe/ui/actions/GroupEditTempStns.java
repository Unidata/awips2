...
/**
 * Applies quality code updates made in Group Edit Mode to a temperature station
 ...
 * Aug 11, 2017    6148    bkowal      Cleanup. Force the refresh of the station display.
 * 
 * </pre>
 * 
 * @author snaples
...
public class GroupEditTempStns {
    ...
    public void group_edit_temp_stations(ReferencedCoordinate rcoord) {
        ...
        for (i = 0; i < max_stations; i++) {
            ...
            if (DailyQcUtils.tdata[DailyQcUtils.pcpn_day].tstn[i].tlevel2[time_pos].data < dqc.temperature_filter_value) {
                continue;
            }
            ...
            for (m = 0; m < DailyQcUtils.tsmax; m++) {
                if ((DailyQcUtils.temperature_stations.get(i).parm
                        .substring(3, 5)
