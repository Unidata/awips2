...
public class DispatchingMosaicOrderedExtension extends
        DispatchingMosaicExtension implements IMosaicOrderedImageExtension {

    public static final String MOSAIC_TYPE = "ordered";
    ...
    protected Class<? extends IMosaicImageExtension> getMosaicExtension() {
        return IMosaicOrderedImageExtension.class;
    }
