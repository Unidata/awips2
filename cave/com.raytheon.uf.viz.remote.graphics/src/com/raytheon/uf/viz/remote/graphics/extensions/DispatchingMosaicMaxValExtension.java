...
public class DispatchingMosaicMaxValExtension extends
        DispatchingMosaicExtension implements IMosaicMaxValImageExtension {

    public static final String MOSAIC_TYPE = "maxVal";
    ...
    protected Class<? extends IMosaicImageExtension> getMosaicExtension() {
        return IMosaicMaxValImageExtension.class;
    }
