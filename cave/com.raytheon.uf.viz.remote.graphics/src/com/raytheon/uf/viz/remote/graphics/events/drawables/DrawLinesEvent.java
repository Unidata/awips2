...
/**
 * Bulk rendering method for lines
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 */
@DynamicSerialize
public class DrawLinesEvent extends
        AbstractRemoteGraphicsBulkRenderEvent<DrawLineEvent> {
     ...
     */
    @Override
    protected Class<DrawLineEvent> getObjectClass() {
        return DrawLineEvent.class;
    }
