 ...
 *                                     (no longer exists).
 * Aug 28, 2016 5839       rferrel     Implement new ICommand methods.
 * </pre>
 * 
 * @author rjpeter
 * @version 1.0
...
public class WMOCommand implements ICommand {
     ...
     * 
     */
    public WMOCommand(String wmoId, String site, String awipsid, String hdrtime,
            String bbbid) {
        this.wmoId = wmoId;
        this.site = site;
    ...
    public List<StdTextProduct> executeCommand() throws CommandFailedException {
        ...
        try {
            ...
            System.out.println(
                    "Time spent on WMOCommand.executeCommand()'s ThriftClient.sendRequest():"
