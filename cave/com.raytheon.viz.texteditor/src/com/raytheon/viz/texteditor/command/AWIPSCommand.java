 ...
 * Nov 26, 2018 7538       tgurney     Allow 5-character AWIPS ID
 *
 * </pre>
 *
 * @author rjpeter
...
public class AWIPSCommand implements ICommand {
    ...
    public boolean isValid() {
        return (awipsid != null) && (awipsid.length() >= 5);
    }
    ...
    public List<StdTextProduct> executeCommand() throws CommandFailedException {
        ...
        try {
            ...
            statusHandler
                    .debug("Time spent on AWIPSCommand.executeCommand()'s ThriftClient.sendRequest():"
