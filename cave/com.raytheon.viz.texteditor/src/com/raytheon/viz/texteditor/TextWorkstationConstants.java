...
public class TextWorkstationConstants {
    ...
    private static String TEXTWS = "localhost";
     ...
     * @deprecated use {@link com.raytheon.uf.common.util.SystemUtil#getHostName()}
     */
    @Deprecated
    public static synchronized String getHostName() {
        return SystemUtil.getHostName();
    }
    ...
    /**
     * @return the text workstation queue name
     */
    public static String getTextWorkstationQueueName() {
        StringBuilder queueName = getTextWorkstationQueueNameBuilder();
        queueName.append("_");
        queueName.append(SystemUtil.getHostName());
        return queueName.toString();
    }
