 ...
 * Nov 15, 2018  7624      tgurney     Save dialog dimensions when closed
 * </pre>
 *
 * @author mnash
 */
...
public class CurrentAlarmQueue extends CaveSWTDialog implements
        IAfosBrowserCallback, ICurrentAlarmListener, ControlListener {
    ...
    private class ProduceTextProductsJob extends Job {
        private Queue<Pair<Long, String[]>> queue = new ConcurrentLinkedQueue<>();
        ...
        public void queue(Long refTime, String... commands) {
            queue.add(new Pair<>(refTime, commands));
            this.schedule();
        }
    ...
    private java.util.List<StdTextProduct> produceTextProducts(Long refTime,
        ...
        java.util.List<StdTextProduct> prods = new ArrayList<>();
