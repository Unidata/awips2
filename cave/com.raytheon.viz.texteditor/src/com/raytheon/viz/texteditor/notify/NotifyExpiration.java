 ...
 * Apr 25, 2014  16668    D. Friedman  Only notify on NEW products.
 * Jan 26, 2016  5054     randerso     Changed to use display as parent
 * Mar 23, 2016  5343     bkowal       Updated site retrieval for compatibility
 *                                     with non-standard products.
 * Mar 30, 2016  5513     randerso     Fixed to return the status of the close
 *                                     prompt
 * May 12, 2016  5621     jschmid      Changed timer to use simulated time alert
 *                                     (or immediate)
...
public class NotifyExpiration {
    ...
    public void add(String warning) {
        ...
        long msToWarningEndTime = (vtecObject.getEndTime().getTimeInMillis()
                - SimulatedTime.getSystemTime().getMillis());
        long msToAlert = (msToWarningEndTime
                - (10 * TimeUtil.MILLIS_PER_MINUTE));
