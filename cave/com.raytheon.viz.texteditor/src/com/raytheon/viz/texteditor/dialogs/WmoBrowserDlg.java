 ...
 * ------------- -------- --------- --------------------------------------------
 * Aug 04, 2009  2191     rjpeter   Initial implementation.
 * Apr 14, 2010  4734     mhuang    Corrected StdTextProduct import dependency
 * Sep 11, 2014  3580     mapeters  Removed IQueryTransport usage (no longer
 *                                  exists).
 * May 01, 2019  7831     randerso  GUI cleanup
 *
 * </pre>
 *
 * @author rjpeter
...
public class WmoBrowserDlg extends CaveJFACEDialog {
    ...
    private void generateProductMaps(java.util.List<StdTextProduct> products) {
        TreeMap<String, TreeMap<String, TreeMap<String, TreeMap<String, TreeMap<String, StdTextProduct>>>>> wmoIdMap = new TreeMap<>();
    ...
    private void initializeComponents() {
        ...
        gd.heightHint = ttaaiiList.getItemHeight() * 10;
        ...
        gd = new GridData(SWT.FILL, SWT.TOP, true, true);
        gd.heightHint = ccccList.getItemHeight() * 10;
        ...
        awipsIdList = new List(listComp,
                SWT.BORDER | SWT.SINGLE | SWT.V_SCROLL);
        gd = new GridData(SWT.FILL, SWT.TOP, true, true);
        gd.heightHint = awipsIdList.getItemHeight() * 10;
        ...
        gd = new GridData(SWT.FILL, SWT.TOP, true, true);
        gd.heightHint = ddhhmmList.getItemHeight() * 10;
        ...
        gd = new GridData(SWT.FILL, SWT.TOP, true, true);
        gd.heightHint = bbbList.getItemHeight() * 10;
            ...
            if (currentProduct != null) {
                ...
                try {
                    ...
                    if (CollectionUtils.isNotEmpty(prodList)) {
                        ...
                        callbackClient.setCommandText(
                                "WMO:" + prod.getWmoid() + prod.getSite());
    ...
    private void loadInitialLists() {
        ...
        Map<String, String> timesToLoad = new HashMap<>();
        ...
        if (ttaaiiList.getItemCount() == 1) {
            ...
            ccccList.add(
                    availableProducts.get(ttaaiiList.getItem(0)).firstKey());
            ccccList.select(0);
    ...
    private void selectCCCC(int index) {
        ...
        if (ttaaiiIndex >= 0) {
            if (index >= 0 && index < ccccList.getItemCount()) {
                ...
                Set<String> awipsIdSet = availableProducts.get(ttaaii).get(cccc)
                        .keySet();
