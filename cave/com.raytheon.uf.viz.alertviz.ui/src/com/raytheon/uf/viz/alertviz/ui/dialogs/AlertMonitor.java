...
public class AlertMonitor {
    private static final IUFStatusHandler statusHandler = UFStatus
            .getHandler(AlertMonitor.class, "AV_ADMIN", "AV_ADMIN");
    ...
    private void updateImageData(Display display) {
        try {
            ...
            ImageData imageData = new ImageData(
                    loadMonitorImage(this.imageName));

            PaletteData pd = imageData.palette;
     ...
     *            Background color.
     */
    private void setFgBgColors(Display display, RGB foreground,
            RGB background) {
        if (foregroundColor != null) {
    ...
    private String loadMonitorImage(String imageFile) {
        ...
        String subDir = LocalizationUtil.join("alertViz", "monitorIcons",
                imageFile);
