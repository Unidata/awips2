...
/**
 * This is a special confirmation dialog to use with dialogs that have an
 * SWT.ON_TOP style. Any dialog with the SWT.ON_TOP style will appear over a
 * MessageBox (which is modal) and will put the GUI in a dead-lock.
 *
 * <pre>
 *
 * SOFTWARE HISTORY
 ...
 * ------------- -------- --------- --------------------------------------------
 * Apr 02, 2009  2194     lvenable  Fix for TTR 577
...
public class ConfirmationDlg extends Dialog {
    ...
    public int open(){
        ...
        setDialogLocation();
        DialogUtil.centerOnParentShell(parentShell, shell);
        shell.open();
