 ...
 * Jun 18, 2018  6601     bsteffen  Change speed to magnitude since that is
 *                                  what is in baseline config files.
 * 
 * </pre>
 * 
 * @author bsteffen
...
public class WindPlotConfig {
    ...
    @XmlElement
    private WindPlotParameter magnitude = new WindPlotParameter("windSpd",
            "kn");
    ...
    public WindPlotParameter getMagnitude() {
        return magnitude;
    }

    public void setMagnitude(WindPlotParameter magnitude) {
    ...
    public Set<String> getUniqueParameters() {
        ...
        result.add(magnitude.getParameter());
