...
public class PlotPythonScriptFactory
        implements PythonInterpreterFactory<PlotPythonScript> {
        ...
        synchronized (PlotPythonScriptFactory.class) {
            if (includePath == null) {
                ...
                LocalizationFile[] files = pm.listFiles(
                        pm.getLocalSearchHierarchy(
                                LocalizationType.CAVE_STATIC),
                        IPlotModelFactory.PLOT_MODEL_DIR, null, false,
                        false);
