...
/**
 * {@link XyPaneCreator} extension for creating var height panes.
 *
 * <pre>
 *
 * SOFTWARE HISTORY
 ...
 * @author mapeters
 */
public class VarHeightXyPaneCreator extends XyPaneCreator {
    ...
    public IPane createPane(IDisplayPaneContainer paneContainer, Composite comp,
        ...
        return new VarHeightXyPane(paneContainer, comp, display, panes);
    }
}
