 ...
 * Oct 12, 2015 4929       rferrel     Properly set up dialog when rateOfChangeRdo selected.
 ...
 *
 */
public class SCANAlarmThreshDlg extends CaveSWTDialog
        implements ICommonDialogAction {

    /** "Absolute Value" */
    private static final String absValStr = "Absolute Value";

    /** "Rate of Change" */
    private static final String rocStr = "Rate of Change";
    ...
    private void createControls() {
        ...
        rateOfChangeRdo.addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
                if (rateOfChangeRdo.getSelection()) {
                    alarmChoiceChanged();
                }
            }
        });
    ...
    private void createBottomButtons() {
        ...
        okBtn.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (mgr.hasUnclearedAlarms(site, scanTable)) {
    ...
    private void alarmChoiceChanged() {
        ...
        if (absValueRdo.getSelection()) {
            ...
            double val = scanCfg.getAbsConfigMgr(scanTable)
                    .getAbsoluteValue(attrName);
            valueTF.setText(String.valueOf(val));
            selectedChoiceLbl.setText(absValStr + ":");
        } else {
            type = AlarmType.RateOfChange;
            double val = scanCfg.getAbsConfigMgr(scanTable)
                    .getRateOfChange(attrName);
            valueTF.setText(String.valueOf(val));
    ...
    private void validateAndSetValue() {
        ...
        if (newValue.isNaN()) {
            ...
            mb.setMessage(
                    "You must enter a number - no letters, spaces, or special characters");
            mb.open();
