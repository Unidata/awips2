 ...
 * @author lvenable
 */
public class DmdDisplayFilterDlg extends CaveSWTDialog
    ...
    private void createTracksAndOverlapControls() {
        ...
        tracksOverlapComp.setLayoutData(
    ...
    private void createDisplayThresholdControls() {
        ...
        threshFilterComp.setLayoutData(
                new GridData(SWT.FILL, SWT.DEFAULT, true, false));

        GridData gd = new GridData(SWT.CENTER, SWT.DEFAULT, true, false);
        gd.horizontalSpan = ((GridLayout) threshFilterComp
        ...
        notesLbl.setText(
                "Notes: These settings will filter icons from the D-2D display, but the circulation\n"
    ...
    private void setSliderValues() {
        ...
        if (attrData.getLow() < attrData.getMin()) {
            ...
            sb.append("The lower value for ")
                    ...
                    .append(" is less than\n");
            sb.append(
                    "the minimum value of the scale.  Setting the lower value to the\n");
            sb.append("lowest value allowed on the scale");

            lowerVal = attrData.getMin();
        }

        if (attrData.getUpper() > (Math.round(attrData.getRange())
                + attrData.getMin())) {
            if (sb.length() > 0) {
                sb.append("\n\n");
            } else {
            ...
            sb.append("The upper value for ")
                    ...
                    .append(" is less than\n");
            sb.append(
                    "the highest value of the scale.  Setting the upper value to the\n");
