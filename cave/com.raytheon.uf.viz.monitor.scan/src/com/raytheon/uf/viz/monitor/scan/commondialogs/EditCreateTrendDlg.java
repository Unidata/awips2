 ...
 * @author lvenable
 */
public class EditCreateTrendDlg extends CaveSWTDialog
    ...
    private void createAttributeControls() {
        ...
        availAttrList = new List(attrComp,
        ...
        selectedAttrList = new List(attrComp,
                SWT.BORDER | SWT.SINGLE | SWT.V_SCROLL);
    ...
    private void createTrendControls() {
        ...
        GridData gd = new GridData(100, 170);
        availTrendsList = new List(trendComp,
                SWT.BORDER | SWT.SINGLE | SWT.V_SCROLL);
        ...
        trendControlComp.setLayoutData(
                new GridData(SWT.DEFAULT, SWT.CENTER, false, true));
    ...
    private void populateAvailableAttributeList() {
        String[] trendAttrNames = SCANConfig.getInstance()
                .getTrendAttributes(scanTable);
    ...
    private void handleAddAttributeAction() {
        if (selectedAttrList.getItemCount() >= 5) {
            ...
            mb.setMessage(
                    "There can only be a maximum of 5 attributes in a trend set.");
            mb.open();
            return;
        }
    ...
    private void handleUpdateTrendAction() {
        ...
        String trendName = availTrendsList
                .getItem(availTrendsList.getSelectionIndex());
    ...
    private void handleTrendListSelection() {
        ...
        String selectedTrend = availTrendsList
                .getItem(availTrendsList.getSelectionIndex());
    ...
    private void handleAddNewTrend() {
        ...
        if (availTrendsList.indexOf(newTrendName) >= 0) {
            ...
            mb.setText("Entry Error");
            mb.setMessage(
                    "That trend name already exists.  Please enter a new one.");
            mb.open();
