...
public class ScanMonitor extends ResourceMonitor
    ...
    private final ConcurrentHashMap<String, SCANCellTableDlg> cellDialogs = new ConcurrentHashMap<>();

    /** Map of icao -> meso table dialog */
    private final ConcurrentHashMap<String, SCANMesoTableDlg> mesoDialogs = new ConcurrentHashMap<>();

    /** Map of icao -> tvs table dialog */
    private final ConcurrentHashMap<String, SCANTvsTableDlg> tvsDialogs = new ConcurrentHashMap<>();

    /** Map of icao -> dmd table dialog */
    private final ConcurrentHashMap<String, SCANDmdTableDlg> dmdDialogs = new ConcurrentHashMap<>();
    ...
    public TrendGraphData getGraphData(ScanTables type, String icao,
        ...
        LinkedHashMap<Date, Double> graphData = new LinkedHashMap<>();
        LinkedHashMap<Date, Color> dataColors = new LinkedHashMap<>();
    ...
    public Map<String, UnwarnedCell> retrieveWarnings(String icao, Date time,
        ...
        HashMap<String, UnwarnedCell> cells = new HashMap<>();
