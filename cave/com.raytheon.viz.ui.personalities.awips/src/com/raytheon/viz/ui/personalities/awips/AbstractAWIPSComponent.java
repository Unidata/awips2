 ...
 *                                  command line even if practice mode is off.
 ...
 *                                  initialization before connecting to JMS to
 *                                  avoid deadlock
 ...
 * Jun 22, 2015  4474     njensen   Don't check for alertviz if alertview is
 *                                  enabled
 * Jan 21, 2016  5193     bsteffen  Disable IWorkbench.PERSIST_STATE
 * Sep 20, 2018  7457     randerso  Moved AlertVisualization out of dialogs package
 *
 * </pre>
 *
 * @author mschenke
...
public abstract class AbstractAWIPSComponent extends CAVEApplication {
    ...
    protected final WorkbenchAdvisor getWorkbenchAdvisor() {
        ...
        if (!(workbenchAdvisor instanceof HiddenWorkbenchAdvisor)) {
            try {
