 ...
 * Oct 01, 2018  7455     randerso  Changed retrieveByCategory to return list
 *                                  instead of array.
 * Dec 06, 2018  7513     randerso  Minor API improvement.
 *
 * </pre>
 *
 * @author chammack
...
public class SystemStatusHandler extends AbstractStatusHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger("CaveLogger");
     ...
     *
     * @param sm
     *            statusMessage to be acknowledged
     *
     * @param username
    ...
    /**
     * Retrieve a list the last count messages of a set of specific categories
     *
     * @param count
     ...
     * @throws AlertvizException
     */
    public static List<StatusMessage> retrieveByCategory(int count,
            Category... categories) throws AlertvizException {
        return LogMessageDAO.getInstance().load(count, categories);
    }
}
