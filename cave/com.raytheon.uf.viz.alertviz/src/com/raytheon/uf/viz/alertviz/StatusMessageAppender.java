 ...
 * Apr 15, 2020 8144       tgurney     Set the alert server URI from
 *                                     localization
 *
 * </pre>
 *
...
public class StatusMessageAppender extends JmsQueueAppender {
    ...
    public StatusMessageAppender() throws JAXBException {
        ...
        setUri(store.getString(LocalizationConstants.P_ALERT_SERVER));
    ...
    protected void append(ILoggingEvent event) {
        ...
        if (sm != null) {
            ...
            if (!isConnected()) {
                ...
                if (connected) {
                    System.err.println(
                            "StatusMessageAppender established connection to AlertViz");
            ...
            if (!connected) {
                if (printQueueWarning) {
                    System.err.println(
                            "StatusMessageAppender couldn't connect to AlertViz, queueing message(s)");
     ...
     * @throws Exception
     */
    protected void sendMessage(StatusMessage sm)
    ...
    protected void queueMessage(StatusMessage sm) {
        while (!queued.offerLast(sm)) {
            ...
            if (old != null) {
                ...
                ps.println(
                        sdf.format(old.getEventTime()) + "  " + old.toString());
            }
        }
    }
    ...
    protected StatusMessage buildStatusMessage(ILoggingEvent event) {
        ...
        if (priority != null) {
            ...
            default:
                ...
                System.err.println(
                        "StatusMessageAppender received unsupported Level "
                                + level);
