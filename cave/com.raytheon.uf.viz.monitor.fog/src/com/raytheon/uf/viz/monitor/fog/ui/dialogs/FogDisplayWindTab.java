 ...
 * </pre>
 */
public class FogDisplayWindTab extends TabItemComp
    ...
    private List<FogDisplayWindData> fogDataArray;
    ...
    private void createDataArray() {
        ...
        for (String areaID : areaList) {
            ...
            fdwd.setWindDirFromR(
                    ftm.getThresholdValue(duKey, threshKeyR, areaID, xmlKey));
            fdwd.setWindDirFromY(
                    ftm.getThresholdValue(duKey, threshKeyY, areaID, xmlKey));
