...
AreaDictionary = {
 ...
 'FLZ139': {'fullStateName': 'Florida',
            ...
            'stateAbbr': 'FL',
            'ugcCities': ['Cedar Key', 'Hudson Beach', 'McKethan Pine Island Park'],
            'ugcCode': 'FLZ139',
            'ugcName': 'Levy',
            'ugcTimeZone': 'EST5EDT',
            'landSeaArea': 'SRF_850',
 ...
 'FLZ050': {'fullStateName': 'Florida',
            'partOfState': 'west central',
            'stateAbbr': 'FL',
            'ugcCities': ['Bradenton Beach', 'Clearwater Beach', 'Siesta Key', 'Saint Pete Beach', 'Venice Beach'],
            'ugcCode': 'FLZ050',
            'ugcName': 'Pinellas',
            'ugcTimeZone': 'EST5EDT',
            'landSeaArea': 'SRF_853',
 ...
 'FLZ162': {'fullStateName': 'Florida',
            ...
            'stateAbbr': 'FL',
            'ugcCities': ['Boca Grande', 'Englewood'],
            'ugcCode': 'FLZ162',
            'ugcName': 'Charlotte',
            'ugcTimeZone': 'EST5EDT',
            'landSeaArea': 'SRF_856',
 ...
 'FLZ165': {'fullStateName': 'Florida',
            'partOfState': 'Southwest',
            'stateAbbr': 'FL',
            'ugcCities': ['Fort Myers Beach', 'Sanibel Island'],
            'ugcCode': 'FLZ165',
            'ugcName': 'Lee',
            'ugcTimeZone': 'EST5EDT',
            },
