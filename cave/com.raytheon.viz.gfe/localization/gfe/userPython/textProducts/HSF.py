...
#                "EQUATOR E OF 120W\n\n"
    ...
    def _determineTimeRanges(self, argDict):
        ...
        self._validTime = `validTime`.zfill(4) + " UTC"
        return None
    ...
    def _createFeatures(self, argDict):
        ...
        try:
            with open(self._savePathFile, "r") as f:
                toolFeatures = cPickle.load(f)
                f.close()
        except:
            toolFeatures = []
    ...
    def _createGridBasedFeatures(self, argDict):
        ...
        # Try to fetch the old object
        try:
            f = open(self._gridBasedPathFile, "r")
            gridBasedFeatureList = cPickle.load(f)
            f.close()
        except:
            gridBasedFeatures = []
    ...
    def _populateFeatures(self, argDict):
        ...
        for feature in self._features: 
            ...
            if len(featureAreaList) > 0:
                featureAreaList.sort(self._sortAreasForWarningType)
            ...
            timePeriodList = sorted(feature.periods, self._sortTimePeriods)
    ...
    def _orderFeatures(self):
        ...
        for feature in self._features:
            ...
            if feature.featureType == "GridBased":
                continue
            for period in feature.periods:
                period.areas.sort(self._sortAreas)
        ...
        self._warningFeatures.sort(self._sortWarningFeatures)
        self._synopsisFeatures.sort(self._sortSynopsisFeatures)
...
#             elif sectionType == "Synopsis":
    ...
    def _sortAreasForWarningType(self, a, b):
    ...
    def _sortWarningFeatures(self, a, b):
    ...
    def _sortSynopsisFeatures(self, a, b):
    ...
    def _sortPeriodsByTime(self, a, b):
        if a.timePeriod.startTime() > b.timePeriod.startTime():
            return -1
        elif a.timePeriod.startTime() < b.timePeriod.startTime():
            return 1
 ...
 ### modified to add leading zero for 06 hour forecast ##
    ...
    def descriptorFileName(self):
        ...
        return "/data/local/HighSeas/Formatter/NH2/HSF_AT2HighSeasDescriptors.pic"
    ...
    def gridBasedFileName(self):
        ...
        #TextProduct instance has no attribute '_siteID below for AT2
        return "/data/local/HighSeas/Formatter/NH2/HSF_AT2GridBasedFeatures.pic"
...
#         return editArea.getGrid().__numpy__[0].astype(numpy.bool8)
    ...
    def _close(self, (lat1, lon1), (lat2, lon2)):
