...
class Procedure (SmartScript.SmartScript):
   ...
   def errorHistogram(self,parmList,cycleList,modelList,obsmodel,
      ...
      #
      histkey1=list(self.histograms.keys())[0]
      maxHist=zeros_like(self.histograms[histkey1])
      for histkey in list(self.histograms.keys()):
   ...
   def scatterPlot(self,parmList,cycleList,modelList,obsmodel,
      ...
      for key in list(self.flists.keys()):
      ...
      for key in fullkeys:
         ...
         if key not in list(maxcounts.keys()):
   ...
   def makeTimeSeries(self,DialogDict):
      ...
      for parm in parmList:
         ...
         for model in modelList:
            ...
            if model in list(gridsCases.keys()):
            ...
            for key in tkeys:
               ...
               if ((AreaCombine==1)and(len(areaNames)>1)):
                  ...
                  if outkey not in list(outdata.keys()):
                     outdata[outkey]=[]
   ...
   def makeFhourGraph(self,DialogDict):
      ...
      for parm in parmList:
         ...
         for model in modelList:
            ...
            if model in list(gridCases.keys()):
            ...
            for key in tkeys:
               ...
               if ((AreaCombine==1)and(len(areaNames)>1)):
                  ...
                  outkey="%s,%s,%3.3d,-01"%(parm,model,fhr)
                  if display!="TwoCat":
                     if outkey not in list(sumdata.keys()):
                        sumdata[outkey]=0.0
                        cntdata[outkey]=0
                     sumdata[outkey]+=valx
                     cntdata[outkey]+=1
                  else:
                     if outkey not in list(hitsdata.keys()):
                        hitsdata[outkey]=0
                        missdata[outkey]=0
                        falrdata[outkey]=0
                        corndata[outkey]=0
