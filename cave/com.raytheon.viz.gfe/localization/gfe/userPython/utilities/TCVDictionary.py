...
#
# 09/14/2016 by swhite to address overdone Moderate and Elevated Wind Threats (DR 19349) and align Wind/Surge recovery with new TCV time range paradigm
# ----------------------------------------------------------------------------
    ...
    "Wind": {
        ...
        "Mod": {
            "check plans": {
                ...
                "action": "Dangerous wind is possible. Failure to adequately shelter may result in injury.",
            },
            "complete preparations": {
                ...
                "action": "Dangerous wind is possible. Failure to adequately shelter may result in injury. Move to safe shelter before the wind becomes hazardous.",
            },
            "hunker down": {
                ...
                "action": "Now is the time to hide from the wind. Failure to adequately shelter may result in injury. Remain sheltered until the hazardous wind subsides.",
            },
            "recovery": {
                "planning": "The threat for hazardous wind has subsided.", 
                "preparation": "Be safe and heed the instructions of local officials when moving about. Stay out of restricted areas.",
        ...
        "Elevated": {
            ...
            "hunker down": {
                ...
                "action": "Now is the time to hide from the wind. Remain sheltered until the hazardous wind subsides.", 
            },
            "recovery": {
                "planning": "The threat for hazardous wind has subsided.", 
                "preparation": "Be safe and heed the instructions of local officials when moving about. Stay out of restricted areas.",
    ...
    "Storm Surge": {
        ...
        "Mod": {
            ...
            "hunker down": {
                ...
                "action": "Life-threatening inundation is possible. Those who failed to take protective action risk serious injury or loss of life.",
            },
            "recovery": {
