...
ThreatStatements = {
    "Wind": {
        "Extreme": {
            "check plans": {
                "planning": "PLAN: Plan for extreme wind of equivalent CAT 3 hurricane force or higher due to possible forecast changes in track, size, or intensity.",
        ...
        "High": {
            "check plans": {
                "planning": "PLAN: Plan for life-threatening wind of equivalent CAT 1 or 2 hurricane force due to possible forecast changes in track, size, or intensity.",
        ...
        "Mod": {
            "check plans": {
                "planning": "PLAN: Plan for dangerous wind of equivalent strong tropical storm force due to possible forecast changes in track, size, or intensity.",
        ...
        "Elevated": {
            "check plans": {
                "planning": "PLAN: Plan for hazardous wind of equivalent tropical storm force due to possible forecast changes in track, size, or intensity.",
    ...
    "Tornado": {
        "Extreme": {
            "check plans": {
                ...
                "preparation": "PREPARE: Those living in manufactured homes or on small boats should prepare to relocate to safe shelter before hazardous weather arrives.", 
                "action": "ACT: Listen for tornado watches and warnings. If a tornado warning is issued, be ready to shelter quickly.",
            },
            "complete preparations": {
                "planning": "PLAN: Emergency plans should include the potential for an outbreak of many tornadoes with some possibly intense having larger damage paths." ,
                "preparation": "PREPARE: Those living in manufactured homes or on small boats are urged to relocate to safe shelter before hazardous weather arrives.", 
                "action": "ACT: Listen for tornado watches and warnings. If a tornado warning is issued, be ready to shelter quickly.",
            },
            "hunker down": {
...
EvacuationStatements = ["WATCH/WARNING PHASE - Listen to local official for recommended preparedness actions, including possible evacuation.  If ordered to evacuate, do so immediately.",
