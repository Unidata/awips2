 ...
 * Jul 09, 2009  2454     ryu       Put user and site's python scripts on path
 *                                  for import
 * May 20, 2015  4509     njensen   Added time and dataaccess to include path
 * Jul 23, 2015  4263     dgilling  Refactored to support changes to
 *                                  SmartToolController.
...
public class SmartToolScriptFactory
        implements PythonInterpreterFactory<SmartToolController> {
     ...
     * @param dataMgr
     */
    public SmartToolScriptFactory(final DataManager dataMgr) {
    ...
    @Override
    public SmartToolController createPythonScript() throws JepException {
        return new SmartToolController(getScriptPath(), getIncludePath(),
