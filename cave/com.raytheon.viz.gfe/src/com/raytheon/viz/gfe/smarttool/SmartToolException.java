 ...
 * Feb 13, 2018  6906     randerso  Allow non-VizException cause
 *
 * </pre>
 *
 * @author njensen
...
public class SmartToolException extends VizException {
    ...
    public SmartToolException(String message, Throwable cause) {
        super(message, cause);
    }
    ...
    public SmartToolException(String message, Throwable cause, ErrorType type) {
        super(message, cause);
        errorType = type;
    }
