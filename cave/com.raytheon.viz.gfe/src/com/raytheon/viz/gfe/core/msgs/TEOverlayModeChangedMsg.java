...
/**
 * Temporal Editor Overlay Mode Changed message
 *
 * <pre>
 *
 * SOFTWARE HISTORY
...
public class TEOverlayModeChangedMsg extends Message {
    ...
    public TEOverlayModeChangedMsg() {
        enabled = GFEPreference.getBoolean("TemporalEditorOverlay");
    }
    ...
    /**
     * @return true if Temporal Editor Overlay Mode is enabled
     */
