...
import com.raytheon.viz.gfe.localization.util.UtilitiesScriptUtil;

/**
 * Smart Tool Utility Adapter.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public class UtilityAdapter extends LocalizationPerspectiveAdapter {

    @Override
    public boolean addContextMenuItems(IMenuManager menuMgr,
            FileTreeEntryData[] selectedData) {
        UtilitiesScriptUtil util = new UtilitiesScriptUtil();
