...
import com.raytheon.viz.gfe.localization.dialogs.NewTextProductDialog;
 ...
 * Nov 12, 2012  1298     rferrel    Changes for non-blocking
 *                                   NewTextProductDialog.
 * Aug 11, 2016  5816     randerso   Class renamed and moved to
 *                                   gfe.localization.actions. Code refactored
 *                                   and cleaned up
 * 
 * </pre>
 * 
...
public class NewTextProductAction extends Action {

    /**
     * The action to create a new text product.
     */
    public NewTextProductAction() {
        super("New...");
    }
