 ...
 * 01/15/2016    5193      bsteffen    Lazy load prefs.
 *
 * </pre>
 * 
 * @author chammack
...
public class FreeformRenderable implements IRenderable {
    ...
    private static RGB getDrawingColor() {
        return DrawingColorPreference.instance.getDrawingColor();
    }

    private static class DrawingColorPreference extends PreferenceInitializer {
         ...
         */
        public static final DrawingColorPreference instance = new DrawingColorPreference();

        private RGB drawingColor = new RGB(255, 255, 255);

        private DrawingColorPreference() {
            run();
        }

        public RGB getDrawingColor() {
            return drawingColor;
        }
