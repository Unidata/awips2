...
public class PencilTool extends AbstractFreeformTool {
    ...
    private static int[] getInfluences() {
        return PencilToolPreferences.instance.getInfluences();
    }

    private static class PencilToolPreferences extends PreferenceInitializer {
         ...
         */
        public static final PencilToolPreferences instance = new PencilToolPreferences();

        private int[] influences = new int[] { 1, 2, 5, 10, 15 };

        private PencilToolPreferences() {
            run();
        }
