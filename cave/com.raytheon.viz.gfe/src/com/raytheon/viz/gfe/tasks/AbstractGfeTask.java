 ...
 * Sep 13, 2016  #19362    bhunder     getLogDir().  Delete logs older than 30 days.
 * 
 * </pre>
 * 
 * @author randerso
...
public abstract class AbstractGfeTask extends Thread implements
    ...
    private static final long LOG_RETENTION_PERIOD = 30 * TimeUtil.MILLIS_PER_DAY;
            ...
            try {
                ...
                if (!logBaseDir.exists()) {
                    logBaseDir.mkdirs();
                     ...
                     long purgeTime = System.currentTimeMillis() - LOG_RETENTION_PERIOD;
