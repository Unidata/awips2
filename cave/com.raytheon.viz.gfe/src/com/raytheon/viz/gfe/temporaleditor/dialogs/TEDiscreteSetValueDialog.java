...
import com.raytheon.viz.gfe.dialogs.DiscreteSetValue;
...
public class TEDiscreteSetValueDialog extends CaveJFACEDialog {
    ...
    private DiscreteSetValue setValue;

    /**
     * @param parentShell
     */
    public TEDiscreteSetValueDialog(Shell parentShell, Parm parm, Date date) {
        super(parentShell);
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        setValue = new DiscreteSetValue(valueFrame, parm, true, false, false);
