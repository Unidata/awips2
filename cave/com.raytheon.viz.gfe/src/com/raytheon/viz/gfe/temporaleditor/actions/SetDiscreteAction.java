...
import com.raytheon.viz.gfe.temporaleditor.dialogs.TEDiscreteSetValueDialog;

/**
 * Used by the right click menu on a Discrete grid type, to set a discrete
 * weather element.
 * 
 * <pre>
 * SOFTWARE HISTORY
 ...
 * @version 1.0
 */
public class SetDiscreteAction extends Action {
    private Parm parm;

    private Date date;

    public SetDiscreteAction(Parm parm, Date date) {
        super("Set...");
        this.parm = parm;
        this.date = date;
    }
