...
# grouping
    ...
    "createGrids": [
       ...
       ("Fcst", "Hazards", "DISCRETE", 0, 36, "DU.W", ["FLZ139"]),
       ],
    "checkStrings": [
       "WWUS72 KTBW 030000",
       "NPWTBW",
       ...
       ".|*Overview (must edit)*|.",
       "FLZ139-030800-",
       "/O.NEW.KTBW.DU.W.0001.101203T0000Z-101204T1200Z/",
       "Coastal Levy-",
       "700 PM EST Thu Dec 2 2010",
       "...BLOWING DUST WARNING IN EFFECT UNTIL 7 AM EST SATURDAY...",
       "The National Weather Service in Tampa Bay Ruskin has issued a Blowing Dust Warning, which is in effect until 7 AM EST Saturday.",
...
# downgrading DU.W to DU.Y will result in a NEW/CAN event for us to test
# the action grouping
    {
    "commentary": "Non-Marine Setup for action grouping - NEW/CAN, DU.W->DU.Y",
    ...
    "checkStrings": [
       ...
       ".|*Overview (must edit)*|.",
       "FLZ139-030800-",
       "/O.CAN.KTBW.DU.W.0001.000000T0000Z-101204T1200Z/",
