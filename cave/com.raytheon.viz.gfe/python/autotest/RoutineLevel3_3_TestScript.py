...
scripts = [
    ...
    "checkStrings": [
       "Windward, partly sunny in the morning then becoming cloudy, Widespread snow showers",
       "Leeward, sunny in the morning then becoming partly sunny, Isolated showers",
       ],
    },
    ...
    "checkStrings": [
       "Rain and snow likely windward, partly sunny with a 30 percent chance of rain leeward, chance of precipitation 70 percent windward",
       ],
    },
    {
    ...
    "checkStrings": [
       "Sunny, mostly cloudy with a 30 percent chance of rain leeward, widespread fog leeward.",
       ],
    "notCheckStrings":[
