...
#all time zone tests
alltzdef = """
AreaDictionary['FLZ239']['ugcTimeZone'] = 'America/Puerto_Rico'
AreaDictionary['FLZ242']['ugcTimeZone'] = 'EST5EDT'
AreaDictionary['FLZ043']['ugcTimeZone'] = 'EST5'
AreaDictionary['FLZ248']['ugcTimeZone'] = 'CST6CDT'
AreaDictionary['FLZ249']['ugcTimeZone'] = 'CST6'
AreaDictionary['FLZ050']['ugcTimeZone'] = 'MST7MDT'
AreaDictionary['FLZ251']['ugcTimeZone'] = 'MST7'
AreaDictionary['FLZ052']['ugcTimeZone'] = 'PST8PDT'
AreaDictionary['FLZ255']['ugcTimeZone'] = 'PST8'
AreaDictionary['FLZ056']['ugcTimeZone'] = 'America/Anchorage'
AreaDictionary['FLZ057']['ugcTimeZone'] = 'AKST9'
AreaDictionary['FLZ260']['ugcTimeZone'] = 'Pacific/Honolulu'
AreaDictionary['FLZ061']['ugcTimeZone'] = 'Pacific/Guam'

"""

alldefaultEditAreasTZ = """
...
# Testing Spans
    ...
    "createGrids": [
       ...
       ("Fcst", "MaxT", "SCALAR", "MaxTBegin", "MaxTEnd", 80, ['FLZ251']),
       ("Fcst", "MaxT", "SCALAR", "MaxTBegin+24", "MaxTEnd+24", 88, ['FLZ251','FLZ050']),
       ("Fcst", "QPF", "SCALAR", 6, 9, 1.00, ['FLZ050']),
       ("Fcst", "QPF", "SCALAR", 6, 9, 2.00, ['FLZ251']),
       ("Fcst", "QPF", "SCALAR", Day+6, Day+9, 2.24, ['FLZ251','FLZ050']),
       ("Fcst", "SnowAmt", "SCALAR", 6, 18, 6, ['FLZ050']),
       ("Fcst", "SnowAmt", "SCALAR", 6, 18, 12, ['FLZ251']),
       ("Fcst", "SnowAmt", "SCALAR", 18, Day, 15, ['FLZ251','FLZ050']),
       ],
    },
...
# Testing Hazards
    ...
    "createGrids": [
       ...
       ("Fcst", "Hazards", "DISCRETE", 6, 6+1, "TY.A", ['FLZ056']),
