...
scripts = [
    ...
    {"name":"BLU1",  
     "productType" : "CivilEmerg_BLU_Local",
     "commentary": "Basic BLUE ALERT formatter test",
     "checkStrings" : ["Blue Alert"],
     },
    {"name":"BLU2",  
     "productType" : "CivilEmerg_BLU_Local", 
     "commentary": "Different Options BLUE ALERT formatter test",
     "cmdLineVars" :"{('Source', 'source'): 'Colorado Emergency Management Agency Denver Colorado', ('Issued By', 'issuedBy'): None, ('EAS Level', 'eas'): 'BULLETIN - EAS ACTIVATION REQUESTED'}",
     "checkStrings" : ["BULLETIN - EAS ACTIVATION REQUESTED","Blue Alert"],
     },
    {"name":"CAE1",  
