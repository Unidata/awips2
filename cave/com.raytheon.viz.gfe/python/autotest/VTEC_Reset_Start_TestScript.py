...
scripts = [
    ...
    "createGrids": [
       ...
       ("Fcst", "Hazards", "DISCRETE", 0, 24, "WW.Y", ["FLZ039","FLZ042"]),
       ],
    "checkStrings": [
       "WWUS42 KTBW 200510",
       "WSWTBW",
    ...
    "createGrids": [
       #("Fcst", "Hazards", "DISCRETE", -100, 100, "<None>", "all"),
       ("Fcst", "Hazards", "DISCRETE", 0, 10, "WW.Y", ["FLZ039","FLZ042"]),
       ("Fcst", "Hazards", "DISCRETE", 12, 24, "WW.Y", ["FLZ039","FLZ042"]),
       ],
    "checkStrings": [
       "WWUS42 KTBW 200520",
       "WSWTBW",
    ...
    "createGrids": [
       #("Fcst", "Hazards", "DISCRETE", -100, 100, "<None>", "all"),
       ("Fcst", "Hazards", "DISCRETE", 2, 10, "WW.Y", ["FLZ039","FLZ042"]),
       ("Fcst", "Hazards", "DISCRETE", 12, 24, "WW.Y", ["FLZ039","FLZ042"]),
       ],
    "checkStrings": [
       "WWUS42 KTBW 200520",
    ...
    "createGrids": [
       #("Fcst", "Hazards", "DISCRETE", -100, 100, "<None>", "all"),
       ("Fcst", "Hazards", "DISCRETE", 0, 12, "BZ.W", ["FLZ039","FLZ042"]),
       ("Fcst", "Hazards", "DISCRETE", 12, 24, "WW.Y", ["FLZ039","FLZ042"]),
       ],
    "checkStrings": [
       "WWUS42 KTBW 200520",
    ...
    "createGrids": [
       #("Fcst", "Hazards", "DISCRETE", -100, 100, "<None>", "all"),
       ("Fcst", "Hazards", "DISCRETE", 3, 10, "WS.W", ["FLZ039","FLZ042"]),
       ("Fcst", "Hazards", "DISCRETE", 12, 24, "WW.Y", ["FLZ039","FLZ042"]),
       ],
    "checkStrings": [
       "WWUS42 KTBW 200520",
    ...
    "createGrids": [
       #("Fcst", "Hazards", "DISCRETE", -100, 100, "<None>", "all"),
       ("Fcst", "Hazards", "DISCRETE", 2, 12, "WW.Y", ["FLZ039","FLZ042"]),
       ("Fcst", "Hazards", "DISCRETE", 15, 20, "BZ.W", ["FLZ039","FLZ042"]),
       ],
    "checkStrings": [
       "WWUS42 KTBW 200520",
       "WSWTBW",
       ...
       "...BLIZZARD WARNING IN EFFECT FROM 3 PM THIS AFTERNOON TO 8 PM "
       "EST THIS EVENING...",
       "$$"
       ],
    },
    ...
    "createGrids": [
       #("Fcst", "Hazards", "DISCRETE", -100, 100, "<None>", "all"),
       ("Fcst", "Hazards", "DISCRETE", 2, 10, "WC.Y", ["FLZ039","FLZ042"]),
       ("Fcst", "Hazards", "DISCRETE", 12, 24, "WW.Y", ["FLZ039","FLZ042"]),
       ],
    "checkStrings": [
       "WWUS42 KTBW 200520",
