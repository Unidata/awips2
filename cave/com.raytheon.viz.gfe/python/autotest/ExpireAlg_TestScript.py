...
#       "|* SEGMENT TEXT GOES HERE *|.",
    ...
    "createGrids": [
       ("Fcst", "Hazards", "DISCRETE", -100, 100, "<None>", "all"),
       ("Fcst", "Hazards", "DISCRETE", 0, 3, "DU.Y", ["FLZ149"]),
       ("Fcst", "Hazards", "DISCRETE", 3, 6, "DU.W", ["FLZ149"]),
       ],
    "checkStrings": [
      "WWUS72 KTBW 010000",
      "NPWTBW",
      ...
      ".|*Overview (must edit)*|.",
      "FLZ149-010600-",
      "/O.NEW.KTBW.DU.W.0001.100101T0300Z-100101T0600Z/",
      "/O.NEW.KTBW.DU.Y.0002.100101T0000Z-100101T0300Z/",
      "Pasco-",
      "700 PM EST Thu Dec 31 2009",
      "...BLOWING DUST ADVISORY IN EFFECT UNTIL 10 PM EST THIS EVENING...",
      "...BLOWING DUST WARNING IN EFFECT FROM 10 PM THIS EVENING TO 1 AM EST FRIDAY...",
      "The National Weather Service in Tampa Bay Ruskin has issued a Blowing Dust Warning, which is in effect from 10 PM this evening to 1 AM EST Friday. A Blowing Dust Advisory has also been issued. This Blowing Dust Advisory is in effect until 10 PM EST this evening.",
    ...
    "createGrids": [
       ("Fcst", "Hazards", "DISCRETE", -100, 100, "<None>", "all"),
       ("Fcst", "Hazards", "DISCRETE", 0, 3, "DU.Y", ["FLZ149"]),
       ("Fcst", "Hazards", "DISCRETE", 30, 60, "DU.W", ["FLZ149"]),
       ],
    "checkStrings": [
      "WWUS72 KTBW 010000",
      "NPWTBW",
      ...
      ".|*Overview (must edit)*|.",
      "FLZ149-010800-",
      "/O.NEW.KTBW.DU.W.0001.100102T0600Z-100103T1200Z/",
      "/O.NEW.KTBW.DU.Y.0002.100101T0000Z-100101T0300Z/",
      "Pasco-",
      "700 PM EST Thu Dec 31 2009",
      "...BLOWING DUST ADVISORY IN EFFECT UNTIL 10 PM EST THIS EVENING...",
      "...BLOWING DUST WARNING IN EFFECT FROM 1 AM SATURDAY TO 7 AM EST SUNDAY...",
      "The National Weather Service in Tampa Bay Ruskin has issued a Blowing Dust Warning, which is in effect from 1 AM Saturday to 7 AM EST Sunday. A Blowing Dust Advisory has also been issued. This Blowing Dust Advisory is in effect until 10 PM EST this evening.",
      "A Blowing Dust Warning means severely limited visibilities are expected with blowing dust. Travel could become extremely dangerous. Persons with respiratory problems should make preparations to stay indoors until the storm passes.",
      "A Blowing Dust Advisory means that blowing dust will restrict visibilities. Travelers are urged to use caution.",
      "$$",
       ],
    ...
    "checkStrings": [
      ...
      ".|*Overview (must edit)*|.",
      "FLZ149-010300-",
      "/O.CAN.KTBW.DU.W.0001.100102T0600Z-100103T1200Z/",
