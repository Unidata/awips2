 ...
 * Aug 19, 2019  67362     ksunil      Add previous run -1 and -2.
 * 
 * </pre>
 * 
 * @author chammack
...
public enum LoadMode {
    STD("Standard"),
    LATEST("Latest"),
    VALID_TIME_SEQ("Valid time seq"),
    PREVIOUS_MODEL_RUN("Previous run"),
    PREVIOUS_VALID_TIME_SEQ("Prev valid time seq"),
    PROG_LOOP("Prognosis loop"),
    ANALYSIS_LOOP("Analysis loop"),
    DPROG_DT("dProg/dt"),
    FORCED("Forced"),
    FCST_TIME_MATCH("Forecast match"),
    INVENTORY("Inventory"),
    SLOT("Slot"),
    NO_BACKFILL("No Backfill"),
    RANGE_MATCH("Range match"),
    PREVIOUS_MODEL_RUN_1("Previous run - 1"),
    PREVIOUS_MODEL_RUN_2("Previous run - 2");
