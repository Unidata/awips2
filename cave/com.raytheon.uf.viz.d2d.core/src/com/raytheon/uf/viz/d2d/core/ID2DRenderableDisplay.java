 ...
 * Oct 10, 2022 8946       mapeters    Extract scale methods to new superinterface
 *                                     IScalableRenderableDisplay
 *
 * </pre>
 *
 * @author njensen
 */
public interface ID2DRenderableDisplay extends IScalableRenderableDisplay {

    GenericResourceData colorBarRscData = new GenericResourceData(
            D2DColorBarResource.class);

    GenericResourceData legendRscData = new GenericResourceData(
            D2DLegendResource.class);

    GenericResourceData selectedRscData = new GenericResourceData(
            D2DSelectedPaneResource.class);

    GenericResourceData samplingRscData = new GenericResourceData(
