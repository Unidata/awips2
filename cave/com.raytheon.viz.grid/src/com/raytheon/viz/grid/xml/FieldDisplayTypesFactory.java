...
/**
 * Singleton for loading {@link FieldDisplayTypes} from localization xml files.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * Jun 20, 2016 5439       bsteffen    Synchronize getInstance
 * 
 * </pre>
 * 
 * @author jelkins
...
public class FieldDisplayTypesFactory {
    ...
    public static synchronized FieldDisplayTypesFactory getInstance() {
        if (instance == null) {
