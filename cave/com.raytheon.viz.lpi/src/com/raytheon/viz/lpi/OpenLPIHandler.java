...
/**
 * 
 * Eclipse handler for opening LPI resources
 * 
 * <pre>
 * SOFTWARE HISTORY
...
public class OpenLPIHandler extends AbstractMapHandler {
    ...
    public Object execute(ExecutionEvent arg0) throws ExecutionException {
        ...
        fd.setFilterExtensions(new String[] { "*.lpi" });
        ...
        if (fd.open() != null) {
            ...
            try {
                ...
                if (mapDesc == null) {
                    Activator
                            ...
                            .log(new Status(Status.ERROR, Activator.PLUGIN_ID,
                                    "Map does not support LPI Files", null));
                    return null;
                }
                ...
                for (String fileName : fileNames) {
                    LPIResourceData rd = new LPIResourceData();
                    rd.setFilename(FileUtil.join(path, fileName));
                    LPIResource spi = rd.construct(new LoadProperties(),
                            mapDesc);
