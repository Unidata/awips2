 ...
 * Apr 19, 2018  7013      tgurney     Call AlertvizJob.setCanExit when starting up
 *
 * </pre>
 *
 * @author mschenke
...
public class ThinAlertVizComponent extends AlertVizApplication
        implements IThinClientComponent {
    ...
    public Object startComponent(String componentName) throws Exception {
        ...
        statsJob = new StatsJob("HTTP Network Statistics",
                HttpClient.getInstance().getStats());
        statsJob.schedule();
        AlertvizJob.getInstance().setCanExit(true);
