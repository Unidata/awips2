...
public class PopupSkewTResource extends
    ...
    private Float getValue(Map<String, Object> dataMap, String ID,
        ...
        if (obj instanceof Quantity) {
            ...
            if (quantity.getValue() instanceof Number
                    && quantity.getUnit().isCompatible(expectedUnit)) {
                Number value = (Number) quantity.getValue();
                expectedValue = (float) UnitConv
                        .getConverterToUnchecked(quantity.getUnit(),
                                expectedUnit)
