 ...
 * ------------- -------- --------- ----------------------------
 * Oct 16, 2018  6835     bsteffen  refactor the print handler.
 * 
 * </pre>
 * 
 */
public class NSharpPrintScreenAction extends PrintImageCaptureHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        NsharpResourceHandler handler = editor.getRscHandler();
        ...
        if (frameMode == null || frameMode.equalsIgnoreCase("current")) {
            ...
            pd.setStartPage(handler.getCurrentIndex() + 1);
            pd.setEndPage(handler.getCurrentIndex() + 1);
    ...
    private void printAllFrames(NsharpPrintHandle printer, NsharpEditor editor)
            throws VizException {
        printFrames(printer, editor, 0, editor.getRscHandler().getFrameCount());
    }
