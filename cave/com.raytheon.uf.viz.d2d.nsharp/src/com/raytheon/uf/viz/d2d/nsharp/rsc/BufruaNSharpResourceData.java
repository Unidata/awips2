...
public class BufruaNSharpResourceData extends D2DNSharpResourceData {
    ...
    protected NcSoundingCube getSoundingCube(NsharpStationInfo stnInfo) {
        ...
        return NcSoundingQuery.soundingQueryByStnId(stnInfo.getReftime()
                .getTime(), latLon, stnInfo.getSndType(),
