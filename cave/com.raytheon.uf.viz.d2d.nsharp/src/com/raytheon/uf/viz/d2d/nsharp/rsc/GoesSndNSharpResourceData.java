...
public class GoesSndNSharpResourceData extends PointDataNSharpResourceData {
    ...
    protected NcSoundingCube getSoundingCube(NsharpStationInfo stnInfo) {
        ...
        try {
            PointDataContainer pdc = PointDataRequest.requestPointDataAllLevels(
                    time, "goes", PARAMETERS, null, getMetadataMap());
            ...
            Unit<Length> heightUnit = pdv.getUnit(HEIGHT).asType(Length.class);
            ...
            Unit<Temperature> dewpointUnit = pdv.getUnit(DEWPOINT)
                    .asType(Temperature.class);
