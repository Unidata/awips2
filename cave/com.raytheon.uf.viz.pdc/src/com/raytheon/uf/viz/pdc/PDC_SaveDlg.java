 ...
 * May 03, 2016 5623       bkowal      Cleanup.
...
public class PDC_SaveDlg extends CaveSWTDialog {
     ...
     */
    private ISavePdcPresets parentDialog;
    ...
    private boolean saveData() {
        ...
        try {
            ...
            statusHandler.error(
                    "Invalid Preset Rank: [" + newRankTF.getText() + "]", e);
            sb.append(prefix).append("Invalid Preset Rank.");
        }
        ...
        try {
            ...
            if (presetString != null) {
                 ...
                 * insert.
                 */
                List<PointDataPreset> presetList = parentDialog.getPresetData();

                if (presetList != null) {
                    for (PointDataPreset pre : presetList) {
                        if (pre.getPresetId()
                                .equalsIgnoreCase(editedPresetId)) {
                            matchFound = true;
                            break;
                        }
                    }
        ...
        } catch (VizException | ParseException e) {
            statusHandler.error("An error occurred during the save function.",
                    e);
            success = false;
        }
