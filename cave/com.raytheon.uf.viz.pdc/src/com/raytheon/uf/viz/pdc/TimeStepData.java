...
/**
 * This class contains the Time Step elements that will be displayed in the
 * elements control.
 * 
 * <pre>
 * SOFTWARE HISTORY
...
public class TimeStepData {
     ...
     */
    private List<TimeStepElements> elementsArray;
     ...
     */
    public List<TimeStepElements> getDataElementArray() {
