...
/**
 * Point Data Control Add Missing
 *
 * <pre>
 * SOFTWARE HISTORY
 *
...
public class PointDataControlAddMissing {
     ...
     */
    public static List<GageData> addMissingReports(
        ...
        List<String> missingLids = new ArrayList<>();
        ...
        if (pcOptions.getFilterByTypeSource() == 1) {
            ...
            if ((pcOptions
                    ...
                    && (pcOptions
                            .getTimeMode() == PDCConstants.TimeModeType.LATEST
                                    .getTimeMode())) {
         ...
         * going on
         */
        Set<String> obsReportLidSet = new HashSet<>();
