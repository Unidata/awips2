...
public class StationEntryDetails {
    ...
    private List<Double> valueArray = new ArrayList<>();
    ...
    public void setObserver(String observer) {
        if (T.equalsIgnoreCase(observer)) {
            this.observer = true;
        } else {
            this.observer = false;
        }
     ...
     */
    public void setValueArray(List<Double> valueArray) {
