 ...
 * Feb 24, 2017 6119       tgurney     Size text area based on font size
 * May 23, 2017 6119       tgurney     Fix text area sizing
 *
 * </pre>
 *
 * @author lvenable
...
public class HelpUsageDlg extends CaveSWTDialog {
    ...
    private void createHelpTextControl() {
        ...
        helpStTxt = new StyledText(shell,
                SWT.BORDER | SWT.MULTI | SWT.V_SCROLL | SWT.H_SCROLL);

        helpStTxt.setWordWrap(false);
        helpStTxt.setFont(textFont);
        helpStTxt.setEditable(false);
        helpStTxt.setText(helpText);
        int textWidth = helpStTxt.computeSize(SWT.DEFAULT, SWT.DEFAULT, true).x;
        GC gc = new GC(helpStTxt);
        gd.widthHint = Math.min(textWidth, gc.getCharWidth('x') * 100) + 5;
