 ...
 *                                     HDF5.
 * May 11, 2016 18800      jdynina     Removed alerting
 * May 11, 2016 18795      jdynina     Added CPM
 *
 * </pre>
 *
 * @author mschenke
...
public class RadarRecordDataRetriever implements
    ...
    public int getSize(RadarRecord object) {
        ...
        if (object.getCpmMessage() != null) {
            objs.add(object.getCpmMessage());
        }
