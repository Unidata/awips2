...
public class NextGraphicPage extends AbstractRightClickAction {
    ...
    public static void goToNext(RadarGraphicsResource resource) {
        RadarGraphicsDisplay rgd = resource.getRadarGraphicsDisplay().get(
                resource.getDescriptor().getTimeForResource(resource));
        if (rgd.getCurrentPage() == rgd.getNumPages() - 1) {
            rgd.setCurrentPage(0);
        } else {
