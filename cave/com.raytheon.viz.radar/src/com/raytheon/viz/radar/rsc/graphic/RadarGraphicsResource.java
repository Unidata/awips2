...
/**
 * Resource for displaying radar products which are rendered as graphics, such
 * as lines symbols and text.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * ------------- -------- --------- --------------------------------------------
 * May 13, 2010  4560     mnash     Initial creation
...
public class RadarGraphicsResource extends AbstractRadarResource<MapDescriptor>
    ...
    protected Map<DataTime, RGB> lastColor = new HashMap<>();
    ...
    public RadarGraphicsResource(RadarResourceData rrd,
        ...
        radarGraphicsDisplay = new HashMap<>();
    ...
    public String[] getExtraText(DataTime time) {
        ...
        if (record != null && record.getProductCode() == 140) {
            return super.getExtraText(time);
        }
