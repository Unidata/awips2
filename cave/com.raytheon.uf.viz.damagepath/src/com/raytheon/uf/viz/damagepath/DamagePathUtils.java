 ...
 * Oct 17, 2018 7534       dgilling    Update error message when baselines are
 *                                     too far from home radar station.
 *
 * </pre>
 *
 * @author nabowle
...
public class DamagePathUtils {
    ...
    private static UnitConverter TO_METERS = USCustomary.MILE
    ...
    public static Polygon estimateTornadoDamagePath(Baseline baseline) {
        ...
        if (!skippedCoords.isEmpty()) {
            ...
            sb.append("Skipped the following Coordinates for Baseline ")
                    .append(baseline.name).append(" because they ")
                    .append("are out of range of the radar station [")
                    .append(station.getRdaId()).append("]: ");
        ...
        if (validCoords.isEmpty()) {
            ...
            if (skippedCoords.isEmpty()) {
                ...
                suggestion = String.format(
                        "Make sure the baseline is within 300 miles of the radar station [%s]. If the wrong radar station was selected, use the Home or Put Home tool to verify and move your home location.",
                        station.getRdaId(),
