...
public class PlanViewInfoComposite extends Composite {
    ...
    public void createRootArea() {
        ...
        frameTimeUsingBasisLbl.setFont(SWTResourceManager.getFont("Dialog", 9,
                SWT.NONE));
        ...
        metaDataScrolledComposite = new ScrolledComposite(this, SWT.BORDER
                | SWT.H_SCROLL | SWT.V_SCROLL);

        GridData metaDataScrolledComposite_gd = new GridData(SWT.FILL,
                SWT.FILL, true, true, 4, 1);
    ...
    public void updateMetaDataInfo(GridResourceHolder grh) {
        ...
        if (grh != null) {
            ...
            if (rsc != null) {
                ...
                metaDataContents.setBackground(GlobalColor
                        .get(GlobalColor.PALE_EXTRA_LIGHT_AZURE));
    ...
    private void addNameValuePairLabels(Composite metaDataContents,
        ...
        metaDataDescription.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER,
                true, false, 2, 1));
        metaDataDescription.setText(name);
        metaDataDescription.setBackground(GlobalColor
                .get(GlobalColor.PALE_EXTRA_LIGHT_AZURE));
        metaDataValue = new Label(metaDataContents, SWT.NONE);
        metaDataValue.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, true,
                false, 2, 1));
        metaDataValue.setText(value);
        metaDataValue.setBackground(GlobalColor
                .get(GlobalColor.PALE_EXTRA_LIGHT_AZURE));
    }
