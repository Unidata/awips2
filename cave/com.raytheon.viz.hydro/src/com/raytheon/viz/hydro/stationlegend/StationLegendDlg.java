...
public class StationLegendDlg extends CaveSWTDialog {
    ...
    private class LegendData {
        ...
        protected ThreatIndex threatIndex;
    ...
    private static final String STATION_ICON_TEXT = "Station Icons";

    /** Header for column to display river/reservoir colors. */
    private static final String STATION_COLOR_TEXT = "River/Reservoir Station Colors";

    /** Title for river point icon. */
    private static final String RIVER_POINT_TEXT = "River Data Point";

    /** Title for forecast point icon. */
    private static final String FORECAST_POINT_TEXT = "River Forecast Point";

    /** Title for reservoir data point icon. */
    private static final String RESERVOIR_DATA_POINT_TEXT = "Reservoir Data Point";

    /** Title for reservoir forecast point icon. */
    private static final String RESERVOIR_FORECAST_POINT_TEXT = "Reservoir Forecast Point";

    /** Title for meteorological station icon. */
    private static final String MET_STATION_TEXT = "Meteorological Station";

    /**
     * Title for combined river forecast point and meteorological station icon.
     */
    private static final String RIVER_FORECAST_MET_POINT_TEXT = "River Forecast Point with Meteorological Station";

    /** Title for river forecast point with missing data icon. */
    private static final String MISSING_DATA_TEXT = "River Forecast Point with missing data";

    /** Title for river forecast point above flood stage icon. */
    private static final String FLOOD_STAGE_TEXT = "River Forecast Point above flood stage";

    /** Title for river forecast point above action stage icon. */
    private static final String ACTION_STAGE_TEXT = "River Forecast Point above action stage";

    /** Title for river forecast point below action stage icon. */
    private static final String BELOW_ACTION_STAGE_TEXT = "River Forecast Point below action stage";

    /** Title for river forecast poine missing action/flood stage value icon. */
    private static final String MISSING_STAGE_TEXT = "River Forecast Point missing action/flood stage values";

    /** Title for station data display. */
    private static final String STATION_DATA_TEXT = "Station Data";
    ...
    private LegendData[][] legendData = {
            // Column 1
            { new LegendData("R", ThreatIndex.THREAT_NONE, RIVER_POINT_TEXT),
        ...
        for (int column = 0; column < 2; column++) {
            ...
            for (LegendData data : legendData[column]) {
                ...
                maxWidth = Math.max(maxWidth,
                        x1 + gc.textExtent(data.legend).x);
