 ...
 * May 03, 2016 5576       bkowal      Never return a disposed instance of this dialog.
 *                                     Cleanup.
 * 
 * </pre>
 * 
...
public class PointDataControlDlg extends CaveSWTDialog {
     ...
     */
    public List<PointDataPreset> presets;
    ...
    private void handleStationsOrPE() {
        if (elementTypeCbo.getSelectionIndex() != TimeStepDataElementType.RAIN_TIME_STEP_TYPE
                .ordinal()) {
    ...
    private void setPcOptionsUsingPresets(PointDataPreset preset) {
        ...
        try {
            Map<String, String[]> presetData = (HashMap<String, String[]>) PDCUtils
                    .tokenizePresetString(presetString);

            setPCOptions(presetData);
        } catch (ParseException e) {
            statusHandler.error("Failed to parse Point Data Preset: "
                    + presetString + ".", e);
        }
    }

    private void setPCOptions(Map<String, String[]> presetData) {
        PDCOptionData pcOptions = PDCOptionData.getInstance();
        pcOptions.reset();
        ...
        if (pcOptions.getQueryMode() == 0) { // AdHoc Mode
            ...
            if (pcOptions.getElementType() == HydroConstants.TimeStepDataElementType.RAIN_TIME_STEP_TYPE
                ...
                if (pcOptions.getTsDataElement() == HydroConstants.TimeStepDataElement.INSTANTANEOUS_PRECIP_TSDE
                    ...
                    statusHandler
                            .error("An unknown precipitation type: "
