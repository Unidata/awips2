...
/**
 * This class contains the Time Step elements data.
 * 
 * <pre>
 * SOFTWARE HISTORY
...
public class TimeStepElements
{
     ...
     */
    public TimeStepElements(String elementType)
    {
     ...
     */
    public TimeStepElements(String elementType, ArrayList<String> array)
    {
        this.elementType = elementType;
