...
/**
 * Precip accumulation calculations are done here.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * sep 29, 2010 4384      lbousaidi  Fixed bugs related to TS Lookup for PP
 * 									  and PC      
 * </pre>
 * 
 * @author mpduff
...
public class PrecipAccumulation {
     ...
     * 
     * Not using the settings as in the original code because for this dialog the 
     * values are always PrecipPEBest and PrecipTSSingle
     */
    ...
    private void getTotalRawPP(ArrayList<Rawpp> ppGroup) {
        ...
        if (noAccumFlag) {
            for (Rawpp rpp : ppGroup) {
                ...
                if ((rpp.getValue() != MISSING_PRECIP)
                     ...
                     * the start time.
                     */
                    dataDur = DurationUtils.durationToSeconds(rpp.getDur(), rpp
                            .getObstime().getTime());
    ...
    private boolean findDurationMatch(ArrayList<Rawpp> ppGroup) {
        boolean match = false;
        ...
        long duration = endTime.getTimeInMillis() - beginTime
                .getTimeInMillis();
            ...
            if ((value != MISSING_PRECIP)
                ...
                if (dataDur == duration) {
                    ...
                    if (((rpp.getDur() == 5004) || (rpp.getDur() == 2001))
                        ...
                        if (rpp.getObstime().getTime() == endTime.getTimeInMillis()) {
                            ppTotal = rpp.getValue();
                            ppMatchTime = rpp.getObstime().getTime();
                            prevDiff = diff;
                        }
    ...
    private void getTotalBySummingRawPC(ArrayList<Rawpc> dataList) {
        /*
        ...
        ArrayList<Rawpc> validDataList = new ArrayList<Rawpc>();
    ...
    private void getTotalBySubtractingRawPC(ArrayList<Rawpc> dataList) {
