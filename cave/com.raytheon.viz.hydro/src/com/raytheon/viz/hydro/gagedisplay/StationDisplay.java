...
import com.raytheon.viz.hydrocommon.resource.DamLocationResourceData;
...
public class StationDisplay
    ...
    public DamLocationResource getDamLocationResource() {
        if ((dlr == null) || dlr.isDisposed()) {
            ...
            try {
                ...
                statusHandler.error(
                        "Error constructing the Dam Location Resource.", e);
            }
        }
     ...
     */
    public synchronized AbstractMultiPointResource getMultiPointResource() {
        ...
        if ((mpr == null) || mpr.isDisposed()) {
            MultiPointResourceData resourceData = new MultiPointResourceData(
                    "Gages");
            try {
                mpr = resourceData.construct(new LoadProperties(),
                        EditorUtil.getActiveVizContainer()
                                .getActiveDisplayPane().getDescriptor());
                mpr.getCapability(ColorableCapability.class)
