 ...
 * Jan 13, 2016    5243          tgurney        Added duration codes E (5 min.)
 *                                              and G (10 min.)
 * 
 * </pre>
 * 
...
public class TraceData implements Serializable {
    ...
    private static final String CODES = "IUEGCJHBTFQAKLDWMYZSRPX";

    private static final int[] INT_CODE_ARRAY = { 0, 1, 5, 10, 15, 30, 1001,
            1002, 1003, 1004, 1006, 1008, 1012, 1018, 2001, 2007, 3001, 4001,
