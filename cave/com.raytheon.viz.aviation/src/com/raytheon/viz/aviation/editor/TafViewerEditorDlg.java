        ...
        if (parsedText.keySet().size() == 2) {
                ...
                if (results != null) {
                    if ("index".equals(k)) {
                        ...
                        errorLevel = createErrorStyleRange(
                                ...
                                k, syntaxMap, currentLineNo, range,
                                doLogMessage);
            ...
            for (String k : parsedText.keySet()) {
                ...
                if (!"group".equals(k) && !"bbb".equals(k)) {
                    Map<String, java.util.List<String>> m = (Map<String, java.util.List<String>>) parsedText
                            .get(k);
                    ...
                    for (Map<String, Object> m1 : lm1) {
                        for (String k2 : m1.keySet()) {
                            if (traceEnabled()) {
                                statusHandler
                                        .debug("The next inner key is " + k2);
                            }
                            Object o2 = m1.get(k2);
                            if (traceEnabled()) {
