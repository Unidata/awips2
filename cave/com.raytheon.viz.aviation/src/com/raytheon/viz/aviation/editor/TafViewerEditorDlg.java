 ...
 * Aug 25, 2016 17295       zhao        Added code to allow saving TAF to a user selected location
...
public class TafViewerEditorDlg extends CaveSWTDialog implements ITafSettable,
        ...
        protected IStatus run(IProgressMonitor monitor) {
            if (!monitor.isCanceled()) {
                ...
                try {
                    ...
                    statusHandler.error(
                            "An Exception occured while saving file "
                                    + fileName, e);
                }
                return Status.OK_STATUS;
            }
            ...
            public void widgetSelected(SelectionEvent event) {
                ...
                try {
                    ...
                    saveFile(fileName, editorTafTabComp.getWmoId(),
                            editorTafTabComp.getWmoSiteId(), editorTafTabComp
                                    .getLargeTF(), editorTafTabComp
                                    .getTextEditorControl().getText());
                    setMessageStatusOK("File " + fileName
                            + " saved successfully.");
                } catch (IOException | LocalizationException e) {
        ...
        for (ViewerTabConfig vtc : viewTabCfgArray) {
            ...
            try {
                ...
                if (obj instanceof MetarViewer) {
                    ...
                    metarViewer
                            .addHighlightAlertSelectionListener(new SelectionAdapter() {
    ...
    private void saveFile(String filename, String wmoId, String siteId,
            String issueTime, String taf) throws IOException,
    ...
    private void updateTimes() {
        ...
        ArrayList<String> updatedTafs = new ArrayList<>();
                ...
                qcDlg.setCloseCallback(new ICloseCallback() {
                    ...
                    public void dialogClosed(Object returnValue) {
                        ...
                        if (returnValue instanceof HashMap<?, ?>) {
                            ...
                            HashMap<String, HashMap<String, String>> qcMap = new HashMap<>();
    ...
    private void qcCheck(HashMap<String, HashMap<String, String>> qcMap) {
        try {
            ...
            ArrayList<Object> tafs = new ArrayList<>();
            HashMap<String, Object> siteInfo = new HashMap<>();
            HashMap<String, Object> qcItems = new HashMap<>();
    ...
    private void handleSaveAs() {
        ...
        if (filepath != null) {
            try {
                ...
                e.printStackTrace();
                setMessageStatusError("A LocalizationException occured while saving file "
                        + filepath);
            } finally {
                setWaitCursor(false);
            }
