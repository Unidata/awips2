 ...
 * Aug 12, 2013  2256     lvenable  Reworked the code to dispose of the font
...
public class ResourceItemComp extends Composite {
     ...
     */
    private List<Button> fontButtons = new ArrayList<>();
    ...
    private void initialize() {
        resTagValMap = new HashMap<>();
        resetButtons = new ArrayList<>();
    ...
    private void createResourceControls(ResourceConfigMgr configMgr,
        ...
        gd.verticalIndent = 3;
        Label resourceLbl = new Label(this, SWT.NONE);
    ...
    private void updateFontButton(ResourceConfigMgr configMgr, Button fontBtn,
        ...
        Font tmpFont = new Font(getParent().getDisplay(),
                new FontData(string[0], Integer.valueOf(string[1]),
     ...
     *            Resource tag.
     */
    private void updateColorButton(ResourceConfigMgr configMgr, Button colorBtn,
            ResourceTag tag) {
    ...
    public void restoreAllResources() {
        ...
        confirmCloseMB.setMessage(
                "This will delete your configuration and reset all\n"
