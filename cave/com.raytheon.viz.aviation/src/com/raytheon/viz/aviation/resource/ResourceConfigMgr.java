...
public class ResourceConfigMgr implements IResourceAction {
    ...
    private EnumMap<ResourceTag, ResourceInfo> resourceTypeMap;
    ...
    public static enum ResourceTag {
        ...
        TextEditorForeground("textEditorForeground"),
        TextEditorWidth("textEditorWidth"),
        TextEditorHeight("textEditorHeight"),
        TextEditorCursor("textEditorCursor"),
        TextEditorInsWidth("textEditorInsWidth"),
        InsertBackground("insertBackground"),
        TextViewerWidth("textViewerWidth"),
        TextViewerHeight("textViewerHeight"),
        Orientation("orientation"), ListBoxFont("listBoxFont"),
        EntryFont("entryFont"),
        EntryBackground("entryBackground"),
        MsgBarEntryBgnd("msgBarEntryBgnd"),
        ImpactPlacement("impactPlacement"),
        TransientDialogs("transientDialogs"),
        ConfirmClose("confirmClose"),
        ConfirmSend("confirmSend"),
        AlertLevel0("alertLevel0"),
        AlertLevel1("alertLevel1"),
        AlertLevel2("alertLevel2"),
        AlertLevel3("alertLevel3"),
        AlertLevel4("alertLevel4"),
        AlertLevel5("alertLevel5"),
        AlertLevel6("alertLevel6"),
        ViewerAlertColor( "viewerAlertColor"),
        NotifyRaise("notifyRaise"),
        NotifyPlay("notifyPlay"),
        PlayFile("playFile"),
        AlertIntervalMinutes( "alertIntervalMinutes"),
        Blink("blink"),
        DisallowSend("disallowSend"),
        LoadOrder("loadOrder"),
        AutoSave("autoSave"),
        ...
        Insert("insert"),
        Wrap("wrap"),
        AmdButtons("amdbuttons"),
        NumTafs("numTafs"),
        NumHours("numHours"),
        NumHoursAll("numHoursAll"),
        ShowHeaders("showHeaders"),
        ShowDecoded("showDecoded"),
        ShowRoutine("showRoutine"),
        ShowProbs("showProbs"),
        ShowFormatted("showFormatted"),
        HighlightFlightCat("highlightFlightCat"),
        LifrColor("lifrColor"),
        IfrColor("ifrColor"),
        MvfrColor("mvfrColor"),
        VfrColor("vfrColor");
    ...
    private void createResourceTypeMap() {
        resourceTypeMap = new EnumMap<>(ResourceTag.class);
        ...
        resourceTypeMap.put(ResourceTag.ViewerAlertColor,
                new ResourceInfo(ResourceType.COLOR,
                        "Viewer/Editor Alert Text Background Color"));
    ...
    public void saveResources() {
        ...
        try {
            ...
            statusHandler.warn("Failed to save AvnFPS config", e);
        }
    }
