...
public class ResourceConfigMgr implements IResourceAction {
    ...
    public static enum ResourceTag {
        Font("font"), Background("background"), Foreground("foreground"), TextFont(
                ...
                "alertLevel5"), AlertLevel6("alertLevel6"), ViewerAlertColor(
                "viewerAlertColor"), NotifyDeiconify("notifyDeiconify"), NotifyRaise(
                "notifyRaise"), NotifyPlay("notifyPlay"), PlayFile("playFile"), AlertIntervalMinutes(
