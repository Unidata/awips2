 ...
 *
 */
public class TugViewer extends ViewerTab
    ...
    public int generateGuidance(String siteID) {
        ...
        if (taf != null) {
            ...
            ArrayList<byte[]> siteObjs = new ArrayList<>();
            ArrayList<CacheGuidanceRequest> cacheRequests = new ArrayList<>();
            ...
            requestComplete(
                    new String[] { "No TAF available for site " + siteID });
        }
        return cnt;
    }
