...
abstract public class CigVisCanvasComp extends Composite {
    ...
    public void drawGraphLegend(GC gc, int graphXCoord, int graphYCoord,
        ...
        gc.fillRectangle(legendXCoord + legendXOffset,
                legendYCoord + legendYOffset, legendBarWidth, legendBarHeight);

        gc.setForeground(parent.getDisplay().getSystemColor(SWT.COLOR_BLACK));
        gc.drawRectangle(legendXCoord + legendXOffset,
                legendYCoord + legendYOffset, legendBarWidth, legendBarHeight);

        gc.drawString("MVFR", legendXCoord + legendXOffset * 2 + legendBarWidth,
                legendYCoord + legendYOffset, true);

        // IFR
        gc.setBackground(ifrColor);
        gc.fillRectangle(legendXCoord + legendXOffset,
                legendYCoord + legendYOffset * 2 + legendBarHeight,
        ...
        gc.fillRectangle(legendXCoord + legendXOffset,
                legendYCoord + legendYOffset * 3 + legendBarHeight * 2,
                legendBarWidth, legendBarHeight);
        ...
        gc.drawString("LIFR", legendXCoord + legendXOffset * 2 + legendBarWidth,
                legendYCoord + legendYOffset * 3 + legendBarHeight * 2, true);

        // VLIFR
        gc.setBackground(vlifrColor);
        gc.fillRectangle(legendXCoord + legendXOffset,
                legendYCoord + legendYOffset * 4 + legendBarHeight * 3,
                legendBarWidth, legendBarHeight);
        ...
        gc.drawString("VLIFR",
                legendXCoord + legendXOffset * 2 + legendBarWidth,
                legendYCoord + legendYOffset * 4 + legendBarHeight * 3, true);
    }
