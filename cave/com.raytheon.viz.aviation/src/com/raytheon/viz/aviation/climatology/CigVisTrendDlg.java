 ...
 * Feb 20, 2016 5979       njensen     Cleanup
 * 
 * </pre>
 * 
 * @author lvenable
...
public class CigVisTrendDlg extends CaveSWTDialog {
    ...
    protected void disposed() {
        textFont.dispose();
        CigVisTrendDataManager.getInstance().cancelPythonTask();
        super.disposed();
    }
    ...
    private void createSiteControls(Composite parentComp) {
        ...
        Button jointRdo = new Button(elementGroup, SWT.RADIO);
                ...
                if ((siteList != null) && (siteList.getItemCount() != 0)) {
                    ...
                    if (dataMgr.hasRetrievedMetar()) {
                        ...
                        Map<String, Object> tmp = (HashMap<String, Object>) metarDcd
                                .get("itime");
                        long itime = (long) (((Number) tmp.get("value")).doubleValue() * 1000);
                        ...
                        double vsby = ((Number) tmp.get("value")).doubleValue();
                        ...
                        int cig = ((Number) tmp.get("cig")).intValue();
                        ...
                        if (ddObj instanceof java.lang.String) {
                            ...
                            dd = Integer.toString(((Number) ddObj).intValue());
                        }

                        int dd0;
                        int dd1;

                        if ("0".equals(dd) || "VRB".equals(dd)) {
                            dd = "CALM";
                        }
                        ...
                        int ff = ((Number) tmp.get("ff")).intValue();
