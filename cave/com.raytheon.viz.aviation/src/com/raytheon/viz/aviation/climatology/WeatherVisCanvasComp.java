        ...
        if (dataMgr != null) {
            ...
            if (tafs != null) {
                ...
                for (Map<String, Object> taf : tafs) {
                    ...
                    long to = ((Number) taf.get("to")).longValue();
                    float vis = ((Number) taf.get("vis")).floatValue();
        ...
        if (dataMgr != null) {
            ...
            if (mtrs != null) {
                ...
                while (itr.hasPrevious()) {
                    ...
                    float vis = ((Number) mtr.get("vis")).floatValue();
    ...
    private void drawModel(GC gc, List<Map<String, Object>> data) {
        if (data != null) {
            ...
            for (Map<String, Object> record : data) {
                ...
                long to = ((Number) record.get("to")).longValue();
                float vis = ((Number) record.get("vis")).floatValue();
