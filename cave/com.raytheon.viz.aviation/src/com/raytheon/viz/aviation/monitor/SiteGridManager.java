...
public class SiteGridManager {
    ...
    private final List<IGridDataRetrieveListener> listeners = new ArrayList<>();
    ...
    public static List<String> getSiteIDs() {
        synchronized (instance) {
            return new ArrayList<>(instance.siteIDs);
        }
    }
     ...
     * @param dataMap
     */
    public static void setContainersMap(Map<String, byte[]> dataMap) {
        synchronized (instance) {
            instance.dataMap.clear();
    ...
    private static void notifyListeners() {
        ...
        synchronized (instance) {
            listeners = new ArrayList<>(instance.listeners);
        }
     ...
     * @return data
     */
    public static byte[] getData(String siteID, long timeSeconds) {
        synchronized (instance) {
