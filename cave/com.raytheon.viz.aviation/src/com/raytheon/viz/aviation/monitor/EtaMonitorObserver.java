...
/**
 * Watches incoming ETA (bufrmosETA) alerts to see if they apply to any
 ...
 * @version 1.0
 */
public class EtaMonitorObserver extends MonitorObserver implements
        IAlertObserver {

    public static String pluginName = "bufrmosETA";

    public EtaMonitorObserver(TafMonitorDlg dlg) {
        super(dlg);
    }
