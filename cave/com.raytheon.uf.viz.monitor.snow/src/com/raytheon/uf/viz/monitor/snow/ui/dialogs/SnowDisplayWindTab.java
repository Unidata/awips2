 ...
 *
 */
public class SnowDisplayWindTab extends TabItemComp
        implements IUpdateDisplayWind {
    private SnowDisplayWindEditDlg windEditDlg;

    private List<SnowDisplayWindData> snowDataArray;
    ...
    private void createDataArray() {
        ...
        for (String areaID : areaList) {
            ...
            sdwd.setWindDirFromR(
                    stm.getThresholdValue(duKey, threshKeyR, areaID, xmlKey));
            sdwd.setWindDirFromY(
                    stm.getThresholdValue(duKey, threshKeyY, areaID, xmlKey));
