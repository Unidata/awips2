 ...
 *
 */
public class SnowMonitorMeteoTab extends TabItemComp
        implements IUpdateMonitorMeteo {
    private SnowMonitorMeteoEditDlg meteoEditDlg;

    private List<SnowMonitorMeteoData> snowDataArray;
    ...
    protected void populateTable() {
        ...
        for (int i = 0; i < snowDataArray.size(); i++) {
            ...
            item.setText(11, formatTableData(tmpVisStr));

            visVal = smmd.getVisY();
            tmpVisStr = rangeUtil.getVisString((int) visVal);
            item.setText(12, formatTableData(tmpVisStr));
