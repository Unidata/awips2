        ...
        synchronized (this) {
            ...
            for (TextBlock tb : this.textBlocks) {
                ...
                if (tb.offset != null) {
                     ...
                     * This applies to both the x and y direction. Note that
                     * this is an integer calculation so an offset of +/-1
                     * normally does nothing.
                     * 
                     * The default AWIPS 2 character width is currently 9 so the
                     * character size is modified to get a similar affect. Also,
                     * the calculation is different for x and y because the
                     * AWIPS 2 font is not as square as AWIPS 1.
                     */
