...
public class ForecastTsSaveDialog extends JDialog {
    ...
    private JComboBox _typeSourceComboBox = new JComboBox(
            _typeSourceStringArray);

    private JComboBox _shefQualifierComboBox = new JComboBox(
            _shefQualifierStringArray);
    ...
    // "<HTML><CENTER>Save to<BR>Database</CENTER></HTML>" );
    private JButton _saveButton = new JButton("Save to Database");

    private JButton _closeButton = new JButton("Close");

    /*
     * Empty Constructor Sets the basis and product time to the current system
     * time
     */

    public ForecastTsSaveDialog(JFrame owner, String lid, String title,
            RegularTimeSeriesHolder timeSeriesHolder, DataMgr dataMgr,
            String tableName, String[] physicalElementStringArray,
            String preferredPhysicalElement) {

        this(owner, lid, title, timeSeriesHolder, System.currentTimeMillis(),
                System.currentTimeMillis(), dataMgr, tableName,
                physicalElementStringArray, preferredPhysicalElement, true);
    }

    public ForecastTsSaveDialog(JFrame owner, String lid, String title,
            RegularTimeSeriesHolder timeSeriesHolder, long productTime,
            long basisTime, DataMgr dataMgr, String tableName,
            String[] physicalElementStringArray, String preferredPhysicalElement) {
        this(owner, lid, title, timeSeriesHolder, productTime, basisTime,
                dataMgr, tableName, physicalElementStringArray,
    ...
    public ForecastTsSaveDialog(JFrame owner, String lid, String title,
            ...
            String preferredPhysicalElement, boolean isModal) {
        super(owner, isModal);
        ...
        long latestHourTime = TimeHelper.truncateTimeInMillisToNearestHour(
                currentTime, 1);
        _basisTimeTextField = new DateTimeTextField(latestHourTime, owner,
                "Basis Time", 19);

        _productTimeTextField = new DateTimeTextField(latestHourTime, owner,
                "Product Time", 19);
        ...
        int initialValue = timeSeriesHolder.getTimeSeries()
                .getMeasurementCount();
        int min = 1;
        int max = initialValue;
        int step = SAVE_HOURS_STEPS;

        SpinnerModel model = new SpinnerNumberModel(initialValue, min, max,
                step);
        _hoursToSaveSpinner = new JSpinner(model);

        // load this token and set the initially selected type/source to this
        // default value
        ...
        // System.out.println("ForecastTsSaveDialog(): _sshpForecastTsToken = "
    ...
    private void selectDefaultTypeSource(String typeSource) {
        ...
        // System.out.println("ForecastTsSaveDialog.selectDefaultTypeSource() typeSource="
        // + typeSource);
        if (typeSource == null) {
    ...
    private void addDataPanelComponents() {
        ...
        _basisTimeTextField.setText(DbTimeHelper
                .getDateTimeStringFromLongTime(_basisTime));
        _productTimeTextField.setText(DbTimeHelper
                .getDateTimeStringFromLongTime(_productTime));

        // X, Y, #Col, #Row
        ComponentHelper.addPanelComponent(_dataPanel, _physicalElementLabel, 0,
                0, 3, 1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dataPanel, _physicalElementComboBox,
                3, 0, 1, 1, GridBagConstraints.NONE);
        ComponentHelper.addPanelComponent(_dataPanel, hSeparator[0], 0, 1, 4,
                1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dataPanel, _typeSourceLabel, 0, 2,
                3, 1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dataPanel, _typeSourceComboBox, 3,
                2, 2, 1, GridBagConstraints.NONE);
        ComponentHelper.addPanelComponent(_dataPanel, hSeparator[1], 0, 3, 4,
                1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dataPanel, _shefQualifierLabel, 0,
                4, 3, 1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dataPanel, _shefQualifierComboBox,
                3, 4, 2, 1, GridBagConstraints.NONE);
        ComponentHelper.addPanelComponent(_dataPanel, hSeparator[2], 0, 5, 4,
                1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dataPanel, _productIDLabel, 0, 6, 3,
                1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dataPanel, _productIDTextField, 3,
                6, 1, 1, GridBagConstraints.BOTH);

        ComponentHelper.addPanelComponent(_dataPanel, hSeparator[3], 0, 7, 4,
                1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dataPanel, _basisTimeLabel, 0, 8, 3,
                1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dataPanel, _basisTimeTextField, 3,
                8, 1, 1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dataPanel, hSeparator[4], 0, 9, 4,
                1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dataPanel, _productTimeLabel, 0, 10,
                3, 1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dataPanel, _productTimeTextField, 3,
                10, 1, 1, GridBagConstraints.BOTH);

        ComponentHelper.addPanelComponent(_dataPanel, hSeparator[5], 0, 11, 4,
                1, GridBagConstraints.BOTH);

        ComponentHelper.addPanelComponent(_dataPanel, _hoursToSaveLabel, 0, 12,
                3, 1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dataPanel, _hoursToSaveSpinner, 3,
                12, 1, 1, GridBagConstraints.BOTH);

        ComponentHelper.addPanelComponent(_dataPanel, hSeparator[6], 0, 13, 4,
                1, GridBagConstraints.BOTH);
    ...
    private void addButtonPanelComponents() {
        ...
        // X, Y, #Col, #Row
        ComponentHelper.addPanelComponent(_buttonPanel, _saveButton, 0, 0, 1,
                1, GridBagConstraints.NONE);
        ComponentHelper.addPanelComponent(_buttonPanel, horizSeparatorPanel, 1,
                0, 1, 1, GridBagConstraints.NONE);
        ComponentHelper.addPanelComponent(_buttonPanel, _closeButton, 2, 0, 1,
                1, GridBagConstraints.BOTH);
    }
    ...
    private void addFrameComponents() {
        ...
        // X, Y, #Col, #Row
        ComponentHelper.addFrameComponent(_frameContentPane, _dataPanel, 0, 0,
                4, 13, GridBagConstraints.BOTH);
        ComponentHelper.addFrameComponent(_frameContentPane, hLine, 0, 13, 4,
                1, GridBagConstraints.NONE);
        ComponentHelper.addFrameComponent(_frameContentPane, hSeparator, 0, 14,
                4, 1, GridBagConstraints.NONE);
        ComponentHelper.addFrameComponent(_frameContentPane, _buttonPanel, 0,
                15, 4, 1, GridBagConstraints.BOTH);
    }
    ...
    private FcstTsDescriptor getFcstTsDescriptor(String tableName) {
        ...
        fcstTs.setShef_qual_code((String) _shefQualifierComboBox
                .getSelectedItem());
    ...
    /*
     * private class TimeTextFieldListener extends MouseAdapter { public void
     * mousePressed( MouseEvent e ) { long dateTime = 0; JTextField textField =
     * (JTextField) e.getSource();
     * 
     * if ( ! textField.getText().equals( "yyyy-mm-dd hh:mm:ss" ) ) { dateTime =
     * DbTimeHelper.getLongTimeFromDateTimeString( textField.getText() ); } else
     * { dateTime = new Date().getTime(); }
     * 
     * DateTimeDialog dateTimeGUI = null; if ( textField == _basisTimeTextField
     * ) { dateTimeGUI = new DateTimeDialog( ForecastTsSaveDialog.this,
     * dateTime, "Basis Time" );
     * 
     * } else { dateTimeGUI = new DateTimeDialog( ForecastTsSaveDialog.this,
     * dateTime, "Product Time" ); }
     * 
     * dateTimeGUI.addDateTimeEventListener( new DateTimeListener( textField )
     * ); dateTimeGUI.show(); _basisTime =
     * DbTimeHelper.getLongTimeFromDateTimeString(
     * _basisTimeTextField.getText().trim() ); _productTime =
     * DbTimeHelper.getLongTimeFromDateTimeString(
     * _productTimeTextField.getText().trim() ); } }
     */
    /*
     * private class DateTimeListener implements DateTimeEventListener { private
     * JTextField _timeTextField = null;
     * 
     * public DateTimeListener( JTextField timeTextField ) { _timeTextField =
     * timeTextField; }
     * 
     * public void dateTimeEntered( DateTimeEvent dateTimeEvent ) { if (
     * dateTimeEvent.isGoodDate() ) { String timeString =
     * DbTimeHelper.getDateTimeStringFromLongTime(
     * dateTimeEvent.getDateTimeLong() ); _timeTextField.setText( timeString );
     * } } }
     */
    private class SaveButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            Integer hoursToSaveInteger = (Integer) _hoursToSaveSpinner
                    .getValue();
            int hoursToSave = hoursToSaveInteger.intValue();

            success = _dataMgr.saveFcstTimeSeries(fcstTs, _timeSeries,
                    hoursToSave);

            if (success) {
                DialogHelper.displayMessageDialog(ForecastTsSaveDialog.this,
                        "Insert Successful!");
            } else {
                DialogHelper.displayMessageDialog(ForecastTsSaveDialog.this,
                        "Insert Failed!");
    ...
    private class WindowResizeComponentListener extends ComponentAdapter {
        ...
        public void componentResized(ComponentEvent e) {
            ...
            if (width < MIN_WIDTH) {
                ForecastTsSaveDialog.this.setSize(new Dimension(MIN_WIDTH,
                        height));
            }
            if (width > MAX_WIDTH) {
                ForecastTsSaveDialog.this.setSize(new Dimension(MAX_WIDTH,
                        height));
            }
            if (height < MIN_HEIGHT) {
                ForecastTsSaveDialog.this.setSize(new Dimension(width,
                        MIN_HEIGHT));
            }
    ...
    private static RegularTimeSeries getTestTimeSeries() {
        ...
        currentTime = TimeHelper.truncateTimeInMillisToNearestHour(currentTime,
                1);
        long startTime = currentTime - (24 * HOUR_IN_MILLIS);
        long endTime = startTime + (10 * HOUR_IN_MILLIS);
        testTimeSeries = new RegularTimeSeries(startTime, endTime, 1,
    ...
    public static void main(String[] args) {
        ...
        ForecastTsSaveDialog saveForecast = new ForecastTsSaveDialog(
                new JFrame(), "BLUO2", "Save Fcst Time Series Dialog ", holder,
                dataMgr, "FcstHeight", physicalElementStringArray, "HG");
