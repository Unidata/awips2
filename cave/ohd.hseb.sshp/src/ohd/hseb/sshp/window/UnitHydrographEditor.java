...
public class UnitHydrographEditor extends JDialog {
    ...
    private static final String[] _modelStringArray = { "ANY", "API-MKC",
            "SAC-SMA" };
    ...
    private String[] _rowTableColumnNames = { AREA_ID, MODEL, DURATION,
            ORDINAL, DISCHARGE };
    ...
    private TableHelper2 _tableHelper = new TableHelper2(_comparator,
            _rowTableColumnNames);
    ...
    public UnitHydrographEditor(Frame owner, DataMgr dataMgr,
            String locationId, boolean isModal)
    /********************
     * Purpose: Constructor
     *********************/
    {
    ...
    private int getColumnIndex(String columnName) {
        // this does NOT keep track of whether the column has been moved
        // graphically
        int index = -1;
    ...
    private List loadUhgList() {
        ...
        List list = _dataMgr.loadUnitHydrographEntryList(_locationId,
                "ORDER BY ordinal");
    ...
    private void initJTable() {
        ...
        _rowTableModel = new SshpTableModel(_rowTableColumnNames,
                _unitHydrographStringArray);
    ...
    private void refreshUnitHydrographTable() {
        ...
        if (_unitHydrographEntry != null) {
            for (int i = 0; i < _uhgList.size(); i++) {
                UnitHydrographEntry uhgEntry = (UnitHydrographEntry) _uhgList
                        .get(i);
    ...
    private String[][] convertMasterListToArray() {
        ...
        for (int i = 0; i < dataArray.length; i++) {
            UnitHydrographEntry unitHydrographEntry = (UnitHydrographEntry) _uhgList
                    .get(i);
    ...
    private String[][] convertListToArray() {
        ...
        for (int i = 0; i < dataArray.length; i++) {
            ...
            dataArray[i][1] = "" + unitHydrographEntry.getModel();
            dataArray[i][2] = ""
                    + DurationCode.getHoursFromCode(unitHydrographEntry
                            .getDur());
            dataArray[i][3] = "" + unitHydrographEntry.getOrdinal();
            dataArray[i][4] = "" + unitHydrographEntry.getDischarge();
        }
     ...
     *********************/
    {
        ...
        // X, Y, #Col, #Row
        ComponentHelper.addFrameComponent(_frameContentPane, _uhgListPanel, 0,
                0, 25, 5, 1, 1, GridBagConstraints.BOTH);
        ComponentHelper.addFrameComponent(_frameContentPane,
                horizontalSeparatorPanel, 0, 5, 25, 2, GridBagConstraints.BOTH);
        ComponentHelper.addFrameComponent(_frameContentPane, _uhgTextPanel, 0,
                7, 25, 1, 1, 0, GridBagConstraints.BOTH);
        ComponentHelper
                .addFrameComponent(_frameContentPane,
                        horizontalSeparatorPanel2, 0, 8, 25, 2,
                        GridBagConstraints.BOTH);
        ComponentHelper.addFrameComponent(_frameContentPane, _listButtonPanel,
                0, 10, 25, 1, GridBagConstraints.NONE);
        ComponentHelper.addFrameComponent(_frameContentPane,
                horizontalSeparatorPanel3, 0, 11, 25, 2,
                GridBagConstraints.BOTH);
        ComponentHelper.addFrameComponent(_frameContentPane, buttonSeparator,
                0, 13, 25, 2, GridBagConstraints.BOTH);
        ComponentHelper.addFrameComponent(_frameContentPane,
                horizontalSeparatorPanel4, 0, 15, 25, 2,
                GridBagConstraints.BOTH);

        ComponentHelper.addFrameComponent(_frameContentPane,
                _dialogButtonPanel, 0, 17, 25, 2, GridBagConstraints.BOTH);
        ComponentHelper.addFrameComponent(_frameContentPane,
                verticalSeparatorPanel, 25, 0, 1, 15, GridBagConstraints.BOTH);
        ComponentHelper.addFrameComponent(_frameContentPane, _canvasPanel, 26,
                0, 15, 15, 1, 1, GridBagConstraints.BOTH);
     ...
     *********************/
    {
        ...
        // X, Y, #Col, #Row
        ComponentHelper.addPanelComponent(_uhgListPanel, _scrollPane, 0, 0, 5,
                25, 1, 1, GridBagConstraints.BOTH);
     ...
     *********************/
    {
        ...
        // X, Y, #Col, #Row
        ComponentHelper.addPanelComponent(_uhgTextPanel, _areaIdLabel, gbc, 0,
                0, 1, 1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_uhgTextPanel, _areaIdTextField, gbc,
                0, 1, 1, 1, GridBagConstraints.BOTH);

        ComponentHelper.addPanelComponent(_uhgTextPanel, _modelLabel, gbc, 2,
                0, 1, 1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_uhgTextPanel, _modelComboBox, gbc,
                2, 1, 1, 1, GridBagConstraints.BOTH);

        ComponentHelper.addPanelComponent(_uhgTextPanel, _durationLabel, gbc,
                4, 0, 1, 1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_uhgTextPanel, _durationComboBox,
                gbc, 4, 1, 1, 1, GridBagConstraints.BOTH);

        ComponentHelper.addPanelComponent(_uhgTextPanel, _ordLabel, gbc, 6, 0,
                1, 1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_uhgTextPanel, _ordTextField, gbc, 6,
                1, 1, 1, GridBagConstraints.BOTH);

        ComponentHelper.addPanelComponent(_uhgTextPanel, _dischargeLabel, gbc,
                8, 0, 1, 1, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_uhgTextPanel, _dischargeTextField,
                gbc, 8, 1, 1, 1, GridBagConstraints.BOTH);

        ComponentHelper.addPanelComponent(_uhgTextPanel,
                verticalSeparatorPanel, gbc, 1, 0, 1, 2,
                GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_uhgTextPanel,
                verticalSeparatorPanel2, gbc, 3, 0, 1, 2,
                GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_uhgTextPanel,
                verticalSeparatorPanel3, gbc, 5, 0, 1, 2,
                GridBagConstraints.BOTH);
    }
     ...
     *********************/
    {
        ...
        gbc.insets = new Insets(5, 5, 5, 5);
        // X, Y, #Col, #Row
        ComponentHelper.addPanelComponent(_listButtonPanel, _addButton, gbc, 0,
                0, 2, 2, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_listButtonPanel,
                verticalSeparatorPanel, gbc, 2, 0, 1, 2,
                GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_listButtonPanel, _modifyButton, gbc,
                3, 0, 2, 2, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_listButtonPanel,
                verticalSeparatorPanel2, gbc, 5, 0, 1, 2,
                GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_listButtonPanel, _removeButton, gbc,
                6, 0, 2, 2, GridBagConstraints.BOTH);

        /*
         * if ( _uhgList.size() > 0 ) { _importButton.setEnabled( false ); }
         */
     ...
     *********************/
    {
        ...
        // X, Y, #Col, #Row
        ComponentHelper.addPanelComponent(_dialogButtonPanel, _saveButton, 6,
                0, 2, 2, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dialogButtonPanel,
                verticalSeparatorPanel, 8, 0, 4, 2, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dialogButtonPanel, _deleteButton,
                12, 0, 2, 2, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dialogButtonPanel,
                verticalSeparatorPanel2, 14, 0, 4, 2, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dialogButtonPanel, _importButton,
                18, 0, 2, 2, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dialogButtonPanel,
                verticalSeparatorPanel3, 20, 0, 4, 2, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dialogButtonPanel, _exportButton,
                24, 0, 2, 2, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dialogButtonPanel,
                verticalSeparatorPanel4, 26, 0, 4, 2, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dialogButtonPanel, _closeButton, 30,
                0, 2, 2, GridBagConstraints.BOTH);
        ComponentHelper.addPanelComponent(_dialogButtonPanel,
                horizontalSeparatorPanel, 0, 2, 20, 2, GridBagConstraints.BOTH);
    }
     ...
     *********************/
    {
        if (_unitHydrographEntry != null) {
            ...
            // _modelComboBox.setSelectedIndex(
            // getModelIndex(_unitHydrographEntry.getModel()));

            ensureModelIsInModelComboBox(_modelComboBox, _unitHydrographEntry
                    .getModel());
            _modelComboBox.setSelectedItem(_unitHydrographEntry.getModel());

            _durationComboBox.setSelectedItem(""
                    + DurationCode.getHoursFromCode(_unitHydrographEntry
                            .getDur()));
            ...
            _dischargeTextField.setText(""
                    + _unitHydrographEntry.getDischarge());
        } else {
    ...
    // -------------------------------------------------------------------------------------
    private void ensureModelIsInModelComboBox(JComboBox comboBox,
            String modelString)
     ...
     *********************/
    {
        ...
        _rowListSelectionModel
                .addListSelectionListener(new TableUpdateListener());
        _uhgRowJTable.getTableHeader().addMouseListener(
                new TableSortingListener());

        // _apiMkcCheckBox.addActionListener(new
        // UnitgraphDrawingListener("API-MKC"));
        // _sacSmaCheckBox.addActionListener(new
        // UnitgraphDrawingListener("SAC-SMA"));
    }
    ...
    private void saveChanges() {
        for (int i = 0; i < _uhgEntryAddModifyDeleteList.size(); i++) {
            UnitHydrographEntryCommand entry = (UnitHydrographEntryCommand) _uhgEntryAddModifyDeleteList
                    .get(i);
    ...
    private class TableSortingListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            _lastColumnSorted = _uhgRowJTable.getTableHeader().columnAtPoint(
                    point);
    ...
    private class TableUpdateListener implements ListSelectionListener {
        public void valueChanged(ListSelectionEvent arg0) {
            ...
            if ((index >= 0) && (!_uhgList.isEmpty())) {
                _unitHydrographEntry = (UnitHydrographEntry) _uhgList
                        .get(index);
            } else {
    ...
    private class DeleteButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            String durationString = (String) _durationComboBox
                    .getSelectedItem();
            int durationCode = DurationCode
                    .getCodeFromHoursString(durationString);
            ...
            confirm = DialogHelper.displayConfirmDialog(null,
                    ...
                    "Delete Unit Hydrograph");

            if (confirm) {
                _dataMgr.deleteUnitHydrograph(_locationId, basinId, model,
                        durationCode);
                _uhgEntryAddModifyDeleteList.clear(); // Clears the queue of all
                                                      // updates/deletions
    ...
    private boolean isAnyFieldEmpty() {
        ...
        if ((isEmptyString(_areaIdTextField.getText()))
                ...
                || (isEmptyString(_dischargeTextField.getText()))) // Checks to
                                                                   // make sure
                                                                   // the text
                                                                   // fields do
                                                                   // not
    ...
    private UnitHydrographEntry getUnitHydrographEntryFromFields() {
        ...
        try {
            ...
            newUHGEntry.setDur(DurationCode
                    .getCodeFromHoursString((String) _durationComboBox
                            .getSelectedItem()));
            newUHGEntry.setOrdinal(Integer.parseInt(_ordTextField.getText()
                    .trim()));
            newUHGEntry.setDischarge(Double.parseDouble(_dischargeTextField
                    .getText().trim()));
            newUHGEntry.setLocationId(_locationId);
        }

        catch (Exception e) {
            DialogHelper.displayErrorDialog(this,
                    "Error parsing an input field, please examine.",
                    "UnitHydrographEditor Data Entry Error");
            newUHGEntry = null;
    ...
    private class AddModifyButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (!isAnyFieldEmpty()) {
                ...
                if (newUHGEntry != null) {
                    ...
                    notifyAllApplyActionListeners(); // notifies all the
                                                     // listeners
        ...
        private boolean validateNewUnitHydrographEntry(
                UnitHydrographEntry newUHGEntry) {
            boolean foundEntry = false;

            for (int i = 0; i < _uhgList.size(); i++) {
                UnitHydrographEntry entry = (UnitHydrographEntry) _uhgList
                        .get(i);
    ...
    private void exportUnitHydrographToFile() {
        ...
        UnitHydrographDescriptor selectedDescriptor = new UnitHydrographDescriptor(
                _locationId, basinId, model, durationCode);
        ...
        confirm = DialogHelper.displayConfirmDialog(null, message,
        ...
        if (confirm) {
            ...
            if (!fileIsOpen) {
                try {
                    ...
                    String errorMessage = "Error exporting file: "
                            + e.getMessage();
                    DialogHelper.displayErrorDialog(null, message,
                            "Export Error");
                    // e.printStackTrace();
                }
            }
    ...
    private class ImportButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            File importFile = UnitHydrographEditor.this
                    .displayImportFileChooser();
            if (importFile != null) {
                boolean result = UnitHydrographEditor.this
                        .importUnitHydrographFromFile(importFile);
    ...
    private void notifyAllApplyActionListeners() {
        for (int i = 0; i < _applyListenerList.size(); i++) {
            ActionListener listener = (ActionListener) _applyListenerList
                    .get(i);
            ActionEvent event = new ActionEvent(this,
                    ActionEvent.ACTION_PERFORMED, "APPLY action");
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (_unitHydrographEntry != null) {
                ...
                if (confirm) // User selected YES
                {
                    ...
                    UnitHydrographEntryCommand deleteEntry = new UnitHydrographEntryCommand(
                            _unitHydrographEntry, addToDatabase);
    ...
    private class WindowCloserListener extends WindowAdapter implements
            ActionListener {
        @Override
    ...
    private class WindowResizeComponentListener extends ComponentAdapter {
        ...
        public void componentResized(ComponentEvent e) {
            ...
            if (width < MIN_WIDTH) {
                UnitHydrographEditor.this.setSize(new Dimension(MIN_WIDTH,
                        height));
            }
            if (width > MAX_WIDTH) {
                UnitHydrographEditor.this.setSize(new Dimension(MAX_WIDTH,
                        height));
            }
            if (height < MIN_HEIGHT) {
                UnitHydrographEditor.this.setSize(new Dimension(width,
                        MIN_HEIGHT));
            }
    ...
    private boolean importUnitHydrographFromFile(File importFile) {
        ...
        try {
            ...
            // determine if need to do something special to translate from
            // original format UHG files to
            // new format
            ...
            if (tokenCount == oldFormatTokenCount) {
                ...
                String message = "Invalid file format. There are " + tokenCount
                        ...
                        + oldFormatTokenCount + " or " + newFormatTokenCount
                        + " fields.";
            ...
            while (line != null) {
                ...
                String[] tokenizedLine = getTokenizedLine(line,
                        needToAddModelType, defaultModelType);
                ...
                UnitHydrographEntryCommand entryCommand = new UnitHydrographEntryCommand(
                        entry, addToDatabase);
            ...
            DialogHelper.displayErrorDialog(this, "Error Importing File: "
                    + errorMessage, title);
        } catch (IOException e) {
            String errorMessage = e.getMessage();
    ...
    private String getModelTypeFromDialog() {
        ...
        String[] optionArray = { "ANY ", "API-MKC", "SAC-SMA" };

        OptionSelectionDialog dialog = new OptionSelectionDialog();

        dialog.requestItemByDialog(title, message, comboBoxLabelString,
                optionArray);
    ...
    private String[] getTokenizedLine(String line, boolean needToAddModelType,
    ...
    private String correctModelName(String origModelName) throws Exception {
        ...
        String[] incorrectApiMkcNameArray = { "API_MKC", "APIMKC", "API MKC",
                "MKCAPI", "KCAPI", "KC_API", "KC-API" };
    ...
    private File displayImportFileChooser() {
        ...
        // reset the import directory to the last one imported from, if it
        // exists
        ...
        _importFileChooser.addChoosableFileFilter(new ExtensionFileFilter(
                filterList, "Unit Hydrograph Files (UHG)"));
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            DialogHelper.displayMessageDialog(UnitHydrographEditor.this,
                    "Unit Hydrograph file not imported.");
        }
        return file;
    }
    ...
    private File displayExportFileChooser() {
        ...
        if (_fileChooserDirectory != null) {
            ...
            AppsDefaults ad = AppsDefaults.getInstance();
            _exportDirString = ad.getToken("whfs_import_dir"); // shares with
                                                               // import
                                                               // directory
        }
        ...
        _exportFileChooser.addChoosableFileFilter(new ExtensionFileFilter(
                filterList, "Unit Hydrograph Files (UHG)"));
        ...
        if (file != null) {
            if ((extension == null)
                    || (!isExtensionInExtensionFilterList(extension, filterList))) {
                file = new File(file.getAbsoluteFile() + "."
                        + (String) filterList.get(0));
            }
        }
    ...
    private boolean isExtensionInExtensionFilterList(String extension,
            List filterList) {
    ...
    private class UnitHydrographEntryCommand {
        ...
        public UnitHydrographEntryCommand(UnitHydrographEntry entry,
    ...
    private JFormattedTextField getJFormattedTextField(String formatString) {
        JFormattedTextField returnJFormattedTextField = new JFormattedTextField(
                formatString);
    ...
    private boolean validateInputParameters(String[] args) {
        ...
        if (args.length < 3) {
            System.out
                    .println("UnitHydrographEditor <DBConnection String> <basin ID> <log directory> ");
            returnValue = false;
        } else {
    ...
    public static void main(String[] args) {
        ...
        if (validInputParameters) {
            dataMgr = new DataMgr(editor.getConnectionString(), editor
                    .getLogger());

            editor = new UnitHydrographEditor(new Frame(), dataMgr, editor
                    .getLocationId(), true);
            editor.show();
        }
