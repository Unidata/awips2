...
public class LowWaterStatementDataManager extends HydroDataManager {
     ...
     * @throws VizException
     */
    public void deleteRecords(List<LowWaterStatementData> recordsToDelete)
            throws VizException {
     ...
     * @throws VizException
     */
    public List<LowWaterStatementData> getLowWaterStatementData(String lid)
            throws VizException {
        ArrayList<LowWaterStatementData> rval = new ArrayList<>();
        ...
        for (QueryResultRow currRow : result.getRows()) {
            rval.add(new LowWaterStatementData(currRow,
