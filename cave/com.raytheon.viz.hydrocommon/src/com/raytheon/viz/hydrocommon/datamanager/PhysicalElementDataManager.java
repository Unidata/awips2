...
public class PhysicalElementDataManager extends HydroDataManager {
    ...
    private static final IUFStatusHandler statusHandler = UFStatus
            .getHandler(PhysicalElementDataManager.class);
     ...
     * @return String[]
     */
    public List<Object[]> getPhysicalElementData(
        ...
        dataQuery.append(
                "phs.extremum, cast(phs.value as float), phs.shef_qual_code,");
        ...
        try {
            ...
            statusHandler.error(
                    "Error executing query for Physical Element data.", e);
        }

        return rval;
    }

    public List<Object[]> getPhysicalElementData(PhysicalElementData currData) {
        ArrayList<Object[]> rval = new ArrayList<>();

        try {
            rval = runQuery(String.format(SELECT_STATEMENT,
    ...
    protected void removePhysicalElementData(PhysicalElementData recordToDelete)
            throws VizException {
        removePhysicalElementData(recordToDelete,
                PhysicalElementTable
                        .valueOf(
                                HydroUtils
                                        .getTableName(recordToDelete.getPe(),
    ...
    private void insertPhysicalElementData(PhysicalElementData currData)
        ...
        runStatement(String.format(INSERT_QUERY,
                HydroUtils.getTableName(currData.getPe(), currData.getTs()),
                currData.getLid(), currData.getPe(), currData.getDur(),
                currData.getTs(), currData.getExtremum(),
                dbFormat.format(currData.getObstime()), currData.getValue(),
                currData.getShefQualCode(), qcCode, currData.getRevision(),
    ...
    public void putPhysicalElementData(PhysicalElementData currData)
        ...
        if (!getPhysicalElementData(currData).isEmpty()) {
            // Do an update
