...
public class ContactsDataManager extends HydroDataManager {
     ...
     * Select statement.
     */
    private static final String SELECT_STATEMENT = "SELECT lid, contact, phone, email, remark, priority FROM contacts";

    /**
     * Insert statement.
     */
    private static final String INSERT_STATEMENT = "INSERT INTO contacts (lid, contact, phone, email, remark, priority) VALUES ('%s', '%s', '%s', '%s', '%s', %d)";

    /**
     * Delete statement.
     */
    private static final String DELETE_STATEMENT = "DELETE FROM contacts";

    /**
     * Update statement.
     */
    private static final String UPDATE_STATEMENT = "UPDATE contacts SET contact='%s', phone='%s', email='%s', remark='%s', priority=%d WHERE lid='%s' AND contact='%s'";
     ...
     *             Database exception.
     */
    public List<ContactsData> getContactData(String lid) throws VizException {
        List<ContactsData> rval = new ArrayList<>();
    ...
    public void deleteRecord(ContactsData contactsData) throws VizException {
        ...
        String contacts = DbUtils
                .escapeSpecialCharforStr(contactsData.getContact());
