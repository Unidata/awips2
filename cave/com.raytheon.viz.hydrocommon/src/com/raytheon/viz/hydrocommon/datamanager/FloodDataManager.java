...
public class FloodDataManager extends HydroDataManager {
     ...
     * @throws VizException
     */
    public void deleteRecords(List<FloodData> recordsToDelete)
            throws VizException {
    ...
    public FloodData getFloodData(FloodData data) throws VizException {
        ...
        return (result.getResultCount() > 0)
                ? new FloodData(result.getRows()[0], result.getColumnNames())
                : new FloodData();
    }
     ...
     * @throws VizException
     */
    public List<FloodData> getFloodData(String lid) throws VizException {
        List<FloodData> rval = new ArrayList<>();
    ...
    private void updateFloodData(FloodData data) throws VizException {
        ...
        runStatement(String.format(UPDATE_STATEMENT, data.getDamage(),
