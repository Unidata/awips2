...
public class LocationAreaManager extends HydroDataManager {
     ...
     * Select statement.
     */
    private static final String SELECT_STATEMENT = "SELECT lid, area FROM locarea";

    /**
     * Insert statement.
     */
    private static final String INSERT_STATEMENT = "INSERT INTO locarea (lid, area) VALUES ('%s', '%s')";

    /**
     * Delete statement.
     */
    private static final String DELETE_STATEMENT = "DELETE FROM locarea";

    /**
     * Update statement.
     */
    private static final String UPDATE_STATEMENT = "UPDATE locarea SET area='%s' WHERE lid='%s'";
     ...
     *             Database exception.
     */
    public List<LocationAreaData> getLocationAreaData(String lid)
            throws VizException {
        List<LocationAreaData> rval = new ArrayList<>();
