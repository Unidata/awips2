...
public class DescriptionDataManager extends HydroDataManager {
     ...
     * Select statement.
     */
    private static final String SELECT_STATEMENT = "SELECT lid, bed, divert, remark, ice, proximity, reach, res, topo FROM descrip";

    /**
     * Insert statement.
     */
    private static final String INSERT_STATEMENT = "INSERT INTO descrip (lid, bed, divert, remark, ice, proximity, reach, res, topo) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')";

    /**
     * Delete statement.
     */
    private static final String DELETE_STATEMENT = "DELETE FROM descrip";

    /**
     * Update statement.
     */
    private static final String UPDATE_STATEMENT = "UPDATE descrip SET bed='%s', divert='%s', remark='%s', ice='%s', proximity='%s', reach='%s', res='%s', topo='%s' WHERE lid='%s'";
     ...
     *             Database exception.
     */
    public List<DescriptionData> getDescriptionData(String lid)
            throws VizException {
        List<DescriptionData> rval = new ArrayList<>();

        QueryResult result = runMappedQuery(
                SELECT_STATEMENT + " WHERE lid='" + lid + "'");
