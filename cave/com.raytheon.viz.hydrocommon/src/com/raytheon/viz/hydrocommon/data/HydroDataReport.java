...
public class HydroDataReport {
    ...
    public HydroDataReport(String pe, int dur, String ts, String extremum,
            double probability, String shefQualCode, long qualityCode,
            double value, Date validTime, Date basisTime) {
        this.pe = pe;
        this.dur = dur;
