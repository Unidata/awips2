 ...
 * 06 Jul 2018  6885       mduff       Changed for new method signature.
 * 
 * </pre>
 * 
 * @author dhladky
...
public class RiverDataPoint {
     ...
     */
    public RGB getColor() {
        List<ColorScaleData> colorData = colorManager
                .getDefaultColorScaleData("Height");
        ...
        case THREAT_MISSING_STAGE:
            returnColor = colorData
                    .get(HydroColorManager.MISSING_STAGE_INDEX).color;
            break;
        ...
        case THREAT_ACTION:
            returnColor = colorData
                    .get(HydroColorManager.NEAR_FLOOD_INDEX).color;
            break;
