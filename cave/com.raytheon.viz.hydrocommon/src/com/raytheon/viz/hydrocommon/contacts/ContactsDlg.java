...
public class ContactsDlg extends CaveSWTDialog {
     ...
     */
    private java.util.List<ContactsData> contactArray;
    ...
    private void clearInformationFields() {
        ...
        int contactNum = 0;
        try {
            contactNum = ContactsDataManager.getInstance()
                    .getContactData(locationId).size();
    ...
    private boolean updateInsertContactData() {
        ...
        if (newContactFlag) {
            ...
            try {
                contactExists = ContactsDataManager.getInstance().recordExists(
    ...
    private void getContacts() {
        ...
        try {
            contactArray = ContactsDataManager.getInstance()
                    .getContactData(locationId);
        } catch (VizException e) {
