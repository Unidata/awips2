 ...
 * Jul 06, 2018 6885       mpduff      Added toString().
 * 
 * </pre>
 * 
 * @author mpduff
...
public class ColorDataClassXML {
    ...
    @XmlElements({
            @XmlElement(name = "threshold", type = ColorThresholdXML.class) })
    private List<ColorThresholdXML> thresholdList = new ArrayList<>();
     ...
     */
    public List<ColorThresholdXML> getThresholdList() {
     ...
     */
    public void setThresholdList(List<ColorThresholdXML> thresholdList) {
        this.thresholdList = thresholdList;
    }

    @Override
    public String toString() {
        return "ColorDataClassXML [colorUseName=" + colorUseName
                + ", dbColorUseName=" + dbColorUseName + "]";
    }
}
