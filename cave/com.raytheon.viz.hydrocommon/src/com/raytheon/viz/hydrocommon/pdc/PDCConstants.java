...
public class PDCConstants extends HydroConstants {
    ...
    public static enum QueryMode {
        AD_HOC_MODE(0), TIME_STEP_MODE(1);
    ...
    /**
     * BASIS_OBS = 0 BASIS_FCST = 1 BASIS_MOFO = 2
     */
    ...
    public static enum ProcessLineMode {
        PROCESS_NEW_STATION(0), PROCESS_DATA_SOURCES(1), PROCESS_VALUES(2);
