 ...
 * May 03, 2018  6631      mduff      Changed default of deriveStageFlow to 0.
 * 
 * </pre>
 * 
 * @author mpduff
...
public abstract class PDCOptions {
    ...
    private Date validTime = Calendar.getInstance(TimeZone.getTimeZone("GMT"))
            .getTime();
    ...
    private List<String> typeSourceChosenList = new ArrayList<>();

    private int filterByHSA = 0;

    private List<String> hsaList = new ArrayList<>();
    ...
    /**
     * SHOW_ALL ("Any Value") 0, SHOW_EQUAL ("Value =") 1, SHOW_NOT_EQUAL
     * ("Value Not =") 2, SHOW_GREATER_EQUAL ("Value >=") 3, SHOW_LESS_EQUAL
     * ("Value <=") 4, SHOW_GREATER ("Value >") 5, SHOW_LESS ("Value <") 6;
     */
    ...
    /**
     * SHOW_ALL ("Any Elev") 0, SHOW_EQUAL ("Elev =") 1, SHOW_NOT_EQUAL ("Elev
     * Not =") 2, SHOW_GREATER_EQUAL ("Elev >=") 3, SHOW_LESS_EQUAL ("Elev <=")
     * 4, SHOW_GREATER ("Elev >") 5, SHOW_LESS ("Elev <") 6;
     */
     ...
     */
    public void setSelectedAdHocElementString(
            String selectedAdHocElementString) {
     ...
     */
    public void setInstPrecipAccumTimeSelection(
            int instPrecipAccumTimeSelection) {
     ...
     * ("Value <=") 4, SHOW_GREATER ("Value >") 5, SHOW_LESS ("Value <") 6;
     * 
     * @param valueFilterOperation
     *            the valueFilterOperation to set
     */
     ...
     * 4, SHOW_GREATER ("Elev >") 5, SHOW_LESS ("Elev <") 6;
     *
     * @param elevFilterOperation
     *            the elevFilterOperation to set
     */
    ...
    public String toString() {
        ...
        sb.append("Instant Precip Accum Time Sel: [")
                .append(getInstPrecipAccumTimeSelection()).append("]\n");
        sb.append("TS Chosen Count:               [")
                .append(getTypeSourceChosenCount()).append("]\n");
        sb.append("Element Type:                  [").append(getElementType())
                .append("]\n");
        sb.append("Derive Stage Flow:             [")
                .append(getDeriveStageFlow()).append("]\n");
        sb.append("Duration Hours:                [").append(getDurHours())
                .append("]\n");
        sb.append("Filter By Data Source:         [")
                .append(getFilterByDataSource()).append("]\n");
        sb.append("Valid Time:                    [")
                .append(getValidTime().toString()).append("]\n");
        sb.append("Elevation Filter Operation:    [")
                .append(getElevFilterOperation()).append("]\n");
        sb.append("Elevation Filter Value:        [")
                .append(getElevFilterValue()).append("]\n");
        sb.append("Flood Level:                   [").append(getFloodLevel())
                .append("]\n");
        sb.append("Forecast Points Only:          [").append(getFcstptsOnly())
                .append("]\n");
        ...
        sb.append("Data Source Chosen Count:      [")
                .append(getDataSourceChosenCount()).append("]\n");
        sb.append("AdHoc Element String Full:     [")
                .append(getSelectedAdHocElementFullString()).append("]\n");
        sb.append("AdHoc Element String:          [")
                .append(getSelectedAdHocElementString()).append("]\n");
        sb.append("PC and PP:                     [").append(getPcAndpp())
                .append("]\n");
        sb.append("Primary:                       [").append(getPrimary())
                .append("]\n");
        sb.append("Process Selected:              [")
                .append(getProcessSelected()).append("]\n");
        sb.append("Query Mode:                    [").append(getQueryMode())
                .append("]\n");
        sb.append("River Status:                  [").append(getRiverStatus())
                .append("]\n");
        sb.append("Stage Basis:                   [").append(getStageBasis())
                .append("]\n");
        sb.append("Elevation:                     [").append(getElevation())
                .append("]\n");
        sb.append("River Station Filter:          [")
                .append(getRiverStationFilter()).append("]\n");
        sb.append("Supress Missing:               [")
                .append(getSupressMissing()).append("]\n");
        sb.append("Param Code:                    [").append(getParamCode())
                .append("]\n");
        ...
        sb.append("TS Data Element:               [").append(getTsDataElement())
                .append("]\n");
        sb.append("Filter By HSA:                 [").append(getFilterByHSA())
                .append("]\n");
        sb.append("Time:                          [").append(getTime())
                .append("]\n");
        sb.append("Time Mode:                     [").append(getTimeMode())
                .append("]\n");
        sb.append("Precip PE Filter:              [")
                .append(getPrecipPeFilter()).append("]\n");
        sb.append("Filter By TS:                  [")
                .append(getFilterByTypeSource()).append("]\n");
        sb.append("Value:                         [").append(getValue())
                .append("]\n");
        sb.append("Value Filter Operation:        [")
                .append(getValueFilterOperation()).append("]\n");
        sb.append("Value Type:                    [").append(getValueType())
                .append("]\n");
        sb.append("Value Filter Value:            [")
                .append(getValueFilterValue()).append("]\n");
        if (getHsaList() != null) {
            sb.append("HSA List:                      [");
