...
/**
 * Utility class for interacting with hydro DB.
 *
 * <pre>
 *
 * SOFTWARE HISTORY
 ...
 * ------------ ---------- ----------- --------------------------
 * ???                                 Initial creation
 * Jan 27, 2025 2038346    mapeters    Added getDAABiasDyn, getPdos
 *
 * </pre>
 */
public class IHFSDbGenerated {
    public static ArrayList<Colorvalue> GetColorValue(String where) {
        ...
        ArrayList<Colorvalue> retVal = new ArrayList<>();
        try {
            List<Object[]> results = DirectDbQuery
                    .executeQuery(query.toString(), "ihfs", QueryLanguage.HQL);
    ...
    public static ArrayList<Hourlypc> GetHourlyPC(String where) {
        ...
        ArrayList<Hourlypc> retVal = new ArrayList<>();
        try {
            List<Object[]> results = DirectDbQuery
                    .executeQuery(query.toString(), "ihfs", QueryLanguage.HQL);
    ...
    public static ArrayList<Hourlypp> GetHourlyPP(String where) {
        ...
        ArrayList<Hourlypp> retVal = new ArrayList<>();
        try {
            List<Object[]> results = DirectDbQuery
                    .executeQuery(query.toString(), "ihfs", QueryLanguage.HQL);
    ...
    public static List<Ingestfilter> GetIngestFilter(String where) {
        ...
        ArrayList<Ingestfilter> retVal = new ArrayList<>();
        try {
            List<Object[]> results = DirectDbQuery
                    .executeQuery(query.toString(), "ihfs", QueryLanguage.HQL);
    ...
    public static List<Rwresult> GetRWResult(String where) {
        ...
        ArrayList<Rwresult> retVal = new ArrayList<>();
        try {
            List<Object[]> results = DirectDbQuery
                    .executeQuery(query.toString(), "ihfs", QueryLanguage.HQL);
    ...
    public static List<Rwbiasdyn> GetRWBiasDyn(String where) {
        ...
        ArrayList<Rwbiasdyn> retVal = new ArrayList<>();
        try {
            List<Object[]> results = DirectDbQuery
                    .executeQuery(query.toString(), "ihfs", QueryLanguage.HQL);
    ...
    /**
     * Get entries from the daabiasdyn table that meet the given where
     * constraint.
     *
     * @param where
     *            where constraint to get objects for
     * @return DAABiasDyn objects
     */
    public static List<DAABiasDyn> getDAABiasDyn(String where) {
        return getPdos(DAABiasDyn.class, where);
    }

    private static <T extends PersistableDataObject<?>> List<T> getPdos(
        ...
        try {
            ...
            throw new RuntimeException("Error getting " + clazz.getSimpleName()
                    + " objects from the database", e);
        }
    ...
    public static ArrayList<Rwbiasstat> GetRWBiasstat(String where) {
        ...
        ArrayList<Rwbiasstat> retVal = new ArrayList<>();
        try {
            List<Object[]> results = DirectDbQuery
                    .executeQuery(query.toString(), "ihfs", QueryLanguage.HQL);
    ...
    public static List<Rwradarresult> GetRWRadarResult(String where) {
        ...
        ArrayList<Rwradarresult> retVal = new ArrayList<>();
        try {
            List<Object[]> results = DirectDbQuery
                    .executeQuery(query.toString(), "ihfs", QueryLanguage.HQL);
    ...
    public static List<DAARadarResult> GetDAARadarResult(String where) {
        ...
        ArrayList<DAARadarResult> retVal = new ArrayList<>();
        try {
            List<Object[]> results = DirectDbQuery
                    .executeQuery(query.toString(), "ihfs", QueryLanguage.HQL);
