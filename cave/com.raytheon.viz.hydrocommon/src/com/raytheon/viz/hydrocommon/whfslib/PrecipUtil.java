...
public final class PrecipUtil {
    ...
    private PrecipModes.PrecipPEmode pe_mode = PrecipModes.PrecipPEmode.PrecipPEbest;

    private PrecipModes.PrecipTSmode ts_mode = PrecipModes.PrecipTSmode.PrecipTSsingle;
    ...
    public total_precip get_total_hourly_precip(
        ...
        if (settings != previous_settings) {
            ...
            if ((settings & PRECIP_PE_BEST) == PRECIP_PE_BEST) {
                pe_mode = PrecipModes.PrecipPEmode.PrecipPEbest;
            } else if ((settings & PRECIP_PP) == PRECIP_PP) {
                pe_mode = PrecipModes.PrecipPEmode.PrecipPEPP;
            } else if ((settings & PRECIP_PC) == PRECIP_PC) {
                pe_mode = PrecipModes.PrecipPEmode.PrecipPEPC;
            }

            if ((settings & PRECIP_TS_BEST) == PRECIP_TS_BEST) {
                ts_mode = PrecipModes.PrecipTSmode.PrecipTSbest;
            } else if ((settings & PRECIP_TS_RANK) == PRECIP_TS_RANK) {
                ts_mode = PrecipModes.PrecipTSmode.PrecipTSrank;
            } else {
                ts_mode = PrecipModes.PrecipTSmode.PrecipTSsingle;
            }
        }
