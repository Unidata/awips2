 ...
 * Sep 26, 2018 7487       tgurney     Dispose old shapes when changing projection
 *
 * </pre>
 *
 * @author mpduff
...
public class RadarRingOverlayResource
    ...
    /** Radar ring range */
    protected static final int RANGE = 230_000;
    ...
    protected void computeRangeCircle(IGraphicsTarget target,
        ...
        try {
            ...
            statusHandler.warn("Failed to compute range circle for " + id, e);
        }
    ...
    protected void constructDataTimer() {
        ...
        timer.schedule(timerTask, 0, 30 * TimeUtil.MILLIS_PER_SECOND);
    }
