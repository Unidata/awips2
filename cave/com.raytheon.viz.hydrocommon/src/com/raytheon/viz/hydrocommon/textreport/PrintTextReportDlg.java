 ...
 * Jun 21, 2018 #6876      dgilling    Handle formfeed characters in text,
 *                                     allow text size to be overridden.
 *
 * </pre>
 *
 * @author wkwock
...
public class PrintTextReportDlg extends CaveSWTDialog {
    ...
    private void print(Printer printer, String text) {
        if (printer.startJob("Text")) {
            ...
            // half inch from left side of paper
            leftMargin = (dpi.x / 2) + trim.x;
            // half inch from right side of paper
            rightMargin = clientArea.width - (dpi.x / 2) + trim.x + trim.width;
            ...
            Font printerFont = new Font(printer, "Monospace", fontSize,
                    SWT.NORMAL);
