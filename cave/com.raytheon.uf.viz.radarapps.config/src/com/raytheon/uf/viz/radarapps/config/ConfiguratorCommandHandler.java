...
/**
 * Handler to display RadarServer Configuration dialog
 *
 * <pre>
 *
 * SOFTWARE HISTORY
 ...
 * ------------- -------- --------- --------------------------------------------
 * Sep 21, 2016  5901     randerso  Add proper parent shell for dialog
 *
 * </pre>
 *
 * @author ????
...
public class ConfiguratorCommandHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        // TODO: Singleton
        if (cfg == null) {
            cfg = new Configurator(HandlerUtil.getActiveShell(event));
            cfg.show();
