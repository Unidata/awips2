...
public class FFMPRowGenerator implements Runnable {
    ...
    public void run() {
        ...
        if (cBasin instanceof FFMPVirtualGageBasin) {
            ...
            ArrayList<String> excludedVGBLids = FFMPTemplateConfigurationManager.getInstance().getExcludedVGBs()
                    .getLids();

            String lid = vgBasin.getLid();

            if (lid != null && (false == excludedVGBLids.contains(lid))){ // DR-11250 get rid of excluded
