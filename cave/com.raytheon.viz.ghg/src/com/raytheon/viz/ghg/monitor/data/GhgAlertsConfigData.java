...
public class GhgAlertsConfigData implements Cloneable {
    /**
     ...
     *            the object to copy.
     */
    public GhgAlertsConfigData(GhgAlertsConfigData rhs) {
...
//    }
    ...
    @Override
    public GhgAlertsConfigData clone() {
        return new GhgAlertsConfigData(this);
    }
}