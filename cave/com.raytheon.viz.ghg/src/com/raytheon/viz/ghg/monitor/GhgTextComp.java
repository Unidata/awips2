 ...
 * Nov 14, 2019  7919     randerso  Updated for changes in GhgData.
 *
 * </pre>
 *
 * @author lvenable
...
public class GhgTextComp extends Composite {
    ...
    public void refresh() {
        ...
        if (dataList != null) {
            ...
            List<GhgData> combined = new ArrayList<>(dataList);
    ...
    private void showGhgText(GhgData data) {
        ...
        if ((overviewText != null) && (overviewText.length() > 0)) {
            ...
            String ovrHdr = String.format(
                    ...
                    data.getDisplayString(DataEnum.PIL),
                    data.getDisplayString(DataEnum.ISSUE_TIME));
