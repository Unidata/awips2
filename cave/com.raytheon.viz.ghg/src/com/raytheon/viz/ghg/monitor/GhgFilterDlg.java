 ...
 * 03 Aug 2016  5790       dgilling    Support changes to GhgData.
 * 
 * </pre>
 * 
 * @author lvenable
...
public class GhgFilterDlg extends CaveSWTDialog {
    ...
    private void updateListBoxes() {
        ...
        if (showCurrentHazardsChk.getSelection()) {
            ...
            Set<String> phenSigSet = new HashSet<>();
            Set<String> pilSet = new HashSet<>();
            Set<String> wfoSet = new HashSet<>();
            Set<String> geoIdSet = new HashSet<>();
            Set<String> etnSet = new HashSet<>();
            ...
            for (ActiveTableRecord rec : tableDataList) {
                ...
                if (filterEngine.filterCheck(data)) {
                    ...
                    segSet.add(data.getSegNumString());
                }
            }
