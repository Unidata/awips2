 ...
 * Jul 30, 2010  6721     mpduff    Fixed an all/none selection problem.
 * Nov 14, 2019  7919     randerso  Made AlertsFilterEnum fields private
 *
 * </pre>
 *
 * @author lvenable
...
public class GhgFilterListGroup extends Composite {
    ...
    private void initializeComponents(Group groupComp) {
        ...
        dataList = new ToggleSelectList(groupComp,
