 ...
 * Nov 14, 2019  7919     randerso  Made AlertsEnum fields private.
 *
 * </pre>
 *
 * @author lvenable
...
public class GhgEnableAlertComp extends Composite {
    ...
    public GhgEnableAlertComp(Composite parent,
            GhgConfigData.AlertsEnum enableTitle, int expireMin,
            boolean enabled) {
        super(parent, SWT.BORDER);
        type = enableTitle;
        this.parent = parent;
        this.enableTitle = enableTitle.getDisplay();
    ...
    private void drawScaleValueCanvas(GC gc) {
        ...
        int newXCoord = (int) Math
                .round(expireMinutes * pixPerInc + xCoordOffset);
    ...
    private void drawScaleLabelCanvas(GC gc) {
        ...
        gc.drawString("15",
                ((int) Math.round(CANVAS_WIDTH * .25)) - fontAveWidth / 2 + 3,
                1, true);

        gc.drawString("30", CANVAS_WIDTH / 2 - fontAveWidth, 1, true);

        gc.drawString("45",
                ((int) Math.round(CANVAS_WIDTH * .75)) - fontAveWidth / 2 - 10,
                1, true);
