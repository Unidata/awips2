 ...
 *
 */
public class SSDisplayProductTab extends TabItemComp
        implements IUpdateDisplayProduct {
    private SSDisplayProductEditDlg productEditDlg;

    private List<SSDisplayProductData> ssDataArray;
    ...
    private void createDataArray() {
        ...
        for (String areaID : areaList) {
            ...
            ssdpd.setStormWrnWindSpeedR(
                    sstm.getThresholdValue(duKey, threshKeyR, areaID, xmlKey));
            ssdpd.setStormWrnWindSpeedY(
                    sstm.getThresholdValue(duKey, threshKeyY, areaID, xmlKey));

            xmlKey = SafeSeasDisplay.SS_DISP_PROD_STORM_GUST_SPEED.getXmlKey();
            ssdpd.setStormWrnGustSpeedR(
                    sstm.getThresholdValue(duKey, threshKeyR, areaID, xmlKey));
            ssdpd.setStormWrnGustSpeedY(
                    sstm.getThresholdValue(duKey, threshKeyY, areaID, xmlKey));

            xmlKey = SafeSeasDisplay.SS_DISP_PROD_STORM_PEAK_WIND.getXmlKey();
            ssdpd.setStormWrnPeakWindR(
                    sstm.getThresholdValue(duKey, threshKeyR, areaID, xmlKey));
            ssdpd.setStormWrnPeakWindY(
                    sstm.getThresholdValue(duKey, threshKeyY, areaID, xmlKey));
            ...
            ssdpd.setHfwwWindSpeedR(
                    sstm.getThresholdValue(duKey, threshKeyR, areaID, xmlKey));
            ssdpd.setHfwwWindSpeedY(
                    sstm.getThresholdValue(duKey, threshKeyY, areaID, xmlKey));

            xmlKey = SafeSeasDisplay.SS_DISP_PROD_HFWW_GUST_SPEED.getXmlKey();
            ssdpd.setHfwwGustSpeedR(
                    sstm.getThresholdValue(duKey, threshKeyR, areaID, xmlKey));
            ssdpd.setHfwwGustSpeedY(
                    sstm.getThresholdValue(duKey, threshKeyY, areaID, xmlKey));

            xmlKey = SafeSeasDisplay.SS_DISP_PROD_HFWW_PEAK_WIND.getXmlKey();
            ssdpd.setHfwwPeakWindR(
                    sstm.getThresholdValue(duKey, threshKeyR, areaID, xmlKey));
            ssdpd.setHfwwPeakWindY(
                    sstm.getThresholdValue(duKey, threshKeyY, areaID, xmlKey));
    ...
    protected void editDataAction() {
        ...
        if (productEditDlg == null) {
            productEditDlg = new SSDisplayProductEditDlg(getParent().getShell(),
                    sspdp, this);
            productEditDlg.open();
            productEditDlg = null;
        }
