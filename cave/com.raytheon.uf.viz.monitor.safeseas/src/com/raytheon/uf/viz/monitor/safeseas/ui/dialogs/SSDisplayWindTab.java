...
public class SSDisplayWindTab extends TabItemComp implements IUpdateDisplayWind
{
    ...
    private void createDataArray()
    {
        ...
        for (AreaXML area : areasArray)
        {
            ...
            ssdwd.setWindSpeedR(sstm.getThresholdValue(duKey, threshKeyR, areaID, xmlKey));
            ssdwd.setWindSpeedY(sstm.getThresholdValue(duKey, threshKeyY, areaID, xmlKey));            
            
            /*
             * Peak Wind
             */
            xmlKey = SafeSeasDisplay.SS_DISP_WIND_PEAK_WIND.getXmlKey();
            ssdwd.setPeakWindR(sstm.getThresholdValue(duKey, threshKeyR, areaID, xmlKey));
            ssdwd.setPeakWindY(sstm.getThresholdValue(duKey, threshKeyY, areaID, xmlKey));   
            
            /*
             * Gust Speed
             */
            xmlKey = SafeSeasDisplay.SS_DISP_WIND_GUST_SPEED.getXmlKey();
            ssdwd.setGustSpeedR(sstm.getThresholdValue(duKey, threshKeyR, areaID, xmlKey));
            ssdwd.setGustSpeedY(sstm.getThresholdValue(duKey, threshKeyY, areaID, xmlKey)); 
            
            /*
             * Wind Direction From
             */
            xmlKey = SafeSeasDisplay.SS_DISP_WIND_DIR_FROM.getXmlKey();
            ssdwd.setWindDirFromR(sstm.getThresholdValue(duKey, threshKeyR, areaID, xmlKey));
            ssdwd.setWindDirFromY(sstm.getThresholdValue(duKey, threshKeyY, areaID, xmlKey)); 
            
            /*
             * Wind Direction To
             */
            xmlKey = SafeSeasDisplay.SS_DISP_WIND_DIR_TO.getXmlKey();
            ssdwd.setWindDirToR(sstm.getThresholdValue(duKey, threshKeyR, areaID, xmlKey));
            ssdwd.setWindDirToY(sstm.getThresholdValue(duKey, threshKeyY, areaID, xmlKey)); 
    ...
    public void commitDataToXML()
    {
        ...
        for (SSDisplayWindData ssdwd : ssDataArray)
        {
             ...
             */
            xmlKey = SafeSeasDisplay.SS_DISP_WIND_WIND_SPEED.getXmlKey();
            sstm.setThresholdValue(duKey, threshKeyR, areaID, xmlKey, ssdwd.getWindSpeedR());
            sstm.setThresholdValue(duKey, threshKeyY, areaID, xmlKey, ssdwd.getWindSpeedY());
            
            /*
             * Peak Wind
             */
            xmlKey = SafeSeasDisplay.SS_DISP_WIND_PEAK_WIND.getXmlKey();
            sstm.setThresholdValue(duKey, threshKeyR, areaID, xmlKey, ssdwd.getPeakWindR());
            sstm.setThresholdValue(duKey, threshKeyY, areaID, xmlKey, ssdwd.getPeakWindY());
            ...
            sstm.setThresholdValue(duKey, threshKeyY, areaID, xmlKey, ssdwd.getGustSpeedY());
            
            /*
             * Wind Direction From
             */
            xmlKey = SafeSeasDisplay.SS_DISP_WIND_DIR_FROM.getXmlKey();
            sstm.setThresholdValue(duKey, threshKeyR, areaID, xmlKey, ssdwd.getWindDirFromR());
            sstm.setThresholdValue(duKey, threshKeyY, areaID, xmlKey, ssdwd.getWindDirFromY());
            
            /*
             * Wind Direction To
             */
            xmlKey = SafeSeasDisplay.SS_DISP_WIND_DIR_TO.getXmlKey();
            sstm.setThresholdValue(duKey, threshKeyR, areaID, xmlKey, ssdwd.getWindDirToR());
            sstm.setThresholdValue(duKey, threshKeyY, areaID, xmlKey, ssdwd.getWindDirToY());
        }
    }
    ...
    protected void editDataAction()
    {
        ...
        if (windEditDlg == null)
        {
            windEditDlg = new SSDisplayWindEditDlg(getParent().getShell(), ssdwd, this);
            windEditDlg.open();
            windEditDlg = null;
        }
    }   
