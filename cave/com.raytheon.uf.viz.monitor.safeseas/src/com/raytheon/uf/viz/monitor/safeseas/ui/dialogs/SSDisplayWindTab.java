 ...
 *
 */
public class SSDisplayWindTab extends TabItemComp
        implements IUpdateDisplayWind {
    private SSDisplayWindEditDlg windEditDlg;

    private List<SSDisplayWindData> ssDataArray;
    ...
    protected void populateTable() {
        ...
        for (int i = 0; i < ssDataArray.size(); i++) {
             ...
             * Wind Speed
             */
            appendIntData(item, 1, ssdwd.getWindSpeedR(),
                    ssdwd.getWindSpeedY());
             ...
             * Gust Speed
             */
            appendIntData(item, 5, ssdwd.getGustSpeedR(),
                    ssdwd.getGustSpeedY());
             ...
             * Wind Direction To
             */
            appendIntData(item, 9, ssdwd.getWindDirToR(),
                    ssdwd.getWindDirToY());
    ...
    private void createDataArray() {
        ...
        for (String areaID : areaList) {
            ...
            ssdwd.setWindDirFromR(
                    sstm.getThresholdValue(duKey, threshKeyR, areaID, xmlKey));
            ssdwd.setWindDirFromY(
                    sstm.getThresholdValue(duKey, threshKeyY, areaID, xmlKey));
