 ...
 * Dec 26, 2015  5114     skorolev  Corrected imports and replaced AppName with
 *                                  MonName.
 ...
 * @author skorolev
 */
public class SSMonitorMeteoTab extends TabItemComp
        implements IUpdateMonitorMeteo {
    private SSMonitorMeteoEditDlg monitorMeteoEditDlg;

    private List<SSMonitorMeteoData> ssDataArray;
    ...
    protected void populateTable() {
        ...
        for (int i = 0; i < ssDataArray.size(); i++) {
             ...
             * Wind Speed
             */
            appendIntData(item, 1, ssmmd.getWindSpeedR(),
                    ssmmd.getWindSpeedY());
             ...
             * Gust Wind
             */
            appendIntData(item, 5, ssmmd.getGustSpeedR(),
                    ssmmd.getGustSpeedY());
            ...
            item.setText(9, formatTableData(tmpVisStr));

            visVal = ssmmd.getVisY();
            tmpVisStr = rangeUtil.getVisString((int) visVal);
            item.setText(10, formatTableData(tmpVisStr));
    ...
    protected void editDataAction() {
        ...
        if (monitorMeteoEditDlg == null) {
            monitorMeteoEditDlg = new SSMonitorMeteoEditDlg(
                    getParent().getShell(), ssmmd, this);
