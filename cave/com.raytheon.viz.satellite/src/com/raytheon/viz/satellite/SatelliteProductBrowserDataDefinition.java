 ...
 * Jun 26, 2018  6615     bsteffen  Use custom data listing for satellite.
 * 
 * </pre>
 * 
 * @author mnash
 */
public class SatelliteProductBrowserDataDefinition
        extends DataListingProductBrowserDefinition {

    public SatelliteProductBrowserDataDefinition() {
        super(new SatDataListing(Arrays.asList(SatDataListing.CREATING_ENTITY,
                SatDataListing.SECTOR_ID, SatDataListing.PHYSICAL_ELEMENT)));
    }
