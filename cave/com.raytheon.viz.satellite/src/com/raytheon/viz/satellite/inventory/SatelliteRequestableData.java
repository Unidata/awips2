...
public class SatelliteRequestableData extends AbstractRequestableData {
    ...
    public Object getDataValue(Object arg) throws DataCubeException {
        if (arg instanceof GridGeometry2D) {
            ...
            unit = SatelliteUnitsUtil.getDataUnit(
                    SatelliteUnitsUtil.getRecordUnit(record), dataRecord);
            ...
            BufferWrapper dest = BufferWrapper.create(source.getPrimitiveType(),
                    requestRange.width, requestRange.height);
            try {
            ...
            dataRecord = DataStoreFactory.createStorageRecord(
                    ...
                    dest.getArray(), 2,
                    new long[] { requestRange.width, requestRange.height });
