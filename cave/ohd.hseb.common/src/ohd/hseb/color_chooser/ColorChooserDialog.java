...
//        ComponentHelper.addPanelComponent( modifyColorSetsPanel, _editTabColor, buttonGbc,          1,   1,    1,    1, GridBagConstraints.BOTH );
//        ComponentHelper.addPanelComponent( modifyColorSetsPanel, _editTabScaleValue, buttonGbc,     1,   2,    1,    1, GridBagConstraints.BOTH );
...
/*
        ComponentHelper.addPanelComponent( _editTabModifyColorScaleValueSetPanel, _editTabColor,          1,   1,    1,    1, 1, 1, GridBagConstraints.BOTH );
        ComponentHelper.addPanelComponent( _editTabModifyColorScaleValueSetPanel, _editTabScaleValue,     1,   2,    1,    1, 1, 1, GridBagConstraints.BOTH );
        ComponentHelper.addPanelComponent( _editTabModifyColorScaleValueSetPanel, _editTabAddColorSet,    6,   1,    2,    2, 1, 1, GridBagConstraints.NONE );
        ComponentHelper.addPanelComponent( _editTabModifyColorScaleValueSetPanel, _editTabDeleteColorSet, 6,   3,    2,    2, 1, 1, GridBagConstraints.NONE );
*/        
...
//        List databaseColorScaleValueSetList = _dataMgr.getColorValueTableColorScaleValueSetList();
...
/*
    private ColorScaleValueSet getUsedColorScaleValueSetByColorUse( String colorUse )
    {
        ColorScaleValueSet foundColorScaleValueSet = null;
        ColorScaleValueSet extractedColorScaleValueSet = null;
        int duration = (Integer) _editTabDurationComboBox.getSelectedItem();
        ...
        for ( int i = 0; i < _usedColorScaleValueSetList.size(); i++ )
        {
            ...
            {
                foundColorScaleValueSet = extractedColorScaleValueSet;
            }
        }
        if ( ( _activeTabID == EDIT_PANEL_TAB_ID ) && ( foundColorScaleValueSet == null ) )
        {
            for ( int i = 0; i < _usedColorScaleValueSetList.size(); i++ )
            {
                extractedColorScaleValueSet = (ColorScaleValueSet) _usedColorScaleValueSetList.get( i );
                ...
                if ( ( extractedColorScaleValueSet.getColorUseString().equalsIgnoreCase( colorUse ) ) &&
                   ( extractedColorScaleValueSet.getDuration() == 0 ) )
                {
                    foundColorScaleValueSet = extractedColorScaleValueSet;
                }
            }
    ...
    private boolean doesUserColorScaleValueSetExist( String colorUse )
    {
        ...
        if ( _activeTabID == EDIT_PANEL_TAB_ID ) // in Edit Tab
        {
            if ( ( setComboBoxString.equalsIgnoreCase( "default" ) ) && ( selectedDurationDouble != null ) )
            {
                ...
                while ( ( i < colorScaleValueSetList.size() ) && ( colorScaleValueSet == null ) )
                {
                    ...
                    {
//                        colorScaleValueSet = new ColorScaleValueSet( (ColorScaleValueSet) colorScaleValueSetList.get( i ) );
            ...
            else if ( ( setComboBoxString.equalsIgnoreCase( "user" ) ) && ( selectedDurationDouble != null ) )
            {
                ...
                if ( selectedDurationDouble != null )
                {
                    ...
                    while ( ( i < colorScaleValueSetList.size() ) && ( colorScaleValueSet == null )  )
                    {
                        ...
                        {
//                            colorScaleValueSet = new ColorScaleValueSet( extractedColorScaleValueSet );
...
//                    colorScaleValueSet = new ColorScaleValueSet( extractedColorScaleValueSet );
    ...
    private Double getDurationComboBoxDoubleValue( JComboBox comboBox )
    {
        ...
        {
            returnValue = Double.parseDouble( selectedItem );
        }
    ...
    private class SaveAsOfficeButtonListener implements ActionListener
    {
        public void actionPerformed( ActionEvent e )
        {
            ...
            {
                Double durationDouble = (Double) _editTabDurationComboBox.getSelectedItem();
...
//                    usedColorScaleValueSet = ColorScaleValueSet.getCopyOfColorScaleValueSet( extractedColorScaleValueSet );
                }
