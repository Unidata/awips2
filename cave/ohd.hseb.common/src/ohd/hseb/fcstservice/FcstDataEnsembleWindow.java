...
public class FcstDataEnsembleWindow implements Subject
{
	...
	public void buttonsActivateWhenKeysTyped()
    {
    	if(locationTextField.getText().length() > 0 || numElevZonesTextField.getText().length() > 0 ||
    	   ...
    	   numMonClimTextField.getText().length() > 0 || numDayHydTextField.getText().length() > 0)
    	{
    		activateClearButton();
    	}
    	else
	...
	private class SaveActionListener implements ActionListener
    {
        public void actionPerformed(ActionEvent e) 
        {
			...
			try
			{
				...
				{
					record.setNummonclim(Short.valueOf(numMonClimTextField.getText()));
				}
				else
				{
					null_or_not = 1;
			...
			try
			{
				...
				{
					record.setNumdayhyd(Short.valueOf(numDayHydTextField.getText()));
				}
				else
				{
					null_or_not = 1;
