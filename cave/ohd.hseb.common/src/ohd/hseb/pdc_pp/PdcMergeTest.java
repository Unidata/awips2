...
public class PdcMergeTest extends TestCase {
    ...
    // 3 hour variables
    private long _3HourStartTime = _3HourCachedTimeValuePairArray[0]
            .getDateTime();

    private String _3HourStartTimeString = DbTimeHelper
            .getDateTimeStringFromLongTime(_3HourStartTime);

    private String _3HourEndTimeString = "2007-01-02 05:15:00";

    private long _3HourEndTime = DbTimeHelper
            .getLongTimeFromDateTimeString(_3HourEndTimeString);

    private int _3HourLookBackWindow = 24;

    // 24 hour variables
    private long _24HourStartTime = _24HourCachedTimeValuePairArray[0]
            .getDateTime();

    private String _24HourStartTimeString = DbTimeHelper
            .getDateTimeStringFromLongTime(_24HourStartTime);

    private String _24HourEndTimeString = "2007-01-11 03:07:00";

    private long _24HourEndTime = DbTimeHelper
            .getLongTimeFromDateTimeString(_24HourEndTimeString);

    private int _24HourLookBackWindow = 240;

    private static TimeValuePair[] _3HourCachedTimeValuePairArray = {
            tvp("2007-01-01 00:00:00", 1.0), tvp("2007-01-01 03:00:00", 2.0),
            tvp("2007-01-01 06:00:00", 3.0), tvp("2007-01-01 09:00:00", 4.0),
            tvp("2007-01-01 12:00:00", 5.0), tvp("2007-01-01 15:00:00", 6.0),
            tvp("2007-01-01 18:00:00", 7.0), tvp("2007-01-01 21:00:00", 8.0),
            tvp("2007-01-02 00:00:00", 9.0), tvp("2007-01-02 03:00:00", 10.0) };
    ...
    private static TimeValuePair[] _3HourFreshTimeValuePairArray = {
            ...
            tvp("2007-01-01 21:00:00", 8.0), tvp("2007-01-02 00:00:00", 9.0),
            tvp("2007-01-02 03:00:00", 11.0), tvp("2007-01-02 06:00:00", 5.5) };
    ...
    private static TimeValuePair[] _3HourExpectedMergedTimeValuePairArray = {
            ...
            tvp("2007-01-01 12:00:00", 5.0), tvp("2007-01-01 15:00:00", 6.0),
            tvp("2007-01-01 18:00:00", 7.0), tvp("2007-01-01 21:00:00", 8.0),
            tvp("2007-01-02 00:00:00", 9.0), tvp("2007-01-02 03:00:00", 11.0),
            tvp("2007-01-02 06:00:00", 5.5) };

    private static TimeValuePair[] _24HourCachedTimeValuePairArray = {
            tvp("2007-01-01 12:00:00", 1.0), tvp("2007-01-02 12:00:00", 2.0),
            tvp("2007-01-03 12:00:00", 3.0), tvp("2007-01-04 12:00:00", 4.0),
            tvp("2007-01-05 12:00:00", 5.0), tvp("2007-01-06 12:00:00", 6.0),
            tvp("2007-01-07 12:00:00", 7.0), tvp("2007-01-08 12:00:00", 8.0),
    ...
    private static TimeValuePair[] _24HourFreshTimeValuePairArray = {
            ...
            tvp("2007-01-06 12:00:00", 6.0), tvp("2007-01-07 12:00:00", 7.0),
            tvp("2007-01-08 12:00:00", 8.0), tvp("2007-01-09 12:00:00", 9.0),
            tvp("2007-01-10 12:00:00", 11.0), tvp("2007-01-11 12:00:00", 5.5) };
    ...
    private static TimeValuePair[] _24HourExpectedMergedTimeValuePairArray = {
            ...
            tvp("2007-01-05 12:00:00", 5.0), tvp("2007-01-06 12:00:00", 6.0),
            tvp("2007-01-07 12:00:00", 7.0), tvp("2007-01-08 12:00:00", 8.0),
            tvp("2007-01-09 12:00:00", 9.0), tvp("2007-01-10 12:00:00", 11.0),
    ...
    public PdcMergeTest() {
        ...
        _dataMgr = new PDCPreprocessorDataMgr(connectionString, logger,
                preprocessedFilePath, 5, 5, true);
    ...
    private RegularObsTimeSeriesDescriptor getRegularObsTimeSeriesDescriptor(
            String lid, String startTimeString, String endTimeString) {
        ...
        long startTime = DbTimeHelper
                .getLongTimeFromDateTimeString(startTimeString);
        descriptor.setStartTime(startTime);

        long endTime = DbTimeHelper
                .getLongTimeFromDateTimeString(endTimeString);
    ...
    // --------------------------------------------------------------------------------------------------------
    private RegularObsTimeSeriesDescriptor getRegularObsTimeSeriesDescriptor(
            String lid, long startTime, long endTime) {
        RegularObsTimeSeriesDescriptor descriptor = new RegularObsTimeSeriesDescriptor();
        descriptor.setLid(lid);
        descriptor.setPe("PP");
        descriptor.setDur((short) 1001);
    ...
    private void addPairs(TimeValuePair[] timeValuePairArray,
            RegularObsTimeSeries regularObsTimeSeries) {
    ...
    // --------------------------------------------------------------------------------------------------------
    private RegularObsTimeSeries createTimeSeries(String lid,
            int durationInHours, TimeValuePair[] timeValuePairArray) {
        ...
        RegularObsTimeSeriesDescriptor descriptor = getRegularObsTimeSeriesDescriptor(
                lid, startTime, endTime);

        RegularObsTimeSeries timeSeries = new RegularObsTimeSeries(descriptor,
                durationInHours, timeSlotPolicy);
    ...
    private void createCachedTimeSeries() {
        _cached3HourTimeSeries = createTimeSeries("TEST1", 3,
                _3HourCachedTimeValuePairArray);
        _cached24HourTimeSeries = createTimeSeries("TEST1", 24,
                _24HourCachedTimeValuePairArray);
    }

    // --------------------------------------------------------------------------------------------------------

    private void createFreshTimeSeries() {
        _fresh3HourTimeSeries = createTimeSeries("TEST1", 3,
                _3HourFreshTimeValuePairArray);
        _fresh24HourTimeSeries = createTimeSeries("TEST1", 24,
                _24HourFreshTimeValuePairArray);
    }

    // --------------------------------------------------------------------------------------------------------

    private void createExpectedMergedTimeSeries() {
        _expectedMerged3HourTimeSeries = createTimeSeries("TEST1", 3,
                _3HourExpectedMergedTimeValuePairArray);
        _expectedMerged24HourTimeSeries = createTimeSeries("TEST1", 24,
                _24HourExpectedMergedTimeValuePairArray);
    }

    // --------------------------------------------------------------------------------------------------------

    public void innerTestMerge(final long endTime, int timeStepInHours,
            int numHoursToPreprocess, RegularObsTimeSeries cachedTimeSeries,
        ...
        long newStartTime = _dataMgr.getNewStartTime(endTime, timeStepInHours,
                numHoursToPreprocess);
        long newEndTime = _dataMgr.getNewEndTime(endTime, timeStepInHours);

        // long newStartTime = getNewStartTime(endTime, timeStepInHours,
        // numHoursToPreprocess);
        // long newEndTime = getNewEndTime(endTime, timeStepInHours);

        String originalEndTimeString = DbTimeHelper
                .getDateTimeStringFromLongTime(endTime);
        ...
        System.out.println(header + "original end time = "
                + originalEndTimeString);
        ...
        List mergedList = TimeSeriesListMgr.mergeTimeSeriesLists(freshList,
                cachedList, newStartTime, newEndTime);
        ...
        boolean freshTsAndCachedEqual = regularTimeSeriesEqual(freshTimeSeries,
                cachedTimeSeries);
        assertEquals(false, freshTsAndCachedEqual);

        // verify that the fresh and mergedTs are equal, since mergeTs really IS
        // freshTs
        boolean mergeTsAndFreshEqual = regularTimeSeriesEqual(mergedTs,
                freshTimeSeries);
        assertEquals(true, mergeTsAndFreshEqual);

        // verify that the cached and mergeTs are not equal
        boolean mergeTsAndCachedEqual = regularTimeSeriesEqual(mergedTs,
                cachedTimeSeries);
        assertEquals(false, mergeTsAndCachedEqual);

        // verify that the mergedTs is equal to the expectedMergedTimeSeries

        boolean mergedTsAndExpectedMergedTsEqual = regularTimeSeriesEqual(
                mergedTs, expectedMergedTimeSeries);
    ...
    public void test3HourMerge() {
        ...
        long expectedLastValue = DbTimeHelper
                .getLongTimeFromDateTimeString("2007-01-02 06:00:00");
    ...
    public void innerTestGetNewEndTime(String expectedDateTimeString,
            String originalDateTimeString, int timeStepInHours) {

        String header = "PdcMergeTest.innerTestGenNewEndTime(): ";

        long origEndTime = DbTimeHelper
                .getLongTimeFromDateTimeString(originalDateTimeString);
        long expectedEndTime = DbTimeHelper
                .getLongTimeFromDateTimeString(expectedDateTimeString);

        long newEndTime = _dataMgr.getNewEndTime(origEndTime, timeStepInHours);
        String newEndDateTimeString = DbTimeHelper
                .getDateTimeStringFromLongTime(newEndTime);

        if (expectedEndTime != newEndTime) {
            System.out.println(header + "originalDateTimeString = "
                    + originalDateTimeString + "\n expectedEndTime = "
                    + expectedDateTimeString + " while the "
    ...
    public void test24HourMerge() {
        innerTestMerge(_24HourEndTime, 24, _24HourLookBackWindow,
                _cached24HourTimeSeries, _fresh24HourTimeSeries,
                _expectedMerged24HourTimeSeries);

        long lastValue = _fresh24HourTimeSeries.getLatestTimeValue(-9999);
        System.out.println("24 hour last value = "
                + DbTimeHelper.getDateTimeStringFromLongTime(lastValue));
        long expectedLastValue = DbTimeHelper
                .getLongTimeFromDateTimeString("2007-01-11 12:00:00");
        assertEquals(expectedLastValue, lastValue);
    }

    // --------------------------------------------------------------------------------------------------------

    private boolean regularTimeSeriesEqual(RegularObsTimeSeries rts1,
            RegularObsTimeSeries rts2) {
        boolean result = true;
