 ...
 //       String header = "initForPrecipDualMode(): ";
  ...
  //      System.out.println(header + "newTs = " + newTs);
    ...
    
    {
        ...
        AbsTimeMeasurement max = getMaxTsMeasurement(obsTs, fcstTs, unit, startTime, endTime);        
        System.out.println(header + "after get max ");
        
        AbsTimeMeasurement min = getMinTsMeasurement(obsTs, fcstTs, unit, startTime, endTime);
        System.out.println(header + "after get min ");
        
        
        AbsTimeMeasurement last = getLastMeasurement(obsTs, fcstTs, unit, startTime, endTime);
