...
import com.raytheon.viz.hydrobase.dialogs.AbstractArealDefinitionsDlg;
...
import com.raytheon.viz.hydrobase.dialogs.ArealDefinitionsDlgFactory;
 ...
 * 04/11/2020   19533    mgamazaychikov Changed to ArealDefinitionsDlgFactory
 * 
 * </pre>
 * 
 * @author lvenable
...
public class HydroBaseDlg extends CaveSWTDialog
     ...
     */
    private AbstractArealDefinitionsDlg arealDlg;
        ...
        arealDefinitionsMI.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent event) {
                if (arealDlg == null || arealDlg.isDisposed()) {
                    arealDlg = ArealDefinitionsDlgFactory.createArealDefinitionsDlg(shell);
                    arealDlg.open();
                } else {
                    arealDlg.bringToTop();
                }
