...
public class XdatDlg extends CaveSWTDialog implements ITextDisplay {
    ...
    private void createPeDateControls(Composite parentComp) {
        peButtons = new ArrayList<Button>();
        ...
        try {
            ...
            if (today == null) {
                ...
                Date sDate = startDate.parse(today);
        ...
        startDate = new SimpleDateFormat("yyyy-MM-dd", Locale.US);

        for (int i = 0; i < databaseMgr.get_obs_days(); i++) {
            String dateStr = startDate.format(calendar.getTime());
    ...
    public String getPeType() {
        ...
        peType = peTF.getText().trim().toUpperCase();
    ...
    private String formatRejectedData(java.util.List<String[]> rejectedDataBuf,
        ...
        strBld.append(
                String.format(headerFmt, "ID", "PE", "DUR", "TS", "E",
                        "OBSTIME", "POSTING TIME", "VALUE")).append("\n");
    ...
    private String formatSiteAboveFldStageData(
        ...
        strBld.append(
                String.format(headerFmt, "ID", "PE", "DUR", "TS", "E",
                        "OBSTIME", "PRODUCT", "VALUE", "FS")).append("\n");
    ...
    private String formatSitesTurnedOffData(
        ...
        for (String[] dataArray : sitesTurnedOffBuf) {
            ...
            strBld.append(
                    String.format(dataFmt, dataArray[0], dataArray[1],
                            dataArray[2], dataArray[3])).append("\n");
        }
    ...
    public ArrayList<String> getSelectedText() {
        ...
        // If the selection ends on a line that is in the header then
        // return an empty array.
        if (endLine < 3) {
            return array;
        }

        // If the start line starts in the header area then
        // set the start line to the index of the first data line.
        if (startLine < 3) {
            startLine = 3;
        }
