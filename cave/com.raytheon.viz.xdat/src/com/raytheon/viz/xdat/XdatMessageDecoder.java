 ...
 * Aug 4, 2016  5800       mduff      Use List interface.
 * 
 * </pre>
 * 
 * @author wkwock2
...
public class XdatMessageDecoder {
     ...
     */
    private final List<DecodedMessage> decodedMsgs = new ArrayList<>();
     ...
     *            Array of data lines.
     */
    public XdatMessageDecoder(List<String> xdatMessages) {
     ...
     *            Array of data lines.
     */
    private void decodeMessage(List<String> xdatMessages) {
     ...
     */
    public List<DecodedMessage> getDecodedMessages() {
        return decodedMsgs;
    }
