 ...
 * ------------- -------- --------- --------------------------------------------
 * Apr 02, 2009           lvenable  Initial creation
 * Aug 05, 2010  6396     wkwock    Change the layout of threshold edit dialog
 * Aug 05, 2010  4036     wkwock    Improve the determineError algorithm
 ...
 * @version 1.0
 */
public abstract class EditThresholdsDlg extends CaveSWTDialog
{
    /**
     * Control font.
     */
     ...
     */
    public EditThresholdsDlg(Shell parent)
    {
