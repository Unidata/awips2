...
public class ColumnAttribData {
    ...
    public String toString() {
        return "ColumnAttribData [name=" + name + ", columnName=" + columnName
                + ", splitColumnName=" + splitColumnName
                + ", columnNameWithSpace=" + columnNameWithSpace
                + ", originalName=" + originalName + ", sortDir=" + sortDir
                + ", reverseFilter=" + reverseFilter + ", graphType="
                + graphType + "]";
    }
