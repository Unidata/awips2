...
/**
 * The drawable representation for a warm front, with
 * with triangular protrusions lining one side of the
 * path.  The path may be created with an arbitrary
 * thickness and symbol size.
 *
 * @author Christopher Golden
 */
public class WarmFront extends Front {
	 ...
	 *                       SMOOTHING_xxx</code>
	 *                       constants.
	 * @param symbolSize     Width of each warm front
	 *                       symbol.
	 * @param symbolInterval Interval along the path
	 *                       between each warm front
	 *                       symbol.
	 ...
	 */
	public WarmFront(int frame, int thickness, int smoothing, double symbolSize,
					 double symbolInterval, boolean rightSide, boolean aloft) {
		super(frame, Color.red, SOLID_STYLE, thickness, smoothing,
    ...
    public boolean equals(Object obj) {
		...
		return (super.equals(obj) && (obj instanceof WarmFront));
    }
	...
	protected void createAdornments() {
		...
		addAdornment(new ArcEdgeAdornment(this, Color.red, rightSide,
