...
/**
 * A sample observer that can be used to test the observer mechanism
 * 
 * <pre>
 * SOFTWARE HISTORY
...
public class DebugAlertObserver implements IAlertObserver {
    ...
    public void alertArrived(Collection<AlertMessage> alertMessages) {
        for (AlertMessage msg : alertMessages) {
            System.out.println(msg.dataURI.toString());
        }
    }
